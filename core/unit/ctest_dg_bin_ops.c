...
void test_1d_p1_ho(){ test_1d(1, false); }
void test_1d_p2_ho(){ test_1d(2, false); }
void test_1d_p3_ho(){ test_1d(3, false); }

void test_inv_1d_p1_ho(){ test_inv_1d(1, false); }

void test_2d_p1_ho(){ test_2d(1, false); }
void test_2d_p2_ho(){ test_2d(2, false); }
void test_2d_p3_ho(){ test_2d(3, false); }

void test_inv_2d_p1_ho(){ test_inv_2d(1, false); }

void test_3d_p1_ho(){ test_3d(1, false); }
void test_3d_p2_ho(){ test_3d(2, false); }

void test_4d_p1_ho(){ test_4d(1, false); }
void test_4d_p2_ho(){ test_4d(2, false); }
...
void test_conf_phase_accumulate_subtract_p1_ho() { test_subspace_accumulate(1, false); }
void test_conf_phase_accumulate_subtract_p2_ho() { test_subspace_accumulate(2, false); }

// Cuda specific tests
#ifdef GKYL_HAVE_CUDA

void test_1d_p1_dev(){ test_1d(1, true); }
void test_1d_p2_dev(){ test_1d(2, true); }
void test_1d_p3_dev(){ test_1d(3, true); }

void test_inv_1d_p1_dev(){ test_inv_1d(1, true); }

void test_2d_p1_dev(){ test_2d(1, true); }
void test_2d_p2_dev(){ test_2d(2, true); }
void test_2d_p3_dev(){ test_2d(3, true); }

void test_inv_2d_p1_dev(){ test_inv_2d(1, true); }

void test_3d_p1_dev(){ test_3d(1, true); }
void test_3d_p2_dev(){ test_3d(2, true); }
...
void test_conf_phase_accumulate_subtract_p1_dev() { test_subspace_accumulate(1, true); }
void test_conf_phase_accumulate_subtract_p2_dev() { test_subspace_accumulate(2, true); }

#endif

TEST_LIST = {
  { "test_1d_p1_ho", test_1d_p1_ho },
  { "test_inv_1d_p1_ho", test_inv_1d_p1_ho },
  { "test_1d_p2_ho", test_1d_p2_ho },
  { "test_1d_p3_ho", test_1d_p3_ho },
  { "test_2d_p1_ho", test_2d_p1_ho },
  { "test_inv_2d_p1_ho", test_inv_2d_p1_ho },
  { "test_2d_p2_ho", test_2d_p2_ho },
  { "test_2d_p3_ho", test_2d_p3_ho },
  { "test_3d_p1_ho", test_3d_p1_ho },
  { "test_3d_p2_ho", test_3d_p2_ho },
  { "test_3d_p3_ho", test_3d_p3_ho },
  { "test_4d_p1_ho", test_4d_p1_ho },
  { "test_4d_p2_ho", test_4d_p2_ho },
  { "test_conf_phase_accumulate_subtract_p1_ho", test_conf_phase_accumulate_subtract_p1_ho },
  { "test_conf_phase_accumulate_subtract_p2_ho", test_conf_phase_accumulate_subtract_p2_ho },
#ifdef GKYL_HAVE_CUDA
  { "test_1d_p1_dev", test_1d_p1_dev },
  { "test_inv_1d_p1_dev", test_inv_1d_p1_dev },
  { "test_1d_p2_dev", test_1d_p2_dev },
  { "test_1d_p3_dev", test_1d_p3_dev },
  { "test_2d_p1_dev", test_2d_p1_dev },
  { "test_inv_2d_p1_dev", test_inv_2d_p1_dev },
  { "test_2d_p2_dev", test_2d_p2_dev },
  { "test_2d_p3_dev", test_2d_p3_dev },
  { "test_3d_p1_dev", test_3d_p1_dev },
  { "test_3d_p2_dev", test_3d_p2_dev },
  { "test_3d_p3_dev", test_3d_p3_dev },
  { "test_conf_phase_accumulate_subtract_p1_dev", test_conf_phase_accumulate_subtract_p1_dev },
  { "test_conf_phase_accumulate_subtract_p2_dev", test_conf_phase_accumulate_subtract_p2_dev },
#endif
  { NULL, NULL },
};