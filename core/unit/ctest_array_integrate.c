...
TEST_LIST = {
  ...
  { "test_1x_gradsq_ho", test_1x_gradsq_ho },
  { "test_2x_gradsq_ho", test_2x_gradsq_ho },
#ifdef GKYL_HAVE_CUDA
  { "test_1x_dev", test_1x_dev },
  { "test_2x_dev", test_2x_dev },
  { "test_1x_gradsq_dev", test_1x_gradsq_dev },
  { "test_2x_gradsq_dev", test_2x_gradsq_dev },
#endif
  { NULL, NULL },
};
