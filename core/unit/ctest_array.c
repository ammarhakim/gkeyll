...
test_grid_sub_array_read_1()
{
  ...
  int err = gkyl_grid_sub_array_read(&grid2, &range, arr2, "ctest_grid_sub_array_1.gkyl");
...
test_grid_sub_array_read_2()
{
  ...
  // read back the grid and the array
  int err = gkyl_grid_sub_array_read(&grid2, &srange, arr2, "ctest_grid_sub_array_2.gkyl");
...
test_grid_array_new_from_file_1()
{
  ...
  struct gkyl_rect_grid grid2;
  struct gkyl_array *arr2 =
    gkyl_grid_array_new_from_file(&grid2, "ctest_grid_array_new_from_file_1.gkyl");
