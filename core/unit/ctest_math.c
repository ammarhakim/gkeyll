...
void test_math_ridders_ho(void)
{
  do {
    ...
    struct gkyl_qr_res res = gkyl_ridders(rfunc_1, 0, x1, x2, f1, f2, 100, 1e-12);
  ...
  do {
    ...
    struct gkyl_qr_res res = gkyl_ridders(rfunc_2, 0, x1, x2, f1, f2, 100, 1e-12);
  ...
  do {
    ...
    struct gkyl_qr_res res = gkyl_ridders(rfunc_3, 0, x1, x2, f1, f2, 100, 1e-12);
...
static struct idx_status check_in_list(int nvals, const double complex *vals,
                                       double complex tocheck, double eps)
{
