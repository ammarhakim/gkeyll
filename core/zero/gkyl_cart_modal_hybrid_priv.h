...
} ev_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
...
} eveg_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
                  { NULL, eval_grad_expand_1x1v_hyb_p1, eval_grad_expand_1x2v_hyb_p1,
                    eval_grad_expand_1x3v_hyb_p1 },
                  { NULL, eval_grad_expand_2x1v_hyb_p1, eval_grad_expand_2x2v_hyb_p1,
                    eval_grad_expand_2x3v_hyb_p1 },
                  { NULL, eval_grad_expand_3x1v_hyb_p1, eval_grad_expand_3x2v_hyb_p1,
                    eval_grad_expand_3x3v_hyb_p1 } };
...
GKYL_CU_D static struct {
  int count[4];
} num_basis_list[] = { { 0, 0, 0, 0 }, // No 0x basis functions.
                       { 0, 6, 16, 40 },
                       { 0, 12, 32, 80 },
                       { 0, 24, 64, 160 } };
...
GKYL_CU_D static struct {
  void (*nl[4])(double *node_list);
} nl_list[] = { { NULL, NULL, NULL, NULL }, // No 0x basis functions
                ...
                { NULL, node_coords_3x1v_hyb_p1, node_coords_3x2v_hyb_p1,
                  node_coords_3x3v_hyb_p1 } };
...
GKYL_CU_D static struct {
  int count[4];
} num_quad_list[] = { { 0, 0, 0, 0 }, { 0, 6, 18, 54 }, { 0, 12, 36, 108 }, { 0, 24, 72, 216 } };
