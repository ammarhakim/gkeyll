...
typedef void (*limit_func_t)(const struct gkyl_limiter *up, const struct gkyl_range *range,
  struct gkyl_array *f);

typedef void (*limit_timestep_func_t)(const struct gkyl_limiter *up,
...
struct gkyl_limiter {
  ...
  limit_timestep_func_t limiter_timestep_func;
