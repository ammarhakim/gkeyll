...
typedef struct {
  eval_at_coord_t kernels[3];
} eval_at_coord_kern_list;
typedef struct {
  basis_tar_t kernels[3];
} basis_tar_kern_list;

// Struct with double array for passing coordinates to CUDA kernels.
typedef struct {
  double c[GKYL_MAX_DIM];
} dg_evproj_struct_double_t;
...
GKYL_CU_D static const eval_at_coord_kern_list ser_eval_at_coord_list[6][63] = {
  ...
  { { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_0,
    ...
    { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_1,
      gkyl_dg_eval_at_coord_proj_2x_ser_p2_eval_dirs_1, NULL },
    { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_01,
      gkyl_dg_eval_at_coord_proj_2x_ser_p2_eval_dirs_01, NULL } },
  // ndim_do = 3.
  ...
  // ndim_do = 4.
  { { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_0,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_0, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_1,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_1, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_01,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_01, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_2,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_2, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_02,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_02, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_12,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_12, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_012,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_012, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_3,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_3, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_03,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_03, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_13,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_13, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_013,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_013, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_23,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_23, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_023,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_023, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_123,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_123, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_0123,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_0123, NULL } },
  // ndim_do = 5.
...
GKYL_CU_D static const basis_tar_kern_list ser_basis_tar_list[6][63] = {
  ...
  { { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_0_target_basis,
    ...
    { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_1_target_basis,
      gkyl_dg_eval_at_coord_proj_2x_ser_p2_eval_dirs_1_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_01_target_basis,
      gkyl_dg_eval_at_coord_proj_2x_ser_p2_eval_dirs_01_target_basis, NULL } },
  // ndim_do = 3.
  ...
  // ndim_do = 4.
  { { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_0_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_0_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_1_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_1_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_01_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_01_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_2_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_2_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_02_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_02_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_12_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_12_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_012_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_012_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_3_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_3_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_03_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_03_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_13_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_13_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_013_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_013_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_23_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_23_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_023_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_023_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_123_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_123_target_basis, NULL },
    { gkyl_dg_eval_at_coord_proj_4x_ser_p1_eval_dirs_0123_target_basis,
      gkyl_dg_eval_at_coord_proj_4x_ser_p2_eval_dirs_0123_target_basis, NULL } },
  // ndim_do = 5.
...
GKYL_CU_D static const eval_at_coord_kern_list ten_eval_at_coord_list[3][7] = {
  ...
  // ndim_do = 2.
  { { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_0,
      gkyl_dg_eval_at_coord_proj_2x_tensor_p2_eval_dirs_0, NULL },
    { gkyl_dg_eval_at_coord_proj_2x_ser_p1_eval_dirs_1,
  ...
  int num_eval_dirs, const int *eval_dirs)
{
  ...
  struct dg_ev_proj_kernels *kers =
    (struct dg_ev_proj_kernels *)gkyl_calloc(1, sizeof(struct dg_ev_proj_kernels));
