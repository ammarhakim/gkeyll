...
GKYL_CU_D static struct {
  void (*ev[4])(const double *z, double *b);
                ...
                { NULL, eval_1d_gkhyb_vel_p1, NULL, NULL },
                { NULL, eval_2d_gkhyb_vel_p1, NULL, NULL } };
...
GKYL_CU_D static struct {
  double (*ev[4])(const double *z, const double *f);
                 ...
                 { NULL, eval_expand_1d_gkhyb_vel_p1, NULL, NULL },
                 { NULL, eval_expand_2d_gkhyb_vel_p1, NULL, NULL } };
...
GKYL_CU_D static struct {
  double (*ev[4])(int dir, const double *z, const double *f);
                  ...
                  { NULL, eval_grad_expand_1d_gkhyb_vel_p1, NULL, NULL },
                  { NULL, eval_grad_expand_2d_gkhyb_vel_p1, NULL, NULL } };
...
GKYL_CU_D static struct {
  void (*fs[4])(int dir, const double *f, double *fout);
                 ...
                 { NULL, flip_odd_sign_1d_gkhyb_vel_p1, NULL, NULL },
                 { NULL, flip_odd_sign_2d_gkhyb_vel_p1, NULL, NULL } };

// Flip-sign functions: ev_list[ndim].ev[poly_order]
GKYL_CU_D static struct {
  void (*fs[4])(int dir, const double *f, double *fout);
} fes_list[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
                 { NULL, flip_even_sign_1d_gkhyb_vel_p1, NULL, NULL },
                 { NULL, flip_even_sign_2d_gkhyb_vel_p1, NULL, NULL } };

// Number of basis functions: num_basis_list[ndim].count[poly_order]
GKYL_CU_D static struct {
  int count[4];
} num_basis_list[] = { { 0, 0, 0, 0 }, { 0, 3, 0, 0 }, { 0, 6, 0, 0 } };

// Node list function: ev_list[ndim].ev[poly_order]
GKYL_CU_D static struct {
  void (*nl[4])(double *node_list);
} nl_list[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
                { NULL, node_coords_1d_gkhyb_vel_p1, NULL, NULL },
                { NULL, node_coords_2d_gkhyb_vel_p1, NULL, NULL } };
...
GKYL_CU_D static struct {
  void (*n2m[4])(const double *fnodal, double *fmodal);
                 ...
                 { NULL, nodal_to_modal_1d_gkhyb_vel_p1, NULL, NULL },
                 { NULL, nodal_to_modal_2d_gkhyb_vel_p1, NULL, NULL } };
...
GKYL_CU_D static struct {
  void (*n2m[4])(const double *fquad, double *fmodal, long linc2);
                  ...
                  { NULL, quad_to_modal_1d_gkhyb_vel_p1, NULL, NULL },
                  { NULL, quad_to_modal_2d_gkhyb_vel_p1, NULL, NULL } };

// Number of quadrature nodes: num_quad_list[ndim].count[poly_order]
GKYL_CU_D static struct {
  int count[4];
} num_quad_list[] = { { 0, 0, 0, 0 }, { 0, 3, 0, 0 }, { 0, 6, 0, 0 } };
...
GKYL_CU_D static struct {
  void (*n2m[4])(const double *fmodal, double *fquad, long linc2);
                  ...
                  { NULL, modal_to_quad_1d_gkhyb_vel_p1, NULL, NULL },
                  { NULL, modal_to_quad_2d_gkhyb_vel_p1, NULL, NULL } };
