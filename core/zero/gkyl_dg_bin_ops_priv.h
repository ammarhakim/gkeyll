...
choose_mul_conf_phase_accumulate_kern(
...
choose_mul_conf_phase_accumulate_comp_par_kern(
  enum gkyl_basis_type btype, int cdim, int vdim, int poly_order)
{
  int pdim = cdim + vdim;
