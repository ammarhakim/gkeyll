...
typedef void (*mul_accumulate_comp_par_op_t)(double a, const double *f, const double *g, double *fg,
                                             int linc2);

typedef struct gkyl_kern_op_count (*mul_op_count_t)(void);

// Function pointer type for setting matrices for division
typedef void (*div_set_op_t)(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *f,
                             const double *g);
...
typedef struct {
  mul_accumulate_op_t kernels[4];
} mul_accumulate_op_kern_list;
typedef struct {
  mul_accumulate_comp_par_op_t kernels[4];
} mul_accumulate_comp_par_op_kern_list;
typedef struct {
  mul_op_kern_list list[3];
} cross_mul_op_kern_list;
typedef struct {
  mul_accumulate_op_kern_list list[3];
} cross_mul_accumulate_op_kern_list;
typedef struct {
  mul_accumulate_comp_par_op_kern_list list[3];
} cross_mul_accumulate_comp_par_op_kern_list;
typedef struct {
  mul_op_count_t kernels[4];
} mul_op_count_kern_list;
typedef struct {
  div_set_op_t kernels[4];
} div_set_op_kern_list;
typedef struct {
  inv_op_t kernels[4];
} inv_op_kern_list;
...
GKYL_CU_D static const cross_mul_accumulate_op_kern_list ser_cross_mul_accumulate_list[] = {
  ...
  { .list = { { NULL, binop_cross_mul_accumulate_1d_3d_ser_p1,
              ...
              { NULL, binop_cross_mul_accumulate_2d_3d_ser_p1,
                binop_cross_mul_accumulate_2d_3d_ser_p2, binop_cross_mul_accumulate_2d_3d_ser_p3 },
              { NULL, NULL, NULL, NULL } } },
  // pdim=4
  { .list = { { NULL, binop_cross_mul_accumulate_1d_4d_ser_p1,
              ...
              { NULL, binop_cross_mul_accumulate_3d_4d_ser_p1,
                binop_cross_mul_accumulate_3d_4d_ser_p2,
                binop_cross_mul_accumulate_3d_4d_ser_p3 } } },
  // pdim=5
  { .list = { { NULL, NULL, NULL, NULL },
              { NULL, binop_cross_mul_accumulate_2d_5d_ser_p1,
                binop_cross_mul_accumulate_2d_5d_ser_p2, NULL },
              { NULL, binop_cross_mul_accumulate_3d_5d_ser_p1,
                binop_cross_mul_accumulate_3d_5d_ser_p2, NULL } } },
  // pdim=6
  { .list = { { NULL, NULL, NULL, NULL },
              { NULL, NULL, NULL, NULL },
...
GKYL_CU_D static const cross_mul_accumulate_op_kern_list ten_cross_mul_accumulate_list[] = {
  ...
  { .list = { { NULL, binop_cross_mul_accumulate_1d_3d_ser_p1,
              ...
              { NULL, binop_cross_mul_accumulate_2d_3d_ser_p1,
                binop_cross_mul_accumulate_2d_3d_tensor_p2, NULL },
              { NULL, NULL, NULL, NULL } } },
  // pdim=4
  { .list = { { NULL, binop_cross_mul_accumulate_1d_4d_ser_p1,
                binop_cross_mul_accumulate_1d_4d_tensor_p2, NULL },
              { NULL, binop_cross_mul_accumulate_2d_4d_ser_p1,
                binop_cross_mul_accumulate_2d_4d_tensor_p2, NULL },
              { NULL, NULL, NULL, NULL } } },
  // pdim=5
  { .list = { { NULL, NULL, NULL, NULL },
              { NULL, binop_cross_mul_accumulate_2d_5d_ser_p1,
                binop_cross_mul_accumulate_2d_5d_tensor_p2, NULL },
...
GKYL_CU_D static mul_op_t choose_ten_mul_kern(int dim, int poly_order)
{
  assert(dim < 4);
  return ten_mul_list[dim].kernels[poly_order];
}

GKYL_CU_D static mul_op_t choose_mul_conf_phase_kern(enum gkyl_basis_type btype, int cdim, int vdim,
                                                     int poly_order)
{
  int pdim = cdim + vdim;
...
choose_mul_conf_phase_accumulate_kern(enum gkyl_basis_type btype, int cdim, int vdim,
                                      int poly_order)
{
  int pdim = cdim + vdim;
...
GKYL_CU_D static mul_accumulate_comp_par_op_t
choose_mul_conf_phase_accumulate_comp_par_kern(enum gkyl_basis_type btype, int cdim, int vdim,
                                               int poly_order)
{
  int pdim = cdim + vdim;
...
static mul_op_count_t choose_ser_mul_op_count_kern(int dim, int poly_order)
{
  return ser_mul_op_count_list[dim].kernels[poly_order];
}

GKYL_CU_D static div_set_op_t choose_ser_div_set_kern(int dim, int poly_order)
{
  return ser_div_set_list[dim].kernels[poly_order];
}

GKYL_CU_D static div_set_op_t choose_ten_div_set_kern(int dim, int poly_order)
{
  return ten_div_set_list[dim].kernels[poly_order];
}

GKYL_CU_D static inv_op_t choose_ser_inv_kern(int dim, int poly_order)
{
  return ser_inv_list[dim].kernels[poly_order];
}

GKYL_CU_D static inline double dg_cell_mean(int nc, const double *f)
{
  return f[0];
}
