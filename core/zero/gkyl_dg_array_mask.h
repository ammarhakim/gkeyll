...
struct gkyl_dg_array_mask_inp {
  ...
  double
    threshold; // Threshold for marking cells as masked. Absolute value for *_THRESHOLD types, fraction (0-1) for *_FRAC_THRESHOLD types.
 ...
 */
void gkyl_dg_array_mask_scale_by_cell(
  struct gkyl_dg_array_mask *mask, const struct gkyl_array *arr_in);
