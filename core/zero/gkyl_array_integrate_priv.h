...
typedef struct {
  array_integrate_t kernels[2];
} array_integrate_none_kern_list;
typedef struct {
  array_integrate_t kernels[2];
} array_integrate_abs_kern_list;
typedef struct {
  array_integrate_t kernels[2];
} array_integrate_sq_kern_list;
typedef struct {
  array_integrate_t kernels[2];
} array_integrate_sq_weighted_kern_list;
typedef struct {
  array_integrate_t kernels[2];
} array_integrate_gradsq_kern_list;
typedef struct {
  array_integrate_t kernels[2];
} array_integrate_gradperpsq_kern_list;
typedef struct {
  array_integrate_t kernels[2];
