...
int
gkyl_comm_allreduce(struct gkyl_comm *pcomm, enum gkyl_elem_type type, enum gkyl_array_op op,
...
int
gkyl_comm_allreduce_host(struct gkyl_comm *pcomm, enum gkyl_elem_type type, enum gkyl_array_op op,
  int nelem, const void *inp, void *out)
{
  struct gkyl_comm_priv *comm = container_of(pcomm, struct gkyl_comm_priv, pub_comm);
...
int
gkyl_comm_array_allgather(struct gkyl_comm *pcomm, const struct gkyl_range *local,
...
int
gkyl_comm_array_allgather_host(struct gkyl_comm *pcomm, const struct gkyl_range *local,
  const struct gkyl_range *global, const struct gkyl_array *array_local,
  struct gkyl_array *array_global)
{
  struct gkyl_comm_priv *comm = container_of(pcomm, struct gkyl_comm_priv, pub_comm);
...
int
gkyl_comm_array_bcast(struct gkyl_comm *pcomm, const struct gkyl_array *array_send,
...
int
gkyl_comm_array_bcast_host(struct gkyl_comm *pcomm, const struct gkyl_array *array_send,
  struct gkyl_array *array_recv, int root)
{
  struct gkyl_comm_priv *comm = container_of(pcomm, struct gkyl_comm_priv, pub_comm);
...
int
gkyl_comm_array_sync(struct gkyl_comm *pcomm, const struct gkyl_range *local,
...
int
gkyl_comm_array_per_sync(struct gkyl_comm *pcomm, const struct gkyl_range *local,
...
int
gkyl_comm_array_write(struct gkyl_comm *pcomm, const struct gkyl_rect_grid *grid,
...
int
gkyl_comm_array_read(struct gkyl_comm *pcomm, const struct gkyl_rect_grid *grid,
...
struct gkyl_comm *
gkyl_comm_extend_comm(const struct gkyl_comm *pcomm, const struct gkyl_range *erange)
{
  struct gkyl_comm_priv *comm = container_of(pcomm, struct gkyl_comm_priv, pub_comm);
...
struct gkyl_comm *
gkyl_comm_split_comm(const struct gkyl_comm *pcomm, int color, struct gkyl_rect_decomp *new_decomp)
{
  struct gkyl_comm_priv *comm = container_of(pcomm, struct gkyl_comm_priv, pub_comm);
...
struct gkyl_comm *
gkyl_comm_create_comm_from_ranks(const struct gkyl_comm *pcomm, int nranks, const int *ranks,
