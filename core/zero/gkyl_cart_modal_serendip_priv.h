...
GKYL_CU_D static struct {
  double (*ev[4])(int dir, const double *z, const double *f);
                  ...
                  { eval_grad_expand_1d_ser_p0, eval_grad_expand_1d_ser_p1,
                    eval_grad_expand_1d_ser_p2, eval_grad_expand_1d_ser_p3 },
                  { eval_grad_expand_2d_ser_p0, eval_grad_expand_2d_ser_p1,
                    eval_grad_expand_2d_ser_p2, eval_grad_expand_2d_ser_p3 },
                  { eval_grad_expand_3d_ser_p0, eval_grad_expand_3d_ser_p1,
                    eval_grad_expand_3d_ser_p2, eval_grad_expand_3d_ser_p3 },
                  { eval_grad_expand_4d_ser_p0, eval_grad_expand_4d_ser_p1,
                    eval_grad_expand_4d_ser_p2, eval_grad_expand_4d_ser_p3 },
                  { eval_grad_expand_5d_ser_p0, eval_grad_expand_5d_ser_p1,
                    eval_grad_expand_5d_ser_p2, NULL },
...
GKYL_CU_D static struct {
  void (*fs[4])(int dir, const double *f, double *fout);
                 ...
                 { flip_odd_sign_2d_ser_p0, flip_odd_sign_2d_ser_p1, flip_odd_sign_2d_ser_p2,
                   flip_odd_sign_2d_ser_p3 },
                 { flip_odd_sign_3d_ser_p0, flip_odd_sign_3d_ser_p1, flip_odd_sign_3d_ser_p2,
                   flip_odd_sign_3d_ser_p3 },
                 { flip_odd_sign_4d_ser_p0, flip_odd_sign_4d_ser_p1, flip_odd_sign_4d_ser_p2,
                   flip_odd_sign_4d_ser_p3 },
                 { flip_odd_sign_5d_ser_p0, flip_odd_sign_5d_ser_p1, flip_odd_sign_5d_ser_p2,
                   NULL },
...
GKYL_CU_D static struct {
  void (*fs[4])(int dir, const double *f, double *fout);
                 ...
                 { flip_even_sign_2d_ser_p0, flip_even_sign_2d_ser_p1, flip_even_sign_2d_ser_p2,
                   flip_even_sign_2d_ser_p3 },
                 { flip_even_sign_3d_ser_p0, flip_even_sign_3d_ser_p1, flip_even_sign_3d_ser_p2,
                   flip_even_sign_3d_ser_p3 },
                 { flip_even_sign_4d_ser_p0, flip_even_sign_4d_ser_p1, flip_even_sign_4d_ser_p2,
                   flip_even_sign_4d_ser_p3 },
                 { flip_even_sign_5d_ser_p0, flip_even_sign_5d_ser_p1, flip_even_sign_5d_ser_p2,
                   NULL },
...
GKYL_CU_D static struct {
  int count[4];
} num_basis_list[] = { { 1, 1, 1, 1 },    { 1, 2, 3, 4 },      { 1, 4, 8, 12 },  { 1, 8, 20, 32 },
                       { 1, 16, 48, 80 }, { 1, 32, 112, 192 }, { 1, 64, 256, 0 } };
...
GKYL_CU_D static struct {
  void (*n2m[4])(const double *fnodal, double *fmodal);
} n2m_quad_surf_list_z[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
                             { NULL, NULL, NULL, NULL }, // No 1D basis functions
                             { NULL, NULL, NULL, NULL }, // No 2D basis functions
                             { NULL, nodal_to_modal_quad_surfz_3d_ser_p1,
                               nodal_to_modal_quad_surfz_3d_ser_p2, NULL } };
...
GKYL_CU_D static struct {
  void (*nl[4])(double *node_list);
} nl_quad_surf_list_z[] = { { NULL, NULL, NULL, NULL }, // No 0D basis functions
                            { NULL, NULL, NULL, NULL }, // No 1D basis functions
                            { NULL, NULL, NULL, NULL }, // No 2D basis functions
                            { NULL, node_coords_quad_surfz_3d_ser_p1,
                              node_coords_quad_surfz_3d_ser_p2, NULL } };
