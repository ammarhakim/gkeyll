...
__global__ void gkyl_dg_array_mask_less_than_kernel(struct gkyl_range mask_rng,
...
__global__ void gkyl_dg_array_mask_greater_than_kernel(struct gkyl_range mask_rng,
                                                       const struct gkyl_array *arr_to_mask,
                                                       struct gkyl_array *mask, double f_threshold)
{
  int idx[GKYL_MAX_DIM];
...
__global__ void gkyl_dg_array_mask_find_local_max_kernel(struct gkyl_range conf_rng,
                                                         struct gkyl_range vel_rng,
                                                         struct gkyl_range mask_rng,
                                                         const struct gkyl_array *arr_to_mask,
...
static void advance_cu_less_than(struct gkyl_dg_array_mask *mask,
                                 const struct gkyl_array *arr_to_mask)
{
...
static void advance_cu_greater_than(struct gkyl_dg_array_mask *mask,
                                    const struct gkyl_array *arr_to_mask)
{
  int nblocks = arr_to_mask->nblocks;
  int nthreads = arr_to_mask->nthreads;
...
static void advance_cu_less_than_frac_conf(struct gkyl_dg_array_mask *mask,
                                           const struct gkyl_array *arr_to_mask)
{
...
static void advance_cu_greater_than_frac_conf(struct gkyl_dg_array_mask *mask,
                                              const struct gkyl_array *arr_to_mask)
{
  int nthreads = mask->mask_arr->nthreads;
  int conf_nblocks = mask->conf_rng->nblocks;
...
__global__ void advance_threshold_frac_kernel(struct gkyl_dg_array_mask *mask,
...
void gkyl_dg_array_mask_advance_threshold_cu(struct gkyl_dg_array_mask *mask,
                                             const double global_max)
{
...
__global__ static void gkyl_dg_array_mask_eval_idx_kernel(struct gkyl_dg_array_mask *mask,
...
__global__ static void gkyl_dg_array_mask_set_dev_func_ptr(struct gkyl_dg_array_mask *mask,
