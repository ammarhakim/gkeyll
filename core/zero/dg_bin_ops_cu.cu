...
__global__ void
gkyl_dg_mul_op_cu_kernel(struct gkyl_basis basis, int c_oop, struct gkyl_array *out, int c_lop,
...
void
gkyl_dg_mul_op_cu(const struct gkyl_basis *basis, int c_oop, struct gkyl_array *out, int c_lop,
  const struct gkyl_array *lop, int c_rop, const struct gkyl_array *rop)
{
...
__global__ void
gkyl_dg_mul_op_range_cu_kernel(struct gkyl_basis basis, int c_oop, struct gkyl_array *out,
  int c_lop, const struct gkyl_array *lop, int c_rop, const struct gkyl_array *rop,
...
void
gkyl_dg_mul_op_range_cu(const struct gkyl_basis *basis, int c_oop, struct gkyl_array *out,
  int c_lop, const struct gkyl_array *lop, int c_rop, const struct gkyl_array *rop,
...
void
gkyl_dg_mul_conf_phase_op_range_cu(const struct gkyl_basis *cbasis, const struct gkyl_basis *pbasis,
  struct gkyl_array *pout, const struct gkyl_array *cop, const struct gkyl_array *pop,
...
gkyl_dg_mul_conf_phase_op_accumulate_range_cu_kernel(struct gkyl_basis cbasis,
  struct gkyl_basis pbasis, struct gkyl_array *pout, double a, const struct gkyl_array *cop,
  const struct gkyl_array *pop, struct gkyl_range crange, struct gkyl_range prange)
{
  int cdim = cbasis.ndim;
  int vdim = pbasis.ndim - cdim;
  int poly_order = cbasis.poly_order;
...
__global__ void
gkyl_dg_dot_product_op_cu_kernel(struct gkyl_basis basis, struct gkyl_array *out,
...
void
gkyl_dg_dot_product_op_cu(const struct gkyl_basis *basis, struct gkyl_array *out,
  const struct gkyl_array *lop, const struct gkyl_array *rop)
{
...
__global__ void
gkyl_dg_dot_product_op_range_cu_kernel(struct gkyl_basis basis, struct gkyl_array *out,
  const struct gkyl_array *lop, const struct gkyl_array *rop, struct gkyl_range range)
{
  int ndim = basis.ndim;
  int poly_order = basis.poly_order;
  mul_op_t mul_op = choose_ser_mul_kern(ndim, poly_order);
...
void
gkyl_dg_dot_product_op_range_cu(const struct gkyl_basis *basis, struct gkyl_array *out,
...
__global__ void
gkyl_dg_div_set_op_cu_kernel(struct gkyl_nmat *As, struct gkyl_nmat *xs, struct gkyl_basis basis,
...
__global__ void
gkyl_dg_div_copy_sol_op_cu_kernel(
  struct gkyl_nmat *xs, struct gkyl_basis basis, int c_oop, struct gkyl_array *out)
{
  int num_basis = basis.num_basis;
  for (unsigned long linc = START_ID; linc < NSIZE(out); linc += blockDim.x * gridDim.x) {
    double *out_d = (double *)gkyl_array_fetch(out, linc);
...
void
gkyl_dg_div_op_cu(gkyl_dg_bin_op_mem *mem, const struct gkyl_basis *basis, int c_oop,
  struct gkyl_array *out, int c_lop, const struct gkyl_array *lop, int c_rop,
  const struct gkyl_array *rop)
{
...
gkyl_dg_div_set_op_range_cu_kernel(struct gkyl_nmat *As, struct gkyl_nmat *xs,
  struct gkyl_basis basis, struct gkyl_array *out, int c_lop, const struct gkyl_array *lop,
...
__global__ void
gkyl_dg_div_copy_sol_op_range_cu_kernel(struct gkyl_nmat *xs, struct gkyl_basis basis, int c_oop,
...
void
gkyl_dg_div_op_range_cu(gkyl_dg_bin_op_mem *mem, const struct gkyl_basis *basis, int c_oop,
  struct gkyl_array *out, int c_lop, const struct gkyl_array *lop, int c_rop,
...
__global__ void
gkyl_dg_inv_op_cu_kernel(struct gkyl_basis basis, int c_oop, struct gkyl_array *out, int c_iop,
...
void
gkyl_dg_inv_op_cu(const struct gkyl_basis *basis, int c_oop, struct gkyl_array *out, int c_iop,
  const struct gkyl_array *iop)
{
...
__global__ void
gkyl_dg_inv_op_range_cu_kernel(struct gkyl_basis basis, int c_oop, struct gkyl_array *out,
...
void
gkyl_dg_inv_op_range_cu(const struct gkyl_basis *basis, int c_oop, struct gkyl_array *out,
