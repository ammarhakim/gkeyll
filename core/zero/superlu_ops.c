...
gkyl_superlu_prob *gkyl_superlu_prob_new(int nprob, int mrow, int ncol, int nrhs)
{
...
static void superlu_alloc_work_if_needed(struct gkyl_superlu_prob *prob, int k)
{
