...
/**
 * Compute out = max(out,inp). Returns out.
 *
 * @param out Output array
 * @param inp Input array
 ...
 * @return out array
 */
struct gkyl_array* gkyl_array_ceil_range(struct gkyl_array *out,
...
void gkyl_array_ceil_range_cu(struct gkyl_array* out, const struct gkyl_array* inp, const struct gkyl_range *range);
