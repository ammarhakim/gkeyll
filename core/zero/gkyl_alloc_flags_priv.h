...
static const uint32_t gkyl_alloc_flags_masks[] = { 0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80 };
...
#define GKYL_IS_ALLOC_ALIGNED(flags) \
  (((flags) & gkyl_alloc_flags_masks[GKYL_IS_ALLOC_ALIGNED]) != 0)
