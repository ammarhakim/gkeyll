...
GKYL_CU_DH void 
dg_differentiate_local_ser_1x_p2_dir0_order1(double dx, const double *fin, double *out) 
{ 
...
GKYL_CU_DH void 
dg_differentiate_local_ser_1x_p2_dir0_order2(double dx, const double *fin, double *out) 
{ 
  // dx: cell size in each direction. 
  // fin: Input scalar DG field. 
  // out: output derivative of fin. 
