...
typedef struct {
  gk_nf_udrift_set_prob_t kernels[4];
} gkyl_gk_nf_prim_vars_udrift_set_prob_kern_list;
typedef struct {
  gk_nf_udrift_get_sol_t kernels[4];
} gkyl_gk_nf_prim_vars_udrift_get_sol_kern_list;
typedef struct {
  gk_nf_pressure_t kernels[4];
} gkyl_gk_nf_prim_vars_pressure_kern_list;
typedef struct {
  gk_nf_temp_set_prob_t kernels[4];
} gkyl_gk_nf_prim_vars_temp_set_prob_kern_list;
typedef struct {
  gk_nf_temp_get_sol_t kernels[4];
} gkyl_gk_nf_prim_vars_temp_get_sol_kern_list;
typedef struct {
  gk_nf_udrift_temp_set_prob_t kernels[4];
} gkyl_gk_nf_prim_vars_udrift_temp_set_prob_kern_list;
typedef struct {
  gk_nf_udrift_temp_get_sol_t kernels[4];
} gkyl_gk_nf_prim_vars_udrift_temp_get_sol_kern_list;
typedef struct {
  gk_nf_flowE_set_prob_t kernels[4];
} gkyl_gk_nf_prim_vars_flowE_set_prob_kern_list;
typedef struct {
  gk_nf_flowE_get_sol_t kernels[4];
} gkyl_gk_nf_prim_vars_flowE_get_sol_kern_list;
...
struct gkyl_gk_neut_fluid_prim_vars {
  ...
  gk_nf_udrift_temp_set_prob_t
    udrift_temp_set_prob_ker; // Kernel for setting matrices for linear solve.
...
GKYL_CU_D static const gkyl_gk_nf_prim_vars_pressure_kern_list
  ser_gk_nf_prim_vars_pressure_kernels[] = {
    { gk_neut_fluid_prim_vars_pressure_1x_ser_p1, gk_neut_fluid_prim_vars_pressure_1x_ser_p2,
      NULL },
...
GKYL_CU_D static const gkyl_gk_nf_prim_vars_temp_get_sol_kern_list
  ser_gk_nf_prim_vars_temp_get_sol_kernels[] = {
    { gk_neut_fluid_prim_vars_temp_get_sol_1x_ser_p1,
      gk_neut_fluid_prim_vars_temp_get_sol_1x_ser_p2, NULL },
...
GKYL_CU_D static gk_nf_udrift_set_prob_t choose_udrift_set_prob_ker(enum gkyl_basis_type b_type,
...
GKYL_CU_D static gk_nf_udrift_get_sol_t choose_udrift_get_sol_ker(enum gkyl_basis_type b_type,
                                                                  int cdim, int poly_order)
{
  switch (b_type) {
  case GKYL_BASIS_MODAL_SERENDIPITY:
...
GKYL_CU_D static gk_nf_pressure_t choose_pressure_ker(enum gkyl_basis_type b_type, int cdim,
                                                      int poly_order)
{
  switch (b_type) {
  case GKYL_BASIS_MODAL_SERENDIPITY:
...
GKYL_CU_D static gk_nf_temp_set_prob_t choose_temp_set_prob_ker(enum gkyl_basis_type b_type,
                                                                int cdim, int poly_order)
{
  switch (b_type) {
  case GKYL_BASIS_MODAL_SERENDIPITY:
...
GKYL_CU_D static gk_nf_temp_get_sol_t choose_temp_get_sol_ker(enum gkyl_basis_type b_type, int cdim,
                                                              int poly_order)
{
  switch (b_type) {
  case GKYL_BASIS_MODAL_SERENDIPITY:
...
GKYL_CU_D static gk_nf_flowE_set_prob_t choose_flowE_set_prob_ker(enum gkyl_basis_type b_type,
                                                                  int cdim, int poly_order)
{
  switch (b_type) {
  case GKYL_BASIS_MODAL_SERENDIPITY:
...
GKYL_CU_D static gk_nf_flowE_get_sol_t choose_flowE_get_sol_ker(enum gkyl_basis_type b_type,
                                                                int cdim, int poly_order)
{
  switch (b_type) {
  case GKYL_BASIS_MODAL_SERENDIPITY:
