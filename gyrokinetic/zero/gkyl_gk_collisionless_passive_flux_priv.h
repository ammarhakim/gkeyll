...
typedef struct {
  gk_collisionless_passive_flux_surf_t kernels[3];
} gkyl_gk_collisionless_passive_flux_surf_kern_list;
...
//
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_surfx_kernels[] = {
...
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_edge_surfx_kernels[] = {
...
//
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_surfy_kernels[] = {
...
//
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_surfz_kernels[] = {
    {NULL, NULL, NULL}, // 0
    {NULL, NULL, NULL}, // 1
    {NULL, NULL, NULL}, // 2
...
// z-direction edge
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_edge_surfz_kernels[] = {
    {NULL, NULL, NULL}, // 0
    {NULL, NULL, NULL}, // 1
    {NULL, NULL, NULL}, // 2
...
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_multib_boundary_surfx_kernels[] = {
...
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_multib_boundary_edge_surfx_kernels[] = {
...
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_multib_boundary_edge_surfy_kernels[] = {
    {NULL, NULL, NULL}, // 0
    {NULL, NULL, NULL}, // 1
...
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_multib_boundary_surfz_kernels[] = {
    {NULL, NULL, NULL}, // 0
    {NULL, NULL, NULL}, // 1
    {NULL, NULL, NULL}, // 2
...
GKYL_CU_D static const gkyl_gk_collisionless_passive_flux_surf_kern_list
  ser_gk_collisionless_passive_flux_multib_boundary_edge_surfz_kernels[] = {
    {NULL, NULL, NULL}, // 0
    {NULL, NULL, NULL}, // 1
    {NULL, NULL, NULL}, // 2
...
{
  if (dir == 0)
    return ser_gk_collisionless_passive_flux_surfx_kernels[cv_index_passive[cdim].vdim[vdim]]
      .kernels[poly_order];
  else if (dir == 1)
    return ser_gk_collisionless_passive_flux_surfy_kernels[cv_index_passive[cdim].vdim[vdim]]
      .kernels[poly_order];
  else if (dir == 2)
    return ser_gk_collisionless_passive_flux_surfz_kernels[cv_index_passive[cdim].vdim[vdim]]
      .kernels[poly_order];
  ...
  int dir, int cdim, int vdim, int poly_order, enum gkyl_gyrokinetic_bc_type bc)
{
  if (bc == GKYL_BC_GK_SKIP) {
    if (dir == 0)
      return ser_gk_collisionless_passive_flux_multib_boundary_surfx_kernels[cv_index_passive[cdim]
                                                                               .vdim[vdim]]
        .kernels[poly_order];
    else if (dir == 1)
      return ser_gk_collisionless_passive_flux_multib_boundary_surfy_kernels[cv_index_passive[cdim]
                                                                               .vdim[vdim]]
        .kernels[poly_order];
    else if (dir == 2)
      return ser_gk_collisionless_passive_flux_multib_boundary_surfz_kernels[cv_index_passive[cdim]
                                                                               .vdim[vdim]]
        .kernels[poly_order];
    else
      return NULL;
  ...
  int dir, int cdim, int vdim, int poly_order, enum gkyl_gyrokinetic_bc_type bc)
{
  if (bc == GKYL_BC_GK_SKIP) {
    if (dir == 0)
      return ser_gk_collisionless_passive_flux_multib_boundary_edge_surfx_kernels
        [cv_index_passive[cdim].vdim[vdim]]
          .kernels[poly_order];
    else if (dir == 1)
      return ser_gk_collisionless_passive_flux_multib_boundary_edge_surfy_kernels
        [cv_index_passive[cdim].vdim[vdim]]
          .kernels[poly_order];
    else if (dir == 2)
      return ser_gk_collisionless_passive_flux_multib_boundary_edge_surfz_kernels
        [cv_index_passive[cdim].vdim[vdim]]
          .kernels[poly_order];
    else
      return NULL;
    ...
    if (dir == 0)
      return ser_gk_collisionless_passive_flux_edge_surfx_kernels[cv_index_passive[cdim].vdim[vdim]]
        .kernels[poly_order];
    else if (dir == 1)
      return ser_gk_collisionless_passive_flux_edge_surfy_kernels[cv_index_passive[cdim].vdim[vdim]]
        .kernels[poly_order];
    else if (dir == 2)
      return ser_gk_collisionless_passive_flux_edge_surfz_kernels[cv_index_passive[cdim].vdim[vdim]]
        .kernels[poly_order];
    return NULL;
  }
