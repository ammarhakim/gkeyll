...
gkyl_mom_bcorr_lbo_gyrokinetic_set_cu_dev_ptrs(struct mom_type_bcorr_lbo_gyrokinetic *mom_bcorr,
                                               enum gkyl_basis_type b_type, int vdim,
                                          ...
                                          const struct gkyl_velocity_map *vel_map)
{
  ...
  struct mom_type_bcorr_lbo_gyrokinetic *mom_bcorr =
    (struct mom_type_bcorr_lbo_gyrokinetic *)gkyl_malloc(sizeof(*mom_bcorr));
  ...
  struct mom_type_bcorr_lbo_gyrokinetic *mom_bcorr_cu =
    (struct mom_type_bcorr_lbo_gyrokinetic *)gkyl_cu_malloc(
      sizeof(struct mom_type_bcorr_lbo_gyrokinetic));
  gkyl_cu_memcpy(mom_bcorr_cu, mom_bcorr, sizeof(struct mom_type_bcorr_lbo_gyrokinetic),
                 GKYL_CU_MEMCPY_H2D);

  assert(cv_index[cdim].vdim[vdim] != -1);

  gkyl_mom_bcorr_lbo_gyrokinetic_set_cu_dev_ptrs<<<1, 1> > >(mom_bcorr_cu, cbasis->b_type, vdim,
