...
calc_RdR_p1(const double *psi, double psi0, double Z, double xc[2], double dx[2])
{
  ...
  double rnorm =
    (-(1.732050807568877 * psi[2] * y) / (3.0 * psi[3] * y + 1.732050807568877 * psi[1])) +
    (2.0 * psi0) / (3.0 * psi[3] * y + 1.732050807568877 * psi[1]) -
    (1.0 * psi[0]) / (3.0 * psi[3] * y + 1.732050807568877 * psi[1]);
...
calc_RdR_p2_tensor(const double *psi, double psi0, double Z, double xc[2], double dx[2])
{
  ...
  double bq = 0.125 *
    (23.2379000772445 * psi[7] * SQ(y) + 12.0 * psi[3] * y - 7.745966692414834 * psi[7] +
      6.928203230275509 * psi[1]);
  double cq = 0.125 *
      ((13.41640786499874 * psi[5] - 15.0 * psi[8]) * SQ(y) +
  ...
  if (delta2 > 0) {
    ...
    if ((-1 <= r1) && (r1 < 1)) {
      ...
      double x = r1;
      double C = 0.125 *
        (SQ(x) * (90.0 * psi[8] * y + 23.2379000772445 * psi[6]) +
          x * (46.47580015448901 * psi[7] * y + 12.0 * psi[3]) +
          2 * (13.41640786499874 * psi[5] - 15.0 * psi[8]) * y - 7.745966692414834 * psi[6] +
          6.928203230275509 * psi[2]);
      double A = 0.125 *
        (2 * x *
            (45.0 * psi[8] * SQ(y) + 23.2379000772445 * psi[6] * y - 15.0 * psi[8] +
              13.41640786499874 * psi[4]) +
...
calc_RdR_p3(const double *psi, double psi0, double Z, double xc[2], double dx[2])
{
  ...
  coeffs[3] = 0.125 *
    (175.0 * psi[15] * CUB(y) + 88.74119674649424 * psi[13] * SQ(y) +
      (45.8257569495584 * psi[11] - 105.0 * psi[15]) * y + 26.45751311064591 * psi[8] -
      29.58039891549808 * psi[13]);
  coeffs[2] = 0.125 *
    (88.74119674649424 * psi[14] * CUB(y) + 45.0 * psi[10] * SQ(y) +
      (23.2379000772445 * psi[6] - 53.24471804789655 * psi[14]) * y + 13.41640786499874 * psi[4] -
      15.0 * psi[10]);
  coeffs[1] = 0.125 *
    ((45.8257569495584 * psi[12] - 105.0 * psi[15]) * CUB(y) +
      (23.2379000772445 * psi[7] - 53.24471804789655 * psi[13]) * SQ(y) +
      (12.0 * psi[3] + 63.0 * psi[15] - 27.49545416973504 * psi[12] - 27.49545416973504 * psi[11]) *
        y -
      15.87450786638754 * psi[8] - 7.745966692414834 * psi[7] + 17.74823934929885 * psi[13] +
      6.928203230275509 * psi[1]);
  coeffs[0] = 0.125 *
      ((26.45751311064591 * psi[9] - 29.58039891549808 * psi[14]) * CUB(y) +
        (13.41640786499874 * psi[5] - 15.0 * psi[10]) * SQ(y) +
        (-15.87450786638754 * psi[9] - 7.745966692414834 * psi[6] + 6.928203230275509 * psi[2] +
          17.74823934929885 * psi[14]) *
          y -
  ...
  for (int i = 0; i < 3; i++) {
    if (rts.rpart[i] < 1.0 && rts.rpart[i] > -1.0 && fabs(rts.impart[i]) < 1e-16) {
      ...
      double dpsidx = 6.5625000000000000e+01 * (x * x) * (y * y * y) * psi[15] +
        -9.6824583655185426e-01 * psi[7] + -6.6555897559870685e+00 * (y * y) * psi[13] +
        5.7282196186947996e+00 * (y * y * y) * psi[12] + 2.9047375096555625e+00 * psi[7] * (y * y) +
        3.3277948779935343e+01 * (x * x) * (y * y) * psi[13] +
        5.8094750193111251e+00 * psi[6] * x * y + -1.3125000000000000e+01 * (y * y * y) * psi[15] +
        9.9215674164922145e+00 * (x * x) * psi[8] + -3.7500000000000000e+00 * x * psi[10] +
        8.6602540378443860e-01 * psi[1] + -3.4369317712168801e+00 * y * psi[12] +
        -1.3311179511974137e+01 * x * psi[14] * y + -1.9843134832984430e+00 * psi[8] +
        -3.4369317712168801e+00 * y * psi[11] + -3.9375000000000000e+01 * (x * x) * y * psi[15] +
        1.7184658856084400e+01 * (x * x) * y * psi[11] + 2.2185299186623562e+00 * psi[13] +
        2.2185299186623560e+01 * x * psi[14] * (y * y * y) + 1.5000000000000000e+00 * y * psi[3] +
        -1.1092649593311780e+01 * (x * x) * psi[13] +
        1.1250000000000000e+01 * x * (y * y) * psi[10] + 7.8750000000000000e+00 * y * psi[15] +
        3.3541019662496847e+00 * x * psi[4];
      double dpsidy = -9.6824583655185426e-01 * psi[6] + 1.5000000000000000e+00 * x * psi[3] +
        2.2185299186623560e+01 * (x * x * x) * y * psi[13] + 7.8750000000000000e+00 * x * psi[15] +
        3.3277948779935343e+01 * (x * x) * psi[14] * (y * y) + 2.2185299186623562e+00 * psi[14] +
        -3.4369317712168801e+00 * x * psi[12] + 9.9215674164922145e+00 * (y * y) * psi[9] +
        -3.4369317712168801e+00 * x * psi[11] + -1.3311179511974137e+01 * x * y * psi[13] +
        -1.1092649593311780e+01 * psi[14] * (y * y) +
        -3.9375000000000000e+01 * x * (y * y) * psi[15] +
        -1.3125000000000000e+01 * (x * x * x) * psi[15] + -3.7500000000000000e+00 * y * psi[10] +
        2.9047375096555625e+00 * psi[6] * (x * x) + 5.8094750193111251e+00 * psi[7] * x * y +
        -6.6555897559870685e+00 * (x * x) * psi[14] +
        5.7282196186947996e+00 * (x * x * x) * psi[11] + -1.9843134832984430e+00 * psi[9] +
        6.5625000000000000e+01 * (x * x * x) * (y * y) * psi[15] +
        3.3541019662496847e+00 * psi[5] * y + 1.1250000000000000e+01 * (x * x) * y * psi[10] +
        1.7184658856084400e+01 * x * (y * y) * psi[12] + 8.6602540378443860e-01 * psi[2];
...
calc_RdR_p3_hyperbolic(const double *psi, double psi0, double Z, double xc[2], double dx[2])
{
  ...
  if (A < 1e-10) { // We have a quadratic, use quadratic solve
    ...
    if (delta2 > 0) {
      ...
      if ((-1 <= r1) && (r1 < 1)) {
        ...
        double dpsidx = 6.5625000000000000e+01 * (x * x) * (y * y * y) * psi[15] +
          -9.6824583655185426e-01 * psi[7] + -6.6555897559870685e+00 * (y * y) * psi[13] +
          5.7282196186947996e+00 * (y * y * y) * psi[12] +
          2.9047375096555625e+00 * psi[7] * (y * y) +
          3.3277948779935343e+01 * (x * x) * (y * y) * psi[13] +
          5.8094750193111251e+00 * psi[6] * x * y +
          -1.3125000000000000e+01 * (y * y * y) * psi[15] +
          9.9215674164922145e+00 * (x * x) * psi[8] + -3.7500000000000000e+00 * x * psi[10] +
          8.6602540378443860e-01 * psi[1] + -3.4369317712168801e+00 * y * psi[12] +
          -1.3311179511974137e+01 * x * psi[14] * y + -1.9843134832984430e+00 * psi[8] +
          -3.4369317712168801e+00 * y * psi[11] + -3.9375000000000000e+01 * (x * x) * y * psi[15] +
          ...
          3.3541019662496847e+00 * x * psi[4];
        double dpsidy = -9.6824583655185426e-01 * psi[6] + 1.5000000000000000e+00 * x * psi[3] +
          2.2185299186623560e+01 * (x * x * x) * y * psi[13] +
          7.8750000000000000e+00 * x * psi[15] +
          3.3277948779935343e+01 * (x * x) * psi[14] * (y * y) + 2.2185299186623562e+00 * psi[14] +
          -3.4369317712168801e+00 * x * psi[12] + 9.9215674164922145e+00 * (y * y) * psi[9] +
          -3.4369317712168801e+00 * x * psi[11] + -1.3311179511974137e+01 * x * y * psi[13] +
          -1.1092649593311780e+01 * psi[14] * (y * y) +
  ...
  double complex x_0 =
    (0.5 + 0.0 * I) * (alpha_0 * croot(s + t, 3.0) + rho / alpha_0 / croot(s + t, 3.0));
  double complex x_1 =
    (0.5 + 0.0 * I) * (alpha_1 * croot(s + t, 3.0) + rho / alpha_1 / croot(s + t, 3.0));
  double complex x_2 =
    (0.5 + 0.0 * I) * (alpha_2 * croot(s + t, 3.0) + rho / alpha_2 / croot(s + t, 3.0));
...
static int
R_psiZ(const struct gkyl_tok_geo *geo, double psi, double Z, int nmaxroots, double *R, double *dRdZ,
  double *dR, double *dZ)
{
...
// these arrays are big enough to hold all roots required
static int
R_psiZ_cubic(const struct gkyl_tok_geo *geo, double psi, double Z, int nmaxroots, double *R,
...
calc_grad_psi_p2_tensor(const double *psih, const double eta[2], const double dx[2])
{
  ...
  double dpsidx = 5.625 * psih[8] * (2.0 * x * SQ(y) - 0.6666666666666666 * x) +
    ...
    5.809475019311126 * psih[6] * x * y + 1.5 * psih[3] * y + 3.354101966249684 * psih[4] * x +
    0.8660254037844386 * psih[1];
...
calc_grad_psi_p3(const double *psih, const double eta[2], const double dx[2])
{
  ...
  double dpsidx = 6.5625000000000000e+01 * (x * x) * (y * y * y) * psih[15] +
    -9.6824583655185426e-01 * psih[7] + -6.6555897559870685e+00 * (y * y) * psih[13] +
    5.7282196186947996e+00 * (y * y * y) * psih[12] + 2.9047375096555625e+00 * psih[7] * (y * y) +
    3.3277948779935343e+01 * (x * x) * (y * y) * psih[13] +
    5.8094750193111251e+00 * psih[6] * x * y + -1.3125000000000000e+01 * (y * y * y) * psih[15] +
    9.9215674164922145e+00 * (x * x) * psih[8] + -3.7500000000000000e+00 * x * psih[10] +
    8.6602540378443860e-01 * psih[1] + -3.4369317712168801e+00 * y * psih[12] +
    -1.3311179511974137e+01 * x * psih[14] * y + -1.9843134832984430e+00 * psih[8] +
    -3.4369317712168801e+00 * y * psih[11] + -3.9375000000000000e+01 * (x * x) * y * psih[15] +
    1.7184658856084400e+01 * (x * x) * y * psih[11] + 2.2185299186623562e+00 * psih[13] +
    2.2185299186623560e+01 * x * psih[14] * (y * y * y) + 1.5000000000000000e+00 * y * psih[3] +
    -1.1092649593311780e+01 * (x * x) * psih[13] + 1.1250000000000000e+01 * x * (y * y) * psih[10] +
    7.8750000000000000e+00 * y * psih[15] + 3.3541019662496847e+00 * x * psih[4];
  double dpsidy = -9.6824583655185426e-01 * psih[6] + 1.5000000000000000e+00 * x * psih[3] +
    2.2185299186623560e+01 * (x * x * x) * y * psih[13] + 7.8750000000000000e+00 * x * psih[15] +
    3.3277948779935343e+01 * (x * x) * psih[14] * (y * y) + 2.2185299186623562e+00 * psih[14] +
    -3.4369317712168801e+00 * x * psih[12] + 9.9215674164922145e+00 * (y * y) * psih[9] +
    -3.4369317712168801e+00 * x * psih[11] + -1.3311179511974137e+01 * x * y * psih[13] +
    -1.1092649593311780e+01 * psih[14] * (y * y) +
    -3.9375000000000000e+01 * x * (y * y) * psih[15] +
    -1.3125000000000000e+01 * (x * x * x) * psih[15] + -3.7500000000000000e+00 * y * psih[10] +
    2.9047375096555625e+00 * psih[6] * (x * x) + 5.8094750193111251e+00 * psih[7] * x * y +
    -6.6555897559870685e+00 * (x * x) * psih[14] + 5.7282196186947996e+00 * (x * x * x) * psih[11] +
    -1.9843134832984430e+00 * psih[9] + 6.5625000000000000e+01 * (x * x * x) * (y * y) * psih[15] +
    3.3541019662496847e+00 * psih[5] * y + 1.1250000000000000e+01 * (x * x) * y * psih[10] +
    1.7184658856084400e+01 * x * (y * y) * psih[12] + 8.6602540378443860e-01 * psih[2];
  dpsidx = dpsidx * 2.0 / dx[0];
  dpsidy = dpsidy * 2.0 / dx[1];
  return sqrt(dpsidx * dpsidx + dpsidy * dpsidy);
}
...
phi_contour_func(double Z, void *ctx)
{
  ...
  if (c->geo->use_cubics) {
    ...
    int rzidx[2];
    int idxtemp = c->geo->rzlocal.lower[0] +
    ...
    rzidx[0] = idxtemp;
    idxtemp =
      c->geo->rzlocal.lower[1] + (int)floor((Z - c->geo->rzgrid.lower[1]) / c->geo->rzgrid.dx[1]);
  ...
  double rclose, bool use_memo, bool fill_memo, double *memo)
{
  ...
  for (int i = ilo; i <= iup; ++i) {
    ...
    if (z1 < z2) {
      if (use_memo) {
        if (fill_memo) {
          struct gkyl_qr_res res_local = gkyl_dbl_exp(contour_func, &ctx, z1, z2, nlevels, eps);
  ...
  double zmax, double rclose, bool use_memo, bool fill_memo, double *memo)
{
  ...
  for (int i = ilo; i <= iup; ++i) {
    ...
    if (z1 < z2) {
      if (use_memo) {
        if (fill_memo) {
          struct gkyl_qr_res res_local = gkyl_dbl_exp(phi_contour_func, &ctx, z1, z2, nlevels, eps);
          memo[i - izlo] = res_local.res;
          res += res_local.res;
        } else {
          if (z2 - z1 == dz) {
