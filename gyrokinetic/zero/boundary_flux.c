...
gkyl_boundary_flux_new(int dir, enum gkyl_edge_loc edge,
  ...
  int num_eqns, const struct gkyl_dg_eqn **eqns, struct gkyl_dg_array_mask *update_cell, bool use_gpu)
{
#ifdef GKYL_HAVE_CUDA
  if (use_gpu) {
    return gkyl_boundary_flux_cu_dev_new(dir, edge, grid, skin_r, ghost_r, num_eqns, eqns, update_cell);
  }
#endif
