...
struct gkyl_gk_rad_drag {
  ...
  struct gkyl_gk_rad_drag
    *data; // data.arr has host pointer with array data and ->on_dev on the GPU (use_gpu=true).
};
 ...
 */
void gkyl_dg_calc_gk_rad_vars_drag_release(struct gkyl_gk_rad_drag *drag, int num_collisions,
                                           bool use_gpu);
