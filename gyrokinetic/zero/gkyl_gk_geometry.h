...
struct gk_geom_surf {
  ...
  struct gkyl_array* ddpsi_nodal;   // dPsi/dpsi, dPsi/dpsi, dPsi/dpsi at surf quad nodes
...
struct gk_geom_int {
  ...
  struct gkyl_array *ddpsi_nodal;// dPsi/dpsi, dPsi/dpsi, dPsi/dpsi at interior quad nodes
  struct gkyl_array* mc2p_nodal; // 3 components. Cartesian X,Y, and Z
