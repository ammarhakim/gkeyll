...
} gkyl_dg_diffusion_gyrokinetic_vol_kern_list_diffdir;
typedef struct {
  gkyl_dg_diffusion_gyrokinetic_vol_kern_list_diffdir list[2];
} gkyl_dg_diffusion_gyrokinetic_vol_kern_list_polyOrder;
typedef struct {
  gkyl_dg_diffusion_gyrokinetic_vol_kern_list_polyOrder list[3];
} gkyl_dg_diffusion_gyrokinetic_vol_kern_list;

// for use in kernel tables
typedef struct {
  diffusion_surf_t kernels[2];
} gkyl_dg_diffusion_gyrokinetic_surf_kernels_polyOrder;
typedef struct {
  gkyl_dg_diffusion_gyrokinetic_surf_kernels_polyOrder list[6];
} gkyl_dg_diffusion_gyrokinetic_surf_kern_list;

typedef struct {
  diffusion_boundary_surf_t kernels[2];
} gkyl_dg_diffusion_gyrokinetic_boundary_surf_kernels_polyOrder;
typedef struct {
  gkyl_dg_diffusion_gyrokinetic_boundary_surf_kernels_polyOrder list[6];
} gkyl_dg_diffusion_gyrokinetic_boundary_surf_kern_list;
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order2_vol_1x_ser_p2_constcoeff_diffdirsx(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order4_vol_1x_ser_p2_constcoeff_diffdirsx(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order6_vol_1x_ser_p2_constcoeff_diffdirsx(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order2_vol_2x_ser_p2_constcoeff_diffdirsxy(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order4_vol_2x_ser_p2_constcoeff_diffdirsxy(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order6_vol_2x_ser_p2_constcoeff_diffdirsxy(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order2_vol_3x_ser_p2_constcoeff_diffdirsxyz(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order4_vol_3x_ser_p2_constcoeff_diffdirsxyz(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order6_vol_3x_ser_p2_constcoeff_diffdirsxyz(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
    ...
    .list =
      {
        // 2nd order diffusion.
        {
          .list =
            {
              {ker_dg_diffusion_gyrokinetic_order2_vol_1x_ser_p1_constcoeff_diffdirsx, NULL, NULL,
                NULL, NULL, NULL, NULL},
        ...
        // 4th order diffusion.
        {
          .list =
            {
              {ker_dg_diffusion_gyrokinetic_order4_vol_1x_ser_p1_constcoeff_diffdirsx, NULL, NULL,
                NULL, NULL, NULL, NULL},
          ...
          .list =
            {
              {ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p1_constcoeff_diffdirsx,
                ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p1_constcoeff_diffdirsy,
                ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p1_constcoeff_diffdirsxy, NULL, NULL,
                NULL, NULL},
              {ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p2_constcoeff_diffdirsx,
                ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p2_constcoeff_diffdirsy,
          ...
          .list =
            {
              {ker_dg_diffusion_gyrokinetic_order4_vol_2x_ser_p1_constcoeff_diffdirsx,
                ker_dg_diffusion_gyrokinetic_order4_vol_2x_ser_p1_constcoeff_diffdirsy,
                ker_dg_diffusion_gyrokinetic_order4_vol_2x_ser_p1_constcoeff_diffdirsxy, NULL, NULL,
                NULL, NULL},
              {ker_dg_diffusion_gyrokinetic_order4_vol_2x_ser_p2_constcoeff_diffdirsx,
                ker_dg_diffusion_gyrokinetic_order4_vol_2x_ser_p2_constcoeff_diffdirsy,
...
GKYL_CU_D static const gkyl_dg_diffusion_gyrokinetic_surf_kern_list
  ser_gyrokinetic_surfx_kernels_constcoeff[] = {
    // 2nd order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order2_surfx_1x1v_ser_p1_constcoeff,
    ...
    // 4th order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order4_surfx_1x1v_ser_p1_constcoeff,
...
GKYL_CU_D static const gkyl_dg_diffusion_gyrokinetic_boundary_surf_kern_list
  ser_gyrokinetic_boundary_surfx_kernels_constcoeff[] = {
    // 2nd order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order2_boundary_surfx_1x1v_ser_p1_constcoeff,
    ...
    // 4th order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order4_boundary_surfx_1x1v_ser_p1_constcoeff,
...
GKYL_CU_D static const gkyl_dg_diffusion_gyrokinetic_boundary_surf_kern_list
  ser_gyrokinetic_boundary_diagx_kernels_constcoeff[] = {
    // 2nd order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order2_boundary_diagx_1x1v_ser_p1_constcoeff,
    ...
    // 4th order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order4_boundary_diagx_1x1v_ser_p1_constcoeff,
  ...
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order2_vol_1x_ser_p2_varcoeff_diffdirsx(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
// 2x 2nd order diffusion.
GKYL_CU_DH static double
  ...
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order2_vol_2x_ser_p2_varcoeff_diffdirsxy(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
// 3x 2nd order diffusion.
GKYL_CU_DH static double
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_gyrokinetic *diffusion =
    container_of(eqn, struct dg_diffusion_gyrokinetic, eqn);
  return dg_diffusion_gyrokinetic_order2_vol_3x_ser_p2_varcoeff_diffdirsxyz(
    xc, dx, _cfD(idx), _cfJacInv(idx), qIn, qRhsOut);
}
    ...
    .list =
      {
        // 2nd order diffusion.
        {
          .list =
            {
              {ker_dg_diffusion_gyrokinetic_order2_vol_1x_ser_p1_varcoeff_diffdirsx, NULL, NULL,
                NULL, NULL, NULL, NULL},
    ...
    .list =
      {
        // 2nd order diffusion.
        {
          .list =
            {
              {ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p1_varcoeff_diffdirsx,
                ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p1_varcoeff_diffdirsy,
                ker_dg_diffusion_gyrokinetic_order2_vol_2x_ser_p1_varcoeff_diffdirsxy, NULL, NULL,
                NULL, NULL},
    ...
    .list =
      {
        // 2nd order diffusion.
        {
          .list =
            {
              {ker_dg_diffusion_gyrokinetic_order2_vol_3x_ser_p1_varcoeff_diffdirsx,
...
GKYL_CU_D static const gkyl_dg_diffusion_gyrokinetic_surf_kern_list
  ser_gyrokinetic_surfx_kernels_varcoeff[] = {
    // 2nd order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order2_surfx_1x1v_ser_p1_varcoeff,
...
GKYL_CU_D static const gkyl_dg_diffusion_gyrokinetic_boundary_surf_kern_list
  ser_gyrokinetic_boundary_surfx_kernels_varcoeff[] = {
    // 2nd order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order2_boundary_surfx_1x1v_ser_p1_varcoeff,
...
GKYL_CU_D static const gkyl_dg_diffusion_gyrokinetic_boundary_surf_kern_list
  ser_gyrokinetic_boundary_diagx_kernels_varcoeff[] = {
    // 2nd order diffusion.
    {
      .list =
        {
          {dg_diffusion_gyrokinetic_order2_boundary_diagx_1x1v_ser_p1_varcoeff,
