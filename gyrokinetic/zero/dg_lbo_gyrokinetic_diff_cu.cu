...
__global__ static void
dg_lbo_gyrokinetic_diff_set_cu_dev_ptrs(struct dg_lbo_gyrokinetic_diff *lbo,
  enum gkyl_basis_type b_type, int cv_index, int cdim, int vdim, int poly_order, bool is_identity)
{
  ...
  const gkyl_dg_lbo_gyrokinetic_diff_boundary_surf_kern_list *boundary_surf_vpar_kernels,
