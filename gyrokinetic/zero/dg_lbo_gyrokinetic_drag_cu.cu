...
__global__ static void gkyl_lbo_gyrokinetic_drag_set_auxfields_cu_kernel(
...
void gkyl_lbo_gyrokinetic_drag_set_auxfields_cu(const struct gkyl_dg_eqn *eqn,
                                                struct gkyl_dg_lbo_gyrokinetic_drag_auxfields auxin)
{
...
__global__ static void dg_lbo_gyrokinetic_drag_set_cu_dev_ptrs(struct dg_lbo_gyrokinetic_drag *lbo,
                                                               ...
                                                               int poly_order)
{
  ...
  const gkyl_dg_lbo_gyrokinetic_drag_boundary_surf_kern_list *boundary_surf_vpar_kernels,
...
{
  struct dg_lbo_gyrokinetic_drag *lbo = (struct dg_lbo_gyrokinetic_drag *)gkyl_malloc(sizeof(*lbo));
