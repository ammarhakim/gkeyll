...
void
gkyl_lbo_gyrokinetic_drag_set_auxfields_cu(
...
__global__ static void
dg_lbo_gyrokinetic_drag_set_cu_dev_ptrs(struct dg_lbo_gyrokinetic_drag *lbo,
...
struct gkyl_dg_eqn *
gkyl_dg_lbo_gyrokinetic_drag_cu_dev_new(const struct gkyl_basis *cbasis,
