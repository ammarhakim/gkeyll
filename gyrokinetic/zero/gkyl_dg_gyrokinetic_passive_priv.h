  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return dg_gyrokinetic_passive_vol_1x1v_ser_p1(xc, dx,
    gkyl_array_cfetch(gkp->vel_map->vmap, vidx),
    gkyl_array_cfetch(gkp->vel_map->vmap_sq, vidx),
    gkp->charge, gkp->mass,
    gkyl_array_cfetch(gkp->gk_geom->geo_corn.bmag, cidx),
    gkyl_array_cfetch(gkp->auxfields.speeds, cidx),
  ...
  double *GKYL_RESTRICT qRhsOut)
{
  ...
  if (dir < gkp->cdim) {
    ...
    return gkp->surf[dir](xcC, dxC,
      gkyl_array_cfetch(gkp->vel_map->vmap_prime, vidxL),
      gkyl_array_cfetch(gkp->vel_map->vmap_prime, vidxC),
      gkyl_array_cfetch(gkp->vel_map->vmap_prime, vidxR),
      gkyl_array_cfetch(gkp->auxfields.flux_surf, pidxC),
      gkyl_array_cfetch(gkp->auxfields.flux_surf, pidxR),
      qRhsOut);
  }
  return 0.0;
}
  ...
  double *GKYL_RESTRICT qRhsOut)
{
  ...
  if (dir < gkp->cdim) {
    ...
    return gkp->boundary_surf[dir](xcSkin, dxSkin,
      gkyl_array_cfetch(gkp->vel_map->vmap_prime, vidxEdge),
      gkyl_array_cfetch(gkp->vel_map->vmap_prime, vidxSkin),
      gkyl_array_cfetch(gkp->auxfields.flux_surf, pidxEdge),
      gkyl_array_cfetch(gkp->auxfields.flux_surf, pidxSkin),
      edge, qRhsOut);
  }
  return 0.0;
}
