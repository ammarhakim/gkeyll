...
static const char *gkyl_gk_distribution_moments_descriptions[] = {
  ...
  "Total kinetic energy density of the gyrokinetic species divided by mass (parallel plus perpendicular contributions). For additional detail, documentation can be found at https://gkeyll.readthedocs.io/en/latest/",
  ...
  "Best-fit Maxwellian parameters for the gyrokinetic species: number density, parallel drift velocity, and thermal speed squared. For additional detail, documentation can be found at https://gkeyll.readthedocs.io/en/latest/",
  "Best-fit bi-Maxwellian parameters for the gyrokinetic species: number density, parallel drift velocity, parallel thermal speed squared, and perpendicular thermal speed squared. For additional detail, documentation can be found at https://gkeyll.readthedocs.io/en/latest/",
...
static const char *gkyl_gk_distribution_moments_source_descriptions[] = {
  ...
  "Total power of the gyrokinetic species source term divided by mass (parallel plus perpendicular energy input rates). For additional detail, documentation can be found at https://gkeyll.readthedocs.io/en/latest/",
  ...
  "Best-fit Maxwellian parameters for the gyrokinetic species source term: source density flux, drift velocity, and thermal speed squared. For additional detail, documentation can be found at https://gkeyll.readthedocs.io/en/latest/",
  "Best-fit bi-Maxwellian parameters for the gyrokinetic species source term: source density flux, drift velocity, parallel thermal speed squared, and perpendicular thermal speed squared. For additional detail, documentation can be found at https://gkeyll.readthedocs.io/en/latest/",
