...
//
// Serendipity surface kernels, general (non-axisymmetric) geometry.
// Only 3x2v is generated; used for stellarators. Full drifts (no_by = false).
//

GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_surfx_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_surfx_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_edge_surfx_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_edge_surfx_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_surfy_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_surfy_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_edge_surfy_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_edge_surfy_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_surfz_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_surfz_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_edge_surfz_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_edge_surfz_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surfvpar_kern_list ser_gk_collisionless_flux_gen_geo_surfvpar_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_surfvpar_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_multib_boundary_surfx_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_multib_boundary_surfx_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_multib_boundary_edge_surfx_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_multib_boundary_edge_surfx_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_multib_boundary_surfy_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_multib_boundary_surfy_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_multib_boundary_edge_surfy_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_multib_boundary_edge_surfy_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_multib_boundary_surfz_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_multib_boundary_surfz_3x2v_ser_p1, NULL }, // 3
};
GKYL_CU_D
static const gkyl_gk_collisionless_flux_surf_kern_list ser_gk_collisionless_flux_gen_geo_multib_boundary_edge_surfz_kernels[] = {
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
  { NULL, gk_collisionless_flux_gen_geo_multib_boundary_edge_surfz_3x2v_ser_p1, NULL }, // 3
};
...
GKYL_CU_D
static gk_collisionless_flux_surf_t
choose_gk_collisionless_flux_gen_geo_surf_conf_kern(int dir, int cdim, int vdim, int poly_order, enum gkyl_gyrokinetic_bc_type bc)
{
  if (bc == GKYL_BC_GK_SKIP) {
    if (dir == 0)
      return ser_gk_collisionless_flux_gen_geo_multib_boundary_surfx_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 1)
      return ser_gk_collisionless_flux_gen_geo_multib_boundary_surfy_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 2)
      return ser_gk_collisionless_flux_gen_geo_multib_boundary_surfz_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else
      return NULL;
  }
  else {
    if (dir == 0)
      return ser_gk_collisionless_flux_gen_geo_surfx_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 1)
      return ser_gk_collisionless_flux_gen_geo_surfy_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 2)
      return ser_gk_collisionless_flux_gen_geo_surfz_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else
      return NULL;
  }
}
...
GKYL_CU_D
static gk_collisionless_flux_surf_t
choose_gk_collisionless_flux_gen_geo_edge_surf_conf_kern(int dir, int cdim, int vdim, int poly_order, enum gkyl_gyrokinetic_bc_type bc)
{
  if (bc == GKYL_BC_GK_SKIP) {
    if (dir == 0)
      return ser_gk_collisionless_flux_gen_geo_multib_boundary_edge_surfx_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 1)
      return ser_gk_collisionless_flux_gen_geo_multib_boundary_edge_surfy_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 2)
      return ser_gk_collisionless_flux_gen_geo_multib_boundary_edge_surfz_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else
      return NULL;
  }
  else {
    if (dir == 0)
      return ser_gk_collisionless_flux_gen_geo_edge_surfx_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 1)
      return ser_gk_collisionless_flux_gen_geo_edge_surfy_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else if (dir == 2)
      return ser_gk_collisionless_flux_gen_geo_edge_surfz_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
    else
      return NULL;
  }
}
...
GKYL_CU_D
static gk_collisionless_flux_surfvpar_t
choose_gk_collisionless_flux_gen_geo_surf_vpar_kern(int cdim, int vdim, int poly_order)
{
  return ser_gk_collisionless_flux_gen_geo_surfvpar_kernels[cv_index[cdim].vdim[vdim]].kernels[poly_order];
}
