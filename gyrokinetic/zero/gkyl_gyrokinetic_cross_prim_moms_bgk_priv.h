...
typedef struct {
  gyrokinetic_cross_prim_moms_bgk_t kernels[3];
} gkyl_gyrokinetic_cross_prim_moms_bgk_kern_list;

// Cross moments kernel list
GKYL_CU_D static const gkyl_gyrokinetic_cross_prim_moms_bgk_kern_list
  ser_gyrokinetic_cross_prim_moms_bgk_list[] = {
    // 1x kernels
    {NULL, gyrokinetic_cross_prim_moms_bgk_1x1v_ser_p1, NULL}, //0
    {NULL, gyrokinetic_cross_prim_moms_bgk_1x2v_ser_p1, NULL}, //1
    // 2x kernels
    {NULL, gyrokinetic_cross_prim_moms_bgk_2x2v_ser_p1,
      NULL}, // no gyrokinetic_cross_prim_moms_bgk_2x2v_ser_p2 due to the lack of gkyl_basis_ser_2x_p2_inv.h //2
    // 3x kernels
    {NULL, gyrokinetic_cross_prim_moms_bgk_3x2v_ser_p1,
      NULL}, // no gyrokinetic_cross_prim_moms_bgk_2x2v_ser_p2 due to the lack of gkyl_basis_ser_3x_p2_inv.h //3
};

GKYL_CU_D static gyrokinetic_cross_prim_moms_bgk_t
