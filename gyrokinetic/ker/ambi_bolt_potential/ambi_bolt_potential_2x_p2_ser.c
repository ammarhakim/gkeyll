...
{ 
  ...
  double phi_qp[9];
  double m0IonS_curr;
  m0IonS_curr = -(0.5999999999999994*sheathvals[7])-0.5999999999999999*sheathvals[6]+0.4472135954999579*sheathvals[5]+0.4472135954999579*sheathvals[4]+0.9*sheathvals[3]-0.6708203932499369*sheathvals[2]-0.6708203932499369*sheathvals[1]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[0] = -((1.0*T_e*log(fmax(-(0.5999999999999994*m0Ion[7])-0.5999999999999999*m0Ion[6]+0.4472135954999579*m0Ion[5]+0.4472135954999579*m0Ion[4]+0.9*m0Ion[3]-0.6708203932499369*m0Ion[2]-0.6708203932499369*m0Ion[1]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)-0.5999999999999994*sheathvals[15]-0.5999999999999999*sheathvals[14]+0.4472135954999579*sheathvals[13]+0.4472135954999579*sheathvals[12]+0.9*sheathvals[11]-0.6708203932499369*sheathvals[10]-0.6708203932499369*sheathvals[9]+0.5*sheathvals[8];
  } else {
    phi_qp[0] = 0.0;
  }
  m0IonS_curr = 0.75*sheathvals[7]-0.5590169943749475*sheathvals[5]+0.4472135954999579*sheathvals[4]-0.6708203932499369*sheathvals[1]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[1] = -((1.0*T_e*log(fmax(0.75*m0Ion[7]-0.5590169943749475*m0Ion[5]+0.4472135954999579*m0Ion[4]-0.6708203932499369*m0Ion[1]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)+0.75*sheathvals[15]-0.5590169943749475*sheathvals[13]+0.4472135954999579*sheathvals[12]-0.6708203932499369*sheathvals[9]+0.5*sheathvals[8];
  } else {
    phi_qp[1] = 0.0;
  }
  m0IonS_curr = -(0.5999999999999994*sheathvals[7])+0.5999999999999999*sheathvals[6]+0.4472135954999579*sheathvals[5]+0.4472135954999579*sheathvals[4]-0.9*sheathvals[3]+0.6708203932499369*sheathvals[2]-0.6708203932499369*sheathvals[1]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[2] = -((1.0*T_e*log(fmax(-(0.5999999999999994*m0Ion[7])+0.5999999999999999*m0Ion[6]+0.4472135954999579*m0Ion[5]+0.4472135954999579*m0Ion[4]-0.9*m0Ion[3]+0.6708203932499369*m0Ion[2]-0.6708203932499369*m0Ion[1]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)-0.5999999999999994*sheathvals[15]+0.5999999999999999*sheathvals[14]+0.4472135954999579*sheathvals[13]+0.4472135954999579*sheathvals[12]-0.9*sheathvals[11]+0.6708203932499369*sheathvals[10]-0.6708203932499369*sheathvals[9]+0.5*sheathvals[8];
  } else {
    phi_qp[2] = 0.0;
  }
  m0IonS_curr = 0.75*sheathvals[6]+0.4472135954999579*sheathvals[5]-0.5590169943749475*sheathvals[4]-0.6708203932499369*sheathvals[2]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[3] = -((1.0*T_e*log(fmax(0.75*m0Ion[6]+0.4472135954999579*m0Ion[5]-0.5590169943749475*m0Ion[4]-0.6708203932499369*m0Ion[2]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)+0.75*sheathvals[14]+0.4472135954999579*sheathvals[13]-0.5590169943749475*sheathvals[12]-0.6708203932499369*sheathvals[10]+0.5*sheathvals[8];
  } else {
    phi_qp[3] = 0.0;
  }
  m0IonS_curr = -(0.5590169943749475*sheathvals[5])-0.5590169943749475*sheathvals[4]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[4] = -((1.0*T_e*log(fmax(-(0.5590169943749475*m0Ion[5])-0.5590169943749475*m0Ion[4]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)-0.5590169943749475*sheathvals[13]-0.5590169943749475*sheathvals[12]+0.5*sheathvals[8];
  } else {
    phi_qp[4] = 0.0;
  }
  m0IonS_curr = -(0.75*sheathvals[6])+0.4472135954999579*sheathvals[5]-0.5590169943749475*sheathvals[4]+0.6708203932499369*sheathvals[2]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[5] = -((1.0*T_e*log(fmax(-(0.75*m0Ion[6])+0.4472135954999579*m0Ion[5]-0.5590169943749475*m0Ion[4]+0.6708203932499369*m0Ion[2]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)-0.75*sheathvals[14]+0.4472135954999579*sheathvals[13]-0.5590169943749475*sheathvals[12]+0.6708203932499369*sheathvals[10]+0.5*sheathvals[8];
  } else {
    phi_qp[5] = 0.0;
  }
  m0IonS_curr = 0.5999999999999994*sheathvals[7]-0.5999999999999999*sheathvals[6]+0.4472135954999579*sheathvals[5]+0.4472135954999579*sheathvals[4]-0.9*sheathvals[3]-0.6708203932499369*sheathvals[2]+0.6708203932499369*sheathvals[1]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[6] = -((1.0*T_e*log(fmax(0.5999999999999994*m0Ion[7]-0.5999999999999999*m0Ion[6]+0.4472135954999579*m0Ion[5]+0.4472135954999579*m0Ion[4]-0.9*m0Ion[3]-0.6708203932499369*m0Ion[2]+0.6708203932499369*m0Ion[1]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)+0.5999999999999994*sheathvals[15]-0.5999999999999999*sheathvals[14]+0.4472135954999579*sheathvals[13]+0.4472135954999579*sheathvals[12]-0.9*sheathvals[11]-0.6708203932499369*sheathvals[10]+0.6708203932499369*sheathvals[9]+0.5*sheathvals[8];
  } else {
    phi_qp[6] = 0.0;
  }
  m0IonS_curr = -(0.75*sheathvals[7])-0.5590169943749475*sheathvals[5]+0.4472135954999579*sheathvals[4]+0.6708203932499369*sheathvals[1]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[7] = -((1.0*T_e*log(fmax(-(0.75*m0Ion[7])-0.5590169943749475*m0Ion[5]+0.4472135954999579*m0Ion[4]+0.6708203932499369*m0Ion[1]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)-0.75*sheathvals[15]-0.5590169943749475*sheathvals[13]+0.4472135954999579*sheathvals[12]+0.6708203932499369*sheathvals[9]+0.5*sheathvals[8];
  } else {
    phi_qp[7] = 0.0;
  }
  m0IonS_curr = 0.5999999999999994*sheathvals[7]+0.5999999999999999*sheathvals[6]+0.4472135954999579*sheathvals[5]+0.4472135954999579*sheathvals[4]+0.9*sheathvals[3]+0.6708203932499369*sheathvals[2]+0.6708203932499369*sheathvals[1]+0.5*sheathvals[0];
  if ((isfinite(m0IonS_curr)) && (m0IonS_curr>0.)) {
    phi_qp[8] = -((1.0*T_e*log(fmax(0.5999999999999994*m0Ion[7]+0.5999999999999999*m0Ion[6]+0.4472135954999579*m0Ion[5]+0.4472135954999579*m0Ion[4]+0.9*m0Ion[3]+0.6708203932499369*m0Ion[2]+0.6708203932499369*m0Ion[1]+0.5*m0Ion[0],m0IonS_curr)/m0IonS_curr))/q_e)+0.5999999999999994*sheathvals[15]+0.5999999999999999*sheathvals[14]+0.4472135954999579*sheathvals[13]+0.4472135954999579*sheathvals[12]+0.9*sheathvals[11]+0.6708203932499369*sheathvals[10]+0.6708203932499369*sheathvals[9]+0.5*sheathvals[8];
  } else {
    phi_qp[8] = 0.0;
  }
