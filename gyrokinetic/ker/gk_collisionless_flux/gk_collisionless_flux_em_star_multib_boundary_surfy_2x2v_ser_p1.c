...
{ 
  ...
  alpha_quad += (mvparsq_quad[0]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * -bhat_quad[1]*((0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5])*rdx2))*area_elem_quad/Jc_quad; 
  ...
  alpha_quad += (mvparsq_quad[1]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * -bhat_quad[1]*((0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5])*rdx2))*area_elem_quad/Jc_quad; 
  ...
  alpha_quad += (mvparsq_quad[2]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * -bhat_quad[1]*((0.6123724356957944*hamil[1]-0.6123724356957944*hamil[5])*rdx2))*area_elem_quad/Jc_quad; 
  ...
  alpha_quad = (mvpar_quad[0]*B3_quad/(m_*bmag_quad))*area_elem_quad/Jc_quad; 
  alpha_quad += (mvparsq_quad[0]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * -bhat_quad[1]*((0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1])*rdx2))*area_elem_quad/Jc_quad; 
  alpha_quad += mvpar_quad[0]/(m_*bmag_quad) * (0.3535533905932737*apar[0]-0.3535533905932737*apar[1]) * normcurlbhat_quad; 
  alpha_quad += mvpar_quad[0]/(m_*bmag_quad) * bhat_quad[1]*(0.6123724356957944*apar[1]*rdx2); 
  ...
  alpha_quad = (mvpar_quad[1]*B3_quad/(m_*bmag_quad))*area_elem_quad/Jc_quad; 
  alpha_quad += (mvparsq_quad[1]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * -bhat_quad[1]*((0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1])*rdx2))*area_elem_quad/Jc_quad; 
  alpha_quad += mvpar_quad[1]/(m_*bmag_quad) * (0.3535533905932737*apar[0]-0.3535533905932737*apar[1]) * normcurlbhat_quad; 
  alpha_quad += mvpar_quad[1]/(m_*bmag_quad) * bhat_quad[1]*(0.6123724356957944*apar[1]*rdx2); 
  ...
  alpha_quad = (mvpar_quad[2]*B3_quad/(m_*bmag_quad))*area_elem_quad/Jc_quad; 
  alpha_quad += (mvparsq_quad[2]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * -bhat_quad[1]*((0.6123724356957944*hamil[5]+0.6123724356957944*hamil[1])*rdx2))*area_elem_quad/Jc_quad; 
  alpha_quad += mvpar_quad[2]/(m_*bmag_quad) * (0.3535533905932737*apar[0]-0.3535533905932737*apar[1]) * normcurlbhat_quad; 
  alpha_quad += mvpar_quad[2]/(m_*bmag_quad) * bhat_quad[1]*(0.6123724356957944*apar[1]*rdx2); 
