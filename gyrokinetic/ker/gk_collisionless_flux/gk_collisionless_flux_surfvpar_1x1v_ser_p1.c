...
{ 
  ...
  double apargradH_x[2] = {0.}; 
  apargradH_x[0] = 0.8660254037844386*apar[0]*hamil[1]*rdx2; 
  apargradH_x[1] = 0.8660254037844386*apar[1]*hamil[1]*rdx2; 
  ...
  alpha_quad += -1.0/m_/bmag_quad * (0.7071067811865475*apargradH_x[0]-0.7071067811865475*apargradH_x[1])*dualcurlbhat_quad[2]; 
  ...
  alpha_quad = -(0.8660254037844386*hamil[1]*rdx2)/m_/bmag_quad * B3_quad; 
  alpha_quad += -(0.8660254037844386*hamil[1]*rdx2)/m_/bmag_quad * 1/q_*dualcurlbhat_quad[2]*((0.8164965809277261*(0.8660254037844386*hamil[2]-3.3541019662496847*hamil[4]))/vmap[1]); 
  alpha_quad += -1.0/m_/bmag_quad * (0.7071067811865475*apargradH_x[1]+0.7071067811865475*apargradH_x[0])*dualcurlbhat_quad[2]; 
