...
{ 
  ...
  alpha_quad = -(-(1.1180339887498951*yfield[5])+1.118033988749895*yfield[4]+0.8660254037844386*yfield[3]-0.8660254037844386*yfield[2]-0.5*yfield[1]+0.5*yfield[0])/m_/bmag_quad * B3_quad -(-(1.1180339887498951*yfield[5])+1.118033988749895*yfield[4]+0.8660254037844386*yfield[3]-0.8660254037844386*yfield[2]-0.5*yfield[1]+0.5*yfield[0])/m_/bmag_quad * 1/q_*dualcurlbhat_quad[2]*((0.8164965809277261*(0.8660254037844386*hamil[2]-3.3541019662496847*hamil[4]))/vmap[1]);
