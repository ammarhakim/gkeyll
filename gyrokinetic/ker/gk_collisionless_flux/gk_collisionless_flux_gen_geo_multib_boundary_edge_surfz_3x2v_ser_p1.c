...
GKYL_CU_DH double gk_collisionless_flux_gen_geo_multib_boundary_edge_surfz_3x2v_ser_p1(
...
{ 
  ...
  hamil[2] = (2.4494897427831783*phi[6]+1.4142135623730951*phi[2])*q_+vmap[2]*(1.7320508075688772*bmag[6]+bmag[2]); 
  hamil[3] = 1.4142135623730951*vmapSq[1]*m_; 
  hamil[4] = (1.7320508075688772*bmag[3]+bmag[0])*vmap[3]; 
  hamil[5] = (2.4494897427831783*phi[7]+1.4142135623730951*phi[4])*q_+vmap[2]*(1.7320508075688772*bmag[7]+bmag[4]); 
  hamil[8] = vmap[3]*(1.7320508075688772*bmag[5]+bmag[1]); 
  hamil[9] = vmap[3]*(1.7320508075688772*bmag[6]+bmag[2]); 
  hamil[12] = vmap[3]*(1.7320508075688772*bmag[7]+bmag[4]); 
  ...
  JRatfR[16] = 0.016666666666666666*(8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[2]*JfR[34]+jacobgeo_rat_surfR[1]*JfR[33])-4.242640687119286*(jacobgeo_rat_surfR[3]*JfR[43]+jacobgeo_rat_surfR[0]*JfR[35]))-36.74234614174767*(jacobgeo_rat_surfR[2]*JfR[39]+jacobgeo_rat_surfR[1]*JfR[38])+21.213203435596427*(jacobgeo_rat_surfR[3]*JfR[37]+jacobgeo_rat_surfR[0]*JfR[32])); 
  JRatfR[17] = 0.016666666666666666*(-(36.74234614174767*(jacobgeo_rat_surfR[2]*JfR[43]+jacobgeo_rat_surfR[1]*JfR[35]))+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[2]*JfR[37]+jacobgeo_rat_surfR[1]*JfR[32])-4.242640687119286*(jacobgeo_rat_surfR[3]*JfR[39]+jacobgeo_rat_surfR[0]*JfR[38]))+21.213203435596427*(jacobgeo_rat_surfR[3]*JfR[34]+jacobgeo_rat_surfR[0]*JfR[33])); 
  JRatfR[18] = 0.016666666666666666*(-(36.74234614174767*(jacobgeo_rat_surfR[1]*JfR[43]+jacobgeo_rat_surfR[2]*JfR[35]))+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[1]*JfR[37]+jacobgeo_rat_surfR[2]*JfR[32])-4.242640687119286*(jacobgeo_rat_surfR[0]*JfR[39]+jacobgeo_rat_surfR[3]*JfR[38]))+21.213203435596427*(jacobgeo_rat_surfR[0]*JfR[34]+jacobgeo_rat_surfR[3]*JfR[33])); 
  JRatfR[19] = 0.016666666666666666*(8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[2]*JfR[41]+jacobgeo_rat_surfR[1]*JfR[40])-4.242640687119286*(jacobgeo_rat_surfR[3]*JfR[47]+jacobgeo_rat_surfR[0]*JfR[42]))-36.74234614174767*(jacobgeo_rat_surfR[2]*JfR[46]+jacobgeo_rat_surfR[1]*JfR[45])+21.213203435596427*(jacobgeo_rat_surfR[3]*JfR[44]+jacobgeo_rat_surfR[0]*JfR[36])); 
  JRatfR[20] = 0.016666666666666666*(8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[1]*JfR[34]+jacobgeo_rat_surfR[2]*JfR[33])-4.242640687119286*(jacobgeo_rat_surfR[0]*JfR[43]+jacobgeo_rat_surfR[3]*JfR[35]))-36.74234614174767*(jacobgeo_rat_surfR[1]*JfR[39]+jacobgeo_rat_surfR[2]*JfR[38])+21.213203435596427*(jacobgeo_rat_surfR[0]*JfR[37]+jacobgeo_rat_surfR[3]*JfR[32])); 
  JRatfR[21] = 0.016666666666666666*(-(36.74234614174767*(jacobgeo_rat_surfR[2]*JfR[47]+jacobgeo_rat_surfR[1]*JfR[42]))+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[2]*JfR[44]+jacobgeo_rat_surfR[1]*JfR[36])-4.242640687119286*(jacobgeo_rat_surfR[3]*JfR[46]+jacobgeo_rat_surfR[0]*JfR[45]))+21.213203435596427*(jacobgeo_rat_surfR[3]*JfR[41]+jacobgeo_rat_surfR[0]*JfR[40])); 
  JRatfR[22] = 0.016666666666666666*(-(36.74234614174767*(jacobgeo_rat_surfR[1]*JfR[47]+jacobgeo_rat_surfR[2]*JfR[42]))+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[1]*JfR[44]+jacobgeo_rat_surfR[2]*JfR[36])-4.242640687119286*(jacobgeo_rat_surfR[0]*JfR[46]+jacobgeo_rat_surfR[3]*JfR[45]))+21.213203435596427*(jacobgeo_rat_surfR[0]*JfR[41]+jacobgeo_rat_surfR[3]*JfR[40])); 
  JRatfR[23] = 0.016666666666666666*(8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfR[1]*JfR[41]+jacobgeo_rat_surfR[2]*JfR[40])-4.242640687119286*(jacobgeo_rat_surfR[0]*JfR[47]+jacobgeo_rat_surfR[3]*JfR[42]))-36.74234614174767*(jacobgeo_rat_surfR[1]*JfR[46]+jacobgeo_rat_surfR[2]*JfR[45])+21.213203435596427*(jacobgeo_rat_surfR[0]*JfR[44]+jacobgeo_rat_surfR[3]*JfR[36])); 
