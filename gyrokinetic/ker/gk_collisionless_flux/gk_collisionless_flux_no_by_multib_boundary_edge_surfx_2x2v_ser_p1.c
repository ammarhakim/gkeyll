...
{ 
  ...
  double JRatfR[12] = {0.}; 
  JRatfR[0] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[1]*JfR[5]+jacobgeo_rat_surfR[0]*JfR[1])-1.0*(jacobgeo_rat_surfR[1]*JfR[2]+JfR[0]*jacobgeo_rat_surfR[0])); 
  JRatfR[1] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[0]*JfR[5]+JfR[1]*jacobgeo_rat_surfR[1])-1.0*(jacobgeo_rat_surfR[0]*JfR[2]+JfR[0]*jacobgeo_rat_surfR[1])); 
  JRatfR[2] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[1]*JfR[11]+jacobgeo_rat_surfR[0]*JfR[6])-1.0*(jacobgeo_rat_surfR[1]*JfR[7]+jacobgeo_rat_surfR[0]*JfR[3])); 
  JRatfR[3] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[1]*JfR[12]+jacobgeo_rat_surfR[0]*JfR[8])-1.0*(jacobgeo_rat_surfR[1]*JfR[9]+jacobgeo_rat_surfR[0]*JfR[4])); 
  JRatfR[4] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[0]*JfR[11]+jacobgeo_rat_surfR[1]*JfR[6])-1.0*(jacobgeo_rat_surfR[0]*JfR[7]+jacobgeo_rat_surfR[1]*JfR[3])); 
  JRatfR[5] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[0]*JfR[12]+jacobgeo_rat_surfR[1]*JfR[8])-1.0*(jacobgeo_rat_surfR[0]*JfR[9]+jacobgeo_rat_surfR[1]*JfR[4])); 
  JRatfR[6] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[1]*JfR[15]+jacobgeo_rat_surfR[0]*JfR[13])-1.0*(jacobgeo_rat_surfR[1]*JfR[14]+jacobgeo_rat_surfR[0]*JfR[10])); 
  JRatfR[7] = -0.5*(1.732050807568877*(jacobgeo_rat_surfR[0]*JfR[15]+jacobgeo_rat_surfR[1]*JfR[13])-1.0*(jacobgeo_rat_surfR[0]*JfR[14]+jacobgeo_rat_surfR[1]*JfR[10])); 
  JRatfR[8] = 0.03333333333333333*((-25.98076211353316*jacobgeo_rat_surfR[1]*JfR[20])+8.660254037844387*(1.732050807568877*jacobgeo_rat_surfR[1]*JfR[18]-3.0*jacobgeo_rat_surfR[0]*JfR[17])+15.0*jacobgeo_rat_surfR[0]*JfR[16]); 
  JRatfR[9] = 0.03333333333333333*(8.660254037844387*(1.732050807568877*jacobgeo_rat_surfR[1]*JfR[16]-3.0*jacobgeo_rat_surfR[0]*JfR[20])+15.0*jacobgeo_rat_surfR[0]*JfR[18]-25.98076211353316*jacobgeo_rat_surfR[1]*JfR[17]); 
  JRatfR[10] = 0.03333333333333333*((-25.98076211353316*jacobgeo_rat_surfR[1]*JfR[23])+8.660254037844387*(1.732050807568877*jacobgeo_rat_surfR[1]*JfR[22]-3.0*jacobgeo_rat_surfR[0]*JfR[21])+15.0*jacobgeo_rat_surfR[0]*JfR[19]); 
  JRatfR[11] = 0.03333333333333333*(8.660254037844387*(1.732050807568877*jacobgeo_rat_surfR[1]*JfR[19]-3.0*jacobgeo_rat_surfR[0]*JfR[23])+15.0*jacobgeo_rat_surfR[0]*JfR[22]-25.98076211353316*jacobgeo_rat_surfR[1]*JfR[21]); 
  ...
  cfl = fmax(fabs(alpha_quad), fabs(cfl)); 
  JfL_quad = (-0.3872983346207417*JfL[23])-0.223606797749979*JfL[22]+0.3872983346207416*JfL[21]-0.3872983346207416*JfL[20]+0.2236067977499789*JfL[19]-0.223606797749979*JfL[18]+0.3872983346207417*JfL[17]+0.223606797749979*JfL[16]+0.5809475019311124*JfL[15]+0.3354101966249685*JfL[14]-0.5809475019311124*JfL[13]-0.4330127018922193*JfL[12]+0.5809475019311124*JfL[11]-0.3354101966249685*JfL[10]-0.25*JfL[9]+0.4330127018922193*JfL[8]+0.3354101966249685*JfL[7]-0.5809475019311124*JfL[6]-0.4330127018922193*JfL[5]+0.25*JfL[4]-0.3354101966249685*JfL[3]-0.25*JfL[2]+0.4330127018922193*JfL[1]+0.25*JfL[0]; 
