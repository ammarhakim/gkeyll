...
GKYL_CU_DH double gk_collisionless_flux_add_em_surfx_1x1v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfx_1x1v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfx_1x1v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfx_1x1v_ser_p1(
                  const double *w, const double *dxv,
...
GKYL_CU_DH double gk_collisionless_flux_add_em_surfx_1x1v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfx_1x1v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfx_1x1v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfx_1x1v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfvpar_1x1v_ser_p2(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
...
GKYL_CU_DH double gk_collisionless_flux_add_em_surfx_1x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfx_1x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfx_1x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfx_1x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfvpar_1x2v_ser_p1(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
...
GKYL_CU_DH double gk_collisionless_flux_add_em_surfx_1x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfx_1x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfx_1x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfx_1x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfvpar_1x2v_ser_p2(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
...
GKYL_CU_DH double gk_collisionless_flux_add_em_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfvpar_2x2v_ser_p1(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, const double *JfL, const double *JfR, 
              double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_edge_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_edge_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_edge_surfx_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_edge_surfy_2x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfvpar_2x2v_ser_p1(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
...
GKYL_CU_DH double gk_collisionless_flux_add_em_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfvpar_2x2v_ser_p2(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, const double *JfL, const double *JfR, 
              double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_edge_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_edge_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_edge_surfx_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_edge_surfy_2x2v_ser_p2(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfvpar_2x2v_ser_p2(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
...
GKYL_CU_DH double gk_collisionless_flux_add_em_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_edge_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_multib_boundary_edge_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_surfvpar_3x2v_ser_p1(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
              const double *bmag, const double *phi, const double *JfL, const double *JfR, 
              double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_edge_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_edge_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_edge_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_edge_surfx_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_edge_surfy_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_multib_boundary_edge_surfz_3x2v_ser_p1(
                  const double *w, const double *dxv,
                  ...
                  const double *phi, const double *JfL, const double *JfR, 
                  double* GKYL_RESTRICT flux_surf); 
GKYL_CU_DH double gk_collisionless_flux_add_em_no_by_surfvpar_3x2v_ser_p1(
              const double *w, const double *dxv,
              const double *vmap_prime_l, const double *vmap_prime_r, 
              const double *vmap, const double *vmapSq, const double q_, const double m_, 
              const struct gkyl_dg_vol_geom *dgv, const struct gkyl_gk_dg_vol_geom *gkdgv, 
