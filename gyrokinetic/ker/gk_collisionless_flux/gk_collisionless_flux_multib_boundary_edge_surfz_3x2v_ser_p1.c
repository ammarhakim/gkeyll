...
{ 
  ...
  double hamil[48] = {0.}; 
  hamil[0] = 2.4494897427831783*phiL[3]*q_+1.4142135623730951*(phiL[0]*q_+vmapSq[0]*m_)+vmap[2]*(1.7320508075688772*bmag[3]+bmag[0]); 
  hamil[1] = (2.4494897427831783*phiL[5]+1.4142135623730951*phiL[1])*q_+vmap[2]*(1.7320508075688772*bmag[5]+bmag[1]); 
  hamil[2] = (2.4494897427831783*phiL[6]+1.4142135623730951*phiL[2])*q_; 
  hamil[3] = 1.4142135623730951*vmapSq[1]*m_; 
  hamil[4] = (1.7320508075688772*bmag[3]+bmag[0])*vmap[3]; 
  hamil[5] = (2.4494897427831783*phiL[7]+1.4142135623730951*phiL[4])*q_; 
  ...
  ypotderL[3] += -(3.4641016151377544*phiL[0]*q_*rdz2)-2.4494897427831783*bmag[0]*vmap[2]*rdz2; 
  ypotderL[7] += -(3.4641016151377544*phiL[1]*q_*rdz2)-2.4494897427831783*bmag[1]*vmap[2]*rdz2; 
  ypotderL[8] += -(3.4641016151377544*phiL[2]*q_*rdz2); 
  ypotderL[14] += -(2.4494897427831783*bmag[0]*vmap[3]*rdz2); 
  ypotderL[16] += -(3.4641016151377544*phiL[4]*q_*rdz2); 
  ...
  ypotderL[16] += -(3.4641016151377544*phiL[4]*q_*rdz2); 
  ypotderL[21] += -(2.4494897427831783*bmag[1]*vmap[3]*rdz2); 
  ypotderR[3] += -(3.4641016151377544*phiL[0]*q_*rdz2)-2.4494897427831783*bmag[0]*vmap[2]*rdz2; 
  ypotderR[7] += -(3.4641016151377544*phiL[1]*q_*rdz2)-2.4494897427831783*bmag[1]*vmap[2]*rdz2; 
  ypotderR[8] += -(3.4641016151377544*phiL[2]*q_*rdz2); 
  ypotderR[14] += -(2.4494897427831783*bmag[0]*vmap[3]*rdz2); 
  ypotderR[16] += -(3.4641016151377544*phiL[4]*q_*rdz2); 
