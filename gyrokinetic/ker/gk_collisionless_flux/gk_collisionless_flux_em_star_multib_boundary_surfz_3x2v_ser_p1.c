...
{ 
  ...
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[1]-0.4330127018922193*apar[5])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[2]-0.4330127018922193*apar[5])*rdy2) * bhat_quad[0]) * dHdvpar_quad[0]; 
  ...
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[1]-0.4330127018922193*apar[5])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[2]-0.4330127018922193*apar[5])*rdy2) * bhat_quad[0]) * dHdvpar_quad[1]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[1]-0.4330127018922193*apar[5])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[2]-0.4330127018922193*apar[5])*rdy2) * bhat_quad[0]) * dHdvpar_quad[2]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[2]-0.4330127018922193*hamil[5])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (-(0.25*apar[5])+0.25*apar[2]-0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[0]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[5]+0.4330127018922193*apar[1])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[2]-0.4330127018922193*apar[5])*rdy2) * bhat_quad[0]) * dHdvpar_quad[0]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[2]-0.4330127018922193*hamil[5])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (-(0.25*apar[5])+0.25*apar[2]-0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[1]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[5]+0.4330127018922193*apar[1])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[2]-0.4330127018922193*apar[5])*rdy2) * bhat_quad[0]) * dHdvpar_quad[1]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[2]-0.4330127018922193*hamil[5])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (-(0.25*apar[5])+0.25*apar[2]-0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[2]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[5]+0.4330127018922193*apar[1])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[2]-0.4330127018922193*apar[5])*rdy2) * bhat_quad[0]) * dHdvpar_quad[2]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/m_ * (-(0.25*apar[5])-0.25*apar[2]+0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[0]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[1]-0.4330127018922193*apar[5])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[5]+0.4330127018922193*apar[2])*rdy2) * bhat_quad[0]) * dHdvpar_quad[0]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (-(0.25*apar[5])-0.25*apar[2]+0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[1]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[1]-0.4330127018922193*apar[5])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[5]+0.4330127018922193*apar[2])*rdy2) * bhat_quad[0]) * dHdvpar_quad[1]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (-(0.25*apar[5])-0.25*apar[2]+0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[2]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[1]-0.4330127018922193*apar[5])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[5]+0.4330127018922193*apar[2])*rdy2) * bhat_quad[0]) * dHdvpar_quad[2]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (0.25*apar[5]+0.25*apar[2]+0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[0]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[5]+0.4330127018922193*apar[1])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[5]+0.4330127018922193*apar[2])*rdy2) * bhat_quad[0]) * dHdvpar_quad[0]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (0.25*apar[5]+0.25*apar[2]+0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[1]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[5]+0.4330127018922193*apar[1])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[5]+0.4330127018922193*apar[2])*rdy2) * bhat_quad[0]) * dHdvpar_quad[1]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
  ...
  alpha_quad += 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[0]*((0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdy2) - bhat_quad[1]*((-(0.4330127018922193*hamil[8])+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)); 
  alpha_quad += 1/m_ * (0.25*apar[5]+0.25*apar[2]+0.25*apar[1]+0.25*apar[0]) * normcurlbhat_quad/bmag_quad * dHdvpar_quad[2]; 
  alpha_quad += 1/(m_*bmag_quad*area_elem_quad) * (((0.4330127018922193*apar[5]+0.4330127018922193*apar[1])*rdx2) * bhat_quad[1] - ((0.4330127018922193*apar[5]+0.4330127018922193*apar[2])*rdy2) * bhat_quad[0]) * dHdvpar_quad[2]; 
  alpha_quad = alpha_quad * area_elem_quad/Jc_quad; 
