...
{ 
  ...
  double JRatfR[12] = {0.}; 
  JRatfR[0] = -(0.3535533905932737*(1.7320508075688772*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[5]+JfR[1]*(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0]))-1.0*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[2]+JfR[0]*(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])))); 
  JRatfR[1] = -(0.07071067811865474*(1.7320508075688772*((9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[5]+5.0*JfR[1]*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1]))+(-(9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1])-5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[2]-5.0*JfR[0]*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1]))); 
  JRatfR[2] = -(0.3535533905932737*(1.7320508075688772*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[11]+(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[6])-1.0*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[7]+(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[3]))); 
  JRatfR[3] = -(0.3535533905932737*(1.7320508075688772*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[12]+(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[8])-1.0*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[9]+(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[4]))); 
  JRatfR[4] = -(0.07071067811865474*(1.7320508075688772*((9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[11]+5.0*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[6])+(-(9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1])-5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[7]-5.0*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[3])); 
  JRatfR[5] = -(0.07071067811865474*(1.7320508075688772*((9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[12]+5.0*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[8])+(-(9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1])-5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[9]-5.0*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[4])); 
  JRatfR[6] = -(0.3535533905932737*(1.7320508075688772*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[15]+(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[13])-1.0*((jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[14]+(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[10]))); 
  JRatfR[7] = -(0.07071067811865474*(1.7320508075688772*((9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[15]+5.0*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[13])+(-(9.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1])-5.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[14]-5.0*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[10])); 
  JRatfR[8] = 0.023570226039551577*(-(25.980762113533157*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[20])+8.660254037844387*(1.7320508075688772*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[18]-3.0*(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[17])+15.0*(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[16]); 
  JRatfR[9] = 0.004714045207910316*(8.660254037844387*((-(27.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1])-15.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[20]+8.660254037844386*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[16])+(135.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+75.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[18]-129.9038105676658*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[17]); 
  JRatfR[10] = 0.023570226039551577*(-(25.980762113533157*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[23])+8.660254037844387*(1.7320508075688772*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[22]-3.0*(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[21])+15.0*(jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[19]); 
  JRatfR[11] = 0.004714045207910316*(8.660254037844387*((-(27.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1])-15.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[23]+8.660254037844386*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[19])+(135.0*jacobgeo_inv_surfR[1]*jacobgeo_surfL[1]+75.0*jacobgeo_inv_surfR[0]*jacobgeo_surfL[0])*JfR[22]-129.9038105676658*(jacobgeo_inv_surfR[0]*jacobgeo_surfL[1]+jacobgeo_surfL[0]*jacobgeo_inv_surfR[1])*JfR[21]); 
