...
{ 
  ...
  double hamil[48] = {0.}; 
  hamil[0] = -(2.4494897427831783*phiR[1]*q_)+1.4142135623730951*(phiR[0]*q_+vmapSq[0]*m_)+(bmag[0]-1.7320508075688772*bmag[1])*vmap[2]; 
  hamil[1] = (1.4142135623730951*phiR[2]-2.4494897427831783*phiR[4])*q_; 
  hamil[2] = (1.4142135623730951*phiR[3]-2.4494897427831783*phiR[5])*q_+vmap[2]*(bmag[3]-1.7320508075688772*bmag[5]); 
  hamil[3] = 1.4142135623730951*vmapSq[1]*m_; 
  hamil[4] = (bmag[0]-1.7320508075688772*bmag[1])*vmap[3]; 
  hamil[5] = (1.4142135623730951*phiR[6]-2.4494897427831783*phiR[7])*q_; 
  ...
  ypotderR[6] += -(3.4641016151377544*phiR[2]*q_*rdx2); 
  ypotderR[7] += -(3.4641016151377544*phiR[3]*q_*rdx2)-2.4494897427831783*vmap[2]*bmag[3]*rdx2; 
  ypotderR[12] += -(2.4494897427831783*bmag[0]*vmap[3]*rdx2); 
  ypotderR[16] += -(3.4641016151377544*phiR[6]*q_*rdx2); 
  ...
  ypotderL[1] += -(3.4641016151377544*phiR[0]*q_*rdx2)-2.4494897427831783*bmag[0]*vmap[2]*rdx2; 
  ypotderL[6] += -(3.4641016151377544*phiR[2]*q_*rdx2); 
  ypotderL[7] += -(3.4641016151377544*phiR[3]*q_*rdx2)-2.4494897427831783*vmap[2]*bmag[3]*rdx2; 
  ypotderL[12] += -(2.4494897427831783*bmag[0]*vmap[3]*rdx2); 
  ypotderL[16] += -(3.4641016151377544*phiR[6]*q_*rdx2); 
