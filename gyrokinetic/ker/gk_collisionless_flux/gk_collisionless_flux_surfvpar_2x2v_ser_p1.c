...
{ 
  ...
  alpha_quad += -((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)*m_bmag_inv * Jc_quad/mag_e_3 * (-g_23 * ((0.8660254037844386*apar[2]-0.8660254037844386*apar[3])*rdz2)); 
  alpha_quad += -((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[9]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2)*m_bmag_inv * Jc_quad/mag_e_3 * ( g_23 * ((0.8660254037844386*apar[1]-0.8660254037844386*apar[3])*rdx2)); 
  ...
  alpha_quad += -((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[9]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2)*m_bmag_inv * (-(0.5*apar[3])+0.5*apar[2]-0.5*apar[1]+0.5*apar[0])*dualcurlbhat_quad[2]; 
  alpha_quad += -((-(0.4330127018922193*hamil[12])-0.4330127018922193*hamil[8]+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)*m_bmag_inv * Jc_quad/mag_e_3 * (-g_23 * ((0.8660254037844386*apar[2]-0.8660254037844386*apar[3])*rdz2)); 
  alpha_quad += -((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[9]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2)*m_bmag_inv * Jc_quad/mag_e_3 * ( g_23 * ((0.8660254037844386*apar[3]+0.8660254037844386*apar[1])*rdx2)); 
  ...
  alpha_quad += -((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)*m_bmag_inv * (-(0.5*apar[3])-0.5*apar[2]+0.5*apar[1]+0.5*apar[0])*dualcurlbhat_quad[0]; 
  alpha_quad += -((-(0.4330127018922193*hamil[12])-0.4330127018922193*hamil[9]+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2)*m_bmag_inv * (-(0.5*apar[3])-0.5*apar[2]+0.5*apar[1]+0.5*apar[0])*dualcurlbhat_quad[2]; 
  alpha_quad += -((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)*m_bmag_inv * Jc_quad/mag_e_3 * (-g_23 * ((0.8660254037844386*apar[3]+0.8660254037844386*apar[2])*rdz2)); 
  alpha_quad += -((-(0.4330127018922193*hamil[12])-0.4330127018922193*hamil[9]+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2)*m_bmag_inv * Jc_quad/mag_e_3 * ( g_23 * ((0.8660254037844386*apar[1]-0.8660254037844386*apar[3])*rdx2)); 
