...
{ 
  ...
  alpha_quad += -1.0/m_/bmag_quad * ((0.5*apar[3]-0.5*apar[2]-0.5*apar[1]+0.5*apar[0])*(0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)*dualcurlbhat_quad[0]; 
  alpha_quad += -1.0/m_/bmag_quad * ((0.5*apar[3]-0.5*apar[2]-0.5*apar[1]+0.5*apar[0])*(0.4330127018922193*hamil[12]-0.4330127018922193*hamil[9]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2)*dualcurlbhat_quad[2]; 
  alpha_quad += -bioverJB_quad[2]/m_ *((0.8660254037844386*apar[1]-0.8660254037844386*apar[3])*(0.4330127018922193*hamil[12]-0.4330127018922193*hamil[9]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdx2*rdz2-1.0*(0.8660254037844386*apar[2]-0.8660254037844386*apar[3])*(0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2*rdz2); 
  ...
  alpha_quad += -1.0/m_/bmag_quad * ((-(0.5*apar[3])-0.5*apar[2]+0.5*apar[1]+0.5*apar[0])*(0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2)*dualcurlbhat_quad[0]; 
  alpha_quad += -1.0/m_/bmag_quad * ((-(0.5*apar[3])-0.5*apar[2]+0.5*apar[1]+0.5*apar[0])*(-(0.4330127018922193*hamil[12])-0.4330127018922193*hamil[9]+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2)*dualcurlbhat_quad[2]; 
  alpha_quad += -bioverJB_quad[2]/m_ *((0.8660254037844386*apar[1]-0.8660254037844386*apar[3])*(-(0.4330127018922193*hamil[12])-0.4330127018922193*hamil[9]+0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdx2*rdz2-1.0*(0.8660254037844386*apar[3]+0.8660254037844386*apar[2])*(0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdx2*rdz2); 
  alpha_quad += -q_/m_*(-(0.5*apardot[3])-0.5*apardot[2]+0.5*apardot[1]+0.5*apardot[0]); 
