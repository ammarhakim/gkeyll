...
{ 
  ...
  double hamil[48] = {0.}; 
  hamil[0] = 2.4494897427831783*phiL[1]*q_+1.4142135623730951*(phiL[0]*q_+vmapSq[0]*m_)+(1.7320508075688772*bmag[1]+bmag[0])*vmap[2]; 
  hamil[1] = (2.4494897427831783*phiL[4]+1.4142135623730951*phiL[2])*q_; 
  hamil[2] = (2.4494897427831783*phiL[5]+1.4142135623730951*phiL[3])*q_+vmap[2]*(1.7320508075688772*bmag[5]+bmag[3]); 
  hamil[3] = 1.4142135623730951*vmapSq[1]*m_; 
  hamil[4] = (1.7320508075688772*bmag[1]+bmag[0])*vmap[3]; 
  hamil[5] = (2.4494897427831783*phiL[7]+1.4142135623730951*phiL[6])*q_; 
  ...
  ypotderL[1] += -(3.4641016151377544*phiL[0]*q_*rdx2)-2.4494897427831783*bmag[0]*vmap[2]*rdx2; 
  ypotderL[6] += -(3.4641016151377544*phiL[2]*q_*rdx2); 
  ypotderL[7] += -(3.4641016151377544*phiL[3]*q_*rdx2)-2.4494897427831783*vmap[2]*bmag[3]*rdx2; 
  ypotderL[12] += -(2.4494897427831783*bmag[0]*vmap[3]*rdx2); 
  ypotderL[16] += -(3.4641016151377544*phiL[6]*q_*rdx2); 
  ypotderL[21] += -(2.4494897427831783*bmag[3]*vmap[3]*rdx2); 
  ...
  ypotL_quad = -(0.25*(1.7320508075688772*(1.4142135623730951*phiL[5]*q_+vmap[2]*bmag[5])+1.4142135623730951*phiL[3]*q_+vmap[2]*bmag[3]))+0.25*(1.7320508075688772*(1.4142135623730951*phiL[1]*q_+bmag[1]*vmap[2])+1.4142135623730951*phiL[0]*q_+bmag[0]*vmap[2])+0.25*(2.4494897427831783*phiL[7]*q_+1.4142135623730951*phiL[6]*q_)-0.25*(2.4494897427831783*phiL[4]*q_+1.4142135623730951*phiL[2]*q_)+0.25*(1.7320508075688772*vmap[3]*bmag[5]+bmag[3]*vmap[3])-0.25*(1.7320508075688772*bmag[1]*vmap[3]+bmag[0]*vmap[3]); 
  ypotR_quad = -(0.25*(1.7320508075688772*(-(1.4142135623730951*phiR[5]*q_)-1.0*vmap[2]*bmag[5])+1.4142135623730951*phiR[3]*q_+vmap[2]*bmag[3]))+0.25*(1.7320508075688772*(-(1.4142135623730951*phiR[1]*q_)-1.0*bmag[1]*vmap[2])+1.4142135623730951*phiR[0]*q_+bmag[0]*vmap[2])+0.25*(1.4142135623730951*phiR[6]*q_-2.4494897427831783*phiR[7]*q_)-0.25*(1.4142135623730951*phiR[2]*q_-2.4494897427831783*phiR[4]*q_)+0.25*(bmag[3]*vmap[3]-1.7320508075688772*vmap[3]*bmag[5])-0.25*(bmag[0]*vmap[3]-1.7320508075688772*bmag[1]*vmap[3]); 
  ...
  ypotderL[16] += -(3.4641016151377544*phiL[6]*q_*rdx2); 
  ypotderL[21] += -(2.4494897427831783*bmag[3]*vmap[3]*rdx2); 
  ypotderR[1] += -(3.4641016151377544*phiL[0]*q_*rdx2)-2.4494897427831783*bmag[0]*vmap[2]*rdx2; 
  ypotderR[6] += -(3.4641016151377544*phiL[2]*q_*rdx2); 
  ypotderR[7] += -(3.4641016151377544*phiL[3]*q_*rdx2)-2.4494897427831783*vmap[2]*bmag[3]*rdx2; 
  ypotderR[12] += -(2.4494897427831783*bmag[0]*vmap[3]*rdx2); 
  ypotderR[16] += -(3.4641016151377544*phiL[6]*q_*rdx2); 
  ypotderR[21] += -(2.4494897427831783*bmag[3]*vmap[3]*rdx2); 
