...
GKYL_CU_DH double gk_collisionless_flux_gen_geo_multib_boundary_surfx_3x2v_ser_p1(
...
{ 
  ...
  hamil[1] = (1.4142135623730951*phi[2]-2.4494897427831783*phi[4])*q_+vmap[2]*(bmag[2]-1.7320508075688772*bmag[4]); 
  ...
  hamil[5] = (1.4142135623730951*phi[6]-2.4494897427831783*phi[7])*q_+vmap[2]*(bmag[6]-1.7320508075688772*bmag[7]); 
  hamil[8] = vmap[3]*(bmag[2]-1.7320508075688772*bmag[4]); 
  hamil[9] = vmap[3]*(bmag[3]-1.7320508075688772*bmag[5]); 
  hamil[12] = vmap[3]*(bmag[6]-1.7320508075688772*bmag[7]); 
  ...
  JRatfL[16] = 0.016666666666666666*(8.660254037844387*(4.242640687119286*jacobgeo_rat_surfL[3]*JfL[43]+2.4494897427831783*(jacobgeo_rat_surfL[2]*JfL[35]+jacobgeo_rat_surfL[1]*JfL[34])+4.242640687119286*jacobgeo_rat_surfL[0]*JfL[33])+21.213203435596427*jacobgeo_rat_surfL[3]*JfL[39]+36.74234614174767*(jacobgeo_rat_surfL[2]*JfL[38]+jacobgeo_rat_surfL[1]*JfL[37])+21.213203435596427*jacobgeo_rat_surfL[0]*JfL[32]); 
  JRatfL[17] = 0.016666666666666666*(36.74234614174767*(jacobgeo_rat_surfL[2]*JfL[43]+jacobgeo_rat_surfL[1]*JfL[33])+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfL[2]*JfL[39]+jacobgeo_rat_surfL[1]*JfL[32])+4.242640687119286*(jacobgeo_rat_surfL[3]*JfL[38]+jacobgeo_rat_surfL[0]*JfL[37]))+21.213203435596427*(jacobgeo_rat_surfL[3]*JfL[35]+jacobgeo_rat_surfL[0]*JfL[34])); 
  JRatfL[18] = 0.016666666666666666*(36.74234614174767*(jacobgeo_rat_surfL[1]*JfL[43]+jacobgeo_rat_surfL[2]*JfL[33])+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfL[1]*JfL[39]+jacobgeo_rat_surfL[2]*JfL[32])+4.242640687119286*(jacobgeo_rat_surfL[0]*JfL[38]+jacobgeo_rat_surfL[3]*JfL[37]))+21.213203435596427*(jacobgeo_rat_surfL[0]*JfL[35]+jacobgeo_rat_surfL[3]*JfL[34])); 
  JRatfL[19] = 0.016666666666666666*(8.660254037844387*(4.242640687119286*jacobgeo_rat_surfL[3]*JfL[47]+2.4494897427831783*(jacobgeo_rat_surfL[2]*JfL[42]+jacobgeo_rat_surfL[1]*JfL[41])+4.242640687119286*jacobgeo_rat_surfL[0]*JfL[40])+21.213203435596427*jacobgeo_rat_surfL[3]*JfL[46]+36.74234614174767*(jacobgeo_rat_surfL[2]*JfL[45]+jacobgeo_rat_surfL[1]*JfL[44])+21.213203435596427*jacobgeo_rat_surfL[0]*JfL[36]); 
  JRatfL[20] = 0.016666666666666666*(8.660254037844387*(4.242640687119286*jacobgeo_rat_surfL[0]*JfL[43]+2.4494897427831783*(jacobgeo_rat_surfL[1]*JfL[35]+jacobgeo_rat_surfL[2]*JfL[34])+4.242640687119286*jacobgeo_rat_surfL[3]*JfL[33])+21.213203435596427*jacobgeo_rat_surfL[0]*JfL[39]+36.74234614174767*(jacobgeo_rat_surfL[1]*JfL[38]+jacobgeo_rat_surfL[2]*JfL[37])+21.213203435596427*jacobgeo_rat_surfL[3]*JfL[32]); 
  JRatfL[21] = 0.016666666666666666*(36.74234614174767*(jacobgeo_rat_surfL[2]*JfL[47]+jacobgeo_rat_surfL[1]*JfL[40])+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfL[2]*JfL[46]+jacobgeo_rat_surfL[1]*JfL[36])+4.242640687119286*(jacobgeo_rat_surfL[3]*JfL[45]+jacobgeo_rat_surfL[0]*JfL[44]))+21.213203435596427*(jacobgeo_rat_surfL[3]*JfL[42]+jacobgeo_rat_surfL[0]*JfL[41])); 
  JRatfL[22] = 0.016666666666666666*(36.74234614174767*(jacobgeo_rat_surfL[1]*JfL[47]+jacobgeo_rat_surfL[2]*JfL[40])+8.660254037844387*(2.4494897427831783*(jacobgeo_rat_surfL[1]*JfL[46]+jacobgeo_rat_surfL[2]*JfL[36])+4.242640687119286*(jacobgeo_rat_surfL[0]*JfL[45]+jacobgeo_rat_surfL[3]*JfL[44]))+21.213203435596427*(jacobgeo_rat_surfL[0]*JfL[42]+jacobgeo_rat_surfL[3]*JfL[41])); 
  JRatfL[23] = 0.016666666666666666*(8.660254037844387*(4.242640687119286*jacobgeo_rat_surfL[0]*JfL[47]+2.4494897427831783*(jacobgeo_rat_surfL[1]*JfL[42]+jacobgeo_rat_surfL[2]*JfL[41])+4.242640687119286*jacobgeo_rat_surfL[3]*JfL[40])+21.213203435596427*jacobgeo_rat_surfL[0]*JfL[46]+36.74234614174767*(jacobgeo_rat_surfL[1]*JfL[45]+jacobgeo_rat_surfL[2]*JfL[44])+21.213203435596427*jacobgeo_rat_surfL[3]*JfL[36]); 
  ...
  alpha_quad = (mvparsq_quad[1]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[1]*((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[9]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2) - bhat_quad[2]*((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdy2)))*area_elem_quad/Jc_quad; 
  ...
  alpha_quad = (mvparsq_quad[2]*normcurlbhat_quad/(bmag_quad*q_) + 1/(q_*bmag_quad*area_elem_quad) * (bhat_quad[1]*((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[9]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[2])*rdz2) - bhat_quad[2]*((0.4330127018922193*hamil[12]-0.4330127018922193*hamil[8]-0.4330127018922193*hamil[5]+0.4330127018922193*hamil[1])*rdy2)))*area_elem_quad/Jc_quad; 
