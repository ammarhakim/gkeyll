...
{ 
  ...
  double hamil[48] = {0.}; 
  hamil[0] = -(2.4494897427831783*phiR[2]*q_)+1.4142135623730951*(phiR[0]*q_+vmapSq[0]*m_)+bmag[0]*vmap[2]; 
  hamil[1] = (1.4142135623730951*phiR[1]-2.4494897427831783*phiR[4])*q_+bmag[1]*vmap[2]; 
  hamil[2] = (1.4142135623730951*phiR[3]-2.4494897427831783*phiR[6])*q_+vmap[2]*bmag[3]; 
  hamil[3] = 1.4142135623730951*vmapSq[1]*m_; 
  hamil[4] = bmag[0]*vmap[3]; 
  hamil[5] = (1.4142135623730951*phiR[5]-2.4494897427831783*phiR[7])*q_+vmap[2]*bmag[5]; 
  ...
  ypotderR[2] += -(3.4641016151377544*phiR[0]*q_*rdy2)-2.4494897427831783*bmag[0]*vmap[2]*rdy2; 
  ypotderR[6] += -(3.4641016151377544*phiR[1]*q_*rdy2)-2.4494897427831783*bmag[1]*vmap[2]*rdy2; 
  ypotderR[8] += -(3.4641016151377544*phiR[3]*q_*rdy2)-2.4494897427831783*vmap[2]*bmag[3]*rdy2; 
  ypotderR[13] += -(2.4494897427831783*bmag[0]*vmap[3]*rdy2); 
  ypotderR[16] += -(3.4641016151377544*phiR[5]*q_*rdy2)-2.4494897427831783*vmap[2]*bmag[5]*rdy2; 
  ...
  ypotderL[2] += -(3.4641016151377544*phiR[0]*q_*rdy2)-2.4494897427831783*bmag[0]*vmap[2]*rdy2; 
  ypotderL[6] += -(3.4641016151377544*phiR[1]*q_*rdy2)-2.4494897427831783*bmag[1]*vmap[2]*rdy2; 
  ypotderL[8] += -(3.4641016151377544*phiR[3]*q_*rdy2)-2.4494897427831783*vmap[2]*bmag[3]*rdy2; 
  ypotderL[13] += -(2.4494897427831783*bmag[0]*vmap[3]*rdy2); 
  ypotderL[16] += -(3.4641016151377544*phiR[5]*q_*rdy2)-2.4494897427831783*vmap[2]*bmag[5]*rdy2; 
