...
GKYL_CU_DH bool positivity_shift_gyrokinetic_shift_only_1x2v_ser_p1(double ffloor, double frac_shift, double *distf);
GKYL_CU_DH bool positivity_shift_gyrokinetic_MRS_limiter_1x2v_ser_p1(double ffloor, double frac_shift, double *distf);

GKYL_CU_DH bool positivity_shift_gyrokinetic_conf_pos_check_2x_ser_p1(const double *fld);

GKYL_CU_DH bool positivity_shift_gyrokinetic_shift_only_2x2v_ser_p1(double ffloor, double frac_shift, double *distf);
GKYL_CU_DH bool positivity_shift_gyrokinetic_MRS_limiter_2x2v_ser_p1(double ffloor, double frac_shift, double *distf);
