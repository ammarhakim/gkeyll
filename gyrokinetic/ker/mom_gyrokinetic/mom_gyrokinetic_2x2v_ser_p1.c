...
{ 
  ...
  tmp2[3] = 1.4142135623730951*vmap[3]*f[12]+1.4142135623730951*vmap[2]*f[5]; 
  double tmp3[4]; 
  tmp3[0] = vmap[1]*vmap[3]*f[10]+vmap[0]*vmap[3]*f[4]+vmap[1]*vmap[2]*f[3]+f[0]*vmap[0]*vmap[2]; 
  tmp3[1] = vmap[1]*vmap[3]*f[13]+vmap[0]*vmap[3]*f[8]+vmap[1]*vmap[2]*f[6]+vmap[0]*f[1]*vmap[2]; 
  tmp3[2] = vmap[1]*vmap[3]*f[14]+vmap[0]*vmap[3]*f[9]+vmap[1]*vmap[2]*f[7]+vmap[0]*f[2]*vmap[2]; 
  tmp3[3] = vmap[1]*vmap[3]*f[15]+vmap[0]*vmap[3]*f[12]+vmap[1]*vmap[2]*f[11]+vmap[0]*vmap[2]*f[5]; 
  const double vmap0R2 = pow(vmap[0],2);
  const double vmap0R3 = pow(vmap[0],3);
  const double vmap1R2 = pow(vmap[1],2);
  const double vmap1R3 = pow(vmap[1],3);
  ...
  out[6] += (1.4142135623730951*vmap[1]*f[7]+1.4142135623730951*vmap[0]*f[2])*volFact; 
  out[7] += (1.4142135623730951*vmap[1]*f[11]+1.4142135623730951*vmap[0]*f[5])*volFact; 
  out[8] += ((bmag[3]*tmp2[3]+bmag[2]*tmp2[2]+bmag[1]*tmp2[1]+bmag[0]*tmp2[0])*volFact)/m_+(0.8944271909999159*vmap1R2*f[16]+2.0*vmap[0]*vmap[1]*f[3]+f[0]*vmap1R2+f[0]*vmap0R2)*volFact; 
  out[9] += ((bmag[2]*tmp2[3]+tmp2[2]*bmag[3]+bmag[0]*tmp2[1]+tmp2[0]*bmag[1])*volFact)/m_+(0.8944271909999161*vmap1R2*f[17]+2.0*vmap[0]*vmap[1]*f[6]+f[1]*vmap1R2+vmap0R2*f[1])*volFact; 
  out[10] += ((bmag[1]*tmp2[3]+tmp2[1]*bmag[3]+bmag[0]*tmp2[2]+tmp2[0]*bmag[2])*volFact)/m_+(0.8944271909999161*vmap1R2*f[18]+2.0*vmap[0]*vmap[1]*f[7]+vmap1R2*f[2]+vmap0R2*f[2])*volFact; 
  out[11] += ((bmag[0]*tmp2[3]+tmp2[0]*bmag[3]+bmag[1]*tmp2[2]+tmp2[1]*bmag[2])*volFact)/m_+(0.8944271909999159*vmap1R2*f[20]+2.0*vmap[0]*vmap[1]*f[11]+vmap1R2*f[5]+vmap0R2*f[5])*volFact; 
  out[12] += ((bmag[3]*tmp3[3]+bmag[2]*tmp3[2]+bmag[1]*tmp3[1]+bmag[0]*tmp3[0])*volFact)/m_+(1.8973665961010278*vmap[0]*vmap1R2*f[16]+1.2727922061357855*vmap1R3*f[3]+2.1213203435596424*vmap0R2*vmap[1]*f[3]+2.1213203435596424*f[0]*vmap[0]*vmap1R2+0.7071067811865475*f[0]*vmap0R3)*volFact; 
  out[13] += ((bmag[2]*tmp3[3]+tmp3[2]*bmag[3]+bmag[0]*tmp3[1]+tmp3[0]*bmag[1])*volFact)/m_+(1.897366596101028*vmap[0]*vmap1R2*f[17]+1.2727922061357855*vmap1R3*f[6]+2.1213203435596424*vmap0R2*vmap[1]*f[6]+2.1213203435596424*vmap[0]*f[1]*vmap1R2+0.7071067811865475*vmap0R3*f[1])*volFact; 
  out[14] += ((bmag[1]*tmp3[3]+tmp3[1]*bmag[3]+bmag[0]*tmp3[2]+tmp3[0]*bmag[2])*volFact)/m_+(1.897366596101028*vmap[0]*vmap1R2*f[18]+1.2727922061357855*vmap1R3*f[7]+2.1213203435596424*vmap0R2*vmap[1]*f[7]+2.1213203435596424*vmap[0]*vmap1R2*f[2]+0.7071067811865475*vmap0R3*f[2])*volFact; 
  out[15] += ((bmag[0]*tmp3[3]+tmp3[0]*bmag[3]+bmag[1]*tmp3[2]+tmp3[1]*bmag[2])*volFact)/m_+(1.8973665961010278*vmap[0]*vmap1R2*f[20]+1.2727922061357855*vmap1R3*f[11]+2.1213203435596424*vmap0R2*vmap[1]*f[11]+2.1213203435596424*vmap[0]*vmap1R2*f[5]+0.7071067811865475*vmap0R3*f[5])*volFact; 
} 

GKYL_CU_DH void mom_gyrokinetic_HAMILTONIAN_2x2v_ser_p1(const double *dxv, const double *vmap, double m_, double q_, const double *bmag, const double *phi, const double *f, double* GKYL_RESTRICT out) 
{ 
  const double volFact = 1.5707963267948966*dxv[2]*dxv[3]/m_; 
  double tmp[4]; 
  tmp[0] = 1.4142135623730951*vmap[3]*f[4]+1.4142135623730951*f[0]*vmap[2]; 
...
{ 
  ...
  out[10] += (0.8944271909999161*vmap1R2*f[18]+2.0*vmap[0]*vmap[1]*f[7]+vmap1R2*f[2]+vmap0R2*f[2])*volFact; 
  out[11] += (0.8944271909999159*vmap1R2*f[20]+2.0*vmap[0]*vmap[1]*f[11]+vmap1R2*f[5]+vmap0R2*f[5])*volFact; 
  out[12] += ((bmag[3]*tmp2[3]+bmag[2]*tmp2[2]+bmag[1]*tmp2[1]+bmag[0]*tmp2[0])*volFact)/m_; 
  out[13] += ((bmag[2]*tmp2[3]+tmp2[2]*bmag[3]+bmag[0]*tmp2[1]+tmp2[0]*bmag[1])*volFact)/m_; 
  out[14] += ((bmag[1]*tmp2[3]+tmp2[1]*bmag[3]+bmag[0]*tmp2[2]+tmp2[0]*bmag[2])*volFact)/m_; 
  out[15] += ((bmag[0]*tmp2[3]+tmp2[0]*bmag[3]+bmag[1]*tmp2[2]+tmp2[1]*bmag[2])*volFact)/m_; 
  out[16] += (0.8944271909999159*vmap1R2*f[16]+2.0*vmap[0]*vmap[1]*f[3]+f[0]*vmap1R2+f[0]*vmap0R2)*volFact; 
  out[17] += (0.8944271909999161*vmap1R2*f[17]+2.0*vmap[0]*vmap[1]*f[6]+f[1]*vmap1R2+vmap0R2*f[1])*volFact; 
  out[18] += (0.8944271909999161*vmap1R2*f[18]+2.0*vmap[0]*vmap[1]*f[7]+vmap1R2*f[2]+vmap0R2*f[2])*volFact; 
  out[19] += (0.8944271909999159*vmap1R2*f[20]+2.0*vmap[0]*vmap[1]*f[11]+vmap1R2*f[5]+vmap0R2*f[5])*volFact; 
  out[20] += ((bmag[3]*tmp3[3]+bmag[2]*tmp3[2]+bmag[1]*tmp3[1]+bmag[0]*tmp3[0])*volFact)/m_; 
  out[21] += ((bmag[2]*tmp3[3]+tmp3[2]*bmag[3]+bmag[0]*tmp3[1]+tmp3[0]*bmag[1])*volFact)/m_; 
  out[22] += ((bmag[1]*tmp3[3]+tmp3[1]*bmag[3]+bmag[0]*tmp3[2]+tmp3[0]*bmag[2])*volFact)/m_; 
  out[23] += ((bmag[0]*tmp3[3]+tmp3[0]*bmag[3]+bmag[1]*tmp3[2]+tmp3[1]*bmag[2])*volFact)/m_; 
} 
