...
{ 
  ...
  double enRHS[3] = {0.0}; 
  enRHS[0] = (0.7071067811865475*alphaE[2]*vtsq_other[2]*m_other)/m_self+(0.7071067811865475*alphaE[1]*vtsq_other[1]*m_other)/m_self+(0.7071067811865475*alphaE[0]*vtsq_other[0]*m_other)/m_self+(0.3535533905932737*alphaE[2]*uSumSq[2]*m_diff)/m_self+(0.3535533905932737*alphaE[1]*uSumSq[1]*m_diff)/m_self+(0.3535533905932737*alphaE[0]*uSumSq[0]*m_diff)/m_self-0.7071067811865475*alphaE[2]*vtsq_self[2]-0.7071067811865475*alphaE[1]*vtsq_self[1]-0.7071067811865475*alphaE[0]*vtsq_self[0]-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = (0.6324555320336759*alphaE[1]*vtsq_other[2]*m_other)/m_self+(0.6324555320336759*vtsq_other[1]*alphaE[2]*m_other)/m_self+(0.7071067811865475*alphaE[0]*vtsq_other[1]*m_other)/m_self+(0.7071067811865475*vtsq_other[0]*alphaE[1]*m_other)/m_self+(0.3162277660168379*alphaE[1]*uSumSq[2]*m_diff)/m_self+(0.3162277660168379*uSumSq[1]*alphaE[2]*m_diff)/m_self+(0.3535533905932737*alphaE[0]*uSumSq[1]*m_diff)/m_self+(0.3535533905932737*uSumSq[0]*alphaE[1]*m_diff)/m_self-0.6324555320336759*alphaE[1]*vtsq_self[2]-0.6324555320336759*vtsq_self[1]*alphaE[2]-0.7071067811865475*alphaE[0]*vtsq_self[1]-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]-0.7071067811865475*vtsq_self[0]*alphaE[1]; 
  enRHS[2] = (0.45175395145262565*alphaE[2]*vtsq_other[2]*m_other)/m_self+(0.7071067811865475*alphaE[0]*vtsq_other[2]*m_other)/m_self+(0.7071067811865475*vtsq_other[0]*alphaE[2]*m_other)/m_self+(0.6324555320336759*alphaE[1]*vtsq_other[1]*m_other)/m_self+(0.22587697572631277*alphaE[2]*uSumSq[2]*m_diff)/m_self+(0.3535533905932737*alphaE[0]*uSumSq[2]*m_diff)/m_self+(0.3535533905932737*uSumSq[0]*alphaE[2]*m_diff)/m_self+(0.3162277660168379*alphaE[1]*uSumSq[1]*m_diff)/m_self-0.45175395145262565*alphaE[2]*vtsq_self[2]-0.7071067811865475*alphaE[0]*vtsq_self[2]-1.0*uM1Self[2]-1.0*uM1Other[2]+2.0*m2r[2]-0.7071067811865475*vtsq_self[0]*alphaE[2]-0.6324555320336759*alphaE[1]*vtsq_self[1]; 
