...
{ 
  ...
  momRHS[0] += -(0.5*((alphaE[3]*u_selfr[3]-1.0*alphaE[3]*u_otherr[3]+alphaE[2]*u_selfr[2]-1.0*alphaE[2]*u_otherr[2]+alphaE[1]*u_selfr[1]-1.0*alphaE[1]*u_otherr[1]+alphaE[0]*u_selfr[0]-1.0*alphaE[0]*u_otherr[0])*m_sum-4.0*m1r[0])); 
  momRHS[1] += -(0.5*((alphaE[2]*u_selfr[3]-1.0*alphaE[2]*u_otherr[3]+(u_selfr[2]-1.0*u_otherr[2])*alphaE[3]+alphaE[0]*u_selfr[1]-1.0*alphaE[0]*u_otherr[1]+(u_selfr[0]-1.0*u_otherr[0])*alphaE[1])*m_sum-4.0*m1r[1])); 
  momRHS[2] += -(0.5*((alphaE[1]*u_selfr[3]-1.0*alphaE[1]*u_otherr[3]+(u_selfr[1]-1.0*u_otherr[1])*alphaE[3]+alphaE[0]*u_selfr[2]-1.0*alphaE[0]*u_otherr[2]+(u_selfr[0]-1.0*u_otherr[0])*alphaE[2])*m_sum-4.0*m1r[2])); 
  momRHS[3] += -(0.5*((alphaE[0]*u_selfr[3]-1.0*alphaE[0]*u_otherr[3]+(u_selfr[0]-1.0*u_otherr[0])*alphaE[3]+alphaE[1]*u_selfr[2]-1.0*alphaE[1]*u_otherr[2]+(u_selfr[1]-1.0*u_otherr[1])*alphaE[2])*m_sum-4.0*m1r[3])); 
  ...
  double enRHS[4] = {0.0}; 
  enRHS[0] = -(1.5*alphaE[3]*vtsq_self[3]*m_self)-1.5*alphaE[2]*vtsq_self[2]*m_self-1.5*alphaE[1]*vtsq_self[1]*m_self-1.5*alphaE[0]*vtsq_self[0]*m_self+1.5*alphaE[3]*vtsq_other[3]*m_other+1.5*alphaE[2]*vtsq_other[2]*m_other+1.5*alphaE[1]*vtsq_other[1]*m_other+1.5*alphaE[0]*vtsq_other[0]*m_other+0.25*alphaE[3]*uSumSq[3]*m_diff+0.25*alphaE[2]*uSumSq[2]*m_diff+0.25*alphaE[1]*uSumSq[1]*m_diff+0.25*alphaE[0]*uSumSq[0]*m_diff-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = -(1.5*alphaE[2]*vtsq_self[3]*m_self)-1.5*vtsq_self[2]*alphaE[3]*m_self-1.5*alphaE[0]*vtsq_self[1]*m_self-1.5*vtsq_self[0]*alphaE[1]*m_self+1.5*alphaE[2]*vtsq_other[3]*m_other+1.5*vtsq_other[2]*alphaE[3]*m_other+1.5*alphaE[0]*vtsq_other[1]*m_other+1.5*vtsq_other[0]*alphaE[1]*m_other+0.25*alphaE[2]*uSumSq[3]*m_diff+0.25*uSumSq[2]*alphaE[3]*m_diff+0.25*alphaE[0]*uSumSq[1]*m_diff+0.25*uSumSq[0]*alphaE[1]*m_diff-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]; 
  enRHS[2] = -(1.5*alphaE[1]*vtsq_self[3]*m_self)-1.5*vtsq_self[1]*alphaE[3]*m_self-1.5*alphaE[0]*vtsq_self[2]*m_self-1.5*vtsq_self[0]*alphaE[2]*m_self+1.5*alphaE[1]*vtsq_other[3]*m_other+1.5*vtsq_other[1]*alphaE[3]*m_other+1.5*alphaE[0]*vtsq_other[2]*m_other+1.5*vtsq_other[0]*alphaE[2]*m_other+0.25*alphaE[1]*uSumSq[3]*m_diff+0.25*uSumSq[1]*alphaE[3]*m_diff+0.25*alphaE[0]*uSumSq[2]*m_diff+0.25*uSumSq[0]*alphaE[2]*m_diff-1.0*uM1Self[2]-1.0*uM1Other[2]+2.0*m2r[2]; 
  enRHS[3] = -(1.5*alphaE[0]*vtsq_self[3]*m_self)-1.5*vtsq_self[0]*alphaE[3]*m_self-1.5*alphaE[1]*vtsq_self[2]*m_self-1.5*vtsq_self[1]*alphaE[2]*m_self+1.5*alphaE[0]*vtsq_other[3]*m_other+1.5*vtsq_other[0]*alphaE[3]*m_other+1.5*alphaE[1]*vtsq_other[2]*m_other+1.5*vtsq_other[1]*alphaE[2]*m_other+0.25*alphaE[0]*uSumSq[3]*m_diff+0.25*uSumSq[0]*alphaE[3]*m_diff+0.25*alphaE[1]*uSumSq[2]*m_diff+0.25*uSumSq[1]*alphaE[2]*m_diff-1.0*uM1Self[3]-1.0*uM1Other[3]+2.0*m2r[3]; 
