...
{ 
  ...
  double enRHS[2] = {0.0}; 
  enRHS[0] = -(2.1213203435596424*alphaE[1]*vtsq_self[1]*m_self)-2.1213203435596424*alphaE[0]*vtsq_self[0]*m_self+2.1213203435596424*alphaE[1]*vtsq_other[1]*m_other+2.1213203435596424*alphaE[0]*vtsq_other[0]*m_other+0.3535533905932737*alphaE[1]*uSumSq[1]*m_diff+0.3535533905932737*alphaE[0]*uSumSq[0]*m_diff-1.0*uM1Self[0]-1.0*uM1Other[0]+2.0*m2r[0]; 
  enRHS[1] = -(2.1213203435596424*alphaE[0]*vtsq_self[1]*m_self)-2.1213203435596424*vtsq_self[0]*alphaE[1]*m_self+2.1213203435596424*alphaE[0]*vtsq_other[1]*m_other+2.1213203435596424*vtsq_other[0]*alphaE[1]*m_other+0.3535533905932737*alphaE[0]*uSumSq[1]*m_diff+0.3535533905932737*uSumSq[0]*alphaE[1]*m_diff-1.0*uM1Self[1]-1.0*uM1Other[1]+2.0*m2r[1]; 
