...
{ 
  ...
  alphavpar[0] = (-(0.408248290463863*rtg33inv[3]*yfield[29])-0.408248290463863*rtg33inv[2]*yfield[26]-0.408248290463863*rtg33inv[1]*yfield[25]-0.408248290463863*rtg33inv[0]*yfield[24])/(vmap[1]*m_); 
  alphavpar[1] = (-(0.408248290463863*rtg33inv[2]*yfield[29])-0.408248290463863*rtg33inv[3]*yfield[26]-0.408248290463863*rtg33inv[0]*yfield[25]-0.408248290463863*rtg33inv[1]*yfield[24])/(vmap[1]*m_); 
  alphavpar[2] = (-(0.408248290463863*rtg33inv[1]*yfield[29])-0.408248290463863*rtg33inv[0]*yfield[26]-0.408248290463863*rtg33inv[3]*yfield[25]-0.408248290463863*rtg33inv[2]*yfield[24])/(vmap[1]*m_); 
  alphavpar[3] = (-(0.408248290463863*rtg33inv[3]*yfield[35])-0.408248290463863*rtg33inv[2]*yfield[31]-0.408248290463863*rtg33inv[1]*yfield[30]-0.408248290463863*rtg33inv[0]*yfield[27])/(vmap[1]*m_); 
  alphavpar[4] = (-(0.408248290463863*rtg33inv[3]*yfield[36])-0.408248290463863*rtg33inv[2]*yfield[33]-0.408248290463863*rtg33inv[1]*yfield[32]-0.408248290463863*rtg33inv[0]*yfield[28])/(vmap[1]*m_); 
  alphavpar[5] = (-(0.408248290463863*rtg33inv[0]*yfield[29])-0.408248290463863*rtg33inv[1]*yfield[26]-0.408248290463863*rtg33inv[2]*yfield[25]-0.408248290463863*rtg33inv[3]*yfield[24])/(vmap[1]*m_); 
  alphavpar[6] = (-(0.408248290463863*rtg33inv[2]*yfield[35])-0.408248290463863*rtg33inv[3]*yfield[31]-0.408248290463863*rtg33inv[0]*yfield[30]-0.408248290463863*rtg33inv[1]*yfield[27])/(vmap[1]*m_); 
  alphavpar[7] = (-(0.408248290463863*rtg33inv[1]*yfield[35])-0.408248290463863*rtg33inv[0]*yfield[31]-0.408248290463863*rtg33inv[3]*yfield[30]-0.408248290463863*rtg33inv[2]*yfield[27])/(vmap[1]*m_); 
  alphavpar[8] = (-(0.408248290463863*rtg33inv[2]*yfield[36])-0.408248290463863*rtg33inv[3]*yfield[33]-0.408248290463863*rtg33inv[0]*yfield[32]-0.408248290463863*rtg33inv[1]*yfield[28])/(vmap[1]*m_); 
  alphavpar[9] = (-(0.408248290463863*rtg33inv[1]*yfield[36])-0.408248290463863*rtg33inv[0]*yfield[33]-0.408248290463863*rtg33inv[3]*yfield[32]-0.408248290463863*rtg33inv[2]*yfield[28])/(vmap[1]*m_); 
  alphavpar[10] = (-(0.408248290463863*rtg33inv[3]*yfield[39])-0.408248290463863*rtg33inv[2]*yfield[38]-0.408248290463863*rtg33inv[1]*yfield[37]-0.408248290463863*rtg33inv[0]*yfield[34])/(vmap[1]*m_); 
  alphavpar[11] = (-(0.408248290463863*rtg33inv[0]*yfield[35])-0.408248290463863*rtg33inv[1]*yfield[31]-0.408248290463863*rtg33inv[2]*yfield[30]-0.408248290463863*rtg33inv[3]*yfield[27])/(vmap[1]*m_); 
  alphavpar[12] = (-(0.408248290463863*rtg33inv[0]*yfield[36])-0.408248290463863*rtg33inv[1]*yfield[33]-0.408248290463863*rtg33inv[2]*yfield[32]-0.408248290463863*rtg33inv[3]*yfield[28])/(vmap[1]*m_); 
  alphavpar[13] = (-(0.408248290463863*rtg33inv[2]*yfield[39])-0.408248290463863*rtg33inv[3]*yfield[38]-0.408248290463863*rtg33inv[0]*yfield[37]-0.408248290463863*rtg33inv[1]*yfield[34])/(vmap[1]*m_); 
  alphavpar[14] = (-(0.408248290463863*rtg33inv[1]*yfield[39])-0.408248290463863*rtg33inv[0]*yfield[38]-0.408248290463863*rtg33inv[3]*yfield[37]-0.408248290463863*rtg33inv[2]*yfield[34])/(vmap[1]*m_); 
  alphavpar[15] = (-(0.408248290463863*rtg33inv[0]*yfield[39])-0.408248290463863*rtg33inv[1]*yfield[38]-0.408248290463863*rtg33inv[2]*yfield[37]-0.408248290463863*rtg33inv[3]*yfield[34])/(vmap[1]*m_); 
  alphavpar[16] = (-(0.408248290463863*rtg33inv[3]*yfield[44])-0.40824829046386296*rtg33inv[2]*yfield[42]-0.40824829046386296*rtg33inv[1]*yfield[41]-0.408248290463863*rtg33inv[0]*yfield[40])/(vmap[1]*m_); 
  alphavpar[17] = (-(0.40824829046386296*rtg33inv[2]*yfield[44])-0.408248290463863*rtg33inv[3]*yfield[42]-0.408248290463863*rtg33inv[0]*yfield[41]-0.40824829046386296*rtg33inv[1]*yfield[40])/(vmap[1]*m_); 
  alphavpar[18] = (-(0.40824829046386296*rtg33inv[1]*yfield[44])-0.408248290463863*rtg33inv[0]*yfield[42]-0.408248290463863*rtg33inv[3]*yfield[41]-0.40824829046386296*rtg33inv[2]*yfield[40])/(vmap[1]*m_); 
  alphavpar[19] = (-(0.408248290463863*rtg33inv[3]*yfield[47])-0.40824829046386296*rtg33inv[2]*yfield[46]-0.40824829046386296*rtg33inv[1]*yfield[45]-0.408248290463863*rtg33inv[0]*yfield[43])/(vmap[1]*m_); 
  alphavpar[20] = (-(0.408248290463863*rtg33inv[0]*yfield[44])-0.40824829046386296*rtg33inv[1]*yfield[42]-0.40824829046386296*rtg33inv[2]*yfield[41]-0.408248290463863*rtg33inv[3]*yfield[40])/(vmap[1]*m_); 
  alphavpar[21] = (-(0.40824829046386296*rtg33inv[2]*yfield[47])-0.408248290463863*rtg33inv[3]*yfield[46]-0.408248290463863*rtg33inv[0]*yfield[45]-0.40824829046386296*rtg33inv[1]*yfield[43])/(vmap[1]*m_); 
  alphavpar[22] = (-(0.40824829046386296*rtg33inv[1]*yfield[47])-0.408248290463863*rtg33inv[0]*yfield[46]-0.408248290463863*rtg33inv[3]*yfield[45]-0.40824829046386296*rtg33inv[2]*yfield[43])/(vmap[1]*m_); 
  alphavpar[23] = (-(0.408248290463863*rtg33inv[0]*yfield[47])-0.40824829046386296*rtg33inv[1]*yfield[46]-0.40824829046386296*rtg33inv[2]*yfield[45]-0.408248290463863*rtg33inv[3]*yfield[43])/(vmap[1]*m_); 
