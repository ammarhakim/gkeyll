...
{ 
  ...
  alphavpar[0] = (-((0.9128709291752769*dualcurlbhatoverB_z[1]*yfield[3]*hamil[4])/vmap2)-(0.9128709291752769*dualcurlbhatoverB_z[0]*yfield[2]*hamil[4])/vmap2-(0.408248290463863*dualcurlbhatoverB_z[1]*yfield[1]*hamil[2])/vmap2-(0.408248290463863*dualcurlbhatoverB_z[0]*yfield[0]*hamil[2])/vmap2)/(m_*q_)+(vmap[1]*(-((0.5773502691896258*rtg33inv[1]*yfield[1])/vmap2)-(0.5773502691896258*rtg33inv[0]*yfield[0])/vmap2))/m_; 
  alphavpar[1] = (-((0.9128709291752769*dualcurlbhatoverB_z[0]*yfield[3]*hamil[4])/vmap2)-(0.9128709291752769*dualcurlbhatoverB_z[1]*yfield[2]*hamil[4])/vmap2-(0.408248290463863*dualcurlbhatoverB_z[0]*yfield[1]*hamil[2])/vmap2-(0.408248290463863*yfield[0]*dualcurlbhatoverB_z[1]*hamil[2])/vmap2)/(m_*q_)+(vmap[1]*(-((0.5773502691896258*rtg33inv[0]*yfield[1])/vmap2)-(0.5773502691896258*yfield[0]*rtg33inv[1])/vmap2))/m_; 
  alphavpar[2] = (-((0.816496580927726*dualcurlbhatoverB_z[1]*hamil[4]*yfield[5])/vmap2)-(0.8164965809277261*dualcurlbhatoverB_z[0]*hamil[4]*yfield[4])/vmap2-(0.9128709291752769*dualcurlbhatoverB_z[1]*yfield[1]*hamil[4])/vmap2-(0.9128709291752769*dualcurlbhatoverB_z[0]*yfield[0]*hamil[4])/vmap2-(0.408248290463863*dualcurlbhatoverB_z[1]*hamil[2]*yfield[3])/vmap2-(0.408248290463863*dualcurlbhatoverB_z[0]*hamil[2]*yfield[2])/vmap2)/(m_*q_)+(vmap[1]*(-((0.5773502691896258*rtg33inv[1]*yfield[3])/vmap2)-(0.5773502691896258*rtg33inv[0]*yfield[2])/vmap2))/m_; 
  alphavpar[3] = (-((0.816496580927726*dualcurlbhatoverB_z[0]*hamil[4]*yfield[5])/vmap2)-(0.8164965809277261*dualcurlbhatoverB_z[1]*hamil[4]*yfield[4])/vmap2-(0.9128709291752769*dualcurlbhatoverB_z[0]*yfield[1]*hamil[4])/vmap2-(0.9128709291752769*yfield[0]*dualcurlbhatoverB_z[1]*hamil[4])/vmap2-(0.408248290463863*dualcurlbhatoverB_z[0]*hamil[2]*yfield[3])/vmap2-(0.408248290463863*dualcurlbhatoverB_z[1]*hamil[2]*yfield[2])/vmap2)/(m_*q_)+(vmap[1]*(-((0.5773502691896258*rtg33inv[0]*yfield[3])/vmap2)-(0.5773502691896258*rtg33inv[1]*yfield[2])/vmap2))/m_; 
  alphavpar[4] = (-((0.40824829046386296*dualcurlbhatoverB_z[1]*hamil[2]*yfield[5])/vmap2)-(0.408248290463863*dualcurlbhatoverB_z[0]*hamil[2]*yfield[4])/vmap2-(0.8164965809277261*dualcurlbhatoverB_z[1]*yfield[3]*hamil[4])/vmap2-(0.8164965809277261*dualcurlbhatoverB_z[0]*yfield[2]*hamil[4])/vmap2)/(m_*q_)+(vmap[1]*(-((0.5773502691896257*rtg33inv[1]*yfield[5])/vmap2)-(0.5773502691896258*rtg33inv[0]*yfield[4])/vmap2))/m_; 
  alphavpar[5] = (-((0.408248290463863*dualcurlbhatoverB_z[0]*hamil[2]*yfield[5])/vmap2)-(0.40824829046386296*dualcurlbhatoverB_z[1]*hamil[2]*yfield[4])/vmap2-(0.816496580927726*dualcurlbhatoverB_z[0]*yfield[3]*hamil[4])/vmap2-(0.816496580927726*dualcurlbhatoverB_z[1]*yfield[2]*hamil[4])/vmap2)/(m_*q_)+(vmap[1]*(-((0.5773502691896258*rtg33inv[0]*yfield[5])/vmap2)-(0.5773502691896257*rtg33inv[1]*yfield[4])/vmap2))/m_; 
