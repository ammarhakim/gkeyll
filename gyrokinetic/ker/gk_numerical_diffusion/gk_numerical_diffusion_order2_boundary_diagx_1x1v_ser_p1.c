...
GKYL_CU_DH double gk_numerical_diffusion_order2_boundary_diagx_lower_bound_local_1x1v_ser_p1_varnu(const double *wSkin, const double *dxSkin, const double *nuSkin, const double *nuGhost, const double *jacobgeo_invSkin, const double *jacobgeo_invGhost, int edge, const double *JfSkin, const double *JfGhost, double* GKYL_RESTRICT out) 
{
  ...
  boundSurf_incr[2] = 0.6123724356957944*nuSkin[0]*fSkin[3]-1.060660171779821*nuSkin[1]*fSkin[3]; 
  boundSurf_incr[3] = 1.837117307087383*nuSkin[1]*fSkin[3]-1.060660171779821*nuSkin[0]*fSkin[3]; 
  boundSurf_incr[4] = 0.6123724356957944*nuSkin[0]*fSkin[5]-1.060660171779821*nuSkin[1]*fSkin[5]; 
...
GKYL_CU_DH double gk_numerical_diffusion_order2_boundary_diagx_lower_bound_recovery_1x1v_ser_p1_varnu(const double *wSkin, const double *dxSkin, const double *nuSkin, const double *nuGhost, const double *jacobgeo_invSkin, const double *jacobgeo_invGhost, int edge, const double *JfSkin, const double *JfGhost, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // nuSkin/nuGhost: Diffusivity in skin and ghost cells.
  ...
  boundSurf_incr[2] = 0.33145630368119394*nuSkin[1]*fSkin[3]-0.33145630368119394*nuGhost[1]*fSkin[3]-0.19136638615493565*nuSkin[0]*fSkin[3]-0.19136638615493565*nuGhost[0]*fSkin[3]+0.33145630368119394*nuSkin[1]*fGhost[3]-0.33145630368119394*nuGhost[1]*fGhost[3]-0.19136638615493565*nuSkin[0]*fGhost[3]-0.19136638615493565*nuGhost[0]*fGhost[3]-0.34445949507888407*nuSkin[1]*fSkin[2]+0.34445949507888407*nuGhost[1]*fSkin[2]+0.19887378220871635*nuSkin[0]*fSkin[2]+0.19887378220871635*nuGhost[0]*fSkin[2]+0.34445949507888407*nuSkin[1]*fGhost[2]-0.34445949507888407*nuGhost[1]*fGhost[2]-0.19887378220871635*nuSkin[0]*fGhost[2]-0.19887378220871635*nuGhost[0]*fGhost[2]; 
  boundSurf_incr[3] = -(0.5740991584648069*nuSkin[1]*fSkin[3])+0.5740991584648069*nuGhost[1]*fSkin[3]+0.33145630368119394*nuSkin[0]*fSkin[3]+0.33145630368119394*nuGhost[0]*fSkin[3]-0.5740991584648069*nuSkin[1]*fGhost[3]+0.5740991584648069*nuGhost[1]*fGhost[3]+0.33145630368119394*nuSkin[0]*fGhost[3]+0.33145630368119394*nuGhost[0]*fGhost[3]+0.5966213466261491*nuSkin[1]*fSkin[2]-0.5966213466261491*nuGhost[1]*fSkin[2]-0.34445949507888407*nuSkin[0]*fSkin[2]-0.34445949507888407*nuGhost[0]*fSkin[2]-0.5966213466261491*nuSkin[1]*fGhost[2]+0.5966213466261491*nuGhost[1]*fGhost[2]+0.34445949507888407*nuSkin[0]*fGhost[2]+0.34445949507888407*nuGhost[0]*fGhost[2]; 
  boundSurf_incr[4] = 0.3314563036811939*nuSkin[1]*fSkin[5]-0.3314563036811939*nuGhost[1]*fSkin[5]-0.19136638615493567*nuSkin[0]*fSkin[5]-0.19136638615493567*nuGhost[0]*fSkin[5]+0.3314563036811939*nuSkin[1]*fGhost[5]-0.3314563036811939*nuGhost[1]*fGhost[5]-0.19136638615493567*nuSkin[0]*fGhost[5]-0.19136638615493567*nuGhost[0]*fGhost[5]-0.34445949507888407*nuSkin[1]*fSkin[4]+0.34445949507888407*nuGhost[1]*fSkin[4]+0.19887378220871635*nuSkin[0]*fSkin[4]+0.19887378220871635*nuGhost[0]*fSkin[4]+0.34445949507888407*nuSkin[1]*fGhost[4]-0.34445949507888407*nuGhost[1]*fGhost[4]-0.19887378220871635*nuSkin[0]*fGhost[4]-0.19887378220871635*nuGhost[0]*fGhost[4]; 
  boundSurf_incr[5] = -(0.5740991584648069*nuSkin[1]*fSkin[5])+0.5740991584648069*nuGhost[1]*fSkin[5]+0.33145630368119394*nuSkin[0]*fSkin[5]+0.33145630368119394*nuGhost[0]*fSkin[5]-0.5740991584648069*nuSkin[1]*fGhost[5]+0.5740991584648069*nuGhost[1]*fGhost[5]+0.33145630368119394*nuSkin[0]*fGhost[5]+0.33145630368119394*nuGhost[0]*fGhost[5]+0.5966213466261489*nuSkin[1]*fSkin[4]-0.5966213466261489*nuGhost[1]*fSkin[4]-0.3444594950788842*nuSkin[0]*fSkin[4]-0.3444594950788842*nuGhost[0]*fSkin[4]-0.5966213466261489*nuSkin[1]*fGhost[4]+0.5966213466261489*nuGhost[1]*fGhost[4]+0.3444594950788842*nuSkin[0]*fGhost[4]+0.3444594950788842*nuGhost[0]*fGhost[4]; 
...
GKYL_CU_DH double gk_numerical_diffusion_order2_boundary_diagx_upper_bound_local_1x1v_ser_p1_varnu(const double *wSkin, const double *dxSkin, const double *nuSkin, const double *nuGhost, const double *jacobgeo_invSkin, const double *jacobgeo_invGhost, int edge, const double *JfSkin, const double *JfGhost, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // nuSkin/nuGhost: Diffusivity in skin and ghost cells.
...
GKYL_CU_DH double gk_numerical_diffusion_order2_boundary_diagx_upper_bound_recovery_1x1v_ser_p1_varnu(const double *wSkin, const double *dxSkin, const double *nuSkin, const double *nuGhost, const double *jacobgeo_invSkin, const double *jacobgeo_invGhost, int edge, const double *JfSkin, const double *JfGhost, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // nuSkin/nuGhost: Diffusivity in skin and ghost cells.
