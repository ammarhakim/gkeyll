...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_diagy_3x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qGhost, double* GKYL_RESTRICT out) 
{
  ...
  boundSurf_incr[6] = 0.8660254037844386*coeff[1]*qSkin[1]-1.0*coeff[1]*qSkin[6]; 
  boundSurf_incr[8] = 0.8660254037844386*coeff[1]*qSkin[3]-1.0*coeff[1]*qSkin[8]; 
  boundSurf_incr[10] = 0.8660254037844386*coeff[1]*qSkin[4]-1.0*coeff[1]*qSkin[10]; 
  boundSurf_incr[13] = 0.8660254037844386*coeff[1]*qSkin[5]-1.0*coeff[1]*qSkin[13]; 
  boundSurf_incr[16] = 0.8660254037844386*coeff[1]*qSkin[7]-1.0*coeff[1]*qSkin[16]; 
  boundSurf_incr[17] = 0.8660254037844386*coeff[1]*qSkin[9]-1.0*coeff[1]*qSkin[17]; 
  boundSurf_incr[19] = 0.8660254037844386*coeff[1]*qSkin[11]-1.0*coeff[1]*qSkin[19]; 
  boundSurf_incr[20] = 0.8660254037844386*coeff[1]*qSkin[12]-1.0*coeff[1]*qSkin[20]; 
  boundSurf_incr[22] = 0.8660254037844386*coeff[1]*qSkin[14]-1.0*coeff[1]*qSkin[22]; 
  boundSurf_incr[24] = 0.8660254037844386*coeff[1]*qSkin[15]-1.0*coeff[1]*qSkin[24]; 
  boundSurf_incr[26] = 0.8660254037844386*coeff[1]*qSkin[18]-1.0*coeff[1]*qSkin[26]; 
  boundSurf_incr[27] = 0.8660254037844386*coeff[1]*qSkin[21]-1.0*coeff[1]*qSkin[27]; 
  boundSurf_incr[28] = 0.8660254037844386*coeff[1]*qSkin[23]-1.0*coeff[1]*qSkin[28]; 
  boundSurf_incr[30] = 0.8660254037844386*coeff[1]*qSkin[25]-1.0*coeff[1]*qSkin[30]; 
  boundSurf_incr[31] = 0.8660254037844386*coeff[1]*qSkin[29]-1.0*coeff[1]*qSkin[31]; 
  boundSurf_incr[34] = 0.8660254037844387*coeff[1]*qSkin[32]-1.0*coeff[1]*qSkin[34]; 
  boundSurf_incr[37] = 0.8660254037844387*coeff[1]*qSkin[33]-1.0*coeff[1]*qSkin[37]; 
  boundSurf_incr[39] = 0.8660254037844387*coeff[1]*qSkin[35]-1.0*coeff[1]*qSkin[39]; 
  boundSurf_incr[41] = 0.8660254037844387*coeff[1]*qSkin[36]-1.0*coeff[1]*qSkin[41]; 
  boundSurf_incr[43] = 0.8660254037844387*coeff[1]*qSkin[38]-1.0*coeff[1]*qSkin[43]; 
  boundSurf_incr[44] = 0.8660254037844387*coeff[1]*qSkin[40]-1.0*coeff[1]*qSkin[44]; 
  boundSurf_incr[46] = 0.8660254037844387*coeff[1]*qSkin[42]-1.0*coeff[1]*qSkin[46]; 
  boundSurf_incr[47] = 0.8660254037844387*coeff[1]*qSkin[45]-1.0*coeff[1]*qSkin[47]; 

  } else { 

  boundSurf_incr[2] = -(1.0*coeff[1]*qSkin[2])-0.8660254037844386*qSkin[0]*coeff[1]; 
  boundSurf_incr[6] = -(1.0*coeff[1]*qSkin[6])-0.8660254037844386*coeff[1]*qSkin[1]; 
  boundSurf_incr[8] = -(1.0*coeff[1]*qSkin[8])-0.8660254037844386*coeff[1]*qSkin[3]; 
  boundSurf_incr[10] = -(1.0*coeff[1]*qSkin[10])-0.8660254037844386*coeff[1]*qSkin[4]; 
  boundSurf_incr[13] = -(1.0*coeff[1]*qSkin[13])-0.8660254037844386*coeff[1]*qSkin[5]; 
  boundSurf_incr[16] = -(1.0*coeff[1]*qSkin[16])-0.8660254037844386*coeff[1]*qSkin[7]; 
  boundSurf_incr[17] = -(1.0*coeff[1]*qSkin[17])-0.8660254037844386*coeff[1]*qSkin[9]; 
  boundSurf_incr[19] = -(1.0*coeff[1]*qSkin[19])-0.8660254037844386*coeff[1]*qSkin[11]; 
  boundSurf_incr[20] = -(1.0*coeff[1]*qSkin[20])-0.8660254037844386*coeff[1]*qSkin[12]; 
  boundSurf_incr[22] = -(1.0*coeff[1]*qSkin[22])-0.8660254037844386*coeff[1]*qSkin[14]; 
  boundSurf_incr[24] = -(1.0*coeff[1]*qSkin[24])-0.8660254037844386*coeff[1]*qSkin[15]; 
  boundSurf_incr[26] = -(1.0*coeff[1]*qSkin[26])-0.8660254037844386*coeff[1]*qSkin[18]; 
  boundSurf_incr[27] = -(1.0*coeff[1]*qSkin[27])-0.8660254037844386*coeff[1]*qSkin[21]; 
  boundSurf_incr[28] = -(1.0*coeff[1]*qSkin[28])-0.8660254037844386*coeff[1]*qSkin[23]; 
  boundSurf_incr[30] = -(1.0*coeff[1]*qSkin[30])-0.8660254037844386*coeff[1]*qSkin[25]; 
  boundSurf_incr[31] = -(1.0*coeff[1]*qSkin[31])-0.8660254037844386*coeff[1]*qSkin[29]; 
  boundSurf_incr[34] = -(1.0*coeff[1]*qSkin[34])-0.8660254037844387*coeff[1]*qSkin[32]; 
  boundSurf_incr[37] = -(1.0*coeff[1]*qSkin[37])-0.8660254037844387*coeff[1]*qSkin[33]; 
  boundSurf_incr[39] = -(1.0*coeff[1]*qSkin[39])-0.8660254037844387*coeff[1]*qSkin[35]; 
  boundSurf_incr[41] = -(1.0*coeff[1]*qSkin[41])-0.8660254037844387*coeff[1]*qSkin[36]; 
  boundSurf_incr[43] = -(1.0*coeff[1]*qSkin[43])-0.8660254037844387*coeff[1]*qSkin[38]; 
  boundSurf_incr[44] = -(1.0*coeff[1]*qSkin[44])-0.8660254037844387*coeff[1]*qSkin[40]; 
  boundSurf_incr[46] = -(1.0*coeff[1]*qSkin[46])-0.8660254037844387*coeff[1]*qSkin[42]; 
  boundSurf_incr[47] = -(1.0*coeff[1]*qSkin[47])-0.8660254037844387*coeff[1]*qSkin[45]; 
...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_diagy_3x2v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qGhost, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  boundSurf_incr[2] = 0.6123724356957944*coeff[15]*fSkin[16]-0.3535533905932737*coeff[13]*fSkin[16]-0.5303300858899105*fSkin[7]*coeff[15]+0.6123724356957944*fSkin[8]*coeff[14]-0.5303300858899105*fSkin[3]*coeff[14]+0.3061862178478971*fSkin[7]*coeff[13]+0.6123724356957944*fSkin[6]*coeff[12]-0.5303300858899105*fSkin[1]*coeff[12]-0.3535533905932737*fSkin[8]*coeff[11]+0.3061862178478971*fSkin[3]*coeff[11]+0.6123724356957944*fSkin[2]*coeff[10]-0.5303300858899105*fSkin[0]*coeff[10]-0.3535533905932737*fSkin[6]*coeff[9]+0.3061862178478971*fSkin[1]*coeff[9]-0.3535533905932737*fSkin[2]*coeff[8]+0.3061862178478971*fSkin[0]*coeff[8]; 
  boundSurf_incr[6] = 0.6123724356957944*coeff[14]*fSkin[16]-0.3535533905932737*coeff[11]*fSkin[16]+0.6123724356957944*fSkin[8]*coeff[15]-0.5303300858899105*fSkin[3]*coeff[15]-0.5303300858899105*fSkin[7]*coeff[14]-0.3535533905932737*fSkin[8]*coeff[13]+0.3061862178478971*fSkin[3]*coeff[13]+0.6123724356957944*fSkin[2]*coeff[12]-0.5303300858899105*fSkin[0]*coeff[12]+0.3061862178478971*fSkin[7]*coeff[11]+0.6123724356957944*fSkin[6]*coeff[10]-0.5303300858899105*fSkin[1]*coeff[10]-0.3535533905932737*fSkin[2]*coeff[9]+0.3061862178478971*fSkin[0]*coeff[9]-0.3535533905932737*fSkin[6]*coeff[8]+0.3061862178478971*fSkin[1]*coeff[8]; 
  boundSurf_incr[8] = 0.6123724356957944*coeff[12]*fSkin[16]-0.3535533905932737*coeff[9]*fSkin[16]+0.6123724356957944*fSkin[6]*coeff[15]-0.5303300858899105*fSkin[1]*coeff[15]+0.6123724356957944*fSkin[2]*coeff[14]-0.5303300858899105*fSkin[0]*coeff[14]-0.3535533905932737*fSkin[6]*coeff[13]+0.3061862178478971*fSkin[1]*coeff[13]-0.5303300858899105*fSkin[7]*coeff[12]-0.3535533905932737*fSkin[2]*coeff[11]+0.3061862178478971*fSkin[0]*coeff[11]+0.6123724356957944*fSkin[8]*coeff[10]-0.5303300858899105*fSkin[3]*coeff[10]+0.3061862178478971*fSkin[7]*coeff[9]-0.3535533905932737*coeff[8]*fSkin[8]+0.3061862178478971*fSkin[3]*coeff[8]; 
  boundSurf_incr[10] = 0.6123724356957944*coeff[15]*fSkin[26]-0.3535533905932737*coeff[13]*fSkin[26]+0.6123724356957944*coeff[14]*fSkin[19]-0.3535533905932737*coeff[11]*fSkin[19]-0.5303300858899105*coeff[15]*fSkin[18]+0.3061862178478971*coeff[13]*fSkin[18]+0.6123724356957944*coeff[12]*fSkin[17]-0.3535533905932737*coeff[9]*fSkin[17]-0.5303300858899105*fSkin[11]*coeff[14]-0.5303300858899105*fSkin[9]*coeff[12]+0.3061862178478971*coeff[11]*fSkin[11]+0.6123724356957944*coeff[10]*fSkin[10]-0.3535533905932737*coeff[8]*fSkin[10]-0.5303300858899105*fSkin[4]*coeff[10]+0.3061862178478971*coeff[9]*fSkin[9]+0.3061862178478971*fSkin[4]*coeff[8]; 
  boundSurf_incr[13] = 0.6123724356957944*coeff[15]*fSkin[27]-0.3535533905932737*coeff[13]*fSkin[27]+0.6123724356957944*coeff[14]*fSkin[22]-0.3535533905932737*coeff[11]*fSkin[22]-0.5303300858899105*coeff[15]*fSkin[21]+0.3061862178478971*coeff[13]*fSkin[21]+0.6123724356957944*coeff[12]*fSkin[20]-0.3535533905932737*coeff[9]*fSkin[20]-0.5303300858899105*coeff[14]*fSkin[14]+0.3061862178478971*coeff[11]*fSkin[14]+0.6123724356957944*coeff[10]*fSkin[13]-0.3535533905932737*coeff[8]*fSkin[13]-0.5303300858899105*coeff[12]*fSkin[12]+0.3061862178478971*coeff[9]*fSkin[12]-0.5303300858899105*fSkin[5]*coeff[10]+0.3061862178478971*fSkin[5]*coeff[8]; 
  boundSurf_incr[16] = 0.6123724356957944*coeff[10]*fSkin[16]-0.3535533905932737*coeff[8]*fSkin[16]+0.6123724356957944*fSkin[2]*coeff[15]-0.5303300858899105*fSkin[0]*coeff[15]+0.6123724356957944*fSkin[6]*coeff[14]-0.5303300858899105*fSkin[1]*coeff[14]-0.3535533905932737*fSkin[2]*coeff[13]+0.3061862178478971*fSkin[0]*coeff[13]+0.6123724356957944*fSkin[8]*coeff[12]-0.5303300858899105*fSkin[3]*coeff[12]-0.3535533905932737*fSkin[6]*coeff[11]+0.3061862178478971*fSkin[1]*coeff[11]-0.5303300858899105*fSkin[7]*coeff[10]-0.3535533905932737*fSkin[8]*coeff[9]+0.3061862178478971*fSkin[3]*coeff[9]+0.3061862178478971*fSkin[7]*coeff[8]; 
  boundSurf_incr[17] = 0.6123724356957944*coeff[14]*fSkin[26]-0.3535533905932737*coeff[11]*fSkin[26]+0.6123724356957944*coeff[15]*fSkin[19]-0.3535533905932737*coeff[13]*fSkin[19]-0.5303300858899105*coeff[14]*fSkin[18]+0.3061862178478971*coeff[11]*fSkin[18]+0.6123724356957944*coeff[10]*fSkin[17]-0.3535533905932737*coeff[8]*fSkin[17]-0.5303300858899105*fSkin[11]*coeff[15]+0.3061862178478971*fSkin[11]*coeff[13]+0.6123724356957944*fSkin[10]*coeff[12]-0.5303300858899105*fSkin[4]*coeff[12]-0.3535533905932737*coeff[9]*fSkin[10]-0.5303300858899105*fSkin[9]*coeff[10]+0.3061862178478971*coeff[8]*fSkin[9]+0.3061862178478971*fSkin[4]*coeff[9]; 
  boundSurf_incr[19] = 0.6123724356957944*coeff[12]*fSkin[26]-0.3535533905932737*coeff[9]*fSkin[26]+0.6123724356957944*coeff[10]*fSkin[19]-0.3535533905932737*coeff[8]*fSkin[19]-0.5303300858899105*coeff[12]*fSkin[18]+0.3061862178478971*coeff[9]*fSkin[18]+0.6123724356957944*coeff[15]*fSkin[17]-0.3535533905932737*coeff[13]*fSkin[17]-0.5303300858899105*fSkin[9]*coeff[15]+0.6123724356957944*fSkin[10]*coeff[14]-0.5303300858899105*fSkin[4]*coeff[14]+0.3061862178478971*fSkin[9]*coeff[13]-0.5303300858899105*coeff[10]*fSkin[11]+0.3061862178478971*coeff[8]*fSkin[11]-0.3535533905932737*fSkin[10]*coeff[11]+0.3061862178478971*fSkin[4]*coeff[11]; 
  boundSurf_incr[20] = 0.6123724356957944*coeff[14]*fSkin[27]-0.3535533905932737*coeff[11]*fSkin[27]+0.6123724356957944*coeff[15]*fSkin[22]-0.3535533905932737*coeff[13]*fSkin[22]-0.5303300858899105*coeff[14]*fSkin[21]+0.3061862178478971*coeff[11]*fSkin[21]+0.6123724356957944*coeff[10]*fSkin[20]-0.3535533905932737*coeff[8]*fSkin[20]-0.5303300858899105*fSkin[14]*coeff[15]+0.3061862178478971*coeff[13]*fSkin[14]+0.6123724356957944*coeff[12]*fSkin[13]-0.3535533905932737*coeff[9]*fSkin[13]-0.5303300858899105*coeff[10]*fSkin[12]+0.3061862178478971*coeff[8]*fSkin[12]-0.5303300858899105*fSkin[5]*coeff[12]+0.3061862178478971*fSkin[5]*coeff[9]; 
  boundSurf_incr[22] = 0.6123724356957944*coeff[12]*fSkin[27]-0.3535533905932737*coeff[9]*fSkin[27]+0.6123724356957944*coeff[10]*fSkin[22]-0.3535533905932737*coeff[8]*fSkin[22]-0.5303300858899105*coeff[12]*fSkin[21]+0.3061862178478971*coeff[9]*fSkin[21]+0.6123724356957944*coeff[15]*fSkin[20]-0.3535533905932737*coeff[13]*fSkin[20]-0.5303300858899105*fSkin[12]*coeff[15]-0.5303300858899105*coeff[10]*fSkin[14]+0.3061862178478971*coeff[8]*fSkin[14]+0.6123724356957944*fSkin[13]*coeff[14]-0.5303300858899105*fSkin[5]*coeff[14]-0.3535533905932737*coeff[11]*fSkin[13]+0.3061862178478971*fSkin[12]*coeff[13]+0.3061862178478971*fSkin[5]*coeff[11]; 
  boundSurf_incr[24] = 0.6123724356957944*coeff[15]*fSkin[31]-0.3535533905932737*coeff[13]*fSkin[31]+0.6123724356957944*coeff[14]*fSkin[30]-0.3535533905932737*coeff[11]*fSkin[30]-0.5303300858899105*coeff[15]*fSkin[29]+0.3061862178478971*coeff[13]*fSkin[29]+0.6123724356957944*coeff[12]*fSkin[28]-0.3535533905932737*coeff[9]*fSkin[28]-0.5303300858899105*coeff[14]*fSkin[25]+0.3061862178478971*coeff[11]*fSkin[25]+0.6123724356957944*coeff[10]*fSkin[24]-0.3535533905932737*coeff[8]*fSkin[24]-0.5303300858899105*coeff[12]*fSkin[23]+0.3061862178478971*coeff[9]*fSkin[23]-0.5303300858899105*coeff[10]*fSkin[15]+0.3061862178478971*coeff[8]*fSkin[15]; 
  boundSurf_incr[26] = 0.6123724356957944*coeff[10]*fSkin[26]-0.3535533905932737*coeff[8]*fSkin[26]+0.6123724356957944*coeff[12]*fSkin[19]-0.3535533905932737*coeff[9]*fSkin[19]-0.5303300858899105*coeff[10]*fSkin[18]+0.3061862178478971*coeff[8]*fSkin[18]+0.6123724356957944*coeff[14]*fSkin[17]-0.3535533905932737*coeff[11]*fSkin[17]+0.6123724356957944*fSkin[10]*coeff[15]-0.5303300858899105*fSkin[4]*coeff[15]-0.5303300858899105*fSkin[9]*coeff[14]-0.3535533905932737*fSkin[10]*coeff[13]+0.3061862178478971*fSkin[4]*coeff[13]-0.5303300858899105*fSkin[11]*coeff[12]+0.3061862178478971*coeff[9]*fSkin[11]+0.3061862178478971*fSkin[9]*coeff[11]; 
  boundSurf_incr[27] = 0.6123724356957944*coeff[10]*fSkin[27]-0.3535533905932737*coeff[8]*fSkin[27]+0.6123724356957944*coeff[12]*fSkin[22]-0.3535533905932737*coeff[9]*fSkin[22]-0.5303300858899105*coeff[10]*fSkin[21]+0.3061862178478971*coeff[8]*fSkin[21]+0.6123724356957944*coeff[14]*fSkin[20]-0.3535533905932737*coeff[11]*fSkin[20]+0.6123724356957944*fSkin[13]*coeff[15]-0.5303300858899105*fSkin[5]*coeff[15]-0.5303300858899105*coeff[12]*fSkin[14]+0.3061862178478971*coeff[9]*fSkin[14]-0.5303300858899105*fSkin[12]*coeff[14]-0.3535533905932737*coeff[13]*fSkin[13]+0.3061862178478971*fSkin[5]*coeff[13]+0.3061862178478971*coeff[11]*fSkin[12]; 
  boundSurf_incr[28] = 0.6123724356957944*coeff[14]*fSkin[31]-0.3535533905932737*coeff[11]*fSkin[31]+0.6123724356957944*coeff[15]*fSkin[30]-0.3535533905932737*coeff[13]*fSkin[30]-0.5303300858899105*coeff[14]*fSkin[29]+0.3061862178478971*coeff[11]*fSkin[29]+0.6123724356957944*coeff[10]*fSkin[28]-0.3535533905932737*coeff[8]*fSkin[28]-0.5303300858899105*coeff[15]*fSkin[25]+0.3061862178478971*coeff[13]*fSkin[25]+0.6123724356957944*coeff[12]*fSkin[24]-0.3535533905932737*coeff[9]*fSkin[24]-0.5303300858899105*coeff[10]*fSkin[23]+0.3061862178478971*coeff[8]*fSkin[23]-0.5303300858899105*coeff[12]*fSkin[15]+0.3061862178478971*coeff[9]*fSkin[15]; 
  boundSurf_incr[30] = 0.6123724356957944*coeff[12]*fSkin[31]-0.3535533905932737*coeff[9]*fSkin[31]+0.6123724356957944*coeff[10]*fSkin[30]-0.3535533905932737*coeff[8]*fSkin[30]-0.5303300858899105*coeff[12]*fSkin[29]+0.3061862178478971*coeff[9]*fSkin[29]+0.6123724356957944*coeff[15]*fSkin[28]-0.3535533905932737*coeff[13]*fSkin[28]-0.5303300858899105*coeff[10]*fSkin[25]+0.3061862178478971*coeff[8]*fSkin[25]+0.6123724356957944*coeff[14]*fSkin[24]-0.3535533905932737*coeff[11]*fSkin[24]-0.5303300858899105*coeff[15]*fSkin[23]+0.3061862178478971*coeff[13]*fSkin[23]-0.5303300858899105*coeff[14]*fSkin[15]+0.3061862178478971*coeff[11]*fSkin[15]; 
  boundSurf_incr[31] = 0.6123724356957944*coeff[10]*fSkin[31]-0.3535533905932737*coeff[8]*fSkin[31]+0.6123724356957944*coeff[12]*fSkin[30]-0.3535533905932737*coeff[9]*fSkin[30]-0.5303300858899105*coeff[10]*fSkin[29]+0.3061862178478971*coeff[8]*fSkin[29]+0.6123724356957944*coeff[14]*fSkin[28]-0.3535533905932737*coeff[11]*fSkin[28]-0.5303300858899105*coeff[12]*fSkin[25]+0.3061862178478971*coeff[9]*fSkin[25]+0.6123724356957944*coeff[15]*fSkin[24]-0.3535533905932737*coeff[13]*fSkin[24]-0.5303300858899105*coeff[14]*fSkin[23]+0.3061862178478971*coeff[11]*fSkin[23]-0.5303300858899105*coeff[15]*fSkin[15]+0.3061862178478971*coeff[13]*fSkin[15]; 
  boundSurf_incr[34] = 0.6123724356957944*coeff[15]*fSkin[43]-0.3535533905932737*coeff[13]*fSkin[43]+0.6123724356957944*coeff[14]*fSkin[39]-0.3535533905932737*coeff[11]*fSkin[39]-0.5303300858899104*coeff[15]*fSkin[38]+0.3061862178478971*coeff[13]*fSkin[38]+0.6123724356957944*coeff[12]*fSkin[37]-0.3535533905932737*coeff[9]*fSkin[37]-0.5303300858899105*coeff[14]*fSkin[35]+0.3061862178478971*coeff[11]*fSkin[35]+0.6123724356957944*coeff[10]*fSkin[34]-0.3535533905932737*coeff[8]*fSkin[34]-0.5303300858899105*coeff[12]*fSkin[33]+0.3061862178478971*coeff[9]*fSkin[33]-0.5303300858899104*coeff[10]*fSkin[32]+0.3061862178478971*coeff[8]*fSkin[32]; 
  boundSurf_incr[37] = 0.6123724356957944*coeff[14]*fSkin[43]-0.3535533905932737*coeff[11]*fSkin[43]+0.6123724356957944*coeff[15]*fSkin[39]-0.3535533905932737*coeff[13]*fSkin[39]-0.5303300858899105*coeff[14]*fSkin[38]+0.3061862178478971*coeff[11]*fSkin[38]+0.6123724356957944*coeff[10]*fSkin[37]-0.3535533905932737*coeff[8]*fSkin[37]-0.5303300858899104*coeff[15]*fSkin[35]+0.3061862178478971*coeff[13]*fSkin[35]+0.6123724356957944*coeff[12]*fSkin[34]-0.3535533905932737*coeff[9]*fSkin[34]-0.5303300858899104*coeff[10]*fSkin[33]+0.3061862178478971*coeff[8]*fSkin[33]-0.5303300858899105*coeff[12]*fSkin[32]+0.3061862178478971*coeff[9]*fSkin[32]; 
  boundSurf_incr[39] = 0.6123724356957944*coeff[12]*fSkin[43]-0.3535533905932737*coeff[9]*fSkin[43]+0.6123724356957944*coeff[10]*fSkin[39]-0.3535533905932737*coeff[8]*fSkin[39]-0.5303300858899105*coeff[12]*fSkin[38]+0.3061862178478971*coeff[9]*fSkin[38]+0.6123724356957944*coeff[15]*fSkin[37]-0.3535533905932737*coeff[13]*fSkin[37]-0.5303300858899104*coeff[10]*fSkin[35]+0.3061862178478971*coeff[8]*fSkin[35]+0.6123724356957944*coeff[14]*fSkin[34]-0.3535533905932737*coeff[11]*fSkin[34]-0.5303300858899104*coeff[15]*fSkin[33]+0.3061862178478971*coeff[13]*fSkin[33]-0.5303300858899105*coeff[14]*fSkin[32]+0.3061862178478971*coeff[11]*fSkin[32]; 
  boundSurf_incr[41] = 0.6123724356957944*coeff[15]*fSkin[47]-0.3535533905932737*coeff[13]*fSkin[47]+0.6123724356957944*coeff[14]*fSkin[46]-0.3535533905932737*coeff[11]*fSkin[46]-0.5303300858899104*coeff[15]*fSkin[45]+0.3061862178478971*coeff[13]*fSkin[45]+0.6123724356957944*coeff[12]*fSkin[44]-0.3535533905932737*coeff[9]*fSkin[44]-0.5303300858899105*coeff[14]*fSkin[42]+0.3061862178478971*coeff[11]*fSkin[42]+0.6123724356957944*coeff[10]*fSkin[41]-0.3535533905932737*coeff[8]*fSkin[41]-0.5303300858899105*coeff[12]*fSkin[40]+0.3061862178478971*coeff[9]*fSkin[40]-0.5303300858899104*coeff[10]*fSkin[36]+0.3061862178478971*coeff[8]*fSkin[36]; 
  boundSurf_incr[43] = 0.6123724356957944*coeff[10]*fSkin[43]-0.3535533905932737*coeff[8]*fSkin[43]+0.6123724356957944*coeff[12]*fSkin[39]-0.3535533905932737*coeff[9]*fSkin[39]-0.5303300858899104*coeff[10]*fSkin[38]+0.3061862178478971*coeff[8]*fSkin[38]+0.6123724356957944*coeff[14]*fSkin[37]-0.3535533905932737*coeff[11]*fSkin[37]-0.5303300858899105*coeff[12]*fSkin[35]+0.3061862178478971*coeff[9]*fSkin[35]+0.6123724356957944*coeff[15]*fSkin[34]-0.3535533905932737*coeff[13]*fSkin[34]-0.5303300858899105*coeff[14]*fSkin[33]+0.3061862178478971*coeff[11]*fSkin[33]-0.5303300858899104*coeff[15]*fSkin[32]+0.3061862178478971*coeff[13]*fSkin[32]; 
  boundSurf_incr[44] = 0.6123724356957944*coeff[14]*fSkin[47]-0.3535533905932737*coeff[11]*fSkin[47]+0.6123724356957944*coeff[15]*fSkin[46]-0.3535533905932737*coeff[13]*fSkin[46]-0.5303300858899105*coeff[14]*fSkin[45]+0.3061862178478971*coeff[11]*fSkin[45]+0.6123724356957944*coeff[10]*fSkin[44]-0.3535533905932737*coeff[8]*fSkin[44]-0.5303300858899104*coeff[15]*fSkin[42]+0.3061862178478971*coeff[13]*fSkin[42]+0.6123724356957944*coeff[12]*fSkin[41]-0.3535533905932737*coeff[9]*fSkin[41]-0.5303300858899104*coeff[10]*fSkin[40]+0.3061862178478971*coeff[8]*fSkin[40]-0.5303300858899105*coeff[12]*fSkin[36]+0.3061862178478971*coeff[9]*fSkin[36]; 
  boundSurf_incr[46] = 0.6123724356957944*coeff[12]*fSkin[47]-0.3535533905932737*coeff[9]*fSkin[47]+0.6123724356957944*coeff[10]*fSkin[46]-0.3535533905932737*coeff[8]*fSkin[46]-0.5303300858899105*coeff[12]*fSkin[45]+0.3061862178478971*coeff[9]*fSkin[45]+0.6123724356957944*coeff[15]*fSkin[44]-0.3535533905932737*coeff[13]*fSkin[44]-0.5303300858899104*coeff[10]*fSkin[42]+0.3061862178478971*coeff[8]*fSkin[42]+0.6123724356957944*coeff[14]*fSkin[41]-0.3535533905932737*coeff[11]*fSkin[41]-0.5303300858899104*coeff[15]*fSkin[40]+0.3061862178478971*coeff[13]*fSkin[40]-0.5303300858899105*coeff[14]*fSkin[36]+0.3061862178478971*coeff[11]*fSkin[36]; 
  boundSurf_incr[47] = 0.6123724356957944*coeff[10]*fSkin[47]-0.3535533905932737*coeff[8]*fSkin[47]+0.6123724356957944*coeff[12]*fSkin[46]-0.3535533905932737*coeff[9]*fSkin[46]-0.5303300858899104*coeff[10]*fSkin[45]+0.3061862178478971*coeff[8]*fSkin[45]+0.6123724356957944*coeff[14]*fSkin[44]-0.3535533905932737*coeff[11]*fSkin[44]-0.5303300858899105*coeff[12]*fSkin[42]+0.3061862178478971*coeff[9]*fSkin[42]+0.6123724356957944*coeff[15]*fSkin[41]-0.3535533905932737*coeff[13]*fSkin[41]-0.5303300858899105*coeff[14]*fSkin[40]+0.3061862178478971*coeff[11]*fSkin[40]-0.5303300858899104*coeff[15]*fSkin[36]+0.3061862178478971*coeff[13]*fSkin[36]; 
