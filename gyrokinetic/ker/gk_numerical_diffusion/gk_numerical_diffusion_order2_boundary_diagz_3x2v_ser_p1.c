...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_diagz_3x2v_ser_p1_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qGhost, double* GKYL_RESTRICT out) 
{
  ...
  const double rdx2Sq = pow(2./dx[2],2.);

  double boundSurf_incr[48] = {0.0}; 

  if (edge == -1) { 

  boundSurf_incr[3] = 0.8660254037844386*qSkin[0]*coeff[2]-1.0*coeff[2]*qSkin[3]; 
  boundSurf_incr[7] = 0.8660254037844386*qSkin[1]*coeff[2]-1.0*coeff[2]*qSkin[7]; 
  boundSurf_incr[8] = 0.8660254037844386*coeff[2]*qSkin[2]-1.0*coeff[2]*qSkin[8]; 
  boundSurf_incr[11] = 0.8660254037844386*coeff[2]*qSkin[4]-1.0*coeff[2]*qSkin[11]; 
  boundSurf_incr[14] = 0.8660254037844386*coeff[2]*qSkin[5]-1.0*coeff[2]*qSkin[14]; 
  boundSurf_incr[16] = 0.8660254037844386*coeff[2]*qSkin[6]-1.0*coeff[2]*qSkin[16]; 
  boundSurf_incr[18] = 0.8660254037844386*coeff[2]*qSkin[9]-1.0*coeff[2]*qSkin[18]; 
  boundSurf_incr[19] = 0.8660254037844386*coeff[2]*qSkin[10]-1.0*coeff[2]*qSkin[19]; 
  boundSurf_incr[21] = 0.8660254037844386*coeff[2]*qSkin[12]-1.0*coeff[2]*qSkin[21]; 
  boundSurf_incr[22] = 0.8660254037844386*coeff[2]*qSkin[13]-1.0*coeff[2]*qSkin[22]; 
  boundSurf_incr[25] = 0.8660254037844386*coeff[2]*qSkin[15]-1.0*coeff[2]*qSkin[25]; 
  boundSurf_incr[26] = 0.8660254037844386*coeff[2]*qSkin[17]-1.0*coeff[2]*qSkin[26]; 
  boundSurf_incr[27] = 0.8660254037844386*coeff[2]*qSkin[20]-1.0*coeff[2]*qSkin[27]; 
  boundSurf_incr[29] = 0.8660254037844386*coeff[2]*qSkin[23]-1.0*coeff[2]*qSkin[29]; 
  boundSurf_incr[30] = 0.8660254037844386*coeff[2]*qSkin[24]-1.0*coeff[2]*qSkin[30]; 
  boundSurf_incr[31] = 0.8660254037844386*coeff[2]*qSkin[28]-1.0*coeff[2]*qSkin[31]; 
  boundSurf_incr[35] = 0.8660254037844387*coeff[2]*qSkin[32]-1.0*coeff[2]*qSkin[35]; 
  boundSurf_incr[38] = 0.8660254037844387*coeff[2]*qSkin[33]-1.0*coeff[2]*qSkin[38]; 
  boundSurf_incr[39] = 0.8660254037844387*coeff[2]*qSkin[34]-1.0*coeff[2]*qSkin[39]; 
  boundSurf_incr[42] = 0.8660254037844387*coeff[2]*qSkin[36]-1.0*coeff[2]*qSkin[42]; 
  boundSurf_incr[43] = 0.8660254037844387*coeff[2]*qSkin[37]-1.0*coeff[2]*qSkin[43]; 
  boundSurf_incr[45] = 0.8660254037844387*coeff[2]*qSkin[40]-1.0*coeff[2]*qSkin[45]; 
  boundSurf_incr[46] = 0.8660254037844387*coeff[2]*qSkin[41]-1.0*coeff[2]*qSkin[46]; 
  boundSurf_incr[47] = 0.8660254037844387*coeff[2]*qSkin[44]-1.0*coeff[2]*qSkin[47]; 

  } else { 

  boundSurf_incr[3] = -(1.0*coeff[2]*qSkin[3])-0.8660254037844386*qSkin[0]*coeff[2]; 
  boundSurf_incr[7] = -(1.0*coeff[2]*qSkin[7])-0.8660254037844386*qSkin[1]*coeff[2]; 
  boundSurf_incr[8] = -(1.0*coeff[2]*qSkin[8])-0.8660254037844386*coeff[2]*qSkin[2]; 
  boundSurf_incr[11] = -(1.0*coeff[2]*qSkin[11])-0.8660254037844386*coeff[2]*qSkin[4]; 
  boundSurf_incr[14] = -(1.0*coeff[2]*qSkin[14])-0.8660254037844386*coeff[2]*qSkin[5]; 
  boundSurf_incr[16] = -(1.0*coeff[2]*qSkin[16])-0.8660254037844386*coeff[2]*qSkin[6]; 
  boundSurf_incr[18] = -(1.0*coeff[2]*qSkin[18])-0.8660254037844386*coeff[2]*qSkin[9]; 
  boundSurf_incr[19] = -(1.0*coeff[2]*qSkin[19])-0.8660254037844386*coeff[2]*qSkin[10]; 
  boundSurf_incr[21] = -(1.0*coeff[2]*qSkin[21])-0.8660254037844386*coeff[2]*qSkin[12]; 
  boundSurf_incr[22] = -(1.0*coeff[2]*qSkin[22])-0.8660254037844386*coeff[2]*qSkin[13]; 
  boundSurf_incr[25] = -(1.0*coeff[2]*qSkin[25])-0.8660254037844386*coeff[2]*qSkin[15]; 
  boundSurf_incr[26] = -(1.0*coeff[2]*qSkin[26])-0.8660254037844386*coeff[2]*qSkin[17]; 
  boundSurf_incr[27] = -(1.0*coeff[2]*qSkin[27])-0.8660254037844386*coeff[2]*qSkin[20]; 
  boundSurf_incr[29] = -(1.0*coeff[2]*qSkin[29])-0.8660254037844386*coeff[2]*qSkin[23]; 
  boundSurf_incr[30] = -(1.0*coeff[2]*qSkin[30])-0.8660254037844386*coeff[2]*qSkin[24]; 
  boundSurf_incr[31] = -(1.0*coeff[2]*qSkin[31])-0.8660254037844386*coeff[2]*qSkin[28]; 
  boundSurf_incr[35] = -(1.0*coeff[2]*qSkin[35])-0.8660254037844387*coeff[2]*qSkin[32]; 
  boundSurf_incr[38] = -(1.0*coeff[2]*qSkin[38])-0.8660254037844387*coeff[2]*qSkin[33]; 
  boundSurf_incr[39] = -(1.0*coeff[2]*qSkin[39])-0.8660254037844387*coeff[2]*qSkin[34]; 
  boundSurf_incr[42] = -(1.0*coeff[2]*qSkin[42])-0.8660254037844387*coeff[2]*qSkin[36]; 
  boundSurf_incr[43] = -(1.0*coeff[2]*qSkin[43])-0.8660254037844387*coeff[2]*qSkin[37]; 
  boundSurf_incr[45] = -(1.0*coeff[2]*qSkin[45])-0.8660254037844387*coeff[2]*qSkin[40]; 
  boundSurf_incr[46] = -(1.0*coeff[2]*qSkin[46])-0.8660254037844387*coeff[2]*qSkin[41]; 
  boundSurf_incr[47] = -(1.0*coeff[2]*qSkin[47])-0.8660254037844387*coeff[2]*qSkin[44]; 
...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_diagz_3x2v_ser_p1_varcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qGhost, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  boundSurf_incr[3] = 0.6123724356957944*fSkin[16]*coeff[23]-0.5303300858899105*fSkin[6]*coeff[23]+0.6123724356957944*fSkin[8]*coeff[22]-0.5303300858899105*fSkin[2]*coeff[22]+0.6123724356957944*fSkin[7]*coeff[21]-0.5303300858899105*fSkin[1]*coeff[21]-0.3535533905932737*fSkin[16]*coeff[20]+0.3061862178478971*fSkin[6]*coeff[20]+0.6123724356957944*fSkin[3]*coeff[19]-0.5303300858899105*fSkin[0]*coeff[19]-0.3535533905932737*fSkin[8]*coeff[18]+0.3061862178478971*fSkin[2]*coeff[18]-0.3535533905932737*fSkin[7]*coeff[17]+0.3061862178478971*fSkin[1]*coeff[17]-0.3535533905932737*fSkin[3]*coeff[16]+0.3061862178478971*fSkin[0]*coeff[16]; 
  boundSurf_incr[7] = 0.6123724356957944*fSkin[8]*coeff[23]-0.5303300858899105*fSkin[2]*coeff[23]+0.6123724356957944*fSkin[16]*coeff[22]-0.5303300858899105*fSkin[6]*coeff[22]+0.6123724356957944*fSkin[3]*coeff[21]-0.5303300858899105*fSkin[0]*coeff[21]-0.3535533905932737*fSkin[8]*coeff[20]+0.3061862178478971*fSkin[2]*coeff[20]+0.6123724356957944*fSkin[7]*coeff[19]-0.5303300858899105*fSkin[1]*coeff[19]-0.3535533905932737*fSkin[16]*coeff[18]+0.3061862178478971*fSkin[6]*coeff[18]-0.3535533905932737*fSkin[3]*coeff[17]+0.3061862178478971*fSkin[0]*coeff[17]-0.3535533905932737*fSkin[7]*coeff[16]+0.3061862178478971*fSkin[1]*coeff[16]; 
  boundSurf_incr[8] = 0.6123724356957944*fSkin[7]*coeff[23]-0.5303300858899105*fSkin[1]*coeff[23]+0.6123724356957944*fSkin[3]*coeff[22]-0.5303300858899105*fSkin[0]*coeff[22]+0.6123724356957944*fSkin[16]*coeff[21]-0.5303300858899105*fSkin[6]*coeff[21]-0.3535533905932737*fSkin[7]*coeff[20]+0.3061862178478971*fSkin[1]*coeff[20]+0.6123724356957944*fSkin[8]*coeff[19]-0.5303300858899105*fSkin[2]*coeff[19]-0.3535533905932737*fSkin[3]*coeff[18]+0.3061862178478971*fSkin[0]*coeff[18]-0.3535533905932737*fSkin[16]*coeff[17]+0.3061862178478971*fSkin[6]*coeff[17]-0.3535533905932737*fSkin[8]*coeff[16]+0.3061862178478971*fSkin[2]*coeff[16]; 
  boundSurf_incr[11] = 0.6123724356957944*coeff[23]*fSkin[26]-0.3535533905932737*coeff[20]*fSkin[26]-0.5303300858899105*fSkin[17]*coeff[23]+0.6123724356957944*fSkin[19]*coeff[22]-0.5303300858899105*fSkin[10]*coeff[22]+0.6123724356957944*fSkin[18]*coeff[21]-0.5303300858899105*fSkin[9]*coeff[21]+0.3061862178478971*fSkin[17]*coeff[20]-0.3535533905932737*coeff[18]*fSkin[19]+0.6123724356957944*fSkin[11]*coeff[19]-0.5303300858899105*fSkin[4]*coeff[19]-0.3535533905932737*coeff[17]*fSkin[18]+0.3061862178478971*fSkin[10]*coeff[18]+0.3061862178478971*fSkin[9]*coeff[17]-0.3535533905932737*fSkin[11]*coeff[16]+0.3061862178478971*fSkin[4]*coeff[16]; 
  boundSurf_incr[14] = 0.6123724356957944*coeff[23]*fSkin[27]-0.3535533905932737*coeff[20]*fSkin[27]-0.5303300858899105*fSkin[20]*coeff[23]+0.6123724356957944*coeff[22]*fSkin[22]-0.3535533905932737*coeff[18]*fSkin[22]-0.5303300858899105*fSkin[13]*coeff[22]+0.6123724356957944*coeff[21]*fSkin[21]-0.3535533905932737*coeff[17]*fSkin[21]-0.5303300858899105*fSkin[12]*coeff[21]+0.3061862178478971*coeff[20]*fSkin[20]+0.6123724356957944*fSkin[14]*coeff[19]-0.5303300858899105*fSkin[5]*coeff[19]+0.3061862178478971*fSkin[13]*coeff[18]+0.3061862178478971*fSkin[12]*coeff[17]-0.3535533905932737*fSkin[14]*coeff[16]+0.3061862178478971*fSkin[5]*coeff[16]; 
  boundSurf_incr[16] = 0.6123724356957944*fSkin[3]*coeff[23]-0.5303300858899105*fSkin[0]*coeff[23]+0.6123724356957944*fSkin[7]*coeff[22]-0.5303300858899105*fSkin[1]*coeff[22]+0.6123724356957944*fSkin[8]*coeff[21]-0.5303300858899105*fSkin[2]*coeff[21]-0.3535533905932737*fSkin[3]*coeff[20]+0.3061862178478971*fSkin[0]*coeff[20]+0.6123724356957944*fSkin[16]*coeff[19]-0.5303300858899105*fSkin[6]*coeff[19]-0.3535533905932737*fSkin[7]*coeff[18]+0.3061862178478971*fSkin[1]*coeff[18]-0.3535533905932737*fSkin[8]*coeff[17]+0.3061862178478971*fSkin[2]*coeff[17]-0.3535533905932737*coeff[16]*fSkin[16]+0.3061862178478971*fSkin[6]*coeff[16]; 
  boundSurf_incr[18] = 0.6123724356957944*coeff[22]*fSkin[26]-0.3535533905932737*coeff[18]*fSkin[26]+0.6123724356957944*fSkin[19]*coeff[23]-0.5303300858899105*fSkin[10]*coeff[23]-0.5303300858899105*fSkin[17]*coeff[22]+0.6123724356957944*fSkin[11]*coeff[21]-0.5303300858899105*fSkin[4]*coeff[21]-0.3535533905932737*fSkin[19]*coeff[20]+0.3061862178478971*fSkin[10]*coeff[20]+0.6123724356957944*fSkin[18]*coeff[19]-0.5303300858899105*fSkin[9]*coeff[19]-0.3535533905932737*coeff[16]*fSkin[18]+0.3061862178478971*fSkin[17]*coeff[18]-0.3535533905932737*fSkin[11]*coeff[17]+0.3061862178478971*fSkin[4]*coeff[17]+0.3061862178478971*fSkin[9]*coeff[16]; 
  boundSurf_incr[19] = 0.6123724356957944*coeff[21]*fSkin[26]-0.3535533905932737*coeff[17]*fSkin[26]+0.6123724356957944*fSkin[18]*coeff[23]-0.5303300858899105*fSkin[9]*coeff[23]+0.6123724356957944*fSkin[11]*coeff[22]-0.5303300858899105*fSkin[4]*coeff[22]-0.5303300858899105*fSkin[17]*coeff[21]-0.3535533905932737*fSkin[18]*coeff[20]+0.3061862178478971*fSkin[9]*coeff[20]+0.6123724356957944*coeff[19]*fSkin[19]-0.3535533905932737*coeff[16]*fSkin[19]-0.5303300858899105*fSkin[10]*coeff[19]-0.3535533905932737*fSkin[11]*coeff[18]+0.3061862178478971*fSkin[4]*coeff[18]+0.3061862178478971*coeff[17]*fSkin[17]+0.3061862178478971*fSkin[10]*coeff[16]; 
  boundSurf_incr[21] = 0.6123724356957944*coeff[22]*fSkin[27]-0.3535533905932737*coeff[18]*fSkin[27]+0.6123724356957944*fSkin[22]*coeff[23]-0.5303300858899105*fSkin[13]*coeff[23]-0.3535533905932737*coeff[20]*fSkin[22]-0.5303300858899105*fSkin[20]*coeff[22]+0.6123724356957944*coeff[19]*fSkin[21]-0.3535533905932737*coeff[16]*fSkin[21]+0.6123724356957944*fSkin[14]*coeff[21]-0.5303300858899105*fSkin[5]*coeff[21]+0.3061862178478971*coeff[18]*fSkin[20]+0.3061862178478971*fSkin[13]*coeff[20]-0.5303300858899105*fSkin[12]*coeff[19]-0.3535533905932737*fSkin[14]*coeff[17]+0.3061862178478971*fSkin[5]*coeff[17]+0.3061862178478971*fSkin[12]*coeff[16]; 
  boundSurf_incr[22] = 0.6123724356957944*coeff[21]*fSkin[27]-0.3535533905932737*coeff[17]*fSkin[27]+0.6123724356957944*fSkin[21]*coeff[23]-0.5303300858899105*fSkin[12]*coeff[23]+0.6123724356957944*coeff[19]*fSkin[22]-0.3535533905932737*coeff[16]*fSkin[22]+0.6123724356957944*fSkin[14]*coeff[22]-0.5303300858899105*fSkin[5]*coeff[22]-0.3535533905932737*coeff[20]*fSkin[21]-0.5303300858899105*fSkin[20]*coeff[21]+0.3061862178478971*coeff[17]*fSkin[20]+0.3061862178478971*fSkin[12]*coeff[20]-0.5303300858899105*fSkin[13]*coeff[19]-0.3535533905932737*fSkin[14]*coeff[18]+0.3061862178478971*fSkin[5]*coeff[18]+0.3061862178478971*fSkin[13]*coeff[16]; 
  boundSurf_incr[25] = 0.6123724356957944*coeff[23]*fSkin[31]-0.3535533905932737*coeff[20]*fSkin[31]+0.6123724356957944*coeff[22]*fSkin[30]-0.3535533905932737*coeff[18]*fSkin[30]+0.6123724356957944*coeff[21]*fSkin[29]-0.3535533905932737*coeff[17]*fSkin[29]-0.5303300858899105*coeff[23]*fSkin[28]+0.3061862178478971*coeff[20]*fSkin[28]+0.6123724356957944*coeff[19]*fSkin[25]-0.3535533905932737*coeff[16]*fSkin[25]-0.5303300858899105*coeff[22]*fSkin[24]+0.3061862178478971*coeff[18]*fSkin[24]-0.5303300858899105*coeff[21]*fSkin[23]+0.3061862178478971*coeff[17]*fSkin[23]-0.5303300858899105*fSkin[15]*coeff[19]+0.3061862178478971*fSkin[15]*coeff[16]; 
  boundSurf_incr[26] = 0.6123724356957944*coeff[19]*fSkin[26]-0.3535533905932737*coeff[16]*fSkin[26]+0.6123724356957944*fSkin[11]*coeff[23]-0.5303300858899105*fSkin[4]*coeff[23]+0.6123724356957944*fSkin[18]*coeff[22]-0.5303300858899105*fSkin[9]*coeff[22]+0.6123724356957944*fSkin[19]*coeff[21]-0.5303300858899105*fSkin[10]*coeff[21]-0.3535533905932737*fSkin[11]*coeff[20]+0.3061862178478971*fSkin[4]*coeff[20]-0.3535533905932737*coeff[17]*fSkin[19]-0.5303300858899105*fSkin[17]*coeff[19]-0.3535533905932737*coeff[18]*fSkin[18]+0.3061862178478971*fSkin[9]*coeff[18]+0.3061862178478971*coeff[16]*fSkin[17]+0.3061862178478971*fSkin[10]*coeff[17]; 
  boundSurf_incr[27] = 0.6123724356957944*coeff[19]*fSkin[27]-0.3535533905932737*coeff[16]*fSkin[27]+0.6123724356957944*fSkin[14]*coeff[23]-0.5303300858899105*fSkin[5]*coeff[23]+0.6123724356957944*coeff[21]*fSkin[22]-0.3535533905932737*coeff[17]*fSkin[22]+0.6123724356957944*fSkin[21]*coeff[22]-0.5303300858899105*fSkin[12]*coeff[22]-0.3535533905932737*coeff[18]*fSkin[21]-0.5303300858899105*fSkin[13]*coeff[21]-0.5303300858899105*coeff[19]*fSkin[20]+0.3061862178478971*coeff[16]*fSkin[20]-0.3535533905932737*fSkin[14]*coeff[20]+0.3061862178478971*fSkin[5]*coeff[20]+0.3061862178478971*fSkin[12]*coeff[18]+0.3061862178478971*fSkin[13]*coeff[17]; 
  boundSurf_incr[29] = 0.6123724356957944*coeff[22]*fSkin[31]-0.3535533905932737*coeff[18]*fSkin[31]+0.6123724356957944*coeff[23]*fSkin[30]-0.3535533905932737*coeff[20]*fSkin[30]+0.6123724356957944*coeff[19]*fSkin[29]-0.3535533905932737*coeff[16]*fSkin[29]-0.5303300858899105*coeff[22]*fSkin[28]+0.3061862178478971*coeff[18]*fSkin[28]+0.6123724356957944*coeff[21]*fSkin[25]-0.3535533905932737*coeff[17]*fSkin[25]-0.5303300858899105*coeff[23]*fSkin[24]+0.3061862178478971*coeff[20]*fSkin[24]-0.5303300858899105*coeff[19]*fSkin[23]+0.3061862178478971*coeff[16]*fSkin[23]-0.5303300858899105*fSkin[15]*coeff[21]+0.3061862178478971*fSkin[15]*coeff[17]; 
  boundSurf_incr[30] = 0.6123724356957944*coeff[21]*fSkin[31]-0.3535533905932737*coeff[17]*fSkin[31]+0.6123724356957944*coeff[19]*fSkin[30]-0.3535533905932737*coeff[16]*fSkin[30]+0.6123724356957944*coeff[23]*fSkin[29]-0.3535533905932737*coeff[20]*fSkin[29]-0.5303300858899105*coeff[21]*fSkin[28]+0.3061862178478971*coeff[17]*fSkin[28]+0.6123724356957944*coeff[22]*fSkin[25]-0.3535533905932737*coeff[18]*fSkin[25]-0.5303300858899105*coeff[19]*fSkin[24]+0.3061862178478971*coeff[16]*fSkin[24]-0.5303300858899105*coeff[23]*fSkin[23]+0.3061862178478971*coeff[20]*fSkin[23]-0.5303300858899105*fSkin[15]*coeff[22]+0.3061862178478971*fSkin[15]*coeff[18]; 
  boundSurf_incr[31] = 0.6123724356957944*coeff[19]*fSkin[31]-0.3535533905932737*coeff[16]*fSkin[31]+0.6123724356957944*coeff[21]*fSkin[30]-0.3535533905932737*coeff[17]*fSkin[30]+0.6123724356957944*coeff[22]*fSkin[29]-0.3535533905932737*coeff[18]*fSkin[29]-0.5303300858899105*coeff[19]*fSkin[28]+0.3061862178478971*coeff[16]*fSkin[28]+0.6123724356957944*coeff[23]*fSkin[25]-0.3535533905932737*coeff[20]*fSkin[25]-0.5303300858899105*coeff[21]*fSkin[24]+0.3061862178478971*coeff[17]*fSkin[24]-0.5303300858899105*coeff[22]*fSkin[23]+0.3061862178478971*coeff[18]*fSkin[23]-0.5303300858899105*fSkin[15]*coeff[23]+0.3061862178478971*fSkin[15]*coeff[20]; 
  boundSurf_incr[35] = 0.6123724356957944*coeff[23]*fSkin[43]-0.3535533905932737*coeff[20]*fSkin[43]+0.6123724356957944*coeff[22]*fSkin[39]-0.3535533905932737*coeff[18]*fSkin[39]+0.6123724356957944*coeff[21]*fSkin[38]-0.3535533905932737*coeff[17]*fSkin[38]-0.5303300858899104*coeff[23]*fSkin[37]+0.3061862178478971*coeff[20]*fSkin[37]+0.6123724356957944*coeff[19]*fSkin[35]-0.3535533905932737*coeff[16]*fSkin[35]-0.5303300858899105*coeff[22]*fSkin[34]+0.3061862178478971*coeff[18]*fSkin[34]-0.5303300858899105*coeff[21]*fSkin[33]+0.3061862178478971*coeff[17]*fSkin[33]-0.5303300858899104*coeff[19]*fSkin[32]+0.3061862178478971*coeff[16]*fSkin[32]; 
  boundSurf_incr[38] = 0.6123724356957944*coeff[22]*fSkin[43]-0.3535533905932737*coeff[18]*fSkin[43]+0.6123724356957944*coeff[23]*fSkin[39]-0.3535533905932737*coeff[20]*fSkin[39]+0.6123724356957944*coeff[19]*fSkin[38]-0.3535533905932737*coeff[16]*fSkin[38]-0.5303300858899105*coeff[22]*fSkin[37]+0.3061862178478971*coeff[18]*fSkin[37]+0.6123724356957944*coeff[21]*fSkin[35]-0.3535533905932737*coeff[17]*fSkin[35]-0.5303300858899104*coeff[23]*fSkin[34]+0.3061862178478971*coeff[20]*fSkin[34]-0.5303300858899104*coeff[19]*fSkin[33]+0.3061862178478971*coeff[16]*fSkin[33]-0.5303300858899105*coeff[21]*fSkin[32]+0.3061862178478971*coeff[17]*fSkin[32]; 
  boundSurf_incr[39] = 0.6123724356957944*coeff[21]*fSkin[43]-0.3535533905932737*coeff[17]*fSkin[43]+0.6123724356957944*coeff[19]*fSkin[39]-0.3535533905932737*coeff[16]*fSkin[39]+0.6123724356957944*coeff[23]*fSkin[38]-0.3535533905932737*coeff[20]*fSkin[38]-0.5303300858899105*coeff[21]*fSkin[37]+0.3061862178478971*coeff[17]*fSkin[37]+0.6123724356957944*coeff[22]*fSkin[35]-0.3535533905932737*coeff[18]*fSkin[35]-0.5303300858899104*coeff[19]*fSkin[34]+0.3061862178478971*coeff[16]*fSkin[34]-0.5303300858899104*coeff[23]*fSkin[33]+0.3061862178478971*coeff[20]*fSkin[33]-0.5303300858899105*coeff[22]*fSkin[32]+0.3061862178478971*coeff[18]*fSkin[32]; 
  boundSurf_incr[42] = 0.6123724356957944*coeff[23]*fSkin[47]-0.3535533905932737*coeff[20]*fSkin[47]+0.6123724356957944*coeff[22]*fSkin[46]-0.3535533905932737*coeff[18]*fSkin[46]+0.6123724356957944*coeff[21]*fSkin[45]-0.3535533905932737*coeff[17]*fSkin[45]-0.5303300858899104*coeff[23]*fSkin[44]+0.3061862178478971*coeff[20]*fSkin[44]+0.6123724356957944*coeff[19]*fSkin[42]-0.3535533905932737*coeff[16]*fSkin[42]-0.5303300858899105*coeff[22]*fSkin[41]+0.3061862178478971*coeff[18]*fSkin[41]-0.5303300858899105*coeff[21]*fSkin[40]+0.3061862178478971*coeff[17]*fSkin[40]-0.5303300858899104*coeff[19]*fSkin[36]+0.3061862178478971*coeff[16]*fSkin[36]; 
  boundSurf_incr[43] = 0.6123724356957944*coeff[19]*fSkin[43]-0.3535533905932737*coeff[16]*fSkin[43]+0.6123724356957944*coeff[21]*fSkin[39]-0.3535533905932737*coeff[17]*fSkin[39]+0.6123724356957944*coeff[22]*fSkin[38]-0.3535533905932737*coeff[18]*fSkin[38]-0.5303300858899104*coeff[19]*fSkin[37]+0.3061862178478971*coeff[16]*fSkin[37]+0.6123724356957944*coeff[23]*fSkin[35]-0.3535533905932737*coeff[20]*fSkin[35]-0.5303300858899105*coeff[21]*fSkin[34]+0.3061862178478971*coeff[17]*fSkin[34]-0.5303300858899105*coeff[22]*fSkin[33]+0.3061862178478971*coeff[18]*fSkin[33]-0.5303300858899104*coeff[23]*fSkin[32]+0.3061862178478971*coeff[20]*fSkin[32]; 
  boundSurf_incr[45] = 0.6123724356957944*coeff[22]*fSkin[47]-0.3535533905932737*coeff[18]*fSkin[47]+0.6123724356957944*coeff[23]*fSkin[46]-0.3535533905932737*coeff[20]*fSkin[46]+0.6123724356957944*coeff[19]*fSkin[45]-0.3535533905932737*coeff[16]*fSkin[45]-0.5303300858899105*coeff[22]*fSkin[44]+0.3061862178478971*coeff[18]*fSkin[44]+0.6123724356957944*coeff[21]*fSkin[42]-0.3535533905932737*coeff[17]*fSkin[42]-0.5303300858899104*coeff[23]*fSkin[41]+0.3061862178478971*coeff[20]*fSkin[41]-0.5303300858899104*coeff[19]*fSkin[40]+0.3061862178478971*coeff[16]*fSkin[40]-0.5303300858899105*coeff[21]*fSkin[36]+0.3061862178478971*coeff[17]*fSkin[36]; 
  boundSurf_incr[46] = 0.6123724356957944*coeff[21]*fSkin[47]-0.3535533905932737*coeff[17]*fSkin[47]+0.6123724356957944*coeff[19]*fSkin[46]-0.3535533905932737*coeff[16]*fSkin[46]+0.6123724356957944*coeff[23]*fSkin[45]-0.3535533905932737*coeff[20]*fSkin[45]-0.5303300858899105*coeff[21]*fSkin[44]+0.3061862178478971*coeff[17]*fSkin[44]+0.6123724356957944*coeff[22]*fSkin[42]-0.3535533905932737*coeff[18]*fSkin[42]-0.5303300858899104*coeff[19]*fSkin[41]+0.3061862178478971*coeff[16]*fSkin[41]-0.5303300858899104*coeff[23]*fSkin[40]+0.3061862178478971*coeff[20]*fSkin[40]-0.5303300858899105*coeff[22]*fSkin[36]+0.3061862178478971*coeff[18]*fSkin[36]; 
  boundSurf_incr[47] = 0.6123724356957944*coeff[19]*fSkin[47]-0.3535533905932737*coeff[16]*fSkin[47]+0.6123724356957944*coeff[21]*fSkin[46]-0.3535533905932737*coeff[17]*fSkin[46]+0.6123724356957944*coeff[22]*fSkin[45]-0.3535533905932737*coeff[18]*fSkin[45]-0.5303300858899104*coeff[19]*fSkin[44]+0.3061862178478971*coeff[16]*fSkin[44]+0.6123724356957944*coeff[23]*fSkin[42]-0.3535533905932737*coeff[20]*fSkin[42]-0.5303300858899105*coeff[21]*fSkin[41]+0.3061862178478971*coeff[17]*fSkin[41]-0.5303300858899105*coeff[22]*fSkin[40]+0.3061862178478971*coeff[18]*fSkin[40]-0.5303300858899104*coeff[23]*fSkin[36]+0.3061862178478971*coeff[20]*fSkin[36]; 
