...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_surfx_1x2v_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qEdge, const double *qSkin, double* GKYL_RESTRICT out) 
{
  ...
  vol_incr[11] = 6.7082039324993685*coeff[0]*qSkin[2]; 
  vol_incr[13] = 6.7082039324993685*coeff[0]*qSkin[3]; 
  ...
  edgeSurf_incr[1] = -(1.5855025573536612*coeff[0]*qSkin[7])+0.7382874503707886*coeff[0]*qEdge[7]-2.671875*coeff[0]*qSkin[1]-1.453125*coeff[0]*qEdge[1]-2.0568103339880417*coeff[0]*qSkin[0]+1.1907849302036029*coeff[0]*qEdge[0]; 
  ...
  edgeSurf_incr[4] = -(1.5855025573536612*coeff[0]*qSkin[11])+0.7382874503707888*coeff[0]*qEdge[11]-2.671875*coeff[0]*qSkin[4]-1.453125*coeff[0]*qEdge[4]-2.0568103339880417*coeff[0]*qSkin[2]+1.1907849302036029*coeff[0]*qEdge[2]; 
  edgeSurf_incr[5] = -(1.5855025573536612*coeff[0]*qSkin[13])+0.7382874503707888*coeff[0]*qEdge[13]-2.671875*coeff[0]*qSkin[5]-1.453125*coeff[0]*qEdge[5]-2.0568103339880417*coeff[0]*qSkin[3]+1.1907849302036029*coeff[0]*qEdge[3]; 
  ...
  edgeSurf_incr[7] = -(3.140625*coeff[0]*qSkin[7])-0.140625*coeff[0]*qEdge[7]-5.022775277112744*coeff[0]*qSkin[1]-0.3025768239224549*coeff[0]*qEdge[1]-3.7733647120308955*coeff[0]*qSkin[0]+0.4192627457812108*coeff[0]*qEdge[0]; 
  ...
  edgeSurf_incr[10] = -(1.5855025573536612*coeff[0]*qSkin[17])+0.7382874503707886*coeff[0]*qEdge[17]-2.671875*coeff[0]*qSkin[10]-1.453125*coeff[0]*qEdge[10]-2.0568103339880417*coeff[0]*qSkin[6]+1.1907849302036029*coeff[0]*qEdge[6]; 
  edgeSurf_incr[11] = -(3.140625*coeff[0]*qSkin[11])-0.140625*coeff[0]*qEdge[11]-5.022775277112744*coeff[0]*qSkin[4]-0.30257682392245444*coeff[0]*qEdge[4]-3.773364712030894*coeff[0]*qSkin[2]+0.41926274578121053*coeff[0]*qEdge[2]; 
  edgeSurf_incr[12] = -(2.671875*coeff[0]*qSkin[12])-1.453125*coeff[0]*qEdge[12]-2.0568103339880417*coeff[0]*qSkin[8]+1.190784930203603*coeff[0]*qEdge[8]; 
  edgeSurf_incr[13] = -(3.140625*coeff[0]*qSkin[13])-0.140625*coeff[0]*qEdge[13]-5.022775277112744*coeff[0]*qSkin[5]-0.30257682392245444*coeff[0]*qEdge[5]-3.773364712030894*coeff[0]*qSkin[3]+0.41926274578121053*coeff[0]*qEdge[3]; 
  ...
  edgeSurf_incr[15] = -(2.671875*coeff[0]*qSkin[15])-1.453125*coeff[0]*qEdge[15]-2.0568103339880417*coeff[0]*qSkin[9]+1.190784930203603*coeff[0]*qEdge[9]; 
  ...
  edgeSurf_incr[17] = -(3.140625*coeff[0]*qSkin[17])-0.140625*coeff[0]*qEdge[17]-5.022775277112744*coeff[0]*qSkin[10]-0.3025768239224549*coeff[0]*qEdge[10]-3.7733647120308955*coeff[0]*qSkin[6]+0.4192627457812108*coeff[0]*qEdge[6]; 
  edgeSurf_incr[18] = -(2.671875*coeff[0]*qSkin[18])-1.453125*coeff[0]*qEdge[18]-2.0568103339880417*coeff[0]*qSkin[14]+1.190784930203603*coeff[0]*qEdge[14]; 
  edgeSurf_incr[19] = -(2.671875*coeff[0]*qSkin[19])-1.453125*coeff[0]*qEdge[19]-2.0568103339880417*coeff[0]*qSkin[16]+1.190784930203603*coeff[0]*qEdge[16]; 
...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order2_boundary_surfx_1x2v_ser_p2_varcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qEdge, const double *qSkin, double* GKYL_RESTRICT out) 
{
  // w[NDIM]: Cell-center coordinate.
  // dxv[NDIM]: Cell length.
  // coeff: Diffusion coefficient.
  ...
  fEdge[2] = 0.04714045207910316*(15.000000000000002*jacobgeo_inv[2]*qEdge[11]+15.0*(jacobgeo_inv[1]*qEdge[4]+jacobgeo_inv[0]*qEdge[2])); 
  fEdge[3] = 0.04714045207910316*(15.000000000000002*jacobgeo_inv[2]*qEdge[13]+15.0*(jacobgeo_inv[1]*qEdge[5]+jacobgeo_inv[0]*qEdge[3])); 
  fEdge[4] = 0.04714045207910316*(13.416407864998737*jacobgeo_inv[1]*qEdge[11]+(13.416407864998739*jacobgeo_inv[2]+15.0*jacobgeo_inv[0])*qEdge[4]+15.0*jacobgeo_inv[1]*qEdge[2]); 
  fEdge[5] = 0.04714045207910316*(13.416407864998737*jacobgeo_inv[1]*qEdge[13]+(13.416407864998739*jacobgeo_inv[2]+15.0*jacobgeo_inv[0])*qEdge[5]+15.0*jacobgeo_inv[1]*qEdge[3]); 
  fEdge[6] = 0.7071067811865475*(jacobgeo_inv[2]*qEdge[17]+jacobgeo_inv[1]*qEdge[10]+jacobgeo_inv[0]*qEdge[6]); 
  fEdge[7] = 0.020203050891044214*((22.3606797749979*jacobgeo_inv[2]+35.0*jacobgeo_inv[0])*qEdge[7]+35.0*qEdge[0]*jacobgeo_inv[2]+31.304951684997057*jacobgeo_inv[1]*qEdge[1]); 
  fEdge[8] = 0.04714045207910316*(15.000000000000002*jacobgeo_inv[1]*qEdge[12]+15.0*jacobgeo_inv[0]*qEdge[8]); 
  fEdge[9] = 0.04714045207910316*(15.000000000000002*jacobgeo_inv[1]*qEdge[15]+15.0*jacobgeo_inv[0]*qEdge[9]); 
  ...
  fEdge[11] = 0.006734350297014738*((67.0820393249937*jacobgeo_inv[2]+105.0*jacobgeo_inv[0])*qEdge[11]+93.91485505499116*jacobgeo_inv[1]*qEdge[4]+105.00000000000001*jacobgeo_inv[2]*qEdge[2]); 
  fEdge[12] = 0.04714045207910316*((13.416407864998739*jacobgeo_inv[2]+15.0*jacobgeo_inv[0])*qEdge[12]+15.000000000000002*jacobgeo_inv[1]*qEdge[8]); 
  fEdge[13] = 0.006734350297014738*((67.0820393249937*jacobgeo_inv[2]+105.0*jacobgeo_inv[0])*qEdge[13]+93.91485505499116*jacobgeo_inv[1]*qEdge[5]+105.00000000000001*jacobgeo_inv[2]*qEdge[3]); 
  fEdge[14] = 0.04714045207910316*(15.000000000000002*jacobgeo_inv[1]*qEdge[18]+15.0*jacobgeo_inv[0]*qEdge[14]); 
  fEdge[15] = 0.04714045207910316*((13.416407864998739*jacobgeo_inv[2]+15.0*jacobgeo_inv[0])*qEdge[15]+15.000000000000002*jacobgeo_inv[1]*qEdge[9]); 
  fEdge[16] = 0.04714045207910316*(15.000000000000002*jacobgeo_inv[1]*qEdge[19]+15.0*jacobgeo_inv[0]*qEdge[16]); 
  fEdge[17] = 0.020203050891044214*((22.3606797749979*jacobgeo_inv[2]+35.0*jacobgeo_inv[0])*qEdge[17]+31.304951684997057*jacobgeo_inv[1]*qEdge[10]+35.0*jacobgeo_inv[2]*qEdge[6]); 
  fEdge[18] = 0.04714045207910316*((13.416407864998739*jacobgeo_inv[2]+15.0*jacobgeo_inv[0])*qEdge[18]+15.000000000000002*jacobgeo_inv[1]*qEdge[14]); 
  fEdge[19] = 0.04714045207910316*((13.416407864998739*jacobgeo_inv[2]+15.0*jacobgeo_inv[0])*qEdge[19]+15.000000000000002*jacobgeo_inv[1]*qEdge[16]); 
