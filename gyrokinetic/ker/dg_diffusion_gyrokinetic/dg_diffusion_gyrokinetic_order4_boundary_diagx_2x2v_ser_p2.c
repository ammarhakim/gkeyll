...
GKYL_CU_DH double dg_diffusion_gyrokinetic_order4_boundary_diagx_2x2v_ser_p2_constcoeff(const double *w, const double *dx, const double *coeff, const double *jacobgeo_inv, int edge, const double *qSkin, const double *qGhost, double* GKYL_RESTRICT out) 
{
