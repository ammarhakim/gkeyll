...
void fem_poisson_perp_bias_line_lhs_3x_ser_p1_inx_upy_periodicy(const int *edge, const int *perp_dir, const long *globalIdxs, gkyl_mat_triples *tri) 
{ 
...
void fem_poisson_perp_bias_line_lhs_3x_ser_p1_inx_upy_nonperiodicy(const int *edge, const int *perp_dir, const long *globalIdxs, gkyl_mat_triples *tri) 
{ 
  // edge: -1/+1 for lower or upper edge of the cell in each perp_dir.
  // perp_dirs: directions perpendicular to the biased line.
  // globalIdxs: global linear index of each basis function/node in current cell.
