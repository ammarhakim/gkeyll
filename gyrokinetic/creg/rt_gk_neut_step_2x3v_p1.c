...
void eval_temp_source(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout,
                      void *ctx)
{
  struct gk_step_ctx *app = ctx;
  double n0 = app->n0;
...
void evalNuD0(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
  struct gk_step_ctx *app = ctx;
  fout[0] = app->nuD0;
}
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_neut_species D0 = {.name = "D0",
    ...
    .num_diag_moments = 4,
    .diag_moments = {
      GKYL_F_MOMENT_M0, GKYL_F_MOMENT_M1_FROM_H, GKYL_F_MOMENT_ENERGY, GKYL_F_MOMENT_LTE}};

  // Field.
  struct gkyl_gyrokinetic_field field = { .is_static = true,
