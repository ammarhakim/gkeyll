...
struct gkyl_gk_block_geom *create_gk_block_geom(void *ctx)
{
  ...
  */
  ...
  struct gkyl_efit_inp efit_inp = { .filepath = "./gyrokinetic/data/eqdsk/nstxu_DN.geqdsk",
                                    .rz_poly_order = 2,
                                    .flux_poly_order = 1,
                                    .reflect = true };
  ...
  gkyl_gk_block_geom_set_block(bgeom, 0,
    &(struct gkyl_gk_block_geom_info){.lower = {psi_lo_outer_sol, alpha_lo, theta_lo},
