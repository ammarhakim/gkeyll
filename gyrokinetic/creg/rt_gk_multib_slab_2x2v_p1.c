...
struct slab_ctx create_ctx(void)
{
  ...
  double mu_max_elc =
    (3.0 / 2.0) * 0.5 * mass_elc * pow(4.0 * vte, 2) /
  ...
  double mu_max_ion =
    (3.0 / 2.0) * 0.5 * mass_ion * pow(4.0 * vti, 2) /
...
void evalSourceUparInit(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout,
                        void *ctx)
{
