...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_field field = {
    ...
    .boltzmann_bcs = {
      { .dir = 0, .edge = GKYL_LOWER_EDGE, .type = GKYL_BC_GK_FIELD_BOLTZMANN_SHEATH},
      { .dir = 0, .edge = GKYL_UPPER_EDGE, .type = GKYL_BC_GK_FIELD_BOLTZMANN_FLOAT},
    },
  };

  // GK app
  struct gkyl_gk app_inp = { 
    .name = "gk_mirror_boltz_elc_half_1x2v_p1",
