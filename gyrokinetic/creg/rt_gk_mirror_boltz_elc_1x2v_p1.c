...
int main(int argc, char **argv)
{
  ...
  struct gkyl_gyrokinetic_species ion = {
    ...
    .time_rate_multiplier = { .num_multipliers = 1,
                              .multiplier
                                [0] = { .type = GKYL_GK_FDOT_MULTIPLIER_FIXED_FACTOR_TIMES_OMEGA_MAX,
                                        .cellwise_const = true,
  ...
  struct gkyl_gyrokinetic_species elc = { .name = "elc",
                                          ...
                                          .scaling = { .type = GKYL_GK_SPECIES_SCALING_BOLTZMANN },
  ...
  struct gkyl_gyrokinetic_run_inp run_inp = {
    ...
    .print_verbosity = { .enabled = true, .frequency = 1.0, .disable_timings = true }
  };
