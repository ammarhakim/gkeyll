...
void evalBumpSquareNu(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout,
                      void *ctx)
{
  struct bgk_relax_ctx *app = ctx;
...
void evalSquareBumpNu(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout,
                      void *ctx)
{
  struct bgk_relax_ctx *app = ctx;
