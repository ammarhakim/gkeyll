...
create_asdex_lsn_gk_block_geom(void *ctx)
{
  ...
  // Theta limits are set internally by the code.
  ...
  gkyl_gk_block_geom_set_block(bgeom, 0, &(struct gkyl_gk_block_geom_info) {
      ...
      .upper = { psi_max_pf, theta_max },
      .cells = { Npsi_pf, Ntheta_divertor_lfs },
      .cuts = { 1, 1 },
      .geometry = {
        .world = {0.0},
  ...
  gkyl_gk_block_geom_set_block(bgeom, 1, &(struct gkyl_gk_block_geom_info) {
      .lower = { psi_min_sol, theta_min },
      .upper = { psi_sep, theta_max },
      .cells = { Npsi_sol, Ntheta_divertor_lfs },
      .cuts = { 1, 1 },
      .geometry = {
        .world = {0.0},
        .geometry_id = GKYL_GEOMETRY_TOKAMAK,
  ...
  gkyl_gk_block_geom_set_block(bgeom, 3, &(struct gkyl_gk_block_geom_info) {
      .lower = { psi_min_sol, theta_min },
      .upper = { psi_sep, theta_max },
      .cells = { Npsi_sol, Ntheta_divertor_hfs },
      .cuts = { 1, 1 },
      .geometry = {
        .world = {0.0},
        .geometry_id = GKYL_GEOMETRY_TOKAMAK,
  ...
  gkyl_gk_block_geom_set_block(bgeom, 4, &(struct gkyl_gk_block_geom_info) {
      .lower = { psi_sep, theta_min },
      .upper = { psi_max_pf, theta_max },
      .cells = { Npsi_pf, Ntheta_divertor_hfs },
      .cuts = { 1, 1 },
      .geometry = {
        .world = {0.0},
        .geometry_id = GKYL_GEOMETRY_TOKAMAK,
      ...
      .connections[1] = { // z-direction.
        ...
        { .bid = 4, .dir = 1, .edge = GKYL_PHYSICAL }, // Physical boundary.
      }
    }
  );
...
void mapc2p_vel_elc(double t, const double *vc, double *vp, void *ctx)
{
  struct gk_tcv_ctx *params = ctx;
  double vpar_max_elc = params->vpar_max_elc;
  double mu_max_elc = params->mu_max_elc;
...
void mapc2p_vel_ion(double t, const double *vc, double *vp, void *ctx)
{
  struct gk_tcv_ctx *params = ctx;
  double vpar_max_ion = params->vpar_max_ion;
  double mu_max_ion = params->mu_max_ion;
