...
double
qprofile(double r, double a_mid, double qSep, double sSep)
{
...
create_ctx(void)
{
  ...
  double q0 =
    qprofile(0. + r0, a_mid, qSep, sSep); // Magnetic safety factor in the center of domain.
...
main(int argc, char **argv)
{
  ...
  // field
  struct gkyl_gyrokinetic_field field = { .kperpSq = ctx.kperp * ctx.kperp };
