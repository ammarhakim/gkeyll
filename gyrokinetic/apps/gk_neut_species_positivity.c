...
static void gkns_pos_write_diags_disabled(gkyl_gyrokinetic_app *app, struct gk_neut_species *gkns,
                                          struct gk_positivity *pos, double tm, int frame)
{
  // Empty.
}

static void gkns_pos_deltaf_moms_calc(gkyl_gyrokinetic_app *app, struct gk_neut_species *gkns,
...
static void gkns_pos_deltaf_moms_clear(gkyl_gyrokinetic_app *app, struct gk_neut_species *gkns,
                                       struct gk_positivity *pos)
{
...
static void gkns_pos_write_diags_enabled(gkyl_gyrokinetic_app *app, struct gk_neut_species *gkns,
                                         struct gk_positivity *pos, double tm, int frame)
{
  // Package metadata.
...
static void gkns_pos_calc_integrated_diags_disabled(gkyl_gyrokinetic_app *app,
...
static void gkns_pos_deltaf_integ_moms_calc(gkyl_gyrokinetic_app *app, struct gk_neut_species *gkns,
                                            struct gk_positivity *pos)
{
  gk_neut_species_moment_calc(&pos->integ_moms, gkns->local, app->local, pos->fbuffer_ptr);
}

static void gkns_pos_deltaf_integ_moms_clear(gkyl_gyrokinetic_app *app,
                                             struct gk_neut_species *gkns,
                                             struct gk_positivity *pos)
{
...
static void gkns_pos_calc_integrated_diags_enabled(gkyl_gyrokinetic_app *app,
                                                   struct gk_neut_species *gkns,
                                                   struct gk_positivity *pos, double tm)
{
  struct timespec wst = gkyl_wall_clock();
...
static void gkns_pos_write_integrated_diags_disabled(gkyl_gyrokinetic_app *app,
                                                     struct gk_neut_species *gkns,
                                                     struct gk_positivity *pos)
{
  // Empty.
...
static void gkns_pos_write_integrated_diags_enabled(gkyl_gyrokinetic_app *app,
                                                    struct gk_neut_species *gkns,
                                                    struct gk_positivity *pos)
{
  struct timespec wst = gkyl_wall_clock();
...
void gkns_pos_apply_disabled(gkyl_gyrokinetic_app *app, struct gk_neut_species *species,
...
void gkns_pos_apply_enabled(gkyl_gyrokinetic_app *app, struct gk_neut_species *gkns,
                            struct gk_positivity *pos, struct gkyl_array *fbuffer,
                            struct gkyl_array *fout)
{
  struct timespec wtm = gkyl_wall_clock();
  ...
  // Shift each species.
  gkyl_positivity_shift_vlasov_advance(pos->shift_op_vlasov, &app->local, &gkns->local, fout,
                                       gkns->m0.marr, pos->delta_m0);
                                     ...
                                     struct gk_positivity *pos)
{
  ...
  if (pos->type) {
    ...
    pos->shift_op_vlasov = gkyl_positivity_shift_vlasov_new(app->basis, gkns->basis, gkns->grid,
