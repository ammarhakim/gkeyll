...
static void
gk_neut_species_bflux_clear_enabled(
...
static void
gk_neut_species_bflux_clear_disabled(
  gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux, struct gkyl_array **fin, double val)
{
  // Do nothing.
}
...
static void
gk_neut_species_bflux_scale_enabled(
  gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux, struct gkyl_array **fin, double val)
{
  for (int b = 0; b < bflux->num_boundaries; ++b)
    for (int m = 0; m < bflux->num_calc_moms; m++)
...
static void
gk_neut_species_bflux_scale_disabled(
  gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux, struct gkyl_array **fin, double val)
{
  // Do nothing.
}
...
static void
gk_neut_species_bflux_step_f_enabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
...
static void
gk_neut_species_bflux_step_f_disabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
  struct gkyl_array **fout, double dt, struct gkyl_array **fin)
{
  // Do nothing.
}
...
static void
gk_neut_species_bflux_set_enabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
...
static void
gk_neut_species_bflux_set_disabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
  struct gkyl_array **fout, double fac, struct gkyl_array **fin)
{
}
...
static void
gk_neut_species_bflux_accumulate_enabled(gkyl_gyrokinetic_app *app,
  struct gk_boundary_fluxes *bflux, struct gkyl_array **fout, double fac, struct gkyl_array **fin)
{
  for (int b = 0; b < bflux->num_boundaries; ++b)
    for (int m = 0; m < bflux->num_calc_moms; m++)
...
static void
gk_neut_species_bflux_accumulate_disabled(gkyl_gyrokinetic_app *app,
  struct gk_boundary_fluxes *bflux, struct gkyl_array **fout, double fac, struct gkyl_array **fin)
{
}
...
static void
gk_neut_species_bflux_combine_enabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
...
static void
gk_neut_species_bflux_combine_disabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
  struct gkyl_array **fout, double fac1, struct gkyl_array **fin1, double fac2,
  struct gkyl_array **fin2)
{
}
...
static void
gk_neut_species_bflux_copy_enabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
...
static void
gk_neut_species_bflux_copy_disabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
  struct gkyl_array **fout, struct gkyl_array **fin)
{
}
...
static void
gk_neut_species_bflux_rhs_disabled(gkyl_gyrokinetic_app *app, struct gk_boundary_fluxes *bflux,
  const struct gkyl_array *fin, struct gkyl_array *rhs)
{
}
...
static void
gk_neut_species_bflux_calc_moms_disabled(gkyl_gyrokinetic_app *app,
  struct gk_boundary_fluxes *bflux, const struct gkyl_array *rhs, struct gkyl_array **bflux_moms)
{
  // Do nothing.
}
...
static void
gk_neut_species_bflux_get_flux_mom_enabled(struct gk_boundary_fluxes *bflux, int dir,
  ...
  struct gkyl_array *out, const struct gkyl_range *out_rng)
{
  ...
  gkyl_array_copy_range_to_range(
    out, bflux_moms[b * bflux->num_calc_moms + mom_idx], out_rng, bflux->boundaries_conf_ghost[b]);
}

static void
gk_neut_species_bflux_get_flux_mom_disabled(struct gk_boundary_fluxes *bflux, int dir,
  enum gkyl_edge_loc edge, enum gkyl_distribution_moments mom_type, struct gkyl_array **bflux_moms,
  struct gkyl_array *out, const struct gkyl_range *out_rng)
{
  // Do nothing.
...
static void
gk_neut_species_bflux_get_flux_enabled(struct gk_boundary_fluxes *bflux, int dir,
...
static void
gk_neut_species_bflux_get_flux_disabled(struct gk_boundary_fluxes *bflux, int dir,
  enum gkyl_edge_loc edge, struct gkyl_array *out, const struct gkyl_range *out_rng)
{
}
...
void
gk_neut_species_bflux_calc_integrated_mom_enabled(
...
void
gk_neut_species_bflux_calc_voltime_integrated_mom(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux, double tm)
{
...
static void
gk_neut_species_bflux_append_integrated_mom(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux, double tm)
{
  struct timespec wst = gkyl_wall_clock();
...
static void
gk_neut_species_bflux_calc_integrated_mom_disabled(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux, double tm)
{
}

void
gk_neut_species_bflux_calc_integrated_mom(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux, double tm)
{
...
static void
gk_neut_species_bflux_write_integrated_mom_enabled(
  ...
  for (int b = 0; b < bflux->num_boundaries; ++b) {
    ...
    if ((edi == 0 && rank == 0) || (edi == 1 && rank == comm_size - 1)) {
      for (int m = 0; m < num_diag_int_mom; m++) {
        ...
        snprintf(
          fileNm, sizeof fileNm, fmt, app->name, gkns->info.name, vars[dir], edge[edi], mom_name);
...
static void
gk_neut_species_bflux_write_integrated_mom_disabled(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux)
{
}

void
gk_neut_species_bflux_write_integrated_mom(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux)
{
...
static void
gk_neut_species_bflux_write_mom_enabled(
...
static void
gk_neut_species_bflux_write_mom_disabled(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux, double tm, int frame)
{
}

void
gk_neut_species_bflux_write_mom(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux, double tm, int frame)
{
  ...
  struct gkyl_phase_diagnostics_inp add_moms_inp)
{
    ...
    for (int d = 0; d < app->cdim; ++d) {
      for (int e = 0; e < 2; ++e) {
        if (gkns->bc_is_np[d] &&
          ...
          bflux->boundaries_edge[bflux->num_boundaries] =
            e == 0 ? GKYL_LOWER_EDGE : GKYL_UPPER_EDGE;
          bflux->boundaries_conf_skin[bflux->num_boundaries] =
  ...
  if (bflux_type == GK_SPECIES_BFLUX_CALC_FLUX_STEP_MOMS ||
    ...
    if (num_diag_mom > 0)
      bflux->diag_mom_idx =
        bflux_unionize_moms(num_diag_mom, gkns->info.boundary_flux_diagnostics.diag_moments,
          &bflux->num_calc_moms, bflux->calc_mom_names);

    if (num_diag_int_mom > 0)
      bflux->diag_int_mom_idx = bflux_unionize_moms(num_diag_int_mom,
        gkns->info.boundary_flux_diagnostics.integrated_diag_moments, &bflux->num_calc_moms,
    ...
    if (need_hamil_ghost) {
      ...
      for (int b = 0; b < bflux->num_boundaries; ++b) {
        ...
        bflux->gfss_bc_op[b] = gkyl_bc_basic_gyrokinetic_new(bflux->boundaries_dir[b],
          bflux->boundaries_edge[b], GKYL_BC_GK_SPECIES_REFLECT, &gkns->basis, skin_r,
          bflux->boundaries_phase_ghost[b], 1, app->cdim, app->use_gpu);
...
void
gk_neut_species_bflux_read_voltime_integrated_mom(
  gkyl_gyrokinetic_app *app, void *species, struct gk_boundary_fluxes *bflux)
{
  const struct gk_neut_species *gkns = species;
