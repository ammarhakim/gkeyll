  ...
  struct gk_boundary_fluxes *bflux, double tm, int frame)
{
  ...
  struct gkyl_msgpack_map_elem desc[] = {
    { .key = "Description", .elem_type = GKYL_MP_STRING,
      .cval = "Velocity-space moment of the neutral species distribution function at the domain boundary, representing the particle and energy flux. For additional detail, documentation can be found at https://gkeyll.readthedocs.io/en/latest/" }
  };
