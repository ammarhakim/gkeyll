...
gks_rad_write_drag_enabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame)
{
  ...
  int io_meta_surfvpar_len[] = {app->io_meta_dg_len, rad->io_meta_surfvpar_len, app->gk_geom->io_meta_basic_len, 1};
  const struct gkyl_msgpack_map_elem* io_meta_surfvpar[] = {app->io_meta_dg, rad->io_meta_surfvpar, app->gk_geom->io_meta_basic, desc_nvnu_surf};
  ...
  int io_meta_nvnu_len[] = {app->io_meta_dg_len, gks->io_meta_grid_len, app->gk_geom->io_meta_basic_len, 1};
  const struct gkyl_msgpack_map_elem* io_meta_nvnu[] = {app->io_meta_dg, gks->io_meta_grid, app->gk_geom->io_meta_basic, desc_nvnu};
  ...
  int io_meta_surfmu_len[] = {app->io_meta_dg_len, rad->io_meta_surfmu_len, app->gk_geom->io_meta_basic_len, 1};
  const struct gkyl_msgpack_map_elem* io_meta_surfmu[] = {app->io_meta_dg, rad->io_meta_surfmu, app->gk_geom->io_meta_basic, desc_nvsqnu_surf};
  ...
  int io_meta_nvsqnu_len[] = {app->io_meta_dg_len, gks->io_meta_grid_len, app->gk_geom->io_meta_basic_len, 1};
  const struct gkyl_msgpack_map_elem* io_meta_nvsqnu[] = {app->io_meta_dg, gks->io_meta_grid, app->gk_geom->io_meta_basic, desc_nvsqnu};
...
gks_rad_write_emissivity_enabled(gkyl_gyrokinetic_app* app, struct gk_species *gks, double tm, int frame)
{
  ...
  const struct gkyl_msgpack_map_elem* io_meta[] = {app->io_meta_dg, app->gk_geom->io_meta_basic, desc_emissivity};
