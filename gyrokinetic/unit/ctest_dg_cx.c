...
void test_coll_cx_d(bool use_gpu)
{
  ...
  gkyl_proj_on_basis *proj_n =
    gkyl_proj_on_basis_new(&confGrid, &basis, poly_order + 1, 1, eval_n, NULL);
  gkyl_proj_on_basis *proj_T_over_m_ion =
    gkyl_proj_on_basis_new(&confGrid, &basis, poly_order + 1, 1, eval_T_over_m_ion, NULL);
  gkyl_proj_on_basis *proj_T_over_m_neut =
    gkyl_proj_on_basis_new(&confGrid, &basis, poly_order + 1, 1, eval_T_over_m_neut, NULL);
