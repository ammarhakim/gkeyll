...
TEST_LIST = {
  //{ "test_cartesian_2x_z_ho", test_cartesian_2x_z_ho},
  //{ "test_cartesian_2x_x_ho", test_cartesian_2x_x_ho},
  { "test_cyl_cart_2x_z_ho", test_cyl_cart_2x_z_ho},
  { NULL, NULL },
};
