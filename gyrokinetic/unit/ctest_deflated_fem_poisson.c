...
TEST_LIST = {
  { "test_zind_dd_ho", test_zind_dd_ho},
  { "test_simplez_dd_ho", test_simplez_dd_ho},
  { "test_zdep_nd_ho", test_zdep_nd_ho},
  { "test_3x_dd_dd_ho", test_3x_dd_dd_ho},
  { NULL, NULL },
};
