...
test_1x1v(int polyOrder, bool use_gpu)
{
  ...
  gkyl_proj_on_basis *projDistf =
    gkyl_proj_on_basis_new(&grid, &basis, poly_order + 1, 1, distf_1x1v, NULL);
  ...
  double *m00 = gkyl_array_fetch(m0_ho, 0 + confGhost[0]);
  double *m01 = gkyl_array_fetch(m0_ho, 1 + confGhost[0]);
  ...
  double *m11 = gkyl_array_fetch(m1_ho, 1 + confGhost[0]);
  double *m12 = gkyl_array_fetch(m1_ho, 2 + confGhost[0]);
  double *m13 = gkyl_array_fetch(m1_ho, 3 + confGhost[0]);
  double *m20 = gkyl_array_fetch(m2_ho, 0 + confGhost[0]);
  double *m21 = gkyl_array_fetch(m2_ho, 1 + confGhost[0]);
  double *m22 = gkyl_array_fetch(m2_ho, 2 + confGhost[0]);
  double *m23 = gkyl_array_fetch(m2_ho, 3 + confGhost[0]);
  ...
  gkyl_mom_type_release(M1_t);
  gkyl_mom_type_release(M2_t);
...
test_1x2v(int poly_order, bool use_gpu)
{
  ...
  distf_ho = use_gpu ? mkarr(false, distf->ncomp, distf->size) : gkyl_array_acquire(distf);
  gkyl_proj_on_basis *projDistf =
    gkyl_proj_on_basis_new(&grid, &basis, poly_order + 1, 1, distf_1x2v, NULL);
  gkyl_proj_on_basis_advance(projDistf, 0.0, &local, distf_ho);
  gkyl_array_copy(distf, distf_ho);
...
test_2x2v(int poly_order, bool use_gpu)
{
  ...
  distf_ho = use_gpu ? mkarr(false, distf->ncomp, distf->size) : gkyl_array_acquire(distf);
  gkyl_proj_on_basis *projDistf =
    gkyl_proj_on_basis_new(&grid, &basis, poly_order + 1, 1, distf_2x2v, NULL);
  gkyl_proj_on_basis_advance(projDistf, 0.0, &local, distf_ho);
  gkyl_array_copy(distf, distf_ho);
  ...
  if (poly_order == 1) {
    ...
    double m0Correct[] = {
      5.648341168299724e+01,
      2.250387513900885e+01,
      3.652502205171847e+01,
      1.335144639473130e+01,
      -7.166399139585262e+00,
      7.761081311319963e+00,
      -5.437466693389656e+00,
      2.161243931947423e+00,
      2.224236975980227e+02,
      6.521607861574371e+01,
      4.094337722353598e+01,
      5.582134934124797e+00,
      -4.387646236656694e+01,
      -8.976042695293010e+00,
      -1.237376484382488e+01,
      -2.753498001080819e+00,
      2.224236975980228e+02,
      6.521607861574371e+01,
      -4.094337722353598e+01,
      -5.582134934124794e+00,
      -4.387646236656691e+01,
      -8.976042695293000e+00,
      1.237376484382486e+01,
      -2.753498001080819e+00,
      5.648341168299725e+01,
      2.250387513900884e+01,
      -3.652502205171847e+01,
      -1.335144639473129e+01,
      -7.166399139585268e+00,
      7.761081311319959e+00,
      5.437466693389650e+00,
      2.161243931947424e+00,
      7.646435675172015e+01,
      -3.325734694746438e+00,
      4.121233955674857e+01,
      -4.386344478763552e+00,
      1.342837549799004e-01,
      4.123263549958735e+00,
      5.440652066518922e-01,
      -2.190342820971765e+00,
      1.406410562141511e+02,
      -5.667019945920631e+01,
      -1.815281995189654e+01,
      -2.239122325134061e+01,
