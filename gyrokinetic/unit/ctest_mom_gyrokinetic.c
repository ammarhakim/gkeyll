...
void test_mom_gyrokinetic_ho()
{
  ...
  struct gkyl_mom_type *m2 = gkyl_mom_gyrokinetic_new(&confBasis, &basis, &confLocal, mass, charge,
                                                      gvm, gk_geom, NULL, GKYL_F_MOMENT_M2, false);
...
void test_2x2v(int poly_order, bool use_gpu)
{
  ...
  if (poly_order == 1) {
    ...
    double m2Correct[] = {
      1.7255254110177472e+02,  8.6614534630645736e+01,  1.1063403695082026e+02,
    ...
    double m2Correct[] = {
      1.7748191603964662e+02,  8.7096319372964388e+01,  1.1429246468805900e+02,
