...
TEST_LIST = {
  //{ "test_fixed_z_ho", test_fixed_z_ho},
  { "test_shaped_plate_ho", test_shaped_plate_ho},
  { "test_lower_ho", test_lower_ho},
  { "test_middle_ho", test_middle_ho},
  { "test_upper_ho", test_upper_ho},
  { NULL, NULL },
};
