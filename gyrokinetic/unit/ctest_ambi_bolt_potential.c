...
test_ambi_bolt_init_1x()
{
  ...
  struct gkyl_ambi_bolt_potential *ambi =
    gkyl_ambi_bolt_potential_new(&grid, basis, mass_e, charge_e, temp_e, use_gpu);
...
test_ambi_bolt_sheath_calc_1x()
{
  ...
  gkyl_proj_on_basis *proj_one =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_one, NULL);
...
test_ambi_bolt_phi_calc_1x()
{
  ...
  gkyl_ambi_bolt_potential_phi_calc(ambi, &local, &local_ext, M0, sheath_vals[0], phi);
...
test_ambi_bolt_sheath_calc_1x_hat()
{
  ...
  gkyl_proj_on_basis *proj_one =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_one, NULL);
  gkyl_proj_on_basis *proj_hat =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_hat, NULL);
...
test_ambi_bolt_sheath_calc_2x_hat()
{
  ...
  gkyl_proj_on_basis *proj_one =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_one, NULL);
  gkyl_proj_on_basis *proj_hat =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_hat_2x, NULL);
...
test_ambi_bolt_sheath_calc_2x_ramp_sheath()
{
  ...
  gkyl_proj_on_basis *proj_one =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_one, NULL);
  gkyl_proj_on_basis *proj_ramp =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_ramp_sheath_2x, NULL);
...
test_ambi_bolt_phi_calc_2x_one()
{
  ...
  gkyl_ambi_bolt_potential_phi_calc(ambi, &local, &local_ext, M0, sheath_vals[off], phi);
...
test_ambi_bolt_phi_calc_2x_parabola()
{
  ...
  gkyl_proj_on_basis *proj_one =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_one, NULL);
  gkyl_proj_on_basis *proj_func =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_parabola_2x, NULL);
...
test_ambi_bolt_phi_calc_3x_parabola()
{
  ...
  gkyl_proj_on_basis *proj_one =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_one, NULL);
  gkyl_proj_on_basis *proj_func =
    gkyl_proj_on_basis_new(&grid, basis, poly_order + 1, 1, eval_parabola_3x, NULL);
