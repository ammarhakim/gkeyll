...
void test_3x2v_p1_gk_ho() { test_3x2v_gk(1, false); }

#ifdef GKYL_HAVE_CUDA
void test_1x2v_p1_gk_dev() { test_1x2v_gk(1, true); }
void test_3x2v_p1_gk_dev() { test_3x2v_gk(1, true); }
#endif

TEST_LIST = {
  { "test_1x2v_p1_gk_ho", test_1x2v_p1_gk_ho },
  { "test_3x2v_p1_gk_ho", test_3x2v_p1_gk_ho },

#ifdef GKYL_HAVE_CUDA
  { "test_1x2v_p1_gk_dev", test_1x2v_p1_gk_dev },
  { "test_3x2v_p1_gk_dev", test_3x2v_p1_gk_dev },
#endif
  { NULL, NULL },
};
