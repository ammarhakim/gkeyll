...
*/
GKYL_CU_D void gkyl_gr_euler_flux(double gas_gamma, const double q[71], double flux[71]);
...
*/
GKYL_CU_D void gkyl_gr_euler_prim_vars(double gas_gamma, const double q[71], double v[71]);
...
*/
GKYL_CU_D void gkyl_gr_euler_inv_spatial_metric(const double q[71], double ***inv_spatial_metric);
...
*/
GKYL_CU_D void gkyl_gr_euler_stress_energy_tensor(double gas_gamma, const double q[71],
...
*/
GKYL_CU_D static inline double gkyl_gr_euler_max_abs_speed(double gas_gamma, const double q[71]);
...
*/
GKYL_CU_D static void gr_euler_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void gr_euler_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc,
                                       const double *skin, double *GKYL_RESTRICT ghost, void *ctx);
...
*/
GKYL_CU_D static inline void gr_euler_cons_to_diag(const struct gkyl_wv_eqn *eqn, const double *qin,
                                                   double *diag);
...
*/
GKYL_CU_DH static inline void gr_euler_source(const struct gkyl_wv_eqn *eqn, const double *qin,
                                              double *sout);
