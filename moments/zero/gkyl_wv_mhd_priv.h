...
/**
* Boundary condition function for applying wall boundary conditions for the ideal MHD equations.
*
* @param eqn Base equation object.
...
/**
* Boundary condition function for applying no-slip boundary conditions for the ideal MHD equations.
*
* @param eqn Base equation object.
* @param t Current simulation time.
...
/**
* Determine whether invariant domain of the ideal MHD equations is satisfied.
*
* @param eqn Base equation object.
* @param q Conserved variable vector.
...
/**
* Free ideal MHD equations object.
*
* @param ref Reference counter for ideal MHD equations.
*/
void
