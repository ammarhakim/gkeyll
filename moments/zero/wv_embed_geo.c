...
gkyl_wv_embed_geo_new(enum gkyl_embed_bc_type bc_type, enum gkyl_embed_type type,
  void *mask_func, wv_embed_bc_t embed_bc, wv_embed_func_t embed_func, void *ctx)
{
