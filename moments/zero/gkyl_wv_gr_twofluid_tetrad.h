...
struct gkyl_wv_gr_twofluid_tetrad_inp {
...
/**
* Create a new general relativistic two-fluid equations object in the tetrad basis with ideal gas equation of state.
*
...
* @return Pointer to the general relativistic two-fluid equations object in the tetrad basis with ideal gas equation of state.
*/
struct gkyl_wv_eqn *
...
/**
* Create a new general relativistic two-fluid equations object in the tetrad basis with ideal gas equation of state, from an input context struct.
*
...
* Get electron mass.
*
* @param eqn General relativistic two-fluid equations object in the tetrad basis with ideal gas equation of state.
