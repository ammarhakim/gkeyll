...
*/
GKYL_CU_D static inline double gkyl_iso_euler_max_abs_speed(double vt, const double *q);
...
*/
GKYL_CU_D void gkyl_iso_euler_flux(double vt, const double *q, double *flux);
...
*/
GKYL_CU_D static void iso_euler_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void iso_euler_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc,
                                        const double *skin, double *GKYL_RESTRICT ghost, void *ctx);
...
*/
GKYL_CU_D static inline void iso_euler_cons_to_diag(const struct gkyl_wv_eqn *eqn,
...
*/
GKYL_CU_DH static inline void iso_euler_source(const struct gkyl_wv_eqn *eqn, const double *qin,
                                               double *sout);
