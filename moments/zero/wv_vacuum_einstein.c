...
void
gkyl_vacuum_einstein_flux(double excision_threshold, enum gkyl_spacetime_slicing spacetime_slicing,
  enum gkyl_spacetime_evolution spacetime_evolution, const double q[64], double flux[64])
{
...
gkyl_vacuum_einstein_max_abs_speed(
...
static void
vacuum_einstein_wall(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
...
struct gkyl_wv_eqn *
gkyl_wv_vacuum_einstein_new(double excision_threshold,
