...
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_flux(double gas_gamma, double light_speed, double b_fact,
...
* @param flux Flux vector in direction 'dir' (output).
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_flux_correction(double gas_gamma, double light_speed,
                                                  double b_fact, const double q[75],
                                                  const double flux_sr[75], double flux_gr[75]);
...
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_prim_vars(double gas_gamma, const double q[75], double v[75]);
...
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_inv_spatial_metric(const double q[75],
...
*/
GKYL_CU_D void gkyl_gr_mhd_tetrad_stress_energy_tensor(double gas_gamma, const double q[75],
...
*/
GKYL_CU_D static inline double gkyl_gr_mhd_tetrad_max_abs_speed(double gas_gamma,
                                                                const double q[71]);
...
/**
* Boundary condition function for applying wall boundary conditions for the general relativistic magnetohydrodynamics equations in the tetrad basis with ideal gas equation of state.
*
* @param eqn Base equation object.
...
*/
GKYL_CU_D static void gr_mhd_tetrad_tetrad_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
                                                const double *skin, double *GKYL_RESTRICT ghost,
                                                void *ctx);

/**
* Boundary condition function for applying no-slip boundary conditions for the general relativistic magnetohydrodynamics equations in the tetrad basis with ideal gas equation of state.
*
* @param eqn Base equation object.
* @param t Current simulation time.
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void gr_mhd_tetrad_tetrad_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc,
                                                   const double *skin, double *GKYL_RESTRICT ghost,
                                                   void *ctx);
...
/**
* Determine whether invariant domain of the general relativistic magnetohydrodynamics equations in the tetrad basis with ideal gas equation of state is satisfied.
*
* @param eqn Base equation object.
* @param q Conserved variable vector.
...
*/
GKYL_CU_D static inline void gr_mhd_tetrad_cons_to_diag(const struct gkyl_wv_eqn *eqn,
...
*/
GKYL_CU_DH static inline void gr_mhd_tetrad_source(const struct gkyl_wv_eqn *eqn, const double *qin,
                                                   double *sout);

/**
* Free general relativistic magnetohydrodynamics equations object in the tetrad basis with ideal gas equation of state.
*
* @param ref Reference counter for general relativistic magnetohydrodynamics equations in the tetrad basis with ideal gas equation of state.
*/
