...
*/
GKYL_CU_D void gkyl_gr_maxwell_tetrad_flux(double light_speed, double e_fact, double b_fact,
...
*/
GKYL_CU_D void gkyl_gr_maxwell_tetrad_flux_correction(double light_speed, double e_fact,
                                                      double b_fact, const double q[26],
                                                      const double flux_sr[26], double flux_gr[26]);
...
*/
GKYL_CU_D static inline double gkyl_gr_maxwell_tetrad_max_abs_speed(double light_speed,
                                                                    const double q[26]);
...
*/
GKYL_CU_D static void gr_maxwell_tetrad_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
*/
GKYL_CU_D static inline void gr_maxwell_tetrad_cons_to_diag(const struct gkyl_wv_eqn *eqn,
...
*/
GKYL_CU_DH static inline void gr_maxwell_tetrad_source(const struct gkyl_wv_eqn *eqn,
