...
maxwell_wall(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
...
*/
GKYL_CU_DH static void
maxwell_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
  double *GKYL_RESTRICT ghost, void *ctx)
{
...
*/
GKYL_CU_DH static inline void maxwell_source(
