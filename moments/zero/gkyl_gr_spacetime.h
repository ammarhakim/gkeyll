...
typedef void (*gr_spatial_metric_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
...
typedef void (*gr_spacetime_metric_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                             const double t, const double x, const double y,
...
typedef void (*gr_spatial_inv_metric_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                               const double t, const double x, const double y,
...
typedef void (*gr_spacetime_inv_metric_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                                 const double t, const double x, const double y,
                                                 const double z,
...
typedef void (*gr_spatial_metric_det_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
...
typedef void (*gr_spacetime_metric_det_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                          const double x, const double y, const double z,
...
typedef void (*gr_spatial_metric_tensor_der_t)(const struct gkyl_gr_spacetime *spacetime,
                                               const double t, const double x, const double y,
...
typedef void (*gr_spacetime_metric_tensor_der_t)(const struct gkyl_gr_spacetime *spacetime,
                                                 const double t, const double x, const double y,
...
typedef void (*gr_lapse_function_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                    const double x, const double y, const double z,
                                    double *lapse_function);

// Function pointer to compute the rank-1 shift vector at a given point in spacetime.
typedef void (*gr_shift_vector_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                  const double x, const double y, const double z,
                                  double **shift_vector);

// Function pointer to compute the rank-1 (spatial) partial derivative of the lapse function at a given point in spacetime.
typedef void (*gr_lapse_function_der_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                        const double x, const double y, const double z,
                                        const double dx, const double dy, const double dz,
                                        double **lapse_function_der);

// Function pointer to compute the rank-2 (spatial) partial derivative of the shift vector at a given point in spacetime.
typedef void (*gr_shift_vector_der_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                      const double x, const double y, const double z,
                                      const double dx, const double dy, const double dz,
                                      double ***shift_vector_der);

// Function pointer to compute the rank-3 (spatial) Christoffel symbols at a given point in spacetime.
typedef void (*gr_spatial_christoffel_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                         const double x, const double y, const double z,
                                         const double dx, const double dy, const double dz,
...
typedef void (*gr_spacetime_christoffel_t)(const struct gkyl_gr_spacetime *spacetime,
                                           const double t, const double x, const double y,
                                           const double z, const double dt, const double dx,
                                           const double dy, const double dz,
...
typedef void (*gr_spatial_riemann_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                            const double t, const double x, const double y,
                                            const double z, const double dx, const double dy,
...
typedef void (*gr_spacetime_riemann_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                              const double t, const double x, const double y,
                                              const double z, const double dt, const double dx,
                                              const double dy, const double dz,
...
typedef void (*gr_spatial_ricci_tensor_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                          const double x, const double y, const double z,
                                          const double dx, const double dy, const double dz,
...
typedef void (*gr_spacetime_ricci_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                            const double t, const double x, const double y,
                                            const double z, const double dt, const double dx,
                                            const double dy, const double dz,
...
typedef void (*gr_spatial_ricci_scalar_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                          const double x, const double y, const double z,
                                          const double dx, const double dy, const double dz,
...
typedef void (*gr_spacetime_ricci_scalar_t)(const struct gkyl_gr_spacetime *spacetime,
                                            const double t, const double x, const double y,
                                            const double z, const double dt, const double dx,
                                            const double dy, const double dz,
...
typedef void (*gr_spatial_weyl_tensor_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                         const double x, const double y, const double z,
                                         const double dx, const double dy, const double dz,
...
typedef void (*gr_spacetime_weyl_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                           const double t, const double x, const double y,
                                           const double z, const double dt, const double dx,
                                           const double dy, const double dz,
...
typedef void (*gr_extrinsic_curvature_tensor_t)(const struct gkyl_gr_spacetime *spacetime,
                                                const double t, const double x, const double y,
                                                const double z, const double dx, const double dy,
                                                const double dz,
...
typedef void (*gr_conformal_factor_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                      const double x, const double y, const double z,
                                      double *conformal_factor);

// Function pointer to compute the BSSN conformal factor at a given point in spacetime.
typedef void (*gr_bssn_conformal_factor_t)(const struct gkyl_gr_spacetime *spacetime,
                                           const double t, const double x, const double y,
                                           const double z, double *bssn_conformal_factor);

// Function pointer to compute the rank-1 (spatial) partial derivative of the conformal factor function at a given point in spacetime.
typedef void (*gr_conformal_factor_der_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                          const double x, const double y, const double z,
                                          const double dx, const double dy, const double dz,
                                          double **conformal_factor_der);

// Function pointer to compute the rank-1 (spatial) partial derivative of the BSSN conformal factor function at a given point in spacetime.
typedef void (*gr_bssn_conformal_factor_der_t)(const struct gkyl_gr_spacetime *spacetime,
                                               const double t, const double x, const double y,
                                               const double z, const double dx, const double dy,
                                               const double dz, double **bssn_conformal_factor_der);

// Function pointer to compute the rank-2 (spatial) second partial derivative of the conformal factor function at a given point in spacetime.
typedef void (*gr_conformal_factor_der2_t)(const struct gkyl_gr_spacetime *spacetime,
                                           const double t, const double x, const double y,
                                           const double z, const double dx, const double dy,
                                           const double dz, double ***conformal_factor_der2);

// Function pointer to compute the rank-2 (spatial) second partial derivative of the BSSN conformal factor function at a given point in spacetime.
typedef void (*gr_bssn_conformal_factor_der2_t)(const struct gkyl_gr_spacetime *spacetime,
                                                const double t, const double x, const double y,
                                                const double z, const double dx, const double dy,
                                                const double dz,
...
typedef void (*gr_excision_region_t)(const struct gkyl_gr_spacetime *spacetime, const double t,
                                     const double x, const double y, const double z,
                                     bool *in_excision_region);

struct gkyl_gr_spacetime {
  gr_spatial_metric_tensor_t spatial_metric_tensor_func; // Function to compute spatial metric tensor.
  gr_spacetime_metric_tensor_t
    spacetime_metric_tensor_func; // Function to compute spacetime metric tensor.

  gr_spatial_inv_metric_tensor_t
    spatial_inv_metric_tensor_func; // Function to compute inverse spatial metric tensor.
  gr_spacetime_inv_metric_tensor_t
    spacetime_inv_metric_tensor_func; // Function to compute inverse spacetime metric tensor.

  gr_spatial_metric_det_t spatial_metric_det_func; // Function to compute spatial metric determinant.
  gr_spacetime_metric_det_t
    spacetime_metric_det_func; // Function to compute spacetime metric determinant.

  gr_spatial_metric_tensor_der_t
    spatial_metric_tensor_der_func; // Function to compute partial derivative of spatial metric tensor.
  gr_spacetime_metric_tensor_der_t
    spacetime_metric_tensor_der_func; // Function to compute partial derivative of spacetime metric tensor.
  ...
  gr_lapse_function_der_t
    lapse_function_der_func; // Function to compute partial derivative of lapse function.
  gr_shift_vector_der_t
    shift_vector_der_func; // Function to compute partial derivative of shift vector.

  gr_spatial_christoffel_t
    spatial_christoffel_func; // Function to compute spatial Christoffel symbols.
  gr_spacetime_christoffel_t
    spacetime_christoffel_func; // Function to compute spacetime Christoffel symbols.

  gr_spatial_riemann_tensor_t
    spatial_riemann_tensor_func; // Function to compute spatial Riemann curvature tensor.
  gr_spacetime_riemann_tensor_t
    spacetime_riemann_tensor_func; // Function to compute spacetime Riemann curvature tensor.

  gr_spatial_ricci_tensor_t
    spatial_ricci_tensor_func; // Function to compute spatial Ricci curvature tensor.
  gr_spacetime_ricci_tensor_t
    spacetime_ricci_tensor_func; // Function to compute spacetime Ricci curvature tensor.

  gr_spatial_ricci_scalar_t
    spatial_ricci_scalar_func; // Function to compute spatial Ricci scalar curvature.
  gr_spacetime_ricci_scalar_t
    spacetime_ricci_scalar_func; // Function to compute spacetime Ricci scalar curvature.

  gr_spatial_weyl_tensor_t
    spatial_weyl_tensor_func; // Function to compute spatial Weyl curvature tensor.
  gr_spacetime_weyl_tensor_t
    spacetime_weyl_tensor_func; // Function to compute spacetime Weyl curvature tensor.

  gr_extrinsic_curvature_tensor_t
    extrinsic_curvature_tensor_func; // Function to compute extrinsic curvature tensor.
  ...
  gr_conformal_factor_der_t
    conformal_factor_der_func; // Function to compute partial derivative of conformal factor.
  gr_bssn_conformal_factor_der_t
    bssn_conformal_factor_der_func; // Function to compute partial derivative of BSSN conformal factor.

  gr_conformal_factor_der2_t
    conformal_factor_der2_func; // Function to compute second partial derivative of conformal factor.
  gr_bssn_conformal_factor_der2_t
    bssn_conformal_factor_der2_func; // Function to compute second partial derivative of BSSN conformal factor.

  gr_excision_region_t
    excision_region_func; // Function to determine whether point lies within excision region.
...
gkyl_gr_spatial_metric_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                              const double x, const double y, const double z,
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_metric_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                                const double x, const double y, const double z,
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spatial_inv_metric_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                                  const double x, const double y, const double z,
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_inv_metric_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                                    const double x, const double y, const double z,
                                    double ***spacetime_inv_metric_tensor);
...
*/
GKYL_CU_DH static inline void gkyl_gr_spatial_metric_det(const struct gkyl_gr_spacetime *spacetime,
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_metric_det(const struct gkyl_gr_spacetime *spacetime, const double t,
                             const double x, const double y, const double z,
                             double *spacetime_metric_det);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spatial_metric_tensor_der(const struct gkyl_gr_spacetime *spacetime, const double t,
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_metric_tensor_der(const struct gkyl_gr_spacetime *spacetime, const double t,
                                    const double x, const double y, const double z, const double dt,
                                    const double dx, const double dy, const double dz,
                                    double ****spacetime_metric_tensor_der);
...
*/
GKYL_CU_DH static inline void gkyl_gr_lapse_function(const struct gkyl_gr_spacetime *spacetime,
                                                     const double t, const double x, const double y,
...
*/
GKYL_CU_DH static inline void gkyl_gr_shift_vector(const struct gkyl_gr_spacetime *spacetime,
                                                   const double t, const double x, const double y,
...
*/
GKYL_CU_DH static inline void
gkyl_gr_lapse_function_der(const struct gkyl_gr_spacetime *spacetime, const double t,
                           const double x, const double y, const double z, const double dx,
                           const double dy, const double dz, double **lapse_function_der);
...
*/
GKYL_CU_DH static inline void gkyl_gr_shift_vector_der(const struct gkyl_gr_spacetime *spacetime,
                                                       const double t, const double x,
                                                       const double y, const double z,
...
/**
* Compute the rank-3 (spatial) Christoffel symbols at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spatial_christoffel(const struct gkyl_gr_spacetime *spacetime, const double t,
                            const double x, const double y, const double z, const double dx,
                            const double dy, const double dz, double ****spatial_christoffel);

/**
* Compute the rank-3 (spacetime) Christoffel symbols at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_christoffel(const struct gkyl_gr_spacetime *spacetime, const double t,
                              const double x, const double y, const double z, const double dt,
                              const double dx, const double dy, const double dz,
                              double ****spacetime_christoffel);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spatial_riemann_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                               const double x, const double y, const double z, const double dx,
                               const double dy, const double dz,
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_riemann_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                                 const double x, const double y, const double z, const double dt,
                                 const double dx, const double dy, const double dz,
                                 double *****spacetime_riemann_tensor);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spatial_ricci_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                             const double x, const double y, const double z, const double dx,
                             const double dy, const double dz, double ***spatial_ricci_tensor);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_ricci_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                               const double x, const double y, const double z, const double dt,
                               const double dx, const double dy, const double dz,
                               double ***spacetime_ricci_tensor);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spatial_ricci_scalar(const struct gkyl_gr_spacetime *spacetime, const double t,
                             const double x, const double y, const double z, const double dx,
                             const double dy, const double dz, double *spatial_ricci_scalar);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_ricci_scalar(const struct gkyl_gr_spacetime *spacetime, const double t,
                               const double x, const double y, const double z, const double dt,
                               const double dx, const double dy, const double dz,
                               double *spacetime_ricci_scalar);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spatial_weyl_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                            const double x, const double y, const double z, const double dx,
                            const double dy, const double dz, double *****spatial_weyl_tensor);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_spacetime_weyl_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                              const double x, const double y, const double z, const double dt,
                              const double dx, const double dy, const double dz,
                              double *****spacetime_weyl_tensor);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_extrinsic_curvature_tensor(const struct gkyl_gr_spacetime *spacetime, const double t,
                                   const double x, const double y, const double z, const double dx,
                                   const double dy, const double dz,
                                   double ***extrinsic_curvature_tensor);
...
*/
GKYL_CU_DH static inline void gkyl_gr_conformal_factor(const struct gkyl_gr_spacetime *spacetime,
                                                       const double t, const double x,
                                                       const double y, const double z,
                                                       double *conformal_factor);
...
*/
GKYL_CU_DH static inline void
gkyl_gr_bssn_conformal_factor(const struct gkyl_gr_spacetime *spacetime, const double t,
                              const double x, const double y, const double z,
                              double *bssn_conformal_factor);

/**
* Compute the rank-1 (spatial) partial derivative of the conformal factor at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
*/
GKYL_CU_DH static inline void
gkyl_gr_conformal_factor_der(const struct gkyl_gr_spacetime *spacetime, const double t,
                             const double x, const double y, const double z, const double dx,
                             const double dy, const double dz, double **conformal_factor_der);

/**
* Compute the rank-1 (spatial) partial derivative of the BSSN conformal factor at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
*/
GKYL_CU_DH static inline void
gkyl_gr_bssn_conformal_factor_der(const struct gkyl_gr_spacetime *spacetime, const double t,
                                  const double x, const double y, const double z, const double dx,
                                  const double dy, const double dz,
                                  double **bssn_conformal_factor_der);

/**
* Compute the rank-2 (spatial) second partial derivative of the conformal factor at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
*/
GKYL_CU_DH static inline void
gkyl_gr_conformal_factor_der2(const struct gkyl_gr_spacetime *spacetime, const double t,
                              const double x, const double y, const double z, const double dx,
                              const double dy, const double dz, double ***conformal_factor_der2);

/**
* Compute the rank-2 (spatial) second partial derivative of the BSSN conformal factor at a given point in spacetime.
*
* @param spacetime Base spacetime object.
* @param t Time coordinate.
* @param x Spatial coordinate (x-direction).
...
*/
GKYL_CU_DH static inline void
gkyl_gr_bssn_conformal_factor_der2(const struct gkyl_gr_spacetime *spacetime, const double t,
                                   const double x, const double y, const double z, const double dx,
                                   const double dy, const double dz,
                                   double ***bssn_conformal_factor_der2);
...
*/
GKYL_CU_DH static inline void gkyl_gr_excision_region(const struct gkyl_gr_spacetime *spacetime,
                                                      const double t, const double x,
                                                      const double y, const double z,
                                                      bool *in_excision_region);
