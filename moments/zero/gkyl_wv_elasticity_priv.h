...
/**
* Boundary condition function for applying wall boundary conditions for the nonlinear elasticity equations object with Godunov-Romenskii hyperelastic equation of state.
*
* @param eqn Base equation object.
...
/**
* Boundary condition function for applying no-slip boundary conditions for the nonlinear elasticity equations object with Godunov-Romenskii hyperelastic equation of state.
*
* @param eqn Base equation object.
* @param t Current simulation time.
...
/**
* Determine whether invariant domain of the nonlinear elasticity equations object with Godunov-Romenskii hyperelastic equation of state is satisfied.
*
* @param eqn Base equation object.
* @param q Conserved variable vector.
...
GKYL_CU_DH
static inline void
elasticity_source(const struct gkyl_wv_eqn* eqn, const double* qin, double* sout);
