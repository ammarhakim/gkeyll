...
*
* @param num_species Number of distinct species in the domain.
* @param rho_ref_s Reference densities (unstress configuration) for each species in the domain.
* @param T_ref_s Reference temperatures (unstressed configuration) for each species in the domain.
* @param sound_speed_s Sound speeds (speed of pressure waves) for each species in the domain.
* @param shear_speed_s Shear speeds (speed of shear waves) for each species in the domain.
* @param heat_capacity_s Specific heat capacities at constant volume for each species in the domain.
...
/**
* Boundary condition function for applying wall boundary conditions for the nonlinear elasticity Riemann ghost fluid equations object with Godunov-Romenskii hyperelastic equation of state.
*
* @param eqn Base equation object.
...
/**
* Boundary condition function for applying no-slip boundary conditions for the nonlinear elasticity Riemann ghost fluid equations object with Godunov-Romenskii hyperelastic equation of state.
*
* @param eqn Base equation object.
* @param t Current simulation time.
...
/**
* Determine whether invariant domain of the nonlinear elasticity Riemann ghost fluid equations object with Godunov-Romenskii hyperelastic equation of state is satisfied.
*
* @param eqn Base equation object.
* @param q Conserved variable vector.
