...
var_setup(const gkyl_ten_moment_grad_closure *gces, int start, int end, const double *fluid_d[],
...
GKYL_CU_D static void
calc_unmag_heat_flux_1d(const gkyl_ten_moment_grad_closure *gces, const double *fluid_d[],
  double *cflrate, double dt, double *q)
{
...
GKYL_CU_D static void
calc_unmag_heat_flux_2d(const gkyl_ten_moment_grad_closure *gces, const double *fluid_d[],
  double *cflrate, double dt, double *q)
{
  const int ndim = gces->ndim;
  double rho_avg = 0.0;
...
GKYL_CU_D static void
calc_unmag_heat_flux_3d(const gkyl_ten_moment_grad_closure *gces, const double *fluid_d[],
  double *cflrate, double dt, double *q)
{
  const int ndim = gces->ndim;
  double rho_avg = 0.0;
