...
extern inline double gkyl_wv_eqn_waves(const struct gkyl_wv_eqn *eqn, enum gkyl_wv_flux_type type,
                                       ...
                                       const double phil, const double phir, double *waves,
                                       double *speeds);
...
extern inline void gkyl_wv_eqn_qfluct(const struct gkyl_wv_eqn *eqn, enum gkyl_wv_flux_type type,
                                      ...
                                      const double phir, const double *waves, const double *speeds,
...
extern inline double gkyl_wv_eqn_flux_jump(const struct gkyl_wv_eqn *eqn, const double *ql,
...
extern inline void gkyl_wv_eqn_rotate_to_local(const struct gkyl_wv_eqn *eqn, const double *tau1,
                                               const double *tau2, const double *norm,
                                               const double *GKYL_RESTRICT qglobal,
                                               double *GKYL_RESTRICT qlocal);

extern inline void gkyl_wv_eqn_rotate_to_global(const struct gkyl_wv_eqn *eqn, const double *tau1,
                                                const double *tau2, const double *norm,
                                                const double *GKYL_RESTRICT qlocal,
                                                double *GKYL_RESTRICT qglobal);

extern inline void gkyl_wv_eqn_source(const struct gkyl_wv_eqn *eqn, const double *qin,
                                      double *sout);
