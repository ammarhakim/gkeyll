...
static inline double calc_sym_gradx_2D(double dx, double a_ll, double a_lu, double a_ul,
                                       double a_uu)
{
  return (a_ul + a_uu - a_ll - a_lu) / (2 * dx);
}

static inline double calc_sym_grady_2D(double dy, double a_ll, double a_lu, double a_ul,
                                       double a_uu)
{
...
static inline double calc_sym_gradxy_2D(double dx, double dy, double a_ll, double a_lu, double a_ul,
                                        double a_uu)
{
...
static inline double calc_sym_gradx_3D(double dx, double a_lll, double a_llu, double a_lul,
                                       double a_luu, double a_ull, double a_ulu, double a_uul,
                                       double a_uuu)
{
...
static inline void calc_grad_u_3D(double dx, double dy, double dz, double u_lll[3], double u_llu[3],
                                  double u_lul[3], double u_luu[3], double u_ull[3],
                                  double u_ulu[3], double u_uul[3], double u_uuu[3],
                                  double grad_u[9])
{
  grad_u[0] = calc_sym_gradx_3D(dx, u_lll[0], u_llu[0], u_lul[0], u_luu[0], u_ull[0], u_ulu[0],
                                u_uul[0], u_uuu[0]);
  grad_u[1] = calc_sym_gradx_3D(dx, u_lll[1], u_llu[1], u_lul[1], u_luu[1], u_ull[1], u_ulu[1],
                                u_uul[1], u_uuu[1]);
  grad_u[2] = calc_sym_gradx_3D(dx, u_lll[2], u_llu[2], u_lul[2], u_luu[2], u_ull[2], u_ulu[2],
                                u_uul[2], u_uuu[2]);

  grad_u[3] = calc_sym_grady_3D(dy, u_lll[0], u_llu[0], u_lul[0], u_luu[0], u_ull[0], u_ulu[0],
                                u_uul[0], u_uuu[0]);
  grad_u[4] = calc_sym_grady_3D(dy, u_lll[1], u_llu[1], u_lul[1], u_luu[1], u_ull[1], u_ulu[1],
                                u_uul[1], u_uuu[1]);
  grad_u[5] = calc_sym_grady_3D(dy, u_lll[2], u_llu[2], u_lul[2], u_luu[2], u_ull[2], u_ulu[2],
                                u_uul[2], u_uuu[2]);

  grad_u[6] = calc_sym_gradz_3D(dz, u_lll[0], u_llu[0], u_lul[0], u_luu[0], u_ull[0], u_ulu[0],
                                u_uul[0], u_uuu[0]);
  grad_u[7] = calc_sym_gradz_3D(dz, u_lll[1], u_llu[1], u_lul[1], u_luu[1], u_ull[1], u_ulu[1],
                                u_uul[1], u_uuu[1]);
  grad_u[8] = calc_sym_gradz_3D(dz, u_lll[2], u_llu[2], u_lul[2], u_luu[2], u_ull[2], u_ulu[2],
                                u_uul[2], u_uuu[2]);
}
...
static inline void calc_ros_2D(double dx, double dy, double u_ll[3], double u_lu[3], double u_ul[3],
                               double u_uu[3], double w[6])
{
  double grad_u[6] = { 0.0 };
...
static inline void calc_ros_3D(double dx, double dy, double dz, double u_lll[3], double u_llu[3],
                               double u_lul[3], double u_luu[3], double u_ull[3], double u_ulu[3],
                               double u_uul[3], double u_uuu[3], double w[6])
{
  double grad_u[9] = { 0.0 };
                              ...
                              double charge2, double mass1, double mass2, double rho, double temp)
{
  return coll_fac * 6.0 *
         ...
         epsilon0 / (coulomb_log * charge1 * charge1 * charge2 * charge2 * rho);
}
...
static void calc_pi_par(double eta_par, double b_avg[3], double w[6], double pi_par[6])
{
  ...
  double par_ros = (b_avg[0] * b_avg[0] - 1.0 / 3.0) * w[0] + 2.0 * b_avg[0] * b_avg[1] * w[1] +
                   2.0 * b_avg[0] * b_avg[2] * w[2] + (b_avg[1] * b_avg[1] - 1.0 / 3.0) * w[3] +
                   2.0 * b_avg[1] * b_avg[2] * w[4] + (b_avg[2] * b_avg[2] - 1.0 / 3.0) * w[5];
...
static void calc_pi_perp(double eta_perp, double b_avg[3], double w[6], double pi_perp[6])
{
  ...
  // b . W . b
  double bWb = b_avg[0] * b_avg[0] * w[0] + 2.0 * b_avg[0] * b_avg[1] * w[1] +
               2.0 * b_avg[0] * b_avg[2] * w[2] + b_avg[1] * b_avg[1] * w[3] +
               2.0 * b_avg[1] * b_avg[2] * w[4] + b_avg[2] * b_avg[2] * w[5];
