...
static inline double
calc_sym_gradx_3D(double dx, double a_lll, double a_llu, double a_lul, double a_luu, double a_ull,
  double a_ulu, double a_uul, double a_uuu)
{
  return (a_ull + a_ulu + a_uul + a_uuu - a_lll - a_llu - a_lul - a_luu) / (4 * dx);
}

static inline double
calc_sym_grady_3D(double dy, double a_lll, double a_llu, double a_lul, double a_luu, double a_ull,
  double a_ulu, double a_uul, double a_uuu)
{
...
static inline double
calc_sym_gradz_3D(double dz, double a_lll, double a_llu, double a_lul, double a_luu, double a_ull,
  double a_ulu, double a_uul, double a_uuu)
{
...
static inline double
calc_arithm_avg_3D(double a_lll, double a_llu, double a_lul, double a_luu, double a_ull,
  double a_ulu, double a_uul, double a_uuu)
{
...
static inline double
calc_harmonic_avg_3D(double a_lll, double a_llu, double a_lul, double a_luu, double a_ull,
  double a_ulu, double a_uul, double a_uuu)
{
  return 1.0 /
    (0.125 / a_lll + 0.125 / a_llu + 0.125 / a_lul + 0.125 / a_luu + 0.125 / a_ull + 0.125 / a_ulu +
      0.125 / a_uul + 0.125 / a_uuu);
}
...
static inline void
calc_grad_u_2D(double dx, double dy, double u_ll[3], double u_lu[3], double u_ul[3], double u_uu[3],
  double grad_u[6])
{
...
static inline void
calc_grad_u_3D(double dx, double dy, double dz, double u_lll[3], double u_llu[3], double u_lul[3],
...
static inline double
calc_tau(double coulomb_log, double coll_fac, double epsilon0, double charge1, double charge2,
...
calc_pi_perp(double eta_perp, double b_avg[3], double w[6], double pi_perp[6])
{
  ...
  pi_perp[1] = -eta_perp *
    (2.0 * w[1] + 2.0 * (b_avg[1] * bWIx + b_avg[0] * bWIy) - 6.0 * b_avg[0] * b_avg[1] * bWb);
  pi_perp[2] = -eta_perp *
    (2.0 * w[2] + 2.0 * (b_avg[2] * bWIx + b_avg[0] * bWIz) - 6.0 * b_avg[0] * b_avg[2] * bWb);
  pi_perp[3] = -eta_perp * (2.0 * (w[3] + 2.0 * b_avg[1] * bWIy - 3.0 * b_avg[1] * b_avg[1] * bWb));
  pi_perp[4] = -eta_perp *
    (2.0 * w[4] + 2.0 * (b_avg[2] * bWIy + b_avg[1] * bWIz) - 6.0 * b_avg[1] * b_avg[2] * bWb);
