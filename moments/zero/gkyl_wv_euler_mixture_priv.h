...
*/
GKYL_CU_D void gkyl_euler_mixture_prim_vars(int num_species, double *gas_gamma_s, const double *q,
                                            double *v);
...
*/
GKYL_CU_D void gkyl_euler_mixture_flux(int num_species, double *gas_gamma_s, const double *q,
                                       double *flux);
...
*/
GKYL_CU_D static void euler_mixture_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void euler_mixture_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc,
                                            const double *skin, double *GKYL_RESTRICT ghost,
                                            void *ctx);
...
*/
GKYL_CU_D static inline void euler_mixture_cons_to_diag(const struct gkyl_wv_eqn *eqn,
...
*/
GKYL_CU_DH static inline void euler_mixture_source(const struct gkyl_wv_eqn *eqn, const double *qin,
                                                   double *sout);
