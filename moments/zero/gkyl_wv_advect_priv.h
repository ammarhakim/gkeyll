...
*/
GKYL_CU_D static inline double gkyl_advect_max_abs_speed(double a, const double *q);
...
*/
GKYL_CU_D void gkyl_advect_flux(double a, const double *q, double *flux);
...
*/
GKYL_CU_D void gkyl_advect_flux_deriv(double a, const double *q, double *flux_deriv);
...
*/
GKYL_CU_D static void advect_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void advect_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc,
                                     const double *skin, double *GKYL_RESTRICT ghost, void *ctx);
...
GKYL_CU_D static void qfluct_roe(const struct gkyl_wv_eqn *eqn, const double *ql, const double *qr,
                                 const double phil, const double phir, const double *waves,
...
* @return Maximum wave speed.
*/
GKYL_CU_D static double wave(const struct gkyl_wv_eqn *eqn, enum gkyl_wv_flux_type type,
                             const double *delta, const double *ql, const double *qr,
                             const double phil, const double phir, double *waves, double *s);
...
* @param apdq Right-moving fluctuations (output).
*/
GKYL_CU_D static void qfluct(const struct gkyl_wv_eqn *eqn, enum gkyl_wv_flux_type type,
                             const double *ql, const double *qr, const double phil,
...
*/
GKYL_CU_D static inline void advect_cons_to_diag(const struct gkyl_wv_eqn *eqn, const double *qin,
                                                 double *diag);
...
*/
GKYL_CU_DH static inline void advect_source(const struct gkyl_wv_eqn *eqn, const double *qin,
                                            double *sout);
...
*/
void gkyl_advect_free(const struct gkyl_ref_count *ref);
