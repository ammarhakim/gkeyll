...
static void
burgers_wall(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
...
static void
burgers_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
  double *GKYL_RESTRICT ghost, void *ctx)
{
  ghost[0] = skin[0];
}
