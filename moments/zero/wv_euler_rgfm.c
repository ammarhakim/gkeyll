...
static void
euler_rgfm_wall(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
...
static void
euler_rgfm_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
  double *GKYL_RESTRICT ghost, void *ctx)
{
  const struct wv_euler_rgfm *euler_rgfm = container_of(eqn, struct wv_euler_rgfm, eqn);
  int num_species = euler_rgfm->num_species;
