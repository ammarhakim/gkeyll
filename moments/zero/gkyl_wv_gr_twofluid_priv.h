...
*/
GKYL_CU_D void gkyl_gr_twofluid_flux(double gas_gamma_elc, double gas_gamma_ion, double light_speed,
                                     double e_fact, double b_fact, const double q[84],
                                     double flux[84]);
...
*/
GKYL_CU_D void gkyl_gr_twofluid_prim_vars(double gas_gamma_elc, double gas_gama_ion,
...
*/
GKYL_CU_D void gkyl_gr_twofluid_inv_spatial_metric(const double q[84],
...
*/
GKYL_CU_D void gkyl_gr_twofluid_stress_energy_tensor_elc(double gas_gamma_elc, double gas_gamma_ion,
                                                         const double q[84],
...
* @param stress_energy Stress-energy tensor (output).
*/
GKYL_CU_D void gkyl_gr_twofluid_stress_energy_tensor_ion(double gas_gamma_elc, double gas_gamma_ion,
                                                         const double q[84],
...
*/
GKYL_CU_D static inline double gkyl_gr_twofluid_max_abs_speed(double gas_gamma_elc,
...
*/
GKYL_CU_D static void gr_twofluid_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void gr_twofluid_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
*/
GKYL_CU_D static inline void gr_twofluid_cons_to_diag(const struct gkyl_wv_eqn *eqn,
...
*/
GKYL_CU_DH static inline void gr_twofluid_source(const struct gkyl_wv_eqn *eqn, const double *qin,
                                                 double *sout);
