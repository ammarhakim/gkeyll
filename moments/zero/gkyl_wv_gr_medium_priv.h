...
*/
GKYL_CU_D void gkyl_gr_medium_prim_vars(double gas_gamma, const double q[15], double v[15]);
...
*/
GKYL_CU_D static inline double gkyl_gr_medium_max_abs_speed(double gas_gamma, const double q[15]);
