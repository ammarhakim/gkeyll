...
static void
iso_euler_mixture_wall(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
...
static void
iso_euler_mixture_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc, const double *skin,
  double *GKYL_RESTRICT ghost, void *ctx)
{
  const struct wv_iso_euler_mixture *iso_euler_mixture =
    container_of(eqn, struct wv_iso_euler_mixture, eqn);
