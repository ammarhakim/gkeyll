...
*/
GKYL_CU_D void gkyl_reactive_euler_prim_vars(double gas_gamma, double energy_of_formation,
                                             const double q[6], double v[6]);
...
*/
GKYL_CU_D void gkyl_reactive_euler_flux(double gas_gamma, double energy_of_formation,
                                        const double q[6], double flux[6]);
...
*/
GKYL_CU_D static void reactive_euler_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
* @param ctx Context to pass to the function.
*/
GKYL_CU_D static void reactive_euler_no_slip(const struct gkyl_wv_eqn *eqn, double t, int nc,
                                             const double *skin, double *GKYL_RESTRICT ghost,
                                             void *ctx);
...
*/
GKYL_CU_D static inline void reactive_euler_cons_to_diag(const struct gkyl_wv_eqn *eqn,
...
*/
GKYL_CU_DH static inline void reactive_euler_source(const struct gkyl_wv_eqn *eqn,
