...
*/
GKYL_CU_D void gkyl_vacuum_einstein_flux(double excision_threshold,
...
*/
GKYL_CU_D void gkyl_vacuum_einstein_inv_spatial_metric(const double q[64],
...
*/
GKYL_CU_D static inline double gkyl_vacuum_einstein_max_abs_speed(
...
*/
GKYL_CU_D static void vacuum_einstein_wall(const struct gkyl_wv_eqn *eqn, double t, int nc,
...
/**
* Determine whether invariant domain of the vacuum Einstein equations using the Bona-Masso formalism is satisfied.
*
* @param eqn Base equation object.
* @param q Conserved variable vector.
...
*/
GKYL_CU_D static inline void vacuum_einstein_cons_to_diag(const struct gkyl_wv_eqn *eqn,
...
*/
GKYL_CU_DH static inline void vacuum_einstein_source(const struct gkyl_wv_eqn *eqn,
