...
void test_apply_bc_1_ho()
{
  ...
  gkyl_wv_apply_bc *lbc =
    gkyl_wv_apply_bc_new(&grid, eqn, wg, 0, GKYL_LOWER_EDGE, nghost, bc_copy, NULL);
  gkyl_wv_apply_bc *rbc =
    gkyl_wv_apply_bc_new(&grid, eqn, wg, 0, GKYL_UPPER_EDGE, nghost, bc_copy, NULL);
...
void test_apply_bc_2_ho()
{
  ...
  gkyl_wv_apply_bc *bbc =
    gkyl_wv_apply_bc_new(&grid, eqn, wg, 1, GKYL_LOWER_EDGE, nghost, bc_copy, NULL);
  gkyl_wv_apply_bc *tbc =
    gkyl_wv_apply_bc_new(&grid, eqn, wg, 1, GKYL_UPPER_EDGE, nghost, bc_copy, NULL);
...
void test_apply_bc_buff_rtheta_ho()
{
  ...
  struct gkyl_array *bc_buffer = gkyl_array_new(GKYL_DOUBLE, eqn->num_equations, buff_sz);

  struct gkyl_wave_geom *wg = gkyl_wave_geom_new(&grid, &ext_range, rtheta_map, &ndim, false);
