...
struct blackhole_spinning_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  struct blackhole_spinning_ctx ctx = { .pi = pi,
                                        .gas_gamma = gas_gamma,
                                        .rhob = rhob,
                                        .ub = ub,
                                        .pb = pb,
                     ...
                     void *ctx)
{
  ...
  struct blackhole_spinning_ctx *app = ctx;
...
int main(int argc, char **argv)
{
  ...
  struct blackhole_spinning_ctx ctx = create_ctx(); // Context for initialization functions.
