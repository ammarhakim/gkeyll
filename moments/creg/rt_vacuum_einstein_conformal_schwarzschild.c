...
struct einstein_conformal_schwarzschild_ctx {
...
struct einstein_conformal_schwarzschild_ctx create_ctx(void)
{
  // Spacetime parameters (using geometric units).
  ...
  struct einstein_conformal_schwarzschild_ctx ctx = { .mass = mass,
                                                      .spin = spin,
                                                      .pos_x = pos_x,
                                                      .pos_y = pos_y,
                                                      .pos_z = pos_z,
                                     ...
                                     double *GKYL_RESTRICT fout, void *ctx)
{
  ...
  struct einstein_conformal_schwarzschild_ctx *app = ctx;
...
int main(int argc, char **argv)
{
  ...
  struct einstein_conformal_schwarzschild_ctx ctx =
  ...
  // Moment app.
  struct gkyl_moment app_inp = { .name = "vacuum_einstein_conformal_schwarzschild",
