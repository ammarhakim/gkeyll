...
struct perturbed_density_ctx create_ctx(void)
{
  // Physical constants (using normalized code units).
  ...
  struct perturbed_density_ctx ctx = { .gas_gamma = gas_gamma,
                                       .rhol = rhol,
                                       .ul = ul,
                                       .pl = pl,
                                       .rhor = rhor,
...
{
  double x = xn[0];
  struct perturbed_density_ctx *app = ctx;
...
int main(int argc, char **argv)
{
  ...
  struct perturbed_density_ctx ctx = create_ctx(); // Context for initialization functions.
