...
struct expanding_axi_sodshock_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  struct expanding_axi_sodshock_ctx ctx = { .pi = pi,
                                            .gas_gamma = gas_gamma,
                                            .U0 = U0,
                                            .R0 = R0,
                                            .rhol = rhol,
...
void eval10mInit(double t, const double *GKYL_RESTRICT zc, double *GKYL_RESTRICT fout, void *ctx)
{
  double r = zc[0];
