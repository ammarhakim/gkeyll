...
struct einstein_conformal_brill_lindquist_ctx {
...
struct einstein_conformal_brill_lindquist_ctx create_ctx(void)
{
  // Spacetime parameters (using geometric units).
  ...
  struct einstein_conformal_brill_lindquist_ctx ctx = { .mass1 = mass1,
                                                        .mass2 = mass2,
                                                        .pos_x1 = pos_x1,
                                                        .pos_y1 = pos_y1,
                                                        .pos_z1 = pos_z1,
                                     ...
                                     double *GKYL_RESTRICT fout, void *ctx)
{
  ...
  struct einstein_conformal_brill_lindquist_ctx *app = ctx;
...
int main(int argc, char **argv)
{
  ...
  struct einstein_conformal_brill_lindquist_ctx ctx =
  ...
  // Moment app.
  struct gkyl_moment app_inp = { .name = "vacuum_einstein_conformal_brill_lindquist",
