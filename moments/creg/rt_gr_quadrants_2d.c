...
struct quadrants_2d_ctx create_ctx(void)
{
  // Physical constants (using normalized code units).
  ...
  struct quadrants_2d_ctx ctx = { .gas_gamma = gas_gamma,
                                  .rho_ul = rho_ul,
                                  .u_ul = u_ul,
                                  .v_ul = v_ul,
                                  .p_ul = p_ul,
                     ...
                     void *ctx)
{
  ...
  spacetime->extrinsic_curvature_tensor_func(spacetime, 0.0, x, y, 0.0, 1.0, 1.0, 1.0,
                                             &extrinsic_curvature);
