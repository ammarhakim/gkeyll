// 2D Wald-type magnetosphere problem for a static neutron star, for the general relativistic Maxwell equations.
...
struct wald_magnetosphere_static_ctx {
...
struct wald_magnetosphere_static_ctx create_ctx(void)
{
  // Physical constants (using normalized code units).
...
int main(int argc, char **argv)
{
  ...
  struct wald_magnetosphere_static_ctx ctx = create_ctx(); // Context for initialization functions.
