...
struct plane_wave_2d_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  struct plane_wave_2d_ctx ctx = { .pi = pi,
                                   .epsilon0 = epsilon0,
                                   .mu0 = mu0,
                                   .E0 = E0,
                                   .k_wave_x = k_wave_x,
...
void evalFieldInit(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
  ...
  struct plane_wave_2d_ctx *app = ctx;
...
int main(int argc, char **argv)
{
  ...
  struct plane_wave_2d_ctx ctx = create_ctx(); // Context for initialization functions.
