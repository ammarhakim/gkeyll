...
struct ultra_rel_blackhole_collapse_ctx create_ctx(void)
{
  // Physical constants (using normalized code units).
  ...
  struct ultra_rel_blackhole_collapse_ctx ctx = { .gas_gamma = gas_gamma,
                                                  .rhob = rhob,
                                                  .omega_b = omega_b,
                                                  .rhos = rhos,
                                                  .omega_s = omega_s,
                     ...
                     void *ctx)
{
  ...
  double mom_y =
    sqrt(spatial_det) * (rho + p) * (W * W) * v; // Fluid momentum density (y-direction).
