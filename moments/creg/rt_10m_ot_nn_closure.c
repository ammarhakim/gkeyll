...
struct ot_nn_closure_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  struct ot_nn_closure_ctx ctx = { .pi = pi,
                                   .epsilon0 = epsilon0,
                                   .mu0 = mu0,
                                   .mass_elc = mass_elc,
...
{
  struct ot_nn_closure_ctx *app = ctx;
...
int main(int argc, char **argv)
{
  ...
  struct ot_nn_closure_ctx ctx = create_ctx(); // Context for initialization functions.
