...
struct plane_wave_1d_mp_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  struct plane_wave_1d_mp_ctx ctx = { .pi = pi,
                                      .epsilon0 = epsilon0,
                                      .mu0 = mu0,
                                      .E0 = E0,
                                      .k_wave_x = k_wave_x,
...
{
  double x = xn[0];
  struct plane_wave_1d_mp_ctx *app = ctx;
...
int main(int argc, char **argv)
{
  ...
  struct plane_wave_1d_mp_ctx ctx = create_ctx(); // Context for initialization functions.
