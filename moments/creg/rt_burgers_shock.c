...
struct burgers_shock_ctx create_ctx(void)
{
  // Simulation parameters.
  ...
  struct burgers_shock_ctx ctx = { .Nx = Nx,
                                   .Lx = Lx,
                                   .cfl_frac = cfl_frac,
                                   .t_end = t_end,
...
int main(int argc, char **argv)
{
  ...
  struct burgers_shock_ctx ctx = create_ctx(); // Context for initialization functions.
  ...
  struct gkyl_moment_species fluid = { .name = "burgers",
                                       .equation = burgers,
