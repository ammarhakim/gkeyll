...
struct euler_blackhole_collapse_ctx
{
...
create_ctx(void)
{
  ...
  enum gkyl_spacetime_gauge spacetime_gauge = GKYL_NEUTRONSTAR_COLLAPSE_GAUGE; // Spacetime gauge choice.
  ...
  struct euler_blackhole_collapse_ctx ctx = {
    .gas_gamma = gas_gamma,
    .rhob = rhob,
    .omega_b = omega_b,
    .pb = pb,
...
evalGREulerInit(double t, const double* GKYL_RESTRICT xn, double* GKYL_RESTRICT fout, void* ctx)
{
  ...
  struct euler_blackhole_collapse_ctx *app = ctx;
...
main(int argc, char **argv)
{
  ...
  struct euler_blackhole_collapse_ctx ctx = create_ctx(); // Context for initialization functions.
  ...
  struct gkyl_moment app_inp = {
    .name = "gr_euler_blackhole_collapse",
