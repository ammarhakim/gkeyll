// Strongly relativistic blast wave test for the general relativistic Euler equations.
...
struct strong_blast_ctx create_ctx(void)
{
  // Physical constants (using normalized code units).
  ...
  struct strong_blast_ctx ctx = { .gas_gamma = gas_gamma,
                                  .rhol = rhol,
                                  .ul = ul,
                                  .pl = pl,
                                  .rhor = rhor,
