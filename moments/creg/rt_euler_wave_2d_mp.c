// Smooth traveling wave problem, using monotonicity-preserving reconstruction, for the 5-moment (Euler) equations.
...
struct euler_wave_2d_mp_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  struct euler_wave_2d_mp_ctx ctx = { .pi = pi,
                                      .gas_gamma = gas_gamma,
                                      .u = u,
                                      .v = v,
                                      .p = p,
