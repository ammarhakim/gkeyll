...
main(int argc, char **argv)
{
  ...
  struct gkyl_wv_eqn *elc_ten_moment = gkyl_wv_ten_moment_inew(
    &(struct gkyl_wv_ten_moment_inp) {
        .k0 = ctx.k0_elc,
        .use_grad_closure = false,
        .embed_geo = embed_geo_elc,
        .use_gpu = app_args.use_gpu,
    });

  struct gkyl_wv_eqn *ion_ten_moment = gkyl_wv_ten_moment_inew(
    &(struct gkyl_wv_ten_moment_inp) {
        .k0 = ctx.k0_ion,
        .use_grad_closure = false,
        .embed_geo = embed_geo_ion,
        .use_gpu = app_args.use_gpu,
    });
