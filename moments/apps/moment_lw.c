...
static const struct gkyl_str_int_pair moment_scheme_type[] = {
  {"WaveProp", GKYL_MOMENT_WAVE_PROP}, {"MP", GKYL_MOMENT_MP}, {"KEP", GKYL_MOMENT_KEP}, {0, 0}};
...
static const struct gkyl_str_int_pair mhd_rp_type[] = {
  {"Roe", WV_MHD_RP_ROE}, {"HLLD", WV_MHD_RP_HLLD}, {"Lax", WV_MHD_RP_LAX}, {0, 0}};
...
static const struct gkyl_str_int_pair braginskii_type[] = {{"Mag", GKYL_BRAG_MAG},
  {"Visc", GKYL_BRAG_VISC}, {"HeatFlux", GKYL_BRAG_HEATFLUX}, {"UnmagFull", GKYL_BRAG_UNMAG_FULL},
  {"MagFull", GKYL_BRAG_MAG_FULL}, {0, 0}};

// Spacetime gauge type -> enum map.
static const struct gkyl_str_int_pair spacetime_gauge_type[] = {
  {"Static", GKYL_STATIC_GAUGE}, {"BlackHoleCollapse", GKYL_BLACKHOLE_COLLAPSE_GAUGE}, {0, 0}};

// Spacetime slicing type -> enum map.
static const struct gkyl_str_int_pair spacetime_slicing_type[] = {
  {"Geodesic", GKYL_GEODESIC_SLICING}, {"Harmonic", GKYL_HARMONIC_SLICING},
  {"OnePlusLog", GKYL_1PLUSLOG_SLICING}, {0, 0}};
...
static const struct gkyl_str_int_pair wave_split_type[] = {
  {"qwave", GKYL_WAVE_QWAVE}, {"fwave", GKYL_WAVE_FWAVE}, {0, 0}};
...
static const struct gkyl_str_int_pair gr_maxwell_rp_type[] = {
  {"roe", WV_GR_MAXWELL_RP_ROE}, {"lax", WV_GR_MAXWELL_RP_LAX}, {0, 0}};
...
static const struct gkyl_str_int_pair gr_euler_rp_type[] = {
  {"hll", WV_GR_EULER_RP_HLL}, {"roe", WV_GR_EULER_RP_ROE}, {"lax", WV_GR_EULER_RP_LAX}, {0, 0}};
...
static const struct gkyl_str_int_pair gr_euler_tetrad_rp_type[] = {
  {"hll", WV_GR_EULER_TETRAD_RP_HLL}, {"roe", WV_GR_EULER_TETRAD_RP_ROE},
  {"lax", WV_GR_EULER_TETRAD_RP_LAX}, {0, 0}};

// Coupled fluid-Einstein Riemann problem (plane-polarized Gowdy spacetimes) -> enum map.
static const struct gkyl_str_int_pair gr_medium_rp_type[] = {{"lax", WV_GR_MEDIUM_RP_LAX}, {0, 0}};
...
static const struct gkyl_str_int_pair gr_twofluid_rp_type[] = {
  {"hll", WV_GR_TWOFLUID_RP_HLL}, {"lax", WV_GR_TWOFLUID_RP_LAX}, {0, 0}};
...
static const struct gkyl_str_int_pair gr_mhd_rp_type[] = {
  {"hll", WV_GR_MHD_RP_HLL}, {"lax", WV_GR_MHD_RP_LAX}, {0, 0}};
...
// Equation constructor.
static struct luaL_Reg eqn_iso_euler_ctor[] = {{"new", eqn_iso_euler_lw_new}, {0, 0}};
...
// Equation constructor.
static struct luaL_Reg eqn_sr_euler_ctor[] = {{"new", eqn_sr_euler_lw_new}, {0, 0}};
...
// Equation constructor.
static struct luaL_Reg eqn_coldfluid_ctor[] = {{"new", eqn_coldfluid_lw_new}, {0, 0}};
...
eqn_tenmoment_lw_new(lua_State *L)
{
  ...
  tenm_lw->eqn =
    gkyl_wv_ten_moment_new(k0, has_grad_closure, has_nn_closure, poly_order, ann, false);
...
// Equation constructor.
static struct luaL_Reg eqn_tenmoment_ctor[] = {{"new", eqn_tenmoment_lw_new}, {0, 0}};
...
eqn_mhd_lw_new(lua_State *L)
{
  ...
  enum gkyl_wv_mhd_div_constraint divb =
    glua_tbl_get_integer(L, "divergenceConstraint", GKYL_MHD_DIVB_NONE);
...
// Equation constructor.
static struct luaL_Reg eqn_mhd_ctor[] = {{"new", eqn_mhd_lw_new}, {0, 0}};
...
eqn_reactive_euler_lw_new(lua_State *L)
{
  ...
  enum gkyl_wv_reactive_euler_rp rp_type =
...
// Equation constructor.
static struct luaL_Reg eqn_reactive_euler_ctor[] = {{"new", eqn_reactive_euler_lw_new}, {0, 0}};
...
eqn_euler_mixture_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "lax");
  enum gkyl_wv_euler_mixture_rp rp_type =
    gkyl_search_str_int_pair_by_str(euler_mixture_rp_type, rp_str, WV_EULER_MIXTURE_RP_LAX);
...
// Equation constructor.
static const luaL_Reg eqn_euler_mixture_ctor[] = {{"new", eqn_euler_mixture_lw_new}, {0, 0}};
...
eqn_euler_rgfm_lw_new(lua_State *L)
{
  ...
  int reinit_freq = glua_tbl_get_integer(L, "reinitFreq", 3);

  const char *rp_str = glua_tbl_get_string(L, "rpType", "lax");
  enum gkyl_wv_euler_rgfm_rp rp_type =
    gkyl_search_str_int_pair_by_str(euler_rgfm_rp_type, rp_str, WV_EULER_RGFM_RP_LAX);
  ...
  *l_euler_rgfm_lw = euler_rgfm_lw; // Point userdata to the equation object.
...
// Equation constructor.
static const luaL_Reg eqn_euler_rgfm_ctor[] = {{"new", eqn_euler_rgfm_lw_new}, {0, 0}};
...
eqn_iso_euler_mixture_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "lax");
  enum gkyl_wv_iso_euler_mixture_rp rp_type =
    gkyl_search_str_int_pair_by_str(iso_euler_mixture_rp_type, rp_str, WV_ISO_EULER_MIXTURE_RP_LAX);

  iso_euler_mixture_lw->magic = MOMENT_EQN_DEFAULT;
  iso_euler_mixture_lw->eqn =
    gkyl_wv_iso_euler_mixture_inew(&(struct gkyl_wv_iso_euler_mixture_inp){
      .num_species = num_components, .vt_s = vt_s, .rp_type = rp_type, .use_gpu = false});
...
static const luaL_Reg eqn_iso_euler_mixture_ctor[] = {
  {"new", eqn_iso_euler_mixture_lw_new}, {0, 0}};
...
eqn_gr_maxwell_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "lax");
  enum gkyl_wv_gr_maxwell_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_maxwell_rp_type, rp_str, WV_GR_MAXWELL_RP_LAX);
...
// Equation constructor.
static struct luaL_Reg eqn_gr_maxwell_ctor[] = {{"new", eqn_gr_maxwell_lw_new}, {0, 0}};
...
eqn_gr_maxwell_tetrad_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "lax");
  enum gkyl_wv_gr_maxwell_tetrad_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_maxwell_tetrad_rp_type, rp_str, WV_GR_MAXWELL_TETRAD_RP_LAX);
  ...
  gr_maxwell_tetrad_lw->eqn =
    gkyl_wv_gr_maxwell_tetrad_inew(&(struct gkyl_wv_gr_maxwell_tetrad_inp){
      .light_speed = light_speed,
      .e_fact = e_fact,
      .b_fact = b_fact,
      .spacetime = spacetime,
...
static struct luaL_Reg eqn_gr_maxwell_tetrad_ctor[] = {
  {"new", eqn_gr_maxwell_tetrad_lw_new}, {0, 0}};
...
eqn_gr_ultra_rel_euler_lw_new(lua_State *L)
{
  ...
  enum gkyl_wv_gr_ultra_rel_euler_rp rp_type = gkyl_search_str_int_pair_by_str(
    gr_ultra_rel_euler_rp_type, rp_str, WV_GR_ULTRA_REL_EULER_RP_HLL);
  ...
  gr_ultra_rel_euler_lw->eqn =
    gkyl_wv_gr_ultra_rel_euler_inew(&(struct gkyl_wv_gr_ultra_rel_euler_inp){
      .gas_gamma = gas_gamma,
      .spacetime = spacetime,
      .reinit_freq = reinit_freq,
      .rp_type = rp_type,
...
static struct luaL_Reg eqn_gr_ultra_rel_euler_ctor[] = {
  {"new", eqn_gr_ultra_rel_euler_lw_new}, {0, 0}};
...
eqn_gr_ultra_rel_euler_tetrad_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_gr_ultra_rel_euler_tetrad_rp rp_type = gkyl_search_str_int_pair_by_str(
    gr_ultra_rel_euler_tetrad_rp_type, rp_str, WV_GR_ULTRA_REL_EULER_TETRAD_RP_HLL);
  ...
  gr_ultra_rel_euler_tetrad_lw->eqn =
    gkyl_wv_gr_ultra_rel_euler_tetrad_inew(&(struct gkyl_wv_gr_ultra_rel_euler_tetrad_inp){
      .gas_gamma = gas_gamma,
      .spacetime = spacetime,
      .reinit_freq = reinit_freq,
      .rp_type = rp_type,
  ...
  // Create Lua userdata.
  struct wv_eqn_lw **l_gr_ultra_rel_euler_tetrad_lw =
    lua_newuserdata(L, sizeof(struct wv_eqn_lw *));
...
eqn_gr_euler_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_gr_euler_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_euler_rp_type, rp_str, WV_GR_EULER_RP_HLL);
...
// Equation constructor.
static struct luaL_Reg eqn_gr_euler_ctor[] = {{"new", eqn_gr_euler_lw_new}, {0, 0}};
...
eqn_gr_euler_tetrad_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_gr_euler_tetrad_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_euler_tetrad_rp_type, rp_str, WV_GR_EULER_TETRAD_RP_HLL);
...
// Equation constructor.
static struct luaL_Reg eqn_gr_euler_tetrad_ctor[] = {{"new", eqn_gr_euler_tetrad_lw_new}, {0, 0}};
...
eqn_gr_medium_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "lax");
  enum gkyl_wv_gr_medium_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_medium_rp_type, rp_str, WV_GR_MEDIUM_RP_LAX);
...
// Equation constructor.
static struct luaL_Reg eqn_gr_medium_ctor[] = {{"new", eqn_gr_medium_lw_new}, {0, 0}};
...
eqn_vacuum_einstein_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_vacuum_einstein_rp rp_type =
    gkyl_search_str_int_pair_by_str(vacuum_einstein_rp_type, rp_str, WV_VACUUM_EINSTEIN_RP_HLL);
  enum gkyl_spacetime_slicing spacetime_slicing =
    glua_tbl_get_integer(L, "spacetimeSlicing", GKYL_GEODESIC_SLICING);
  enum gkyl_spacetime_evolution spacetime_evolution =
    glua_tbl_get_integer(L, "spacetimeEvolution", GKYL_RICCI_EVOLUTION);
...
// Equation constructor.
static struct luaL_Reg eqn_vacuum_einstein_ctor[] = {{"new", eqn_vacuum_einstein_lw_new}, {0, 0}};
...
eqn_vacuum_einstein_conformal_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_vacuum_einstein_conformal_rp rp_type = gkyl_search_str_int_pair_by_str(
    vacuum_einstein_conformal_rp_type, rp_str, WV_VACUUM_EINSTEIN_CONFORMAL_RP_HLL);
  enum gkyl_spacetime_slicing spacetime_slicing =
    glua_tbl_get_integer(L, "spacetimeSlicing", GKYL_GEODESIC_SLICING);
  enum gkyl_spacetime_evolution spacetime_evolution =
    glua_tbl_get_integer(L, "spacetimeEvolution", GKYL_RICCI_EVOLUTION);
  ...
  vacuum_einstein_conformal_lw->eqn =
    gkyl_wv_vacuum_einstein_conformal_inew(&(struct gkyl_wv_vacuum_einstein_conformal_inp){
      .excision_threshold = excision_threshold,
      .spacetime_slicing = spacetime_slicing,
      .spacetime_evolution = spacetime_evolution,
      .rp_type = rp_type,
  ...
  struct wv_eqn_lw **l_vacuum_einstein_conformal_lw =
    lua_newuserdata(L, sizeof(struct wv_eqn_lw *));
  *l_vacuum_einstein_conformal_lw = vacuum_einstein_conformal_lw;
...
eqn_gr_twofluid_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_gr_twofluid_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_twofluid_rp_type, rp_str, WV_GR_TWOFLUID_RP_HLL);
...
// Equation constructor.
static struct luaL_Reg eqn_gr_twofluid_ctor[] = {{"new", eqn_gr_twofluid_lw_new}, {0, 0}};

/* **************************************************************************************** */
/* General Relativistic Two-Fluid Equations in the Tetrad Basis (General Equation of State) */
/* **************************************************************************************** */
...
eqn_gr_twofluid_tetrad_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_gr_twofluid_tetrad_rp rp_type = gkyl_search_str_int_pair_by_str(
    gr_twofluid_tetrad_rp_type, rp_str, WV_GR_TWOFLUID_TETRAD_RP_HLL);
  ...
  gr_twofluid_tetrad_lw->eqn =
    gkyl_wv_gr_twofluid_tetrad_inew(&(struct gkyl_wv_gr_twofluid_tetrad_inp){
      .mass_elc = mass_elc,
      .mass_ion = mass_ion,
      .charge_elc = charge_elc,
      .charge_ion = charge_ion,
  ...
  *l_gr_twofluid_tetrad_lw = gr_twofluid_tetrad_lw;
...
// Equation constructor.
static struct luaL_Reg eqn_gr_twofluid_tetrad_ctor[] = {
  {"new", eqn_gr_twofluid_tetrad_lw_new}, {0, 0}};
...
eqn_gr_mhd_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_gr_mhd_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_mhd_rp_type, rp_str, WV_GR_MHD_RP_HLL);
...
// Equation constructor.
static struct luaL_Reg eqn_gr_mhd_ctor[] = {{"new", eqn_gr_mhd_lw_new}, {0, 0}};
...
eqn_gr_mhd_tetrad_lw_new(lua_State *L)
{
  ...
  const char *rp_str = glua_tbl_get_string(L, "rpType", "hll");
  enum gkyl_wv_gr_mhd_tetrad_rp rp_type =
    gkyl_search_str_int_pair_by_str(gr_mhd_tetrad_rp_type, rp_str, WV_GR_MHD_TETRAD_RP_HLL);
...
// Equation constructor.
static struct luaL_Reg eqn_gr_mhd_tetrad_ctor[] = {{"new", eqn_gr_mhd_tetrad_lw_new}, {0, 0}};
...
eqn_openlibs(lua_State *L)
{
  ...
  luaL_register(L, "G0.Moments.Eq.GRTwoFluidTetrad", eqn_gr_twofluid_tetrad_ctor);
...
spacetime_blackhole_lw_new(lua_State *L)
{
  ...
  blackhole_lw->spacetime = gkyl_gr_blackhole_inew(&(struct gkyl_gr_blackhole_inp){
    .mass = mass, .spin = spin, .pos_x = pos_x, .pos_y = pos_y, .pos_z = pos_z, .use_gpu = false});
...
static struct luaL_Reg spacetime_blackhole_ctor[] = {{"new", spacetime_blackhole_lw_new},
  ...
  {"lapseFunctionDer", spacetime_blackhole_lw_lapse_function_der},
  {"shiftVectorDer", spacetime_blackhole_lw_shift_vector_der},
  {"spatialMetricTensorDer", spacetime_blackhole_lw_spatial_metric_tensor_der},
  {"excisionRegion", spacetime_blackhole_lw_excision_region},
  {"conformalFactor", spacetime_blackhole_lw_conformal_factor},
...
spacetime_brill_lindquist_lw_new(lua_State *L)
{
  ...
  struct gr_spacetime_lw **l_brill_lindquist_lw =
    lua_newuserdata(L, sizeof(struct gr_spacetime_lw *));
...
struct moment_species_lw {
  ...
  struct lua_func_ctx
    applied_acceleration_func_ref; // Lua registry reference to applied acceleration initialization function.
...
moment_species_lw_new(lua_State *L)
{
  ...
  mom_species.split_type =
    gkyl_search_str_int_pair_by_str(wave_split_type, split_str, GKYL_WAVE_QWAVE);
  ...
  if (mom_species.has_reactivity) {
    ...
    mom_species.reactivity_specific_heat_capacity =
      glua_tbl_get_number(L, "reactivitySpecificHeatCapacity", 2.5);
    mom_species.reactivity_energy_of_formation =
      glua_tbl_get_number(L, "reactivityEnergyOfFormation", 1.0);
    mom_species.reactivity_ignition_temperature =
      glua_tbl_get_number(L, "reactivityIgnitionTemperature", 0.25);
  ...
  if (mom_species.has_vacuum_einstein) {
    mom_species.vacuum_einstein_excision_threshold =
      glua_tbl_get_number(L, "vacuumEinsteinExcisionThreshold", 0.3);
    mom_species.vacuum_einstein_spacetime_slicing =
      glua_tbl_get_integer(L, "vacuumEinsteinSpacetimeSlicing", GKYL_GEODESIC_SLICING);
    mom_species.vacuum_einstein_spacetime_evolution =
      glua_tbl_get_integer(L, "vacuumEinsteinSpacetimeEvolution", GKYL_EINSTEIN_EVOLUTION);
  }

  mom_species.has_vacuum_einstein_conformal =
    glua_tbl_get_bool(L, "hasVacuumEinsteinConformal", false);
  if (mom_species.has_vacuum_einstein_conformal) {
    mom_species.vacuum_einstein_conformal_excision_threshold =
      glua_tbl_get_number(L, "vacuumEinsteinConformalExcisionThreshold", 0.3);
    mom_species.vacuum_einstein_conformal_spacetime_slicing =
      glua_tbl_get_integer(L, "vacuumEinsteinConformalSpacetimeSlicing", GKYL_GEODESIC_SLICING);
    mom_species.vacuum_einstein_conformal_spacetime_evolution =
      glua_tbl_get_integer(L, "vacuumEinsteinConformalSpacetimeEvolution", GKYL_EINSTEIN_EVOLUTION);
  }
  ...
  if (mom_species.has_gr_twofluid) {
    ...
    mom_species.gr_twofluid_gas_gamma_elc =
      glua_tbl_get_number(L, "GRTwoFluidGasGammaElc", 5.0 / 3.0);
    mom_species.gr_twofluid_gas_gamma_ion =
      glua_tbl_get_number(L, "GRTwoFluidGasGammaIon", 5.0 / 3.0);
...
// Species constructor.
static struct luaL_Reg mom_species_ctor[] = {{"new", moment_species_lw_new}, {0, 0}};
...
struct moment_field_lw {
  ...
  struct lua_func_ctx
    applied_current_func_ref; // Lua registry reference to applied current initialization function.
...
// Species constructor.
static struct luaL_Reg mom_field_ctor[] = {{"new", moment_field_lw_new}, {0, 0}};
...
struct moment_app_lw {
  ...
  struct lua_func_ctx
    species_init_ctx[GKYL_MAX_SPECIES]; // Function context for species initial conditions.
  struct lua_func_ctx
    applied_acceleration_func_ctx[GKYL_MAX_SPECIES]; // Function context for applied acceleration.
  struct lua_func_ctx
    species_nT_source_func_ctx[GKYL_MAX_SPECIES]; // Function context for temperature sources.
...
mom_app_new(lua_State *L)
{
  ...
  with_lua_global(L, "GKYL_MPI_COMM")
  {
    if (lua_islightuserdata(L, -1)) {
      ...
      struct {
        MPI_Comm comm;
      } *lw_mpi_comm_world = lua_touserdata(L, -1);
      MPI_Comm mpi_comm = lw_mpi_comm_world->comm;
      comm =
        gkyl_mpi_comm_new(&(struct gkyl_mpi_comm_inp){.mpi_comm = mpi_comm, .sync_corners = true});
    }
  }
#endif
  ...
  if (!has_mpi) {
    ...
    // serial sim.
    comm = gkyl_null_comm_inew(&(struct gkyl_null_comm_inp){.sync_corners = true});
  }
...
static const struct gkyl_str_int_pair rio_status[] = {{"success", GKYL_ARRAY_RIO_SUCCESS},
  ...
  {"fread-failed", GKYL_ARRAY_RIO_FREAD_FAILED}, {"data-mismatch", GKYL_ARRAY_RIO_DATA_MISMATCH},
  {0, 0}};
...
static struct luaL_Reg mom_app_funcs[] = {{"num_species", mom_app_num_species},
  ...
  {"from_file_field", mom_app_from_file_field}, {"from_file_species", mom_app_from_file_species},
