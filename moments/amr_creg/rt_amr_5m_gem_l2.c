// Geospace Environmental Modeling (GEM) magnetic reconnection test, using static, block-structured mesh refinement with doubly-nested refinement blocks (2x2x refinement), for the 5-moment equations.
...
struct amr_5m_gem_ctx create_ctx(void)
{
  ...
  double intermediate_Lx = 8.5333333; // Intermediate domain size (x-direction).
  double intermediate_Ly = 4.2666666; // Intermediate domain size (y-direction).
  double fine_Lx = 2.8444444; // Fine domain size (x-direction).
  double fine_Ly = 1.4222222; // Fine domain size (y-direction).
