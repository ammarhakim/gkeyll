// 2D ring-accretion problem onto a static (Schwarzschild) black hole, using static, block-structured mesh refinement with doubly-nested refinement blocks (4x4x refinement), for the general relativistic Euler equations.
...
struct amr_gr_blackhole_static_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  double intermediate_Lx = 3.5; // Intermediate domain size (x-direction).
  double intermediate_Ly = 3.5; // Intermediate domain size (y-direction).
  double fine_Lx = 2.0; // Fine domain size (x-direction).
  ...
  struct amr_gr_blackhole_static_ctx ctx = { .pi = pi,
                                             .gas_gamma = gas_gamma,
                                             .rhob = rhob,
                                             .ub = ub,
                                             .pb = pb,
                     ...
                     void *ctx)
{
  ...
  struct amr_gr_blackhole_static_ctx new_ctx =
...
int main(int argc, char **argv)
{
  ...
  struct gr_euler2d_double_init init = {
    ...
    .gr_euler_output = "amr_gr_blackhole_static_l2",
