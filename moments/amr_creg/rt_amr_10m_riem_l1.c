// Generalized Brio-Wu Riemann problem, using static, patch-structured mesh refinement with a single refinement patch (4x refinement), for the 10-moment equations.
...
void evalElcInit(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
  ...
  struct amr_10m_riem_ctx *app = &new_ctx;
