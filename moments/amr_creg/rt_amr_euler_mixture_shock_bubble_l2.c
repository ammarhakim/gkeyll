...
create_ctx(void)
{
  ...
  double intermediate_Lx = 0.26; // Intermediate domain size (x-direction).
  double intermediate_Ly = 0.07; // Intermediate domain size (y-direction).
  double fine_Lx = 0.20; // Fine domain size (x-direction).
  double fine_Ly = 0.05; // Fine domain size (y-direction).
...
main(int argc, char **argv)
{
  ...
  struct euler_mixture2d_double_init init = { .base_Nx = ctx.Nx,
    ...
    .euler_mixture_output = "amr_euler_mixture_shock_bubble_l2",
