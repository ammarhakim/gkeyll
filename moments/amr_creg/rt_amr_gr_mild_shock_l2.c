...
struct amr_gr_mild_shock_ctx create_ctx(void)
{
  // Physical constants (using normalized code units).
                     ...
                     void *ctx)
{
  ...
  struct amr_gr_mild_shock_ctx *app = &new_ctx;
...
int main(int argc, char **argv)
{
  ...
  struct gr_euler1d_double_init init = {
    ...
    .intermediate_x1 = (0.75 * ctx.Lx) - (0.5 * ctx.intermediate_Lx),
    .intermediate_x2 = (0.75 * ctx.Lx) + (0.5 * ctx.intermediate_Lx),
    ...
    .gr_euler_output = "amr_gr_mild_shock_l2",
