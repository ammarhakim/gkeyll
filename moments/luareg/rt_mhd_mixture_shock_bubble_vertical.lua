...
local MHDMixture = G0.Moments.Eq.MHDMixture

-- Physical constants (using normalized code units).
gas_gamma1 = 1.4 -- First species adiabatic index.
gas_gamma2 = 1.648 -- Second species adiabatic index.

Bx_total = 0.0 -- Magnetic field (x-direction).
By_total = 0.1 -- Magnetic field (y-direction).
...
Nx = 650 -- Cell count (x-direction).
Ny = 178 -- Cell count (y-direction).
...
momentApp = Moments.App.new {
  ...
  fluid = Moments.Species.new {
    ...
    init = function (t, xn)
      ...
      return rho_total, momx_total, momy_total, momz_total, E_total, Bx_total, By_total, Bz_total, 0.0, vol_frac1, mass_frac1, mass_frac2
    end,
