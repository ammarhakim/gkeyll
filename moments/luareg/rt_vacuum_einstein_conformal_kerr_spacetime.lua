...
-- against the species-driven original (rt_vacuum_einstein_conformal_kerr.lua).
...
spin = -0.3 -- Spin of the black hole.
...
momentApp = Moments.App.new {
  ...
  spacetime = Moments.Spacetime.new {
    ...
    init = function (t, xn)
      ...
      local conformal_lapse = BlackHole.lapseFunction(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0)
      local conformal_shift = BlackHole.shiftVector(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0)
      local conformal_spatial_metric = BlackHole.spatialMetricTensor(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0)
      local inv_conformal_spatial_metric = BlackHole.invSpatialMetricTensor(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0)
      local conformal_spatial_det = BlackHole.spatialMetricDeterminant(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0)
      local conformal_extrinsic_curvature = BlackHole.extrinsicCurvatureTensor(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0,
      ...
      local conformal_lapse_der = BlackHole.lapseFunctionDer(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0,
        math.pow(10.0, -8.0), math.pow(10.0, -8.0), math.pow(10.0, -8.0))
      local conformal_shift_der = BlackHole.shiftVectorDer(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0,
        math.pow(10.0, -8.0), math.pow(10.0, -8.0), math.pow(10.0, -8.0))
      local conformal_spatial_metric_der = BlackHole.spatialMetricTensorDer(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0,
        math.pow(10.0, -8.0), math.pow(10.0, -8.0), math.pow(10.0, -8.0))
      
      local conformal_fact = BlackHole.conformalFactor(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0)
      local bssn_conformal_fact = BlackHole.bssnConformalFactor(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0)

      local conformal_fact_der = BlackHole.conformalFactorDer(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0,
        math.pow(10.0, -8.0), math.pow(10.0, -8.0), math.pow(10.0, -8.0))
      local bssn_conformal_fact_der = BlackHole.bssnConformalFactorDer(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0,
        math.pow(10.0, -8.0), math.pow(10.0, -8.0), math.pow(10.0, -8.0))
      local bssn_conformal_fact_der2 = BlackHole.bssnConformalFactorDer2(mass, spin, pos_x, pos_y, pos_z, 0.0, x, y, 0.0,
        math.pow(10.0, -8.0), math.pow(10.0, -8.0), math.pow(10.0, -8.0))
