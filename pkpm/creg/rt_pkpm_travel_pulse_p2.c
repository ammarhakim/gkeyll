...
create_ctx(void)
{
  ...
  const char* train_nn_file = "pkpm_travel_pulse_p2_moms_nn_1"; // File path of neural network to train.
  ...
  const char* test_nn_file = "pkpm_travel_pulse_p2_moms_nn_1"; // File path of neural network to test.
