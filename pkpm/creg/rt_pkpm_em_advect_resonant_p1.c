...
struct em_advect_resonant_ctx create_ctx(void)
{
  ...
  const char *train_nn_file =
    "pkpm_em_advect_resonant_p1_moms_nn_1"; // File path of neural network to train.
  ...
  const char *test_nn_file =
    "pkpm_em_advect_resonant_p1_moms_nn_1"; // File path of neural network to test.
  int num_tests = 1; // Number of times to test neural network.

  struct em_advect_resonant_ctx ctx = { .pi = pi,
                                        .epsilon0 = epsilon0,
                                        .mu0 = mu0,
                                        .mass_elc = mass_elc,
