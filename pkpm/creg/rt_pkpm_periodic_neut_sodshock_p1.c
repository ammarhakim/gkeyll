...
create_ctx(void)
{
  ...
  const char* train_nn_file = "pkpm_periodic_neut_sodshock_p1_moms_nn_1"; // File path of neural network to train.
  ...
  const char* test_nn_file = "pkpm_periodic_neut_sodshock_p1_moms_nn_1"; // File path of neural network to test.
