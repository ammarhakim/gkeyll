...
struct gkyl_mom_type *gkyl_dg_updater_moment_pkpm_acquire_type(const gkyl_dg_updater_moment *moment)
{
  return gkyl_mom_type_acquire(moment->type);
}

int gkyl_dg_updater_moment_pkpm_num_mom(const gkyl_dg_updater_moment *moment)
{
...
void gkyl_dg_updater_moment_pkpm_release(gkyl_dg_updater_moment *moment)
{
