...
} gkyl_dg_lbo_pkpm_drag_vol_kern_list;
typedef struct {
  lbo_pkpm_drag_surf_t kernels[3];
} gkyl_dg_lbo_pkpm_drag_surf_kern_list;
typedef struct {
  lbo_pkpm_drag_boundary_surf_t kernels[3];
} gkyl_dg_lbo_pkpm_drag_boundary_surf_kern_list;
  ...
  struct dg_lbo_pkpm_drag *lbo_pkpm_drag, const double *nuSum_p, const double *nuVtSqSum_p)
{
  ...
  noPrimMomCross = noPrimMomCross &&
    ((nuVtSqSum_p[0] > 0.) && (nuVtSqSum_p[0] / nuSum_p[0] < lbo_pkpm_drag->vMaxSq));
...
kernel_lbo_pkpm_drag_vol_1x1v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  const double *nuPrimMomsSum_p =
    (const double *)gkyl_array_cfetch(lbo_pkpm_drag->auxfields.nuPrimMomsSum, cidx);
...
GKYL_CU_DH static double
kernel_lbo_pkpm_drag_vol_1x1v_ser_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_lbo_pkpm_drag *lbo_pkpm_drag = container_of(eqn, struct dg_lbo_pkpm_drag, eqn);
  long cidx = gkyl_range_idx(&lbo_pkpm_drag->conf_range, idx);
...
GKYL_CU_DH static double
kernel_lbo_pkpm_drag_vol_1x1v_tensor_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_lbo_pkpm_drag *lbo_pkpm_drag = container_of(eqn, struct dg_lbo_pkpm_drag, eqn);
  long cidx = gkyl_range_idx(&lbo_pkpm_drag->conf_range, idx);
...
GKYL_CU_DH static double
kernel_lbo_pkpm_drag_vol_2x1v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_lbo_pkpm_drag *lbo_pkpm_drag = container_of(eqn, struct dg_lbo_pkpm_drag, eqn);
  long cidx = gkyl_range_idx(&lbo_pkpm_drag->conf_range, idx);
...
GKYL_CU_DH static double
kernel_lbo_pkpm_drag_vol_2x1v_tensor_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_lbo_pkpm_drag *lbo_pkpm_drag = container_of(eqn, struct dg_lbo_pkpm_drag, eqn);
  long cidx = gkyl_range_idx(&lbo_pkpm_drag->conf_range, idx);
...
GKYL_CU_DH static double
kernel_lbo_pkpm_drag_vol_3x1v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_lbo_pkpm_drag *lbo_pkpm_drag = container_of(eqn, struct dg_lbo_pkpm_drag, eqn);
  long cidx = gkyl_range_idx(&lbo_pkpm_drag->conf_range, idx);
...
GKYL_CU_D static const gkyl_dg_lbo_pkpm_drag_vol_kern_list ser_vol_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_lbo_pkpm_drag_vol_kern_list ten_vol_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_lbo_pkpm_drag_surf_kern_list ser_surf_vpar_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_lbo_pkpm_drag_surf_kern_list ten_surf_vpar_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_lbo_pkpm_drag_boundary_surf_kern_list
  ser_boundary_surf_vpar_kernels[] = {
    // 1x kernels
    {NULL, lbo_pkpm_drag_boundary_surfvpar_1x1v_ser_p1,
      lbo_pkpm_drag_boundary_surfvpar_1x1v_ser_p2}, // 0
    // 2x kernels
...
GKYL_CU_D static const gkyl_dg_lbo_pkpm_drag_boundary_surf_kern_list
  ten_boundary_surf_vpar_kernels[] = {
    // 1x kernels
    {NULL, lbo_pkpm_drag_boundary_surfvpar_1x1v_ser_p1,
      lbo_pkpm_drag_boundary_surfvpar_1x1v_tensor_p2}, // 0
    // 2x kernels
    {NULL, lbo_pkpm_drag_boundary_surfvpar_2x1v_ser_p1,
      lbo_pkpm_drag_boundary_surfvpar_2x1v_tensor_p2}, // 1
    // 3x kernels
    {NULL, lbo_pkpm_drag_boundary_surfvpar_3x1v_ser_p1, NULL}, // 2
};
  ...
  double *GKYL_RESTRICT qRhsOut)
{
  ...
  if ((dir >= lbo_pkpm_drag->cdim) && (noPrimMomCross)) {
    return lbo_pkpm_drag->surf(xcC, dxC, nuSum_p, nuPrimMomsSum_p, qInL, qInC, qInR, qRhsOut);
  }
  return 0.;
}
