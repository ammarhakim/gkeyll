...
# CUDA
export USING_NVCC NVCC_FLAGS CUDA_LIBS SQL_CFLAGS CUDAMATH_LIB_DIR
# LAPACK
...
# MPI
export USING_MPI
export MPI_INC_DIR MPI_LIB_DIR MPI_LIBS MPI_RPATH
export CONF_MPI_INC_DIR CONF_MPI_LIB_DIR
# NCCL
export USING_NCCL
export NCCL_INC_DIR NCCL_LIB_DIR NCCL_LIBS
export CONF_NCCL_INC_DIR CONF_NCCL_LIB_DIR
# CUDSS
export USING_CUDSS
export CUDSS_INC_DIR CUDSS_LIB_DIR CUDSS_LIBS CUDSS_RPATH
export CONF_CUDSS_INC_DIR CONF_CUDSS_LIB_DIR
# LUA
export USING_LUA
export LUA_INC_DIR LUA_LIB_DIR LUA_LIBS LUA_RPATH
export CONF_LUA_INC_DIR CONF_LUA_LIB_DIR CONF_LUA_LIB
# SUNDIALS
export USING_SUNDIALS
export SUNDIALS_INC_DIR SUNDIALS_LIB_DIR SUNDIALS_LIBS SUNDIALS_RPATH
export CONF_SUNDIALS_INC_DIR CONF_SUNDIALS_LIB_DIR CONF_SUNDIALS_LIB
