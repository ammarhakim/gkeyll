                                    ...
                                    struct vm_emitting_wall *emit)
{
  ...
  emit->emit_ghost_r = (emit->edge == GKYL_LOWER_EDGE) ? &s->lower_ghost[emit->dir] :
                                                         &s->upper_ghost[emit->dir];
  emit->emit_skin_r = (emit->edge == GKYL_LOWER_EDGE) ? &s->lower_skin[emit->dir] :
                                                        &s->upper_skin[emit->dir];
