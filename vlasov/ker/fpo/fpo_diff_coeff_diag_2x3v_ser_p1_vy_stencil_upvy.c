...
GKYL_CU_DH void fpo_diff_coeff_diag_2x3v_vy_ser_p1_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[3], const double* fpo_d2gdv2_surf, double *diff_coeff) {
  ...
  out[48] = -(1.0489329895978423*G_L[4]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[4]*dv1_sq*gamma_avg-0.6987712429686844*G_L[0]*dv1_sq*gamma_avg+0.6987712429686844*G_C[0]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[0]*gamma_avg; 
  out[49] = -(1.048932989597842*G_L[9]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[9]*dv1_sq*gamma_avg-0.6987712429686844*G_L[1]*dv1_sq*gamma_avg+0.6987712429686844*G_C[1]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[1]*gamma_avg; 
  out[50] = -(1.048932989597842*G_L[10]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[10]*dv1_sq*gamma_avg-0.6987712429686844*G_L[2]*dv1_sq*gamma_avg+0.6987712429686844*G_C[2]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[2]*gamma_avg; 
  out[51] = -(1.048932989597842*G_L[11]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[11]*dv1_sq*gamma_avg-0.6987712429686844*G_L[3]*dv1_sq*gamma_avg+0.6987712429686844*G_C[3]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[3]*gamma_avg; 
  out[52] = -(1.048932989597842*G_L[15]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[15]*dv1_sq*gamma_avg-0.6987712429686844*G_L[5]*dv1_sq*gamma_avg+0.6987712429686844*G_C[5]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[4]*gamma_avg; 
  out[53] = -(1.0489329895978423*G_L[17]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[17]*dv1_sq*gamma_avg-0.6987712429686844*G_L[6]*dv1_sq*gamma_avg+0.6987712429686844*G_C[6]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[5]*gamma_avg; 
  out[54] = -(1.0489329895978423*G_L[18]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[18]*dv1_sq*gamma_avg-0.6987712429686844*G_L[7]*dv1_sq*gamma_avg+0.6987712429686844*G_C[7]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[6]*gamma_avg; 
  out[55] = -(1.0489329895978423*G_L[19]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[19]*dv1_sq*gamma_avg-0.6987712429686844*G_L[8]*dv1_sq*gamma_avg+0.6987712429686844*G_C[8]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[7]*gamma_avg; 
  out[56] = -(1.0489329895978423*G_L[23]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[23]*dv1_sq*gamma_avg-0.6987712429686844*G_L[12]*dv1_sq*gamma_avg+0.6987712429686844*G_C[12]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[8]*gamma_avg; 
  out[57] = -(1.0489329895978423*G_L[24]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[24]*dv1_sq*gamma_avg-0.6987712429686844*G_L[13]*dv1_sq*gamma_avg+0.6987712429686844*G_C[13]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[9]*gamma_avg; 
  out[58] = -(1.0489329895978423*G_L[25]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[25]*dv1_sq*gamma_avg-0.6987712429686844*G_L[14]*dv1_sq*gamma_avg+0.6987712429686844*G_C[14]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[10]*gamma_avg; 
  out[59] = -(1.048932989597842*G_L[26]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[26]*dv1_sq*gamma_avg-0.6987712429686844*G_L[16]*dv1_sq*gamma_avg+0.6987712429686844*G_C[16]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[11]*gamma_avg; 
  out[60] = -(1.048932989597842*G_L[28]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[28]*dv1_sq*gamma_avg-0.6987712429686844*G_L[20]*dv1_sq*gamma_avg+0.6987712429686844*G_C[20]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[12]*gamma_avg; 
  out[61] = -(1.048932989597842*G_L[29]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[29]*dv1_sq*gamma_avg-0.6987712429686844*G_L[21]*dv1_sq*gamma_avg+0.6987712429686844*G_C[21]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[13]*gamma_avg; 
  out[62] = -(1.048932989597842*G_L[30]*dv1_sq*gamma_avg)-1.3716816017817937*G_C[30]*dv1_sq*gamma_avg-0.6987712429686844*G_L[22]*dv1_sq*gamma_avg+0.6987712429686844*G_C[22]*dv1_sq*gamma_avg+0.26352313834736496*d2G_surf_C[14]*gamma_avg; 
  out[63] = -(1.0489329895978423*G_L[31]*dv1_sq*gamma_avg)-1.3716816017817939*G_C[31]*dv1_sq*gamma_avg-0.6987712429686844*G_L[27]*dv1_sq*gamma_avg+0.6987712429686844*G_C[27]*dv1_sq*gamma_avg+0.2635231383473649*d2G_surf_C[15]*gamma_avg; 
} 
