...
void fpo_diff_coeff_cross_1x3v_vxvz_ser_p1_invx_lovz(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[0] = 0.11785113019775789*(GTR[9]+GTL[9])-0.2357022603955158*GTC[9]-0.11785113019775789*(GCR[9]+GCL[9])+0.2357022603955158*GCC[9]-0.10206207261596573*(GTR[4]+GCL[4]+GTR[2]+GTL[2]+GCR[2]+GCL[2])+0.10206207261596573*(GTL[4]+GCR[4])+0.20412414523193148*(GTC[2]+GCC[2])+0.0883883476483184*(GTR[0]+GCR[0])-0.0883883476483184*(GTL[0]+GCL[0]); 
  surft1_up[1] = 0.11785113019775789*(GTR[12]+GTL[12])-0.2357022603955158*GTC[12]-0.11785113019775789*(GCR[12]+GCL[12])+0.2357022603955158*GCC[12]-0.10206207261596573*(GTR[8]+GCL[8]+GTR[5]+GTL[5]+GCR[5]+GCL[5])+0.10206207261596573*(GTL[8]+GCR[8])+0.20412414523193148*(GTC[5]+GCC[5])+0.0883883476483184*(GTR[1]+GCR[1])-0.0883883476483184*(GTL[1]+GCL[1]); 
  surft1_up[2] = 0.20412414523193148*(GTR[9]+GCL[9])-0.20412414523193148*(GTL[9]+GCR[9])-0.1767766952966368*(GTR[4]+GTL[4]+GTR[2]+GCR[2])+0.3535533905932737*GTC[4]+0.1767766952966368*(GCR[4]+GCL[4]+GTL[2]+GCL[2])-0.3535533905932737*GCC[4]+0.15309310892394856*(GTR[0]+GTL[0]+GCR[0]+GCL[0])-0.3061862178478971*(GTC[0]+GCC[0]); 
  surft1_up[3] = 0.11785113019775789*(GTR[14]+GTL[14])-0.2357022603955158*GTC[14]-0.11785113019775789*(GCR[14]+GCL[14])+0.2357022603955158*GCC[14]-0.10206207261596573*(GTR[10]+GCL[10]+GTR[7]+GTL[7]+GCR[7]+GCL[7])+0.10206207261596573*(GTL[10]+GCR[10])+0.20412414523193148*(GTC[7]+GCC[7])+0.0883883476483184*(GTR[3]+GCR[3])-0.0883883476483184*(GTL[3]+GCL[3]); 
  surft1_up[4] = 0.20412414523193148*(GTR[12]+GCL[12])-0.20412414523193148*(GTL[12]+GCR[12])-0.1767766952966368*(GTR[8]+GTL[8]+GTR[5]+GCR[5])+0.3535533905932737*GTC[8]+0.1767766952966368*(GCR[8]+GCL[8]+GTL[5]+GCL[5])-0.3535533905932737*GCC[8]+0.15309310892394856*(GTR[1]+GTL[1]+GCR[1]+GCL[1])-0.3061862178478971*(GTC[1]+GCC[1]); 
  surft1_up[5] = 0.11785113019775789*(GTR[15]+GTL[15])-0.2357022603955158*GTC[15]-0.11785113019775789*(GCR[15]+GCL[15])+0.2357022603955158*GCC[15]-0.10206207261596573*(GTR[13]+GCL[13]+GTR[11]+GTL[11]+GCR[11]+GCL[11])+0.10206207261596573*(GTL[13]+GCR[13])+0.20412414523193148*(GTC[11]+GCC[11])+0.0883883476483184*(GTR[6]+GCR[6])-0.0883883476483184*(GTL[6]+GCL[6]); 
  surft1_up[6] = 0.20412414523193148*(GTR[14]+GCL[14])-0.20412414523193148*(GTL[14]+GCR[14])-0.1767766952966368*(GTR[10]+GTL[10]+GTR[7]+GCR[7])+0.3535533905932737*GTC[10]+0.1767766952966368*(GCR[10]+GCL[10]+GTL[7]+GCL[7])-0.3535533905932737*GCC[10]+0.15309310892394856*(GTR[3]+GTL[3]+GCR[3]+GCL[3])-0.3061862178478971*(GTC[3]+GCC[3]); 
  surft1_up[7] = 0.20412414523193148*(GTR[15]+GCL[15])-0.20412414523193148*(GTL[15]+GCR[15])-0.1767766952966368*(GTR[13]+GTL[13]+GTR[11]+GCR[11])+0.3535533905932737*GTC[13]+0.1767766952966368*(GCR[13]+GCL[13]+GTL[11]+GCL[11])-0.3535533905932737*GCC[13]+0.15309310892394856*(GTR[6]+GTL[6]+GCR[6]+GCL[6])-0.3061862178478971*(GTC[6]+GCC[6]); 
