...
GKYL_CU_DH void fpo_diff_coeff_cross_2x3v_vzvy_ser_p1_invz_invy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = -(0.11785113019775789*(GTL[15]+GBL[15]))+0.11785113019775789*(GTC[15]+GBC[15])+0.2357022603955158*GCL[15]-0.2357022603955158*GCC[15]-0.10206207261596573*(GTL[5]+GTC[5]+GBL[5]+GBC[5]+GTC[4]+GBL[4])+0.20412414523193148*(GCL[5]+GCC[5])+0.10206207261596573*(GTL[4]+GBC[4])+0.0883883476483184*(GTL[0]+GTC[0])-0.0883883476483184*(GBL[0]+GBC[0]); 
  surft1_lo[1] = -(0.11785113019775789*(GTL[23]+GBL[23]))+0.11785113019775789*(GTC[23]+GBC[23])+0.2357022603955158*GCL[23]-0.2357022603955158*GCC[23]-0.10206207261596573*(GTL[12]+GTC[12]+GBL[12]+GBC[12]+GTC[9]+GBL[9])+0.20412414523193148*(GCL[12]+GCC[12])+0.10206207261596573*(GTL[9]+GBC[9])+0.0883883476483184*(GTL[1]+GTC[1])-0.0883883476483184*(GBL[1]+GBC[1]); 
  surft1_lo[2] = -(0.11785113019775789*(GTL[24]+GBL[24]))+0.11785113019775789*(GTC[24]+GBC[24])+0.2357022603955158*GCL[24]-0.2357022603955158*GCC[24]-0.10206207261596573*(GTL[13]+GTC[13]+GBL[13]+GBC[13]+GTC[10]+GBL[10])+0.20412414523193148*(GCL[13]+GCC[13])+0.10206207261596573*(GTL[10]+GBC[10])+0.0883883476483184*(GTL[2]+GTC[2])-0.0883883476483184*(GBL[2]+GBC[2]); 
  surft1_lo[3] = -(0.11785113019775789*(GTL[25]+GBL[25]))+0.11785113019775789*(GTC[25]+GBC[25])+0.2357022603955158*GCL[25]-0.2357022603955158*GCC[25]-0.10206207261596573*(GTL[14]+GTC[14]+GBL[14]+GBC[14]+GTC[11]+GBL[11])+0.20412414523193148*(GCL[14]+GCC[14])+0.10206207261596573*(GTL[11]+GBC[11])+0.0883883476483184*(GTL[3]+GTC[3])-0.0883883476483184*(GBL[3]+GBC[3]); 
  surft1_lo[4] = -(0.20412414523193148*(GTL[15]+GBC[15]))+0.20412414523193148*(GTC[15]+GBL[15])-0.1767766952966368*(GTL[5]+GTC[5]+GTC[4]+GBC[4])+0.1767766952966368*(GBL[5]+GBC[5]+GTL[4]+GBL[4])-0.3535533905932737*GCL[4]+0.3535533905932737*GCC[4]+0.15309310892394856*(GTL[0]+GTC[0]+GBL[0]+GBC[0])-0.3061862178478971*(GCL[0]+GCC[0]); 
  surft1_lo[5] = -(0.11785113019775789*(GTL[28]+GBL[28]))+0.11785113019775789*(GTC[28]+GBC[28])+0.2357022603955158*GCL[28]-0.2357022603955158*GCC[28]-0.10206207261596573*(GTL[20]+GTC[20]+GBL[20]+GBC[20]+GTC[17]+GBL[17])+0.20412414523193148*(GCL[20]+GCC[20])+0.10206207261596573*(GTL[17]+GBC[17])+0.0883883476483184*(GTL[6]+GTC[6])-0.0883883476483184*(GBL[6]+GBC[6]); 
  surft1_lo[6] = -(0.11785113019775789*(GTL[29]+GBL[29]))+0.11785113019775789*(GTC[29]+GBC[29])+0.2357022603955158*GCL[29]-0.2357022603955158*GCC[29]-0.10206207261596573*(GTL[21]+GTC[21]+GBL[21]+GBC[21]+GTC[18]+GBL[18])+0.20412414523193148*(GCL[21]+GCC[21])+0.10206207261596573*(GTL[18]+GBC[18])+0.0883883476483184*(GTL[7]+GTC[7])-0.0883883476483184*(GBL[7]+GBC[7]); 
  surft1_lo[7] = -(0.11785113019775789*(GTL[30]+GBL[30]))+0.11785113019775789*(GTC[30]+GBC[30])+0.2357022603955158*GCL[30]-0.2357022603955158*GCC[30]-0.10206207261596573*(GTL[22]+GTC[22]+GBL[22]+GBC[22]+GTC[19]+GBL[19])+0.20412414523193148*(GCL[22]+GCC[22])+0.10206207261596573*(GTL[19]+GBC[19])+0.0883883476483184*(GTL[8]+GTC[8])-0.0883883476483184*(GBL[8]+GBC[8]); 
  surft1_lo[8] = -(0.20412414523193148*(GTL[23]+GBC[23]))+0.20412414523193148*(GTC[23]+GBL[23])-0.1767766952966368*(GTL[12]+GTC[12]+GTC[9]+GBC[9])+0.1767766952966368*(GBL[12]+GBC[12]+GTL[9]+GBL[9])-0.3535533905932737*GCL[9]+0.3535533905932737*GCC[9]+0.15309310892394856*(GTL[1]+GTC[1]+GBL[1]+GBC[1])-0.3061862178478971*(GCL[1]+GCC[1]); 
  surft1_lo[9] = -(0.20412414523193148*(GTL[24]+GBC[24]))+0.20412414523193148*(GTC[24]+GBL[24])-0.1767766952966368*(GTL[13]+GTC[13]+GTC[10]+GBC[10])+0.1767766952966368*(GBL[13]+GBC[13]+GTL[10]+GBL[10])-0.3535533905932737*GCL[10]+0.3535533905932737*GCC[10]+0.15309310892394856*(GTL[2]+GTC[2]+GBL[2]+GBC[2])-0.3061862178478971*(GCL[2]+GCC[2]); 
  surft1_lo[10] = -(0.20412414523193148*(GTL[25]+GBC[25]))+0.20412414523193148*(GTC[25]+GBL[25])-0.1767766952966368*(GTL[14]+GTC[14]+GTC[11]+GBC[11])+0.1767766952966368*(GBL[14]+GBC[14]+GTL[11]+GBL[11])-0.3535533905932737*GCL[11]+0.3535533905932737*GCC[11]+0.15309310892394856*(GTL[3]+GTC[3]+GBL[3]+GBC[3])-0.3061862178478971*(GCL[3]+GCC[3]); 
  surft1_lo[11] = -(0.11785113019775789*(GTL[31]+GBL[31]))+0.11785113019775789*(GTC[31]+GBC[31])+0.2357022603955158*GCL[31]-0.2357022603955158*GCC[31]-0.10206207261596573*(GTL[27]+GTC[27]+GBL[27]+GBC[27]+GTC[26]+GBL[26])+0.20412414523193148*(GCL[27]+GCC[27])+0.10206207261596573*(GTL[26]+GBC[26])+0.0883883476483184*(GTL[16]+GTC[16])-0.0883883476483184*(GBL[16]+GBC[16]); 
  surft1_lo[12] = -(0.20412414523193148*(GTL[28]+GBC[28]))+0.20412414523193148*(GTC[28]+GBL[28])-0.1767766952966368*(GTL[20]+GTC[20]+GTC[17]+GBC[17])+0.1767766952966368*(GBL[20]+GBC[20]+GTL[17]+GBL[17])-0.3535533905932737*GCL[17]+0.3535533905932737*GCC[17]+0.15309310892394856*(GTL[6]+GTC[6]+GBL[6]+GBC[6])-0.3061862178478971*(GCL[6]+GCC[6]); 
  surft1_lo[13] = -(0.20412414523193148*(GTL[29]+GBC[29]))+0.20412414523193148*(GTC[29]+GBL[29])-0.1767766952966368*(GTL[21]+GTC[21]+GTC[18]+GBC[18])+0.1767766952966368*(GBL[21]+GBC[21]+GTL[18]+GBL[18])-0.3535533905932737*GCL[18]+0.3535533905932737*GCC[18]+0.15309310892394856*(GTL[7]+GTC[7]+GBL[7]+GBC[7])-0.3061862178478971*(GCL[7]+GCC[7]); 
  ...
  surft1_lo[15] = -(0.20412414523193148*(GTL[31]+GBC[31]))+0.20412414523193148*(GTC[31]+GBL[31])-0.1767766952966368*(GTL[27]+GTC[27]+GTC[26]+GBC[26])+0.1767766952966368*(GBL[27]+GBC[27]+GTL[26]+GBL[26])-0.3535533905932737*GCL[26]+0.3535533905932737*GCC[26]+0.15309310892394856*(GTL[16]+GTC[16]+GBL[16]+GBC[16])-0.3061862178478971*(GCL[16]+GCC[16]); 
  surft1_up[0] = 0.11785113019775789*(GTR[15]+GBR[15])-0.11785113019775789*(GTC[15]+GBC[15])-0.2357022603955158*GCR[15]+0.2357022603955158*GCC[15]-0.10206207261596573*(GTR[5]+GTC[5]+GBR[5]+GBC[5]+GTR[4]+GBC[4])+0.20412414523193148*(GCR[5]+GCC[5])+0.10206207261596573*(GTC[4]+GBR[4])+0.0883883476483184*(GTR[0]+GTC[0])-0.0883883476483184*(GBR[0]+GBC[0]); 
  ...
  surft1_up[2] = 0.11785113019775789*(GTR[24]+GBR[24])-0.11785113019775789*(GTC[24]+GBC[24])-0.2357022603955158*GCR[24]+0.2357022603955158*GCC[24]-0.10206207261596573*(GTR[13]+GTC[13]+GBR[13]+GBC[13]+GTR[10]+GBC[10])+0.20412414523193148*(GCR[13]+GCC[13])+0.10206207261596573*(GTC[10]+GBR[10])+0.0883883476483184*(GTR[2]+GTC[2])-0.0883883476483184*(GBR[2]+GBC[2]); 
  surft1_up[3] = 0.11785113019775789*(GTR[25]+GBR[25])-0.11785113019775789*(GTC[25]+GBC[25])-0.2357022603955158*GCR[25]+0.2357022603955158*GCC[25]-0.10206207261596573*(GTR[14]+GTC[14]+GBR[14]+GBC[14]+GTR[11]+GBC[11])+0.20412414523193148*(GCR[14]+GCC[14])+0.10206207261596573*(GTC[11]+GBR[11])+0.0883883476483184*(GTR[3]+GTC[3])-0.0883883476483184*(GBR[3]+GBC[3]); 
  surft1_up[4] = 0.20412414523193148*(GTR[15]+GBC[15])-0.20412414523193148*(GTC[15]+GBR[15])-0.1767766952966368*(GTR[5]+GTC[5]+GTR[4]+GBR[4])+0.1767766952966368*(GBR[5]+GBC[5]+GTC[4]+GBC[4])+0.3535533905932737*GCR[4]-0.3535533905932737*GCC[4]+0.15309310892394856*(GTR[0]+GTC[0]+GBR[0]+GBC[0])-0.3061862178478971*(GCR[0]+GCC[0]); 
  surft1_up[5] = 0.11785113019775789*(GTR[28]+GBR[28])-0.11785113019775789*(GTC[28]+GBC[28])-0.2357022603955158*GCR[28]+0.2357022603955158*GCC[28]-0.10206207261596573*(GTR[20]+GTC[20]+GBR[20]+GBC[20]+GTR[17]+GBC[17])+0.20412414523193148*(GCR[20]+GCC[20])+0.10206207261596573*(GTC[17]+GBR[17])+0.0883883476483184*(GTR[6]+GTC[6])-0.0883883476483184*(GBR[6]+GBC[6]); 
  surft1_up[6] = 0.11785113019775789*(GTR[29]+GBR[29])-0.11785113019775789*(GTC[29]+GBC[29])-0.2357022603955158*GCR[29]+0.2357022603955158*GCC[29]-0.10206207261596573*(GTR[21]+GTC[21]+GBR[21]+GBC[21]+GTR[18]+GBC[18])+0.20412414523193148*(GCR[21]+GCC[21])+0.10206207261596573*(GTC[18]+GBR[18])+0.0883883476483184*(GTR[7]+GTC[7])-0.0883883476483184*(GBR[7]+GBC[7]); 
  surft1_up[7] = 0.11785113019775789*(GTR[30]+GBR[30])-0.11785113019775789*(GTC[30]+GBC[30])-0.2357022603955158*GCR[30]+0.2357022603955158*GCC[30]-0.10206207261596573*(GTR[22]+GTC[22]+GBR[22]+GBC[22]+GTR[19]+GBC[19])+0.20412414523193148*(GCR[22]+GCC[22])+0.10206207261596573*(GTC[19]+GBR[19])+0.0883883476483184*(GTR[8]+GTC[8])-0.0883883476483184*(GBR[8]+GBC[8]); 
  surft1_up[8] = 0.20412414523193148*(GTR[23]+GBC[23])-0.20412414523193148*(GTC[23]+GBR[23])-0.1767766952966368*(GTR[12]+GTC[12]+GTR[9]+GBR[9])+0.1767766952966368*(GBR[12]+GBC[12]+GTC[9]+GBC[9])+0.3535533905932737*GCR[9]-0.3535533905932737*GCC[9]+0.15309310892394856*(GTR[1]+GTC[1]+GBR[1]+GBC[1])-0.3061862178478971*(GCR[1]+GCC[1]); 
  surft1_up[9] = 0.20412414523193148*(GTR[24]+GBC[24])-0.20412414523193148*(GTC[24]+GBR[24])-0.1767766952966368*(GTR[13]+GTC[13]+GTR[10]+GBR[10])+0.1767766952966368*(GBR[13]+GBC[13]+GTC[10]+GBC[10])+0.3535533905932737*GCR[10]-0.3535533905932737*GCC[10]+0.15309310892394856*(GTR[2]+GTC[2]+GBR[2]+GBC[2])-0.3061862178478971*(GCR[2]+GCC[2]); 
  surft1_up[10] = 0.20412414523193148*(GTR[25]+GBC[25])-0.20412414523193148*(GTC[25]+GBR[25])-0.1767766952966368*(GTR[14]+GTC[14]+GTR[11]+GBR[11])+0.1767766952966368*(GBR[14]+GBC[14]+GTC[11]+GBC[11])+0.3535533905932737*GCR[11]-0.3535533905932737*GCC[11]+0.15309310892394856*(GTR[3]+GTC[3]+GBR[3]+GBC[3])-0.3061862178478971*(GCR[3]+GCC[3]); 
  surft1_up[11] = 0.11785113019775789*(GTR[31]+GBR[31])-0.11785113019775789*(GTC[31]+GBC[31])-0.2357022603955158*GCR[31]+0.2357022603955158*GCC[31]-0.10206207261596573*(GTR[27]+GTC[27]+GBR[27]+GBC[27]+GTR[26]+GBC[26])+0.20412414523193148*(GCR[27]+GCC[27])+0.10206207261596573*(GTC[26]+GBR[26])+0.0883883476483184*(GTR[16]+GTC[16])-0.0883883476483184*(GBR[16]+GBC[16]); 
  surft1_up[12] = 0.20412414523193148*(GTR[28]+GBC[28])-0.20412414523193148*(GTC[28]+GBR[28])-0.1767766952966368*(GTR[20]+GTC[20]+GTR[17]+GBR[17])+0.1767766952966368*(GBR[20]+GBC[20]+GTC[17]+GBC[17])+0.3535533905932737*GCR[17]-0.3535533905932737*GCC[17]+0.15309310892394856*(GTR[6]+GTC[6]+GBR[6]+GBC[6])-0.3061862178478971*(GCR[6]+GCC[6]); 
  surft1_up[13] = 0.20412414523193148*(GTR[29]+GBC[29])-0.20412414523193148*(GTC[29]+GBR[29])-0.1767766952966368*(GTR[21]+GTC[21]+GTR[18]+GBR[18])+0.1767766952966368*(GBR[21]+GBC[21]+GTC[18]+GBC[18])+0.3535533905932737*GCR[18]-0.3535533905932737*GCC[18]+0.15309310892394856*(GTR[7]+GTC[7]+GBR[7]+GBC[7])-0.3061862178478971*(GCR[7]+GCC[7]); 
  ...
  out[48] = (vol[48]-2.7386127875258306*surft2_up[4]+2.7386127875258306*surft2_lo[4]+1.5811388300841895*surft1_up[0]-1.5811388300841895*surft1_lo[0])*dv1_sq*gamma_avg; 
  out[49] = (vol[49]-2.7386127875258306*surft2_up[8]+2.7386127875258306*surft2_lo[8]+1.5811388300841898*surft1_up[1]-1.5811388300841898*surft1_lo[1])*dv1_sq*gamma_avg; 
  out[50] = (vol[50]-2.7386127875258306*surft2_up[9]+2.7386127875258306*surft2_lo[9]+1.5811388300841898*surft1_up[2]-1.5811388300841898*surft1_lo[2])*dv1_sq*gamma_avg; 
  out[51] = (vol[51]-2.7386127875258306*surft2_up[10]+2.7386127875258306*surft2_lo[10]+1.5811388300841898*surft1_up[3]-1.5811388300841898*surft1_lo[3])*dv1_sq*gamma_avg; 
  out[52] = (vol[52]-4.743416490252569*(surft2_up[4]+surft2_lo[4])+1.5811388300841898*surft1_up[4]-1.5811388300841898*surft1_lo[4])*dv1_sq*gamma_avg; 
  out[53] = (vol[53]-2.7386127875258306*surft2_up[12]+2.7386127875258306*surft2_lo[12]+1.5811388300841895*surft1_up[5]-1.5811388300841895*surft1_lo[5])*dv1_sq*gamma_avg; 
  out[54] = (vol[54]-2.7386127875258306*surft2_up[13]+2.7386127875258306*surft2_lo[13]+1.5811388300841895*surft1_up[6]-1.5811388300841895*surft1_lo[6])*dv1_sq*gamma_avg; 
  out[55] = (vol[55]-2.7386127875258306*surft2_up[14]+2.7386127875258306*surft2_lo[14]+1.5811388300841895*surft1_up[7]-1.5811388300841895*surft1_lo[7])*dv1_sq*gamma_avg; 
  out[56] = (vol[56]-4.743416490252569*(surft2_up[8]+surft2_lo[8])+1.5811388300841895*surft1_up[8]-1.5811388300841895*surft1_lo[8])*dv1_sq*gamma_avg; 
  out[57] = (vol[57]-4.743416490252569*(surft2_up[9]+surft2_lo[9])+1.5811388300841895*surft1_up[9]-1.5811388300841895*surft1_lo[9])*dv1_sq*gamma_avg; 
  ...
  out[59] = (vol[59]-2.7386127875258306*surft2_up[15]+2.7386127875258306*surft2_lo[15]+1.5811388300841898*surft1_up[11]-1.5811388300841898*surft1_lo[11])*dv1_sq*gamma_avg; 
  out[60] = (vol[60]-4.743416490252569*(surft2_up[12]+surft2_lo[12])+1.5811388300841898*surft1_up[12]-1.5811388300841898*surft1_lo[12])*dv1_sq*gamma_avg; 
  ...
  out[68] = (vol[68]-2.7386127875258306*surft2_up[0]+2.7386127875258306*surft2_lo[0])*dv1_sq*gamma_avg; 
  out[69] = vol[69]*dv1_sq*gamma_avg; 
  out[70] = vol[70]*dv1_sq*gamma_avg; 
  out[71] = vol[71]*dv1_sq*gamma_avg; 
  out[72] = (vol[72]-2.7386127875258306*surft2_up[1]+2.7386127875258306*surft2_lo[1])*dv1_sq*gamma_avg; 
  out[73] = (vol[73]-2.7386127875258306*surft2_up[2]+2.7386127875258306*surft2_lo[2])*dv1_sq*gamma_avg; 
  out[74] = (vol[74]-2.7386127875258306*surft2_up[3]+2.7386127875258306*surft2_lo[3])*dv1_sq*gamma_avg; 
  out[75] = vol[75]*dv1_sq*gamma_avg; 
  out[76] = (vol[76]-2.7386127875258306*surft2_up[5]+2.7386127875258306*surft2_lo[5])*dv1_sq*gamma_avg; 
  out[77] = (vol[77]-2.7386127875258306*surft2_up[6]+2.7386127875258306*surft2_lo[6])*dv1_sq*gamma_avg; 
  out[78] = (vol[78]-2.7386127875258306*surft2_up[7]+2.7386127875258306*surft2_lo[7])*dv1_sq*gamma_avg; 
  out[79] = (vol[79]-2.7386127875258306*surft2_up[11]+2.7386127875258306*surft2_lo[11])*dv1_sq*gamma_avg; 
} 
