...
void fpo_diff_coeff_cross_1x3v_vyvz_ser_p1_lovy_invz(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = -(0.7071067811865475*GCC[10])+0.7071067811865475*GBC[10]+0.6123724356957944*(GCC[3]+GBC[3]); 
  surft1_lo[1] = -(0.7071067811865475*GCC[13])+0.7071067811865475*GBC[13]+0.6123724356957944*(GCC[6]+GBC[6]); 
  surft1_lo[2] = -(0.7071067811865475*GCC[14])+0.7071067811865475*GBC[14]+0.6123724356957944*(GCC[7]+GBC[7]); 
  surft1_lo[4] = -(0.7071067811865475*GCC[15])+0.7071067811865475*GBC[15]+0.6123724356957944*(GCC[11]+GBC[11]); 
  surft1_up[0] = -(0.7071067811865475*GTC[10])+0.7071067811865475*GCC[10]+0.6123724356957944*(GTC[3]+GCC[3]); 
  surft1_up[1] = -(0.7071067811865475*GTC[13])+0.7071067811865475*GCC[13]+0.6123724356957944*(GTC[6]+GCC[6]); 
  surft1_up[2] = -(0.7071067811865475*GTC[14])+0.7071067811865475*GCC[14]+0.6123724356957944*(GTC[7]+GCC[7]); 
  surft1_up[4] = -(0.7071067811865475*GTC[15])+0.7071067811865475*GCC[15]+0.6123724356957944*(GTC[11]+GCC[11]); 
