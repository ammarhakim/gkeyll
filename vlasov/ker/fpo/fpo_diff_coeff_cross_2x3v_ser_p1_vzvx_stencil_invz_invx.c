...
GKYL_CU_DH void fpo_diff_coeff_cross_2x3v_vzvx_ser_p1_invz_invx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_up[0] = 0.11785113019775789*(GTR[14]+GBR[14])-0.11785113019775789*(GTC[14]+GBC[14])-0.2357022603955158*GCR[14]+0.2357022603955158*GCC[14]-0.10206207261596573*(GTR[5]+GTC[5]+GBR[5]+GBC[5]+GTR[3]+GBC[3])+0.20412414523193148*(GCR[5]+GCC[5])+0.10206207261596573*(GTC[3]+GBR[3])+0.0883883476483184*(GTR[0]+GTC[0])-0.0883883476483184*(GBR[0]+GBC[0]); 
  ...
  surft1_up[2] = 0.11785113019775789*(GTR[22]+GBR[22])-0.11785113019775789*(GTC[22]+GBC[22])-0.2357022603955158*GCR[22]+0.2357022603955158*GCC[22]-0.10206207261596573*(GTR[13]+GTC[13]+GBR[13]+GBC[13]+GTR[8]+GBC[8])+0.20412414523193148*(GCR[13]+GCC[13])+0.10206207261596573*(GTC[8]+GBR[8])+0.0883883476483184*(GTR[2]+GTC[2])-0.0883883476483184*(GBR[2]+GBC[2]); 
  surft1_up[3] = 0.11785113019775789*(GTR[25]+GBR[25])-0.11785113019775789*(GTC[25]+GBC[25])-0.2357022603955158*GCR[25]+0.2357022603955158*GCC[25]-0.10206207261596573*(GTR[15]+GTC[15]+GBR[15]+GBC[15]+GTR[11]+GBC[11])+0.20412414523193148*(GCR[15]+GCC[15])+0.10206207261596573*(GTC[11]+GBR[11])+0.0883883476483184*(GTR[4]+GTC[4])-0.0883883476483184*(GBR[4]+GBC[4]); 
  surft1_up[4] = 0.20412414523193148*(GTR[14]+GBC[14])-0.20412414523193148*(GTC[14]+GBR[14])-0.1767766952966368*(GTR[5]+GTC[5]+GTR[3]+GBR[3])+0.1767766952966368*(GBR[5]+GBC[5]+GTC[3]+GBC[3])+0.3535533905932737*GCR[3]-0.3535533905932737*GCC[3]+0.15309310892394856*(GTR[0]+GTC[0]+GBR[0]+GBC[0])-0.3061862178478971*(GCR[0]+GCC[0]); 
  surft1_up[5] = 0.11785113019775789*(GTR[27]+GBR[27])-0.11785113019775789*(GTC[27]+GBC[27])-0.2357022603955158*GCR[27]+0.2357022603955158*GCC[27]-0.10206207261596573*(GTR[20]+GTC[20]+GBR[20]+GBC[20]+GTR[16]+GBC[16])+0.20412414523193148*(GCR[20]+GCC[20])+0.10206207261596573*(GTC[16]+GBR[16])+0.0883883476483184*(GTR[6]+GTC[6])-0.0883883476483184*(GBR[6]+GBC[6]); 
  surft1_up[6] = 0.11785113019775789*(GTR[29]+GBR[29])-0.11785113019775789*(GTC[29]+GBC[29])-0.2357022603955158*GCR[29]+0.2357022603955158*GCC[29]-0.10206207261596573*(GTR[23]+GTC[23]+GBR[23]+GBC[23]+GTR[18]+GBC[18])+0.20412414523193148*(GCR[23]+GCC[23])+0.10206207261596573*(GTC[18]+GBR[18])+0.0883883476483184*(GTR[9]+GTC[9])-0.0883883476483184*(GBR[9]+GBC[9]); 
  surft1_up[7] = 0.11785113019775789*(GTR[30]+GBR[30])-0.11785113019775789*(GTC[30]+GBC[30])-0.2357022603955158*GCR[30]+0.2357022603955158*GCC[30]-0.10206207261596573*(GTR[24]+GTC[24]+GBR[24]+GBC[24]+GTR[19]+GBC[19])+0.20412414523193148*(GCR[24]+GCC[24])+0.10206207261596573*(GTC[19]+GBR[19])+0.0883883476483184*(GTR[10]+GTC[10])-0.0883883476483184*(GBR[10]+GBC[10]); 
  surft1_up[8] = 0.20412414523193148*(GTR[21]+GBC[21])-0.20412414523193148*(GTC[21]+GBR[21])-0.1767766952966368*(GTR[12]+GTC[12]+GTR[7]+GBR[7])+0.1767766952966368*(GBR[12]+GBC[12]+GTC[7]+GBC[7])+0.3535533905932737*GCR[7]-0.3535533905932737*GCC[7]+0.15309310892394856*(GTR[1]+GTC[1]+GBR[1]+GBC[1])-0.3061862178478971*(GCR[1]+GCC[1]); 
  surft1_up[9] = 0.20412414523193148*(GTR[22]+GBC[22])-0.20412414523193148*(GTC[22]+GBR[22])-0.1767766952966368*(GTR[13]+GTC[13]+GTR[8]+GBR[8])+0.1767766952966368*(GBR[13]+GBC[13]+GTC[8]+GBC[8])+0.3535533905932737*GCR[8]-0.3535533905932737*GCC[8]+0.15309310892394856*(GTR[2]+GTC[2]+GBR[2]+GBC[2])-0.3061862178478971*(GCR[2]+GCC[2]); 
  surft1_up[10] = 0.20412414523193148*(GTR[25]+GBC[25])-0.20412414523193148*(GTC[25]+GBR[25])-0.1767766952966368*(GTR[15]+GTC[15]+GTR[11]+GBR[11])+0.1767766952966368*(GBR[15]+GBC[15]+GTC[11]+GBC[11])+0.3535533905932737*GCR[11]-0.3535533905932737*GCC[11]+0.15309310892394856*(GTR[4]+GTC[4]+GBR[4]+GBC[4])-0.3061862178478971*(GCR[4]+GCC[4]); 
  surft1_up[11] = 0.11785113019775789*(GTR[31]+GBR[31])-0.11785113019775789*(GTC[31]+GBC[31])-0.2357022603955158*GCR[31]+0.2357022603955158*GCC[31]-0.10206207261596573*(GTR[28]+GTC[28]+GBR[28]+GBC[28]+GTR[26]+GBC[26])+0.20412414523193148*(GCR[28]+GCC[28])+0.10206207261596573*(GTC[26]+GBR[26])+0.0883883476483184*(GTR[17]+GTC[17])-0.0883883476483184*(GBR[17]+GBC[17]); 
  surft1_up[12] = 0.20412414523193148*(GTR[27]+GBC[27])-0.20412414523193148*(GTC[27]+GBR[27])-0.1767766952966368*(GTR[20]+GTC[20]+GTR[16]+GBR[16])+0.1767766952966368*(GBR[20]+GBC[20]+GTC[16]+GBC[16])+0.3535533905932737*GCR[16]-0.3535533905932737*GCC[16]+0.15309310892394856*(GTR[6]+GTC[6]+GBR[6]+GBC[6])-0.3061862178478971*(GCR[6]+GCC[6]); 
  surft1_up[13] = 0.20412414523193148*(GTR[29]+GBC[29])-0.20412414523193148*(GTC[29]+GBR[29])-0.1767766952966368*(GTR[23]+GTC[23]+GTR[18]+GBR[18])+0.1767766952966368*(GBR[23]+GBC[23]+GTC[18]+GBC[18])+0.3535533905932737*GCR[18]-0.3535533905932737*GCC[18]+0.15309310892394856*(GTR[9]+GTC[9]+GBR[9]+GBC[9])-0.3061862178478971*(GCR[9]+GCC[9]); 
  surft1_up[14] = 0.20412414523193148*(GTR[30]+GBC[30])-0.20412414523193148*(GTC[30]+GBR[30])-0.1767766952966368*(GTR[24]+GTC[24]+GTR[19]+GBR[19])+0.1767766952966368*(GBR[24]+GBC[24]+GTC[19]+GBC[19])+0.3535533905932737*GCR[19]-0.3535533905932737*GCC[19]+0.15309310892394856*(GTR[10]+GTC[10]+GBR[10]+GBC[10])-0.3061862178478971*(GCR[10]+GCC[10]); 
  surft1_up[15] = 0.20412414523193148*(GTR[31]+GBC[31])-0.20412414523193148*(GTC[31]+GBR[31])-0.1767766952966368*(GTR[28]+GTC[28]+GTR[26]+GBR[26])+0.1767766952966368*(GBR[28]+GBC[28]+GTC[26]+GBC[26])+0.3535533905932737*GCR[26]-0.3535533905932737*GCC[26]+0.15309310892394856*(GTR[17]+GTC[17]+GBR[17]+GBC[17])-0.3061862178478971*(GCR[17]+GCC[17]); 
  ...
  out[35] = (vol[35]-2.7386127875258306*surft2_up[10]+2.7386127875258306*surft2_lo[10]+1.5811388300841898*surft1_up[3]-1.5811388300841898*surft1_lo[3])*dv1_sq*gamma_avg; 
  out[36] = (vol[36]+1.5811388300841898*surft1_up[4]-1.5811388300841898*surft1_lo[4]-4.743416490252569*(surft2_up[3]+surft2_lo[3]))*dv1_sq*gamma_avg; 
  ...
  out[38] = (vol[38]-2.7386127875258306*surft2_up[13]+2.7386127875258306*surft2_lo[13]+1.5811388300841895*surft1_up[6]-1.5811388300841895*surft1_lo[6])*dv1_sq*gamma_avg; 
  out[39] = (vol[39]-2.7386127875258306*surft2_up[14]+2.7386127875258306*surft2_lo[14]+1.5811388300841895*surft1_up[7]-1.5811388300841895*surft1_lo[7])*dv1_sq*gamma_avg; 
  out[40] = (vol[40]+1.5811388300841895*surft1_up[8]-1.5811388300841895*surft1_lo[8]-4.743416490252569*(surft2_up[6]+surft2_lo[6]))*dv1_sq*gamma_avg; 
  out[41] = (vol[41]+1.5811388300841895*surft1_up[9]-1.5811388300841895*surft1_lo[9]-4.743416490252569*(surft2_up[7]+surft2_lo[7]))*dv1_sq*gamma_avg; 
  ...
  out[43] = (vol[43]-2.7386127875258306*surft2_up[15]+2.7386127875258306*surft2_lo[15]+1.5811388300841898*surft1_up[11]-1.5811388300841898*surft1_lo[11])*dv1_sq*gamma_avg; 
  out[44] = (vol[44]+1.5811388300841898*surft1_up[12]-1.5811388300841898*surft1_lo[12]-4.743416490252569*(surft2_up[11]+surft2_lo[11]))*dv1_sq*gamma_avg; 
  ...
  out[67] = (vol[67]-2.7386127875258306*surft2_up[0]+2.7386127875258306*surft2_lo[0])*dv1_sq*gamma_avg; 
  out[68] = vol[68]*dv1_sq*gamma_avg; 
  out[69] = vol[69]*dv1_sq*gamma_avg; 
  out[70] = (vol[70]-2.7386127875258306*surft2_up[1]+2.7386127875258306*surft2_lo[1])*dv1_sq*gamma_avg; 
  out[71] = (vol[71]-2.7386127875258306*surft2_up[2]+2.7386127875258306*surft2_lo[2])*dv1_sq*gamma_avg; 
  out[72] = vol[72]*dv1_sq*gamma_avg; 
  out[73] = vol[73]*dv1_sq*gamma_avg; 
  out[74] = (vol[74]-2.7386127875258306*surft2_up[4]+2.7386127875258306*surft2_lo[4])*dv1_sq*gamma_avg; 
  out[75] = (vol[75]-2.7386127875258306*surft2_up[5]+2.7386127875258306*surft2_lo[5])*dv1_sq*gamma_avg; 
  out[76] = vol[76]*dv1_sq*gamma_avg; 
  out[77] = (vol[77]-2.7386127875258306*surft2_up[8]+2.7386127875258306*surft2_lo[8])*dv1_sq*gamma_avg; 
  out[78] = (vol[78]-2.7386127875258306*surft2_up[9]+2.7386127875258306*surft2_lo[9])*dv1_sq*gamma_avg; 
  out[79] = (vol[79]-2.7386127875258306*surft2_up[12]+2.7386127875258306*surft2_lo[12])*dv1_sq*gamma_avg; 
} 
