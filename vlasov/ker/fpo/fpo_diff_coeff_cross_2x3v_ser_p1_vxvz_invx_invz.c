...
void fpo_diff_coeff_cross_2x3v_vxvz_ser_p1_invx_invz(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = 0.11785113019775789*(GCR[14]+GCL[14])-0.2357022603955158*GCC[14]-0.11785113019775789*(GBR[14]+GBL[14])+0.2357022603955158*GBC[14]-0.10206207261596573*(GCR[5]+GBL[5]+GCR[3]+GCL[3]+GBR[3]+GBL[3])+0.10206207261596573*(GCL[5]+GBR[5])+0.20412414523193148*(GCC[3]+GBC[3])+0.0883883476483184*(GCR[0]+GBR[0])-0.0883883476483184*(GCL[0]+GBL[0]); 
  ...
  surft1_lo[2] = 0.11785113019775789*(GCR[22]+GCL[22])-0.2357022603955158*GCC[22]-0.11785113019775789*(GBR[22]+GBL[22])+0.2357022603955158*GBC[22]-0.10206207261596573*(GCR[13]+GBL[13]+GCR[8]+GCL[8]+GBR[8]+GBL[8])+0.10206207261596573*(GCL[13]+GBR[13])+0.20412414523193148*(GCC[8]+GBC[8])+0.0883883476483184*(GCR[2]+GBR[2])-0.0883883476483184*(GCL[2]+GBL[2]); 
  surft1_lo[3] = 0.20412414523193148*(GCR[14]+GBL[14])-0.20412414523193148*(GCL[14]+GBR[14])-0.1767766952966368*(GCR[5]+GCL[5]+GCR[3]+GBR[3])+0.3535533905932737*GCC[5]+0.1767766952966368*(GBR[5]+GBL[5]+GCL[3]+GBL[3])-0.3535533905932737*GBC[5]+0.15309310892394856*(GCR[0]+GCL[0]+GBR[0]+GBL[0])-0.3061862178478971*(GCC[0]+GBC[0]); 
  surft1_lo[4] = 0.11785113019775789*(GCR[25]+GCL[25])-0.2357022603955158*GCC[25]-0.11785113019775789*(GBR[25]+GBL[25])+0.2357022603955158*GBC[25]-0.10206207261596573*(GCR[15]+GBL[15]+GCR[11]+GCL[11]+GBR[11]+GBL[11])+0.10206207261596573*(GCL[15]+GBR[15])+0.20412414523193148*(GCC[11]+GBC[11])+0.0883883476483184*(GCR[4]+GBR[4])-0.0883883476483184*(GCL[4]+GBL[4]); 
  surft1_lo[5] = 0.11785113019775789*(GCR[27]+GCL[27])-0.2357022603955158*GCC[27]-0.11785113019775789*(GBR[27]+GBL[27])+0.2357022603955158*GBC[27]-0.10206207261596573*(GCR[20]+GBL[20]+GCR[16]+GCL[16]+GBR[16]+GBL[16])+0.10206207261596573*(GCL[20]+GBR[20])+0.20412414523193148*(GCC[16]+GBC[16])+0.0883883476483184*(GCR[6]+GBR[6])-0.0883883476483184*(GCL[6]+GBL[6]); 
  surft1_lo[6] = 0.20412414523193148*(GCR[21]+GBL[21])-0.20412414523193148*(GCL[21]+GBR[21])-0.1767766952966368*(GCR[12]+GCL[12]+GCR[7]+GBR[7])+0.3535533905932737*GCC[12]+0.1767766952966368*(GBR[12]+GBL[12]+GCL[7]+GBL[7])-0.3535533905932737*GBC[12]+0.15309310892394856*(GCR[1]+GCL[1]+GBR[1]+GBL[1])-0.3061862178478971*(GCC[1]+GBC[1]); 
  surft1_lo[7] = 0.20412414523193148*(GCR[22]+GBL[22])-0.20412414523193148*(GCL[22]+GBR[22])-0.1767766952966368*(GCR[13]+GCL[13]+GCR[8]+GBR[8])+0.3535533905932737*GCC[13]+0.1767766952966368*(GBR[13]+GBL[13]+GCL[8]+GBL[8])-0.3535533905932737*GBC[13]+0.15309310892394856*(GCR[2]+GCL[2]+GBR[2]+GBL[2])-0.3061862178478971*(GCC[2]+GBC[2]); 
  ...
  surft1_up[3] = 0.20412414523193148*(GTR[14]+GCL[14])-0.20412414523193148*(GTL[14]+GCR[14])-0.1767766952966368*(GTR[5]+GTL[5]+GTR[3]+GCR[3])+0.3535533905932737*GTC[5]+0.1767766952966368*(GCR[5]+GCL[5]+GTL[3]+GCL[3])-0.3535533905932737*GCC[5]+0.15309310892394856*(GTR[0]+GTL[0]+GCR[0]+GCL[0])-0.3061862178478971*(GTC[0]+GCC[0]); 
  ...
  surft1_up[5] = 0.11785113019775789*(GTR[27]+GTL[27])-0.2357022603955158*GTC[27]-0.11785113019775789*(GCR[27]+GCL[27])+0.2357022603955158*GCC[27]-0.10206207261596573*(GTR[20]+GCL[20]+GTR[16]+GTL[16]+GCR[16]+GCL[16])+0.10206207261596573*(GTL[20]+GCR[20])+0.20412414523193148*(GTC[16]+GCC[16])+0.0883883476483184*(GTR[6]+GCR[6])-0.0883883476483184*(GTL[6]+GCL[6]); 
  surft1_up[6] = 0.20412414523193148*(GTR[21]+GCL[21])-0.20412414523193148*(GTL[21]+GCR[21])-0.1767766952966368*(GTR[12]+GTL[12]+GTR[7]+GCR[7])+0.3535533905932737*GTC[12]+0.1767766952966368*(GCR[12]+GCL[12]+GTL[7]+GCL[7])-0.3535533905932737*GCC[12]+0.15309310892394856*(GTR[1]+GTL[1]+GCR[1]+GCL[1])-0.3061862178478971*(GTC[1]+GCC[1]); 
  surft1_up[7] = 0.20412414523193148*(GTR[22]+GCL[22])-0.20412414523193148*(GTL[22]+GCR[22])-0.1767766952966368*(GTR[13]+GTL[13]+GTR[8]+GCR[8])+0.3535533905932737*GTC[13]+0.1767766952966368*(GCR[13]+GCL[13]+GTL[8]+GCL[8])-0.3535533905932737*GCC[13]+0.15309310892394856*(GTR[2]+GTL[2]+GCR[2]+GCL[2])-0.3061862178478971*(GTC[2]+GCC[2]); 
  surft1_up[8] = 0.11785113019775789*(GTR[29]+GTL[29])-0.2357022603955158*GTC[29]-0.11785113019775789*(GCR[29]+GCL[29])+0.2357022603955158*GCC[29]-0.10206207261596573*(GTR[23]+GCL[23]+GTR[18]+GTL[18]+GCR[18]+GCL[18])+0.10206207261596573*(GTL[23]+GCR[23])+0.20412414523193148*(GTC[18]+GCC[18])+0.0883883476483184*(GTR[9]+GCR[9])-0.0883883476483184*(GTL[9]+GCL[9]); 
  surft1_up[9] = 0.11785113019775789*(GTR[30]+GTL[30])-0.2357022603955158*GTC[30]-0.11785113019775789*(GCR[30]+GCL[30])+0.2357022603955158*GCC[30]-0.10206207261596573*(GTR[24]+GCL[24]+GTR[19]+GTL[19]+GCR[19]+GCL[19])+0.10206207261596573*(GTL[24]+GCR[24])+0.20412414523193148*(GTC[19]+GCC[19])+0.0883883476483184*(GTR[10]+GCR[10])-0.0883883476483184*(GTL[10]+GCL[10]); 
  surft1_up[10] = 0.20412414523193148*(GTR[25]+GCL[25])-0.20412414523193148*(GTL[25]+GCR[25])-0.1767766952966368*(GTR[15]+GTL[15]+GTR[11]+GCR[11])+0.3535533905932737*GTC[15]+0.1767766952966368*(GCR[15]+GCL[15]+GTL[11]+GCL[11])-0.3535533905932737*GCC[15]+0.15309310892394856*(GTR[4]+GTL[4]+GCR[4]+GCL[4])-0.3061862178478971*(GTC[4]+GCC[4]); 
  surft1_up[11] = 0.20412414523193148*(GTR[27]+GCL[27])-0.20412414523193148*(GTL[27]+GCR[27])-0.1767766952966368*(GTR[20]+GTL[20]+GTR[16]+GCR[16])+0.3535533905932737*GTC[20]+0.1767766952966368*(GCR[20]+GCL[20]+GTL[16]+GCL[16])-0.3535533905932737*GCC[20]+0.15309310892394856*(GTR[6]+GTL[6]+GCR[6]+GCL[6])-0.3061862178478971*(GTC[6]+GCC[6]); 
  surft1_up[12] = 0.11785113019775789*(GTR[31]+GTL[31])-0.2357022603955158*GTC[31]-0.11785113019775789*(GCR[31]+GCL[31])+0.2357022603955158*GCC[31]-0.10206207261596573*(GTR[28]+GCL[28]+GTR[26]+GTL[26]+GCR[26]+GCL[26])+0.10206207261596573*(GTL[28]+GCR[28])+0.20412414523193148*(GTC[26]+GCC[26])+0.0883883476483184*(GTR[17]+GCR[17])-0.0883883476483184*(GTL[17]+GCL[17]); 
  surft1_up[13] = 0.20412414523193148*(GTR[29]+GCL[29])-0.20412414523193148*(GTL[29]+GCR[29])-0.1767766952966368*(GTR[23]+GTL[23]+GTR[18]+GCR[18])+0.3535533905932737*GTC[23]+0.1767766952966368*(GCR[23]+GCL[23]+GTL[18]+GCL[18])-0.3535533905932737*GCC[23]+0.15309310892394856*(GTR[9]+GTL[9]+GCR[9]+GCL[9])-0.3061862178478971*(GTC[9]+GCC[9]); 
  surft1_up[14] = 0.20412414523193148*(GTR[30]+GCL[30])-0.20412414523193148*(GTL[30]+GCR[30])-0.1767766952966368*(GTR[24]+GTL[24]+GTR[19]+GCR[19])+0.3535533905932737*GTC[24]+0.1767766952966368*(GCR[24]+GCL[24]+GTL[19]+GCL[19])-0.3535533905932737*GCC[24]+0.15309310892394856*(GTR[10]+GTL[10]+GCR[10]+GCL[10])-0.3061862178478971*(GTC[10]+GCC[10]); 
  surft1_up[15] = 0.20412414523193148*(GTR[31]+GCL[31])-0.20412414523193148*(GTL[31]+GCR[31])-0.1767766952966368*(GTR[28]+GTL[28]+GTR[26]+GCR[26])+0.3535533905932737*GTC[28]+0.1767766952966368*(GCR[28]+GCL[28]+GTL[26]+GCL[26])-0.3535533905932737*GCC[28]+0.15309310892394856*(GTR[17]+GTL[17]+GCR[17]+GCL[17])-0.3061862178478971*(GTC[17]+GCC[17]); 
