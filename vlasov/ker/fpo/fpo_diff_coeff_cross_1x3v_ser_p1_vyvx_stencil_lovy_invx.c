...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vyvx_ser_p1_lovy_invx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = 0.7071067811865475*GCL[7]-0.7071067811865475*GCC[7]+0.6123724356957944*(GCL[3]+GCC[3]); 
  surft1_lo[1] = 0.7071067811865475*GCL[11]-0.7071067811865475*GCC[11]+0.6123724356957944*(GCL[6]+GCC[6]); 
  surft1_lo[3] = 0.7071067811865475*GCL[14]-0.7071067811865475*GCC[14]+0.6123724356957944*(GCL[10]+GCC[10]); 
  surft1_lo[5] = 0.7071067811865475*GCL[15]-0.7071067811865475*GCC[15]+0.6123724356957944*(GCL[13]+GCC[13]); 
  surft1_up[0] = -(0.7071067811865475*GCR[7])+0.7071067811865475*GCC[7]+0.6123724356957944*(GCR[3]+GCC[3]); 
  surft1_up[1] = -(0.7071067811865475*GCR[11])+0.7071067811865475*GCC[11]+0.6123724356957944*(GCR[6]+GCC[6]); 
  surft1_up[3] = -(0.7071067811865475*GCR[14])+0.7071067811865475*GCC[14]+0.6123724356957944*(GCR[10]+GCC[10]); 
  surft1_up[5] = -(0.7071067811865475*GCR[15])+0.7071067811865475*GCC[15]+0.6123724356957944*(GCR[13]+GCC[13]); 
