...
GKYL_CU_DH void fpo_drag_coeff_1x3v_vz_ser_p1_upvz(const double *dxv, const double *gamma, 
  ...
  out[32] = ((-(0.4034357652299394*H_L[4])-1.694430213965745*H_C[4]-0.4192627457812106*H_L[0]+0.4192627457812106*H_C[0])*dv1+0.5270462766947298*dHdv_surf_C[0])*gamma_avg; 
  out[33] = ((-(0.4034357652299393*H_L[8])-1.694430213965745*H_C[8]-0.41926274578121053*H_L[1]+0.41926274578121053*H_C[1])*dv1+0.5270462766947299*dHdv_surf_C[1])*gamma_avg; 
  out[34] = ((-(0.4034357652299393*H_L[9])-1.694430213965745*H_C[9]-0.41926274578121053*H_L[2]+0.41926274578121053*H_C[2])*dv1+0.5270462766947299*dHdv_surf_C[2])*gamma_avg; 
  out[35] = ((-(0.4034357652299393*H_L[10])-1.694430213965745*H_C[10]-0.41926274578121053*H_L[3]+0.41926274578121053*H_C[3])*dv1+0.5270462766947299*dHdv_surf_C[3])*gamma_avg; 
  out[36] = ((-(0.4034357652299394*H_L[12])-1.694430213965745*H_C[12]-0.4192627457812106*H_L[5]+0.4192627457812106*H_C[5])*dv1+0.5270462766947298*dHdv_surf_C[4])*gamma_avg; 
  out[37] = ((-(0.4034357652299394*H_L[13])-1.694430213965745*H_C[13]-0.4192627457812106*H_L[6]+0.4192627457812106*H_C[6])*dv1+0.5270462766947298*dHdv_surf_C[5])*gamma_avg; 
  out[38] = ((-(0.4034357652299394*H_L[14])-1.694430213965745*H_C[14]-0.4192627457812106*H_L[7]+0.4192627457812106*H_C[7])*dv1+0.5270462766947298*dHdv_surf_C[6])*gamma_avg; 
  out[39] = ((-(0.4034357652299393*H_L[15])-1.694430213965745*H_C[15]-0.41926274578121053*H_L[11]+0.41926274578121053*H_C[11])*dv1+0.5270462766947299*dHdv_surf_C[7])*gamma_avg; 
