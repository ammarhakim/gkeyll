...
GKYL_CU_DH double fpo_vlasov_drag_boundary_surfvy_1x3v_ser_p1(const double* dxv,
  ...
  out[6] += -(0.6123724356957945*GhatR[1]*dv_inv); 
  out[7] += -(0.6123724356957945*GhatR[2]*dv_inv); 
  out[8] += -(0.35355339059327373*GhatR[5]*dv_inv); 
  out[9] += -(0.35355339059327373*GhatR[6]*dv_inv); 
  out[10] += -(0.6123724356957945*GhatR[3]*dv_inv); 
  out[11] += -(0.6123724356957945*GhatR[4]*dv_inv); 
  out[12] += -(0.35355339059327373*GhatR[7]*dv_inv); 
  out[13] += -(0.6123724356957945*GhatR[5]*dv_inv); 
  out[14] += -(0.6123724356957945*GhatR[6]*dv_inv); 
  out[15] += -(0.6123724356957945*GhatR[7]*dv_inv); 
  out[24] += -(0.7905694150420948*GhatR[0]*dv_inv); 
  out[25] += -(0.7905694150420949*GhatR[1]*dv_inv); 
  out[26] += -(0.7905694150420949*GhatR[2]*dv_inv); 
  out[27] += -(0.7905694150420949*GhatR[3]*dv_inv); 
  out[28] += -(0.7905694150420948*GhatR[4]*dv_inv); 
  out[29] += -(0.7905694150420948*GhatR[5]*dv_inv); 
  out[30] += -(0.7905694150420948*GhatR[6]*dv_inv); 
  out[31] += -(0.7905694150420949*GhatR[7]*dv_inv); 
  ...
  out[6] += -(0.6123724356957945*GhatL[1]*dv_inv); 
  out[7] += -(0.6123724356957945*GhatL[2]*dv_inv); 
  out[8] += 0.35355339059327373*GhatL[5]*dv_inv; 
  out[9] += 0.35355339059327373*GhatL[6]*dv_inv; 
  out[10] += -(0.6123724356957945*GhatL[3]*dv_inv); 
  out[11] += -(0.6123724356957945*GhatL[4]*dv_inv); 
  out[12] += 0.35355339059327373*GhatL[7]*dv_inv; 
  out[13] += -(0.6123724356957945*GhatL[5]*dv_inv); 
  out[14] += -(0.6123724356957945*GhatL[6]*dv_inv); 
  out[15] += -(0.6123724356957945*GhatL[7]*dv_inv); 
  out[24] += 0.7905694150420948*GhatL[0]*dv_inv; 
  out[25] += 0.7905694150420949*GhatL[1]*dv_inv; 
  out[26] += 0.7905694150420949*GhatL[2]*dv_inv; 
  out[27] += 0.7905694150420949*GhatL[3]*dv_inv; 
  out[28] += 0.7905694150420948*GhatL[4]*dv_inv; 
  out[29] += 0.7905694150420948*GhatL[5]*dv_inv; 
  out[30] += 0.7905694150420948*GhatL[6]*dv_inv; 
  out[31] += 0.7905694150420949*GhatL[7]*dv_inv; 
