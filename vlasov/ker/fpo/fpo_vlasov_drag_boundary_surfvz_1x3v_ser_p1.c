...
GKYL_CU_DH double fpo_vlasov_drag_boundary_surfvz_1x3v_ser_p1(const double* dxv,
  ...
  out[8] += -(0.6123724356957945*GhatR[1]*dv_inv); 
  out[9] += -(0.6123724356957945*GhatR[2]*dv_inv); 
  out[10] += -(0.6123724356957945*GhatR[3]*dv_inv); 
  out[11] += -(0.35355339059327373*GhatR[7]*dv_inv); 
  out[12] += -(0.6123724356957945*GhatR[4]*dv_inv); 
  ...
  out[36] += -(0.7905694150420948*GhatR[4]*dv_inv); 
  out[37] += -(0.7905694150420948*GhatR[5]*dv_inv); 
  out[38] += -(0.7905694150420948*GhatR[6]*dv_inv); 
  out[39] += -(0.7905694150420949*GhatR[7]*dv_inv); 
  ...
  out[8] += -(0.6123724356957945*GhatL[1]*dv_inv); 
  out[9] += -(0.6123724356957945*GhatL[2]*dv_inv); 
  out[10] += -(0.6123724356957945*GhatL[3]*dv_inv); 
  out[11] += 0.35355339059327373*GhatL[7]*dv_inv; 
  out[12] += -(0.6123724356957945*GhatL[4]*dv_inv); 
  ...
  out[36] += 0.7905694150420948*GhatL[4]*dv_inv; 
  out[37] += 0.7905694150420948*GhatL[5]*dv_inv; 
  out[38] += 0.7905694150420948*GhatL[6]*dv_inv; 
  out[39] += 0.7905694150420949*GhatL[7]*dv_inv; 
