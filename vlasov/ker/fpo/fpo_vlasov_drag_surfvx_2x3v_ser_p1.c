...
{ 
  ...
  fUp_L[0] = 1.5811388300841895*fL[32]+1.224744871391589*fL[3]+0.7071067811865475*fL[0]; 
  fUp_L[1] = 1.5811388300841898*fL[33]+1.224744871391589*fL[7]+0.7071067811865475*fL[1]; 
  fUp_L[2] = 1.5811388300841898*fL[34]+1.224744871391589*fL[8]+0.7071067811865475*fL[2]; 
  fUp_L[3] = 1.5811388300841898*fL[35]+1.224744871391589*fL[11]+0.7071067811865475*fL[4]; 
  fUp_L[4] = 1.5811388300841898*fL[36]+1.224744871391589*fL[14]+0.7071067811865475*fL[5]; 
  fUp_L[5] = 1.5811388300841895*fL[37]+1.224744871391589*fL[16]+0.7071067811865475*fL[6]; 
  fUp_L[6] = 1.5811388300841895*fL[38]+1.224744871391589*fL[18]+0.7071067811865475*fL[9]; 
  fUp_L[7] = 1.5811388300841895*fL[39]+1.224744871391589*fL[19]+0.7071067811865475*fL[10]; 
  fUp_L[8] = 1.5811388300841895*fL[40]+1.224744871391589*fL[21]+0.7071067811865475*fL[12]; 
  fUp_L[9] = 1.5811388300841895*fL[41]+1.224744871391589*fL[22]+0.7071067811865475*fL[13]; 
  fUp_L[10] = 1.5811388300841895*fL[42]+1.224744871391589*fL[25]+0.7071067811865475*fL[15]; 
  fUp_L[11] = 1.5811388300841898*fL[43]+1.224744871391589*fL[26]+0.7071067811865475*fL[17]; 
  fUp_L[12] = 1.5811388300841898*fL[44]+1.224744871391589*fL[27]+0.7071067811865475*fL[20]; 
  fUp_L[13] = 1.5811388300841898*fL[45]+1.224744871391589*fL[29]+0.7071067811865475*fL[23]; 
  fUp_L[14] = 1.5811388300841898*fL[46]+1.224744871391589*fL[30]+0.7071067811865475*fL[24]; 
  fUp_L[15] = 1.5811388300841895*fL[47]+1.224744871391589*fL[31]+0.7071067811865475*fL[28]; 
    } else { 
  fUp_L[0] = 1.5811388300841895*fC[32]-1.224744871391589*fC[3]+0.7071067811865475*fC[0]; 
  fUp_L[1] = 1.5811388300841898*fC[33]-1.224744871391589*fC[7]+0.7071067811865475*fC[1]; 
  fUp_L[2] = 1.5811388300841898*fC[34]-1.224744871391589*fC[8]+0.7071067811865475*fC[2]; 
  fUp_L[3] = 1.5811388300841898*fC[35]-1.224744871391589*fC[11]+0.7071067811865475*fC[4]; 
  fUp_L[4] = 1.5811388300841898*fC[36]-1.224744871391589*fC[14]+0.7071067811865475*fC[5]; 
  fUp_L[5] = 1.5811388300841895*fC[37]-1.224744871391589*fC[16]+0.7071067811865475*fC[6]; 
  fUp_L[6] = 1.5811388300841895*fC[38]-1.224744871391589*fC[18]+0.7071067811865475*fC[9]; 
  fUp_L[7] = 1.5811388300841895*fC[39]-1.224744871391589*fC[19]+0.7071067811865475*fC[10]; 
  fUp_L[8] = 1.5811388300841895*fC[40]-1.224744871391589*fC[21]+0.7071067811865475*fC[12]; 
  fUp_L[9] = 1.5811388300841895*fC[41]-1.224744871391589*fC[22]+0.7071067811865475*fC[13]; 
  fUp_L[10] = 1.5811388300841895*fC[42]-1.224744871391589*fC[25]+0.7071067811865475*fC[15]; 
  fUp_L[11] = 1.5811388300841898*fC[43]-1.224744871391589*fC[26]+0.7071067811865475*fC[17]; 
  fUp_L[12] = 1.5811388300841898*fC[44]-1.224744871391589*fC[27]+0.7071067811865475*fC[20]; 
  fUp_L[13] = 1.5811388300841898*fC[45]-1.224744871391589*fC[29]+0.7071067811865475*fC[23]; 
  fUp_L[14] = 1.5811388300841898*fC[46]-1.224744871391589*fC[30]+0.7071067811865475*fC[24]; 
  fUp_L[15] = 1.5811388300841895*fC[47]-1.224744871391589*fC[31]+0.7071067811865475*fC[28]; 
   } 
  } else { 
  double fL_r[16] = {0.0}; 
  double fC_l[16] = {0.0}; 
  ...
  fL_r[0] = 1.5811388300841895*fL[32]+1.224744871391589*fL[3]+0.7071067811865475*fL[0]; 
  fL_r[1] = 1.5811388300841898*fL[33]+1.224744871391589*fL[7]+0.7071067811865475*fL[1]; 
  fL_r[2] = 1.5811388300841898*fL[34]+1.224744871391589*fL[8]+0.7071067811865475*fL[2]; 
  fL_r[3] = 1.5811388300841898*fL[35]+1.224744871391589*fL[11]+0.7071067811865475*fL[4]; 
  fL_r[4] = 1.5811388300841898*fL[36]+1.224744871391589*fL[14]+0.7071067811865475*fL[5]; 
  fL_r[5] = 1.5811388300841895*fL[37]+1.224744871391589*fL[16]+0.7071067811865475*fL[6]; 
  fL_r[6] = 1.5811388300841895*fL[38]+1.224744871391589*fL[18]+0.7071067811865475*fL[9]; 
  fL_r[7] = 1.5811388300841895*fL[39]+1.224744871391589*fL[19]+0.7071067811865475*fL[10]; 
  fL_r[8] = 1.5811388300841895*fL[40]+1.224744871391589*fL[21]+0.7071067811865475*fL[12]; 
  fL_r[9] = 1.5811388300841895*fL[41]+1.224744871391589*fL[22]+0.7071067811865475*fL[13]; 
  fL_r[10] = 1.5811388300841895*fL[42]+1.224744871391589*fL[25]+0.7071067811865475*fL[15]; 
  fL_r[11] = 1.5811388300841898*fL[43]+1.224744871391589*fL[26]+0.7071067811865475*fL[17]; 
  fL_r[12] = 1.5811388300841898*fL[44]+1.224744871391589*fL[27]+0.7071067811865475*fL[20]; 
  fL_r[13] = 1.5811388300841898*fL[45]+1.224744871391589*fL[29]+0.7071067811865475*fL[23]; 
  fL_r[14] = 1.5811388300841898*fL[46]+1.224744871391589*fL[30]+0.7071067811865475*fL[24]; 
  fL_r[15] = 1.5811388300841895*fL[47]+1.224744871391589*fL[31]+0.7071067811865475*fL[28]; 

  fC_l[0] = 1.5811388300841895*fC[32]-1.224744871391589*fC[3]+0.7071067811865475*fC[0]; 
  fC_l[1] = 1.5811388300841898*fC[33]-1.224744871391589*fC[7]+0.7071067811865475*fC[1]; 
  fC_l[2] = 1.5811388300841898*fC[34]-1.224744871391589*fC[8]+0.7071067811865475*fC[2]; 
  fC_l[3] = 1.5811388300841898*fC[35]-1.224744871391589*fC[11]+0.7071067811865475*fC[4]; 
  fC_l[4] = 1.5811388300841898*fC[36]-1.224744871391589*fC[14]+0.7071067811865475*fC[5]; 
  fC_l[5] = 1.5811388300841895*fC[37]-1.224744871391589*fC[16]+0.7071067811865475*fC[6]; 
  fC_l[6] = 1.5811388300841895*fC[38]-1.224744871391589*fC[18]+0.7071067811865475*fC[9]; 
  fC_l[7] = 1.5811388300841895*fC[39]-1.224744871391589*fC[19]+0.7071067811865475*fC[10]; 
  fC_l[8] = 1.5811388300841895*fC[40]-1.224744871391589*fC[21]+0.7071067811865475*fC[12]; 
  fC_l[9] = 1.5811388300841895*fC[41]-1.224744871391589*fC[22]+0.7071067811865475*fC[13]; 
  fC_l[10] = 1.5811388300841895*fC[42]-1.224744871391589*fC[25]+0.7071067811865475*fC[15]; 
  fC_l[11] = 1.5811388300841898*fC[43]-1.224744871391589*fC[26]+0.7071067811865475*fC[17]; 
  fC_l[12] = 1.5811388300841898*fC[44]-1.224744871391589*fC[27]+0.7071067811865475*fC[20]; 
  fC_l[13] = 1.5811388300841898*fC[45]-1.224744871391589*fC[29]+0.7071067811865475*fC[23]; 
  fC_l[14] = 1.5811388300841898*fC[46]-1.224744871391589*fC[30]+0.7071067811865475*fC[24]; 
  fC_l[15] = 1.5811388300841895*fC[47]-1.224744871391589*fC[31]+0.7071067811865475*fC[28]; 
  ...
  fUp_R[0] = 1.5811388300841895*fC[32]+1.224744871391589*fC[3]+0.7071067811865475*fC[0]; 
  fUp_R[1] = 1.5811388300841898*fC[33]+1.224744871391589*fC[7]+0.7071067811865475*fC[1]; 
  fUp_R[2] = 1.5811388300841898*fC[34]+1.224744871391589*fC[8]+0.7071067811865475*fC[2]; 
  fUp_R[3] = 1.5811388300841898*fC[35]+1.224744871391589*fC[11]+0.7071067811865475*fC[4]; 
  fUp_R[4] = 1.5811388300841898*fC[36]+1.224744871391589*fC[14]+0.7071067811865475*fC[5]; 
  fUp_R[5] = 1.5811388300841895*fC[37]+1.224744871391589*fC[16]+0.7071067811865475*fC[6]; 
  fUp_R[6] = 1.5811388300841895*fC[38]+1.224744871391589*fC[18]+0.7071067811865475*fC[9]; 
  fUp_R[7] = 1.5811388300841895*fC[39]+1.224744871391589*fC[19]+0.7071067811865475*fC[10]; 
  fUp_R[8] = 1.5811388300841895*fC[40]+1.224744871391589*fC[21]+0.7071067811865475*fC[12]; 
  fUp_R[9] = 1.5811388300841895*fC[41]+1.224744871391589*fC[22]+0.7071067811865475*fC[13]; 
  fUp_R[10] = 1.5811388300841895*fC[42]+1.224744871391589*fC[25]+0.7071067811865475*fC[15]; 
  fUp_R[11] = 1.5811388300841898*fC[43]+1.224744871391589*fC[26]+0.7071067811865475*fC[17]; 
  fUp_R[12] = 1.5811388300841898*fC[44]+1.224744871391589*fC[27]+0.7071067811865475*fC[20]; 
  fUp_R[13] = 1.5811388300841898*fC[45]+1.224744871391589*fC[29]+0.7071067811865475*fC[23]; 
  fUp_R[14] = 1.5811388300841898*fC[46]+1.224744871391589*fC[30]+0.7071067811865475*fC[24]; 
  fUp_R[15] = 1.5811388300841895*fC[47]+1.224744871391589*fC[31]+0.7071067811865475*fC[28]; 
    } else { 
  fUp_R[0] = 1.5811388300841895*fR[32]-1.224744871391589*fR[3]+0.7071067811865475*fR[0]; 
  fUp_R[1] = 1.5811388300841898*fR[33]-1.224744871391589*fR[7]+0.7071067811865475*fR[1]; 
  fUp_R[2] = 1.5811388300841898*fR[34]-1.224744871391589*fR[8]+0.7071067811865475*fR[2]; 
  fUp_R[3] = 1.5811388300841898*fR[35]-1.224744871391589*fR[11]+0.7071067811865475*fR[4]; 
  fUp_R[4] = 1.5811388300841898*fR[36]-1.224744871391589*fR[14]+0.7071067811865475*fR[5]; 
  fUp_R[5] = 1.5811388300841895*fR[37]-1.224744871391589*fR[16]+0.7071067811865475*fR[6]; 
  fUp_R[6] = 1.5811388300841895*fR[38]-1.224744871391589*fR[18]+0.7071067811865475*fR[9]; 
  fUp_R[7] = 1.5811388300841895*fR[39]-1.224744871391589*fR[19]+0.7071067811865475*fR[10]; 
  fUp_R[8] = 1.5811388300841895*fR[40]-1.224744871391589*fR[21]+0.7071067811865475*fR[12]; 
  fUp_R[9] = 1.5811388300841895*fR[41]-1.224744871391589*fR[22]+0.7071067811865475*fR[13]; 
  fUp_R[10] = 1.5811388300841895*fR[42]-1.224744871391589*fR[25]+0.7071067811865475*fR[15]; 
  fUp_R[11] = 1.5811388300841898*fR[43]-1.224744871391589*fR[26]+0.7071067811865475*fR[17]; 
  fUp_R[12] = 1.5811388300841898*fR[44]-1.224744871391589*fR[27]+0.7071067811865475*fR[20]; 
  fUp_R[13] = 1.5811388300841898*fR[45]-1.224744871391589*fR[29]+0.7071067811865475*fR[23]; 
  fUp_R[14] = 1.5811388300841898*fR[46]-1.224744871391589*fR[30]+0.7071067811865475*fR[24]; 
  fUp_R[15] = 1.5811388300841895*fR[47]-1.224744871391589*fR[31]+0.7071067811865475*fR[28]; 
   } 
  } else { 
  double fC_r[16] = {0.0}; 
  double fR_l[16] = {0.0}; 
  ...
  fC_r[0] = 1.5811388300841895*fC[32]+1.224744871391589*fC[3]+0.7071067811865475*fC[0]; 
  fC_r[1] = 1.5811388300841898*fC[33]+1.224744871391589*fC[7]+0.7071067811865475*fC[1]; 
  fC_r[2] = 1.5811388300841898*fC[34]+1.224744871391589*fC[8]+0.7071067811865475*fC[2]; 
  fC_r[3] = 1.5811388300841898*fC[35]+1.224744871391589*fC[11]+0.7071067811865475*fC[4]; 
  fC_r[4] = 1.5811388300841898*fC[36]+1.224744871391589*fC[14]+0.7071067811865475*fC[5]; 
  fC_r[5] = 1.5811388300841895*fC[37]+1.224744871391589*fC[16]+0.7071067811865475*fC[6]; 
  fC_r[6] = 1.5811388300841895*fC[38]+1.224744871391589*fC[18]+0.7071067811865475*fC[9]; 
  fC_r[7] = 1.5811388300841895*fC[39]+1.224744871391589*fC[19]+0.7071067811865475*fC[10]; 
  fC_r[8] = 1.5811388300841895*fC[40]+1.224744871391589*fC[21]+0.7071067811865475*fC[12]; 
  fC_r[9] = 1.5811388300841895*fC[41]+1.224744871391589*fC[22]+0.7071067811865475*fC[13]; 
  fC_r[10] = 1.5811388300841895*fC[42]+1.224744871391589*fC[25]+0.7071067811865475*fC[15]; 
  fC_r[11] = 1.5811388300841898*fC[43]+1.224744871391589*fC[26]+0.7071067811865475*fC[17]; 
  fC_r[12] = 1.5811388300841898*fC[44]+1.224744871391589*fC[27]+0.7071067811865475*fC[20]; 
  fC_r[13] = 1.5811388300841898*fC[45]+1.224744871391589*fC[29]+0.7071067811865475*fC[23]; 
  fC_r[14] = 1.5811388300841898*fC[46]+1.224744871391589*fC[30]+0.7071067811865475*fC[24]; 
  fC_r[15] = 1.5811388300841895*fC[47]+1.224744871391589*fC[31]+0.7071067811865475*fC[28]; 

  fR_l[0] = 1.5811388300841895*fR[32]-1.224744871391589*fR[3]+0.7071067811865475*fR[0]; 
  fR_l[1] = 1.5811388300841898*fR[33]-1.224744871391589*fR[7]+0.7071067811865475*fR[1]; 
  fR_l[2] = 1.5811388300841898*fR[34]-1.224744871391589*fR[8]+0.7071067811865475*fR[2]; 
  fR_l[3] = 1.5811388300841898*fR[35]-1.224744871391589*fR[11]+0.7071067811865475*fR[4]; 
  fR_l[4] = 1.5811388300841898*fR[36]-1.224744871391589*fR[14]+0.7071067811865475*fR[5]; 
  fR_l[5] = 1.5811388300841895*fR[37]-1.224744871391589*fR[16]+0.7071067811865475*fR[6]; 
  fR_l[6] = 1.5811388300841895*fR[38]-1.224744871391589*fR[18]+0.7071067811865475*fR[9]; 
  fR_l[7] = 1.5811388300841895*fR[39]-1.224744871391589*fR[19]+0.7071067811865475*fR[10]; 
  fR_l[8] = 1.5811388300841895*fR[40]-1.224744871391589*fR[21]+0.7071067811865475*fR[12]; 
  fR_l[9] = 1.5811388300841895*fR[41]-1.224744871391589*fR[22]+0.7071067811865475*fR[13]; 
  fR_l[10] = 1.5811388300841895*fR[42]-1.224744871391589*fR[25]+0.7071067811865475*fR[15]; 
  fR_l[11] = 1.5811388300841898*fR[43]-1.224744871391589*fR[26]+0.7071067811865475*fR[17]; 
  fR_l[12] = 1.5811388300841898*fR[44]-1.224744871391589*fR[27]+0.7071067811865475*fR[20]; 
  fR_l[13] = 1.5811388300841898*fR[45]-1.224744871391589*fR[29]+0.7071067811865475*fR[23]; 
  fR_l[14] = 1.5811388300841898*fR[46]-1.224744871391589*fR[30]+0.7071067811865475*fR[24]; 
  fR_l[15] = 1.5811388300841895*fR[47]-1.224744871391589*fR[31]+0.7071067811865475*fR[28]; 
  ...
  out[3] += -(0.6123724356957945*(GhatR[0]+GhatL[0])*dv_inv); 
  out[4] += (0.35355339059327373*GhatL[3]-0.35355339059327373*GhatR[3])*dv_inv; 
  ...
  out[7] += -(0.6123724356957945*(GhatR[1]+GhatL[1])*dv_inv); 
  out[8] += -(0.6123724356957945*(GhatR[2]+GhatL[2])*dv_inv); 
  out[9] += (0.35355339059327373*GhatL[6]-0.35355339059327373*GhatR[6])*dv_inv; 
  out[10] += (0.35355339059327373*GhatL[7]-0.35355339059327373*GhatR[7])*dv_inv; 
  ...
  out[14] += -(0.6123724356957945*(GhatR[4]+GhatL[4])*dv_inv); 
  out[15] += (0.35355339059327373*GhatL[10]-0.35355339059327373*GhatR[10])*dv_inv; 
  out[16] += -(0.6123724356957945*(GhatR[5]+GhatL[5])*dv_inv); 
  out[17] += (0.35355339059327373*GhatL[11]-0.35355339059327373*GhatR[11])*dv_inv; 
  ...
  out[21] += -(0.6123724356957945*(GhatR[8]+GhatL[8])*dv_inv); 
  out[22] += -(0.6123724356957945*(GhatR[9]+GhatL[9])*dv_inv); 
  out[23] += (0.35355339059327373*GhatL[13]-0.35355339059327373*GhatR[13])*dv_inv; 
  out[24] += (0.35355339059327373*GhatL[14]-0.35355339059327373*GhatR[14])*dv_inv; 
  out[25] += -(0.6123724356957945*(GhatR[10]+GhatL[10])*dv_inv); 
  out[26] += -(0.6123724356957945*(GhatR[11]+GhatL[11])*dv_inv); 
  out[27] += -(0.6123724356957945*(GhatR[12]+GhatL[12])*dv_inv); 
  out[28] += (0.35355339059327373*GhatL[15]-0.35355339059327373*GhatR[15])*dv_inv; 
  ...
  out[32] += (0.7905694150420948*GhatL[0]-0.7905694150420948*GhatR[0])*dv_inv; 
  out[33] += (0.7905694150420949*GhatL[1]-0.7905694150420949*GhatR[1])*dv_inv; 
  out[34] += (0.7905694150420949*GhatL[2]-0.7905694150420949*GhatR[2])*dv_inv; 
  out[35] += (0.7905694150420949*GhatL[3]-0.7905694150420949*GhatR[3])*dv_inv; 
  out[36] += (0.7905694150420949*GhatL[4]-0.7905694150420949*GhatR[4])*dv_inv; 
  out[37] += (0.7905694150420948*GhatL[5]-0.7905694150420948*GhatR[5])*dv_inv; 
  out[38] += (0.7905694150420948*GhatL[6]-0.7905694150420948*GhatR[6])*dv_inv; 
  out[39] += (0.7905694150420948*GhatL[7]-0.7905694150420948*GhatR[7])*dv_inv; 
  out[40] += (0.7905694150420948*GhatL[8]-0.7905694150420948*GhatR[8])*dv_inv; 
  out[41] += (0.7905694150420948*GhatL[9]-0.7905694150420948*GhatR[9])*dv_inv; 
  out[42] += (0.7905694150420948*GhatL[10]-0.7905694150420948*GhatR[10])*dv_inv; 
  out[43] += (0.7905694150420949*GhatL[11]-0.7905694150420949*GhatR[11])*dv_inv; 
  out[44] += (0.7905694150420949*GhatL[12]-0.7905694150420949*GhatR[12])*dv_inv; 
  out[45] += (0.7905694150420949*GhatL[13]-0.7905694150420949*GhatR[13])*dv_inv; 
  out[46] += (0.7905694150420949*GhatL[14]-0.7905694150420949*GhatR[14])*dv_inv; 
  out[47] += (0.7905694150420948*GhatL[15]-0.7905694150420948*GhatR[15])*dv_inv; 
