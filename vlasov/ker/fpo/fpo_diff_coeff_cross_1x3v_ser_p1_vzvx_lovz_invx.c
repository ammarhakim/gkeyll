...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvx_ser_p1_lovz_invx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = 0.7071067811865475*GCL[9]-0.7071067811865475*GCC[9]+0.6123724356957944*(GCL[4]+GCC[4]); 
  surft1_lo[1] = 0.7071067811865475*GCL[12]-0.7071067811865475*GCC[12]+0.6123724356957944*(GCL[8]+GCC[8]); 
  surft1_lo[2] = 0.7071067811865475*GCL[14]-0.7071067811865475*GCC[14]+0.6123724356957944*(GCL[10]+GCC[10]); 
  surft1_lo[4] = 0.7071067811865475*GCL[15]-0.7071067811865475*GCC[15]+0.6123724356957944*(GCL[13]+GCC[13]); 
