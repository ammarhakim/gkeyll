...
{ 
  ...
  out[2] += -(0.6123724356957945*(GhatR[0]+GhatL[0])*dv_inv); 
  out[3] += (0.35355339059327373*GhatL[2]-0.35355339059327373*GhatR[2])*dv_inv; 
  out[4] += (0.35355339059327373*GhatL[3]-0.35355339059327373*GhatR[3])*dv_inv; 
  out[5] += -(0.6123724356957945*(GhatR[1]+GhatL[1])*dv_inv); 
  out[6] += (0.35355339059327373*GhatL[4]-0.35355339059327373*GhatR[4])*dv_inv; 
  out[7] += -(0.6123724356957945*(GhatR[2]+GhatL[2])*dv_inv); 
  out[8] += (0.35355339059327373*GhatL[5]-0.35355339059327373*GhatR[5])*dv_inv; 
  out[9] += -(0.6123724356957945*(GhatR[3]+GhatL[3])*dv_inv); 
  out[10] += (0.35355339059327373*GhatL[6]-0.35355339059327373*GhatR[6])*dv_inv; 
  out[11] += -(0.6123724356957945*(GhatR[4]+GhatL[4])*dv_inv); 
  out[12] += -(0.6123724356957945*(GhatR[5]+GhatL[5])*dv_inv); 
  out[13] += (0.35355339059327373*GhatL[7]-0.35355339059327373*GhatR[7])*dv_inv; 
  out[14] += -(0.6123724356957945*(GhatR[6]+GhatL[6])*dv_inv); 
  out[15] += -(0.6123724356957945*(GhatR[7]+GhatL[7])*dv_inv); 
  out[16] += (0.7905694150420948*GhatL[0]-0.7905694150420948*GhatR[0])*dv_inv; 
  out[17] += (0.7905694150420949*GhatL[1]-0.7905694150420949*GhatR[1])*dv_inv; 
  out[18] += (0.7905694150420949*GhatL[2]-0.7905694150420949*GhatR[2])*dv_inv; 
  out[19] += (0.7905694150420949*GhatL[3]-0.7905694150420949*GhatR[3])*dv_inv; 
  out[20] += (0.7905694150420948*GhatL[4]-0.7905694150420948*GhatR[4])*dv_inv; 
  out[21] += (0.7905694150420948*GhatL[5]-0.7905694150420948*GhatR[5])*dv_inv; 
  out[22] += (0.7905694150420948*GhatL[6]-0.7905694150420948*GhatR[6])*dv_inv; 
  out[23] += (0.7905694150420949*GhatL[7]-0.7905694150420949*GhatR[7])*dv_inv; 
