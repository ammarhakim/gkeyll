...
GKYL_CU_DH double fpo_vlasov_drag_boundary_surfvz_2x3v_ser_p1(const double* dxv,
  ...
  const double *drag_coeff_surf_Edge = &alpha_surf_Edge[32]; 
  const double *drag_coeff_surf_Skin = &alpha_surf_Skin[32]; 
  const double *sgn_drag_coeff_surf_Edge = &sgn_alpha_surf_Edge[32]; 
  const double *sgn_drag_coeff_surf_Skin = &sgn_alpha_surf_Skin[32]; 
  ...
  fUp_R[0] = 1.5811388300841895*fSkin[64]+1.224744871391589*fSkin[5]+0.7071067811865475*fSkin[0]; 
  fUp_R[1] = 1.5811388300841898*fSkin[65]+1.224744871391589*fSkin[12]+0.7071067811865475*fSkin[1]; 
  fUp_R[2] = 1.5811388300841898*fSkin[66]+1.224744871391589*fSkin[13]+0.7071067811865475*fSkin[2]; 
  fUp_R[3] = 1.5811388300841898*fSkin[67]+1.224744871391589*fSkin[14]+0.7071067811865475*fSkin[3]; 
  fUp_R[4] = 1.5811388300841898*fSkin[68]+1.224744871391589*fSkin[15]+0.7071067811865475*fSkin[4]; 
  fUp_R[5] = 1.5811388300841895*fSkin[69]+1.224744871391589*fSkin[20]+0.7071067811865475*fSkin[6]; 
  fUp_R[6] = 1.5811388300841895*fSkin[70]+1.224744871391589*fSkin[21]+0.7071067811865475*fSkin[7]; 
  fUp_R[7] = 1.5811388300841895*fSkin[71]+1.224744871391589*fSkin[22]+0.7071067811865475*fSkin[8]; 
  fUp_R[8] = 1.5811388300841895*fSkin[72]+1.224744871391589*fSkin[23]+0.7071067811865475*fSkin[9]; 
  fUp_R[9] = 1.5811388300841895*fSkin[73]+1.224744871391589*fSkin[24]+0.7071067811865475*fSkin[10]; 
  fUp_R[10] = 1.5811388300841895*fSkin[74]+1.224744871391589*fSkin[25]+0.7071067811865475*fSkin[11]; 
  fUp_R[11] = 1.5811388300841898*fSkin[75]+1.224744871391589*fSkin[27]+0.7071067811865475*fSkin[16]; 
  fUp_R[12] = 1.5811388300841898*fSkin[76]+1.224744871391589*fSkin[28]+0.7071067811865475*fSkin[17]; 
  fUp_R[13] = 1.5811388300841898*fSkin[77]+1.224744871391589*fSkin[29]+0.7071067811865475*fSkin[18]; 
  fUp_R[14] = 1.5811388300841898*fSkin[78]+1.224744871391589*fSkin[30]+0.7071067811865475*fSkin[19]; 
  fUp_R[15] = 1.5811388300841895*fSkin[79]+1.224744871391589*fSkin[31]+0.7071067811865475*fSkin[26]; 
    } else { 
  fUp_R[0] = 1.5811388300841895*fEdge[64]-1.224744871391589*fEdge[5]+0.7071067811865475*fEdge[0]; 
  fUp_R[1] = 1.5811388300841898*fEdge[65]-1.224744871391589*fEdge[12]+0.7071067811865475*fEdge[1]; 
  fUp_R[2] = 1.5811388300841898*fEdge[66]-1.224744871391589*fEdge[13]+0.7071067811865475*fEdge[2]; 
  fUp_R[3] = 1.5811388300841898*fEdge[67]-1.224744871391589*fEdge[14]+0.7071067811865475*fEdge[3]; 
  fUp_R[4] = 1.5811388300841898*fEdge[68]-1.224744871391589*fEdge[15]+0.7071067811865475*fEdge[4]; 
  fUp_R[5] = 1.5811388300841895*fEdge[69]-1.224744871391589*fEdge[20]+0.7071067811865475*fEdge[6]; 
  fUp_R[6] = 1.5811388300841895*fEdge[70]-1.224744871391589*fEdge[21]+0.7071067811865475*fEdge[7]; 
  fUp_R[7] = 1.5811388300841895*fEdge[71]-1.224744871391589*fEdge[22]+0.7071067811865475*fEdge[8]; 
  fUp_R[8] = 1.5811388300841895*fEdge[72]-1.224744871391589*fEdge[23]+0.7071067811865475*fEdge[9]; 
  fUp_R[9] = 1.5811388300841895*fEdge[73]-1.224744871391589*fEdge[24]+0.7071067811865475*fEdge[10]; 
  fUp_R[10] = 1.5811388300841895*fEdge[74]-1.224744871391589*fEdge[25]+0.7071067811865475*fEdge[11]; 
  fUp_R[11] = 1.5811388300841898*fEdge[75]-1.224744871391589*fEdge[27]+0.7071067811865475*fEdge[16]; 
  fUp_R[12] = 1.5811388300841898*fEdge[76]-1.224744871391589*fEdge[28]+0.7071067811865475*fEdge[17]; 
  fUp_R[13] = 1.5811388300841898*fEdge[77]-1.224744871391589*fEdge[29]+0.7071067811865475*fEdge[18]; 
  fUp_R[14] = 1.5811388300841898*fEdge[78]-1.224744871391589*fEdge[30]+0.7071067811865475*fEdge[19]; 
  fUp_R[15] = 1.5811388300841895*fEdge[79]-1.224744871391589*fEdge[31]+0.7071067811865475*fEdge[26]; 
   } 
  } else { 
  double fC_r[16] = {0.0}; 
  double fR_l[16] = {0.0}; 
  ...
  fC_r[0] = 1.5811388300841895*fSkin[64]+1.224744871391589*fSkin[5]+0.7071067811865475*fSkin[0]; 
  fC_r[1] = 1.5811388300841898*fSkin[65]+1.224744871391589*fSkin[12]+0.7071067811865475*fSkin[1]; 
  fC_r[2] = 1.5811388300841898*fSkin[66]+1.224744871391589*fSkin[13]+0.7071067811865475*fSkin[2]; 
  fC_r[3] = 1.5811388300841898*fSkin[67]+1.224744871391589*fSkin[14]+0.7071067811865475*fSkin[3]; 
  fC_r[4] = 1.5811388300841898*fSkin[68]+1.224744871391589*fSkin[15]+0.7071067811865475*fSkin[4]; 
  fC_r[5] = 1.5811388300841895*fSkin[69]+1.224744871391589*fSkin[20]+0.7071067811865475*fSkin[6]; 
  fC_r[6] = 1.5811388300841895*fSkin[70]+1.224744871391589*fSkin[21]+0.7071067811865475*fSkin[7]; 
  fC_r[7] = 1.5811388300841895*fSkin[71]+1.224744871391589*fSkin[22]+0.7071067811865475*fSkin[8]; 
  fC_r[8] = 1.5811388300841895*fSkin[72]+1.224744871391589*fSkin[23]+0.7071067811865475*fSkin[9]; 
  fC_r[9] = 1.5811388300841895*fSkin[73]+1.224744871391589*fSkin[24]+0.7071067811865475*fSkin[10]; 
  fC_r[10] = 1.5811388300841895*fSkin[74]+1.224744871391589*fSkin[25]+0.7071067811865475*fSkin[11]; 
  fC_r[11] = 1.5811388300841898*fSkin[75]+1.224744871391589*fSkin[27]+0.7071067811865475*fSkin[16]; 
  fC_r[12] = 1.5811388300841898*fSkin[76]+1.224744871391589*fSkin[28]+0.7071067811865475*fSkin[17]; 
  fC_r[13] = 1.5811388300841898*fSkin[77]+1.224744871391589*fSkin[29]+0.7071067811865475*fSkin[18]; 
  fC_r[14] = 1.5811388300841898*fSkin[78]+1.224744871391589*fSkin[30]+0.7071067811865475*fSkin[19]; 
  fC_r[15] = 1.5811388300841895*fSkin[79]+1.224744871391589*fSkin[31]+0.7071067811865475*fSkin[26]; 

  fR_l[0] = 1.5811388300841895*fEdge[64]-1.224744871391589*fEdge[5]+0.7071067811865475*fEdge[0]; 
  fR_l[1] = 1.5811388300841898*fEdge[65]-1.224744871391589*fEdge[12]+0.7071067811865475*fEdge[1]; 
  fR_l[2] = 1.5811388300841898*fEdge[66]-1.224744871391589*fEdge[13]+0.7071067811865475*fEdge[2]; 
  fR_l[3] = 1.5811388300841898*fEdge[67]-1.224744871391589*fEdge[14]+0.7071067811865475*fEdge[3]; 
  fR_l[4] = 1.5811388300841898*fEdge[68]-1.224744871391589*fEdge[15]+0.7071067811865475*fEdge[4]; 
  fR_l[5] = 1.5811388300841895*fEdge[69]-1.224744871391589*fEdge[20]+0.7071067811865475*fEdge[6]; 
  fR_l[6] = 1.5811388300841895*fEdge[70]-1.224744871391589*fEdge[21]+0.7071067811865475*fEdge[7]; 
  fR_l[7] = 1.5811388300841895*fEdge[71]-1.224744871391589*fEdge[22]+0.7071067811865475*fEdge[8]; 
  fR_l[8] = 1.5811388300841895*fEdge[72]-1.224744871391589*fEdge[23]+0.7071067811865475*fEdge[9]; 
  fR_l[9] = 1.5811388300841895*fEdge[73]-1.224744871391589*fEdge[24]+0.7071067811865475*fEdge[10]; 
  fR_l[10] = 1.5811388300841895*fEdge[74]-1.224744871391589*fEdge[25]+0.7071067811865475*fEdge[11]; 
  fR_l[11] = 1.5811388300841898*fEdge[75]-1.224744871391589*fEdge[27]+0.7071067811865475*fEdge[16]; 
  fR_l[12] = 1.5811388300841898*fEdge[76]-1.224744871391589*fEdge[28]+0.7071067811865475*fEdge[17]; 
  fR_l[13] = 1.5811388300841898*fEdge[77]-1.224744871391589*fEdge[29]+0.7071067811865475*fEdge[18]; 
  fR_l[14] = 1.5811388300841898*fEdge[78]-1.224744871391589*fEdge[30]+0.7071067811865475*fEdge[19]; 
  fR_l[15] = 1.5811388300841895*fEdge[79]-1.224744871391589*fEdge[31]+0.7071067811865475*fEdge[26]; 
  ...
  out[4] += -(0.35355339059327373*GhatR[4]*dv_inv); 
  out[5] += -(0.6123724356957945*GhatR[0]*dv_inv); 
  out[6] += -(0.35355339059327373*GhatR[5]*dv_inv); 
  out[7] += -(0.35355339059327373*GhatR[6]*dv_inv); 
  out[8] += -(0.35355339059327373*GhatR[7]*dv_inv); 
  out[9] += -(0.35355339059327373*GhatR[8]*dv_inv); 
  out[10] += -(0.35355339059327373*GhatR[9]*dv_inv); 
  out[11] += -(0.35355339059327373*GhatR[10]*dv_inv); 
  out[12] += -(0.6123724356957945*GhatR[1]*dv_inv); 
  out[13] += -(0.6123724356957945*GhatR[2]*dv_inv); 
  out[14] += -(0.6123724356957945*GhatR[3]*dv_inv); 
  out[15] += -(0.6123724356957945*GhatR[4]*dv_inv); 
  out[16] += -(0.35355339059327373*GhatR[11]*dv_inv); 
  out[17] += -(0.35355339059327373*GhatR[12]*dv_inv); 
  out[18] += -(0.35355339059327373*GhatR[13]*dv_inv); 
  out[19] += -(0.35355339059327373*GhatR[14]*dv_inv); 
  out[20] += -(0.6123724356957945*GhatR[5]*dv_inv); 
  out[21] += -(0.6123724356957945*GhatR[6]*dv_inv); 
  out[22] += -(0.6123724356957945*GhatR[7]*dv_inv); 
  ...
  out[26] += -(0.35355339059327373*GhatR[15]*dv_inv); 
  out[27] += -(0.6123724356957945*GhatR[11]*dv_inv); 
  ...
  out[64] += -(0.7905694150420948*GhatR[0]*dv_inv); 
  out[65] += -(0.7905694150420949*GhatR[1]*dv_inv); 
  out[66] += -(0.7905694150420949*GhatR[2]*dv_inv); 
  out[67] += -(0.7905694150420949*GhatR[3]*dv_inv); 
  out[68] += -(0.7905694150420949*GhatR[4]*dv_inv); 
  out[69] += -(0.7905694150420948*GhatR[5]*dv_inv); 
  out[70] += -(0.7905694150420948*GhatR[6]*dv_inv); 
  out[71] += -(0.7905694150420948*GhatR[7]*dv_inv); 
  out[72] += -(0.7905694150420948*GhatR[8]*dv_inv); 
  out[73] += -(0.7905694150420948*GhatR[9]*dv_inv); 
  out[74] += -(0.7905694150420948*GhatR[10]*dv_inv); 
  out[75] += -(0.7905694150420949*GhatR[11]*dv_inv); 
  out[76] += -(0.7905694150420949*GhatR[12]*dv_inv); 
  out[77] += -(0.7905694150420949*GhatR[13]*dv_inv); 
  out[78] += -(0.7905694150420949*GhatR[14]*dv_inv); 
  out[79] += -(0.7905694150420948*GhatR[15]*dv_inv); 
  ...
  fUp_L[0] = 1.5811388300841895*fEdge[64]+1.224744871391589*fEdge[5]+0.7071067811865475*fEdge[0]; 
  fUp_L[1] = 1.5811388300841898*fEdge[65]+1.224744871391589*fEdge[12]+0.7071067811865475*fEdge[1]; 
  fUp_L[2] = 1.5811388300841898*fEdge[66]+1.224744871391589*fEdge[13]+0.7071067811865475*fEdge[2]; 
  fUp_L[3] = 1.5811388300841898*fEdge[67]+1.224744871391589*fEdge[14]+0.7071067811865475*fEdge[3]; 
  fUp_L[4] = 1.5811388300841898*fEdge[68]+1.224744871391589*fEdge[15]+0.7071067811865475*fEdge[4]; 
  fUp_L[5] = 1.5811388300841895*fEdge[69]+1.224744871391589*fEdge[20]+0.7071067811865475*fEdge[6]; 
  fUp_L[6] = 1.5811388300841895*fEdge[70]+1.224744871391589*fEdge[21]+0.7071067811865475*fEdge[7]; 
  fUp_L[7] = 1.5811388300841895*fEdge[71]+1.224744871391589*fEdge[22]+0.7071067811865475*fEdge[8]; 
  fUp_L[8] = 1.5811388300841895*fEdge[72]+1.224744871391589*fEdge[23]+0.7071067811865475*fEdge[9]; 
  fUp_L[9] = 1.5811388300841895*fEdge[73]+1.224744871391589*fEdge[24]+0.7071067811865475*fEdge[10]; 
  fUp_L[10] = 1.5811388300841895*fEdge[74]+1.224744871391589*fEdge[25]+0.7071067811865475*fEdge[11]; 
  fUp_L[11] = 1.5811388300841898*fEdge[75]+1.224744871391589*fEdge[27]+0.7071067811865475*fEdge[16]; 
  fUp_L[12] = 1.5811388300841898*fEdge[76]+1.224744871391589*fEdge[28]+0.7071067811865475*fEdge[17]; 
  fUp_L[13] = 1.5811388300841898*fEdge[77]+1.224744871391589*fEdge[29]+0.7071067811865475*fEdge[18]; 
  fUp_L[14] = 1.5811388300841898*fEdge[78]+1.224744871391589*fEdge[30]+0.7071067811865475*fEdge[19]; 
  fUp_L[15] = 1.5811388300841895*fEdge[79]+1.224744871391589*fEdge[31]+0.7071067811865475*fEdge[26]; 
    } else { 
  fUp_L[0] = 1.5811388300841895*fSkin[64]-1.224744871391589*fSkin[5]+0.7071067811865475*fSkin[0]; 
  fUp_L[1] = 1.5811388300841898*fSkin[65]-1.224744871391589*fSkin[12]+0.7071067811865475*fSkin[1]; 
  fUp_L[2] = 1.5811388300841898*fSkin[66]-1.224744871391589*fSkin[13]+0.7071067811865475*fSkin[2]; 
  fUp_L[3] = 1.5811388300841898*fSkin[67]-1.224744871391589*fSkin[14]+0.7071067811865475*fSkin[3]; 
  fUp_L[4] = 1.5811388300841898*fSkin[68]-1.224744871391589*fSkin[15]+0.7071067811865475*fSkin[4]; 
  fUp_L[5] = 1.5811388300841895*fSkin[69]-1.224744871391589*fSkin[20]+0.7071067811865475*fSkin[6]; 
  fUp_L[6] = 1.5811388300841895*fSkin[70]-1.224744871391589*fSkin[21]+0.7071067811865475*fSkin[7]; 
  fUp_L[7] = 1.5811388300841895*fSkin[71]-1.224744871391589*fSkin[22]+0.7071067811865475*fSkin[8]; 
  fUp_L[8] = 1.5811388300841895*fSkin[72]-1.224744871391589*fSkin[23]+0.7071067811865475*fSkin[9]; 
  fUp_L[9] = 1.5811388300841895*fSkin[73]-1.224744871391589*fSkin[24]+0.7071067811865475*fSkin[10]; 
  fUp_L[10] = 1.5811388300841895*fSkin[74]-1.224744871391589*fSkin[25]+0.7071067811865475*fSkin[11]; 
  fUp_L[11] = 1.5811388300841898*fSkin[75]-1.224744871391589*fSkin[27]+0.7071067811865475*fSkin[16]; 
  fUp_L[12] = 1.5811388300841898*fSkin[76]-1.224744871391589*fSkin[28]+0.7071067811865475*fSkin[17]; 
  fUp_L[13] = 1.5811388300841898*fSkin[77]-1.224744871391589*fSkin[29]+0.7071067811865475*fSkin[18]; 
  fUp_L[14] = 1.5811388300841898*fSkin[78]-1.224744871391589*fSkin[30]+0.7071067811865475*fSkin[19]; 
  fUp_L[15] = 1.5811388300841895*fSkin[79]-1.224744871391589*fSkin[31]+0.7071067811865475*fSkin[26]; 
   } 
  } else { 
  double fL_r[16] = {0.0}; 
  double fC_l[16] = {0.0}; 
  ...
  fL_r[0] = 1.5811388300841895*fEdge[64]+1.224744871391589*fEdge[5]+0.7071067811865475*fEdge[0]; 
  fL_r[1] = 1.5811388300841898*fEdge[65]+1.224744871391589*fEdge[12]+0.7071067811865475*fEdge[1]; 
  fL_r[2] = 1.5811388300841898*fEdge[66]+1.224744871391589*fEdge[13]+0.7071067811865475*fEdge[2]; 
  fL_r[3] = 1.5811388300841898*fEdge[67]+1.224744871391589*fEdge[14]+0.7071067811865475*fEdge[3]; 
  fL_r[4] = 1.5811388300841898*fEdge[68]+1.224744871391589*fEdge[15]+0.7071067811865475*fEdge[4]; 
  fL_r[5] = 1.5811388300841895*fEdge[69]+1.224744871391589*fEdge[20]+0.7071067811865475*fEdge[6]; 
  fL_r[6] = 1.5811388300841895*fEdge[70]+1.224744871391589*fEdge[21]+0.7071067811865475*fEdge[7]; 
  fL_r[7] = 1.5811388300841895*fEdge[71]+1.224744871391589*fEdge[22]+0.7071067811865475*fEdge[8]; 
  fL_r[8] = 1.5811388300841895*fEdge[72]+1.224744871391589*fEdge[23]+0.7071067811865475*fEdge[9]; 
  fL_r[9] = 1.5811388300841895*fEdge[73]+1.224744871391589*fEdge[24]+0.7071067811865475*fEdge[10]; 
  fL_r[10] = 1.5811388300841895*fEdge[74]+1.224744871391589*fEdge[25]+0.7071067811865475*fEdge[11]; 
  fL_r[11] = 1.5811388300841898*fEdge[75]+1.224744871391589*fEdge[27]+0.7071067811865475*fEdge[16]; 
  fL_r[12] = 1.5811388300841898*fEdge[76]+1.224744871391589*fEdge[28]+0.7071067811865475*fEdge[17]; 
  fL_r[13] = 1.5811388300841898*fEdge[77]+1.224744871391589*fEdge[29]+0.7071067811865475*fEdge[18]; 
  fL_r[14] = 1.5811388300841898*fEdge[78]+1.224744871391589*fEdge[30]+0.7071067811865475*fEdge[19]; 
  fL_r[15] = 1.5811388300841895*fEdge[79]+1.224744871391589*fEdge[31]+0.7071067811865475*fEdge[26]; 

  fC_l[0] = 1.5811388300841895*fSkin[64]-1.224744871391589*fSkin[5]+0.7071067811865475*fSkin[0]; 
  fC_l[1] = 1.5811388300841898*fSkin[65]-1.224744871391589*fSkin[12]+0.7071067811865475*fSkin[1]; 
  fC_l[2] = 1.5811388300841898*fSkin[66]-1.224744871391589*fSkin[13]+0.7071067811865475*fSkin[2]; 
  fC_l[3] = 1.5811388300841898*fSkin[67]-1.224744871391589*fSkin[14]+0.7071067811865475*fSkin[3]; 
  fC_l[4] = 1.5811388300841898*fSkin[68]-1.224744871391589*fSkin[15]+0.7071067811865475*fSkin[4]; 
  fC_l[5] = 1.5811388300841895*fSkin[69]-1.224744871391589*fSkin[20]+0.7071067811865475*fSkin[6]; 
  fC_l[6] = 1.5811388300841895*fSkin[70]-1.224744871391589*fSkin[21]+0.7071067811865475*fSkin[7]; 
  fC_l[7] = 1.5811388300841895*fSkin[71]-1.224744871391589*fSkin[22]+0.7071067811865475*fSkin[8]; 
  fC_l[8] = 1.5811388300841895*fSkin[72]-1.224744871391589*fSkin[23]+0.7071067811865475*fSkin[9]; 
  fC_l[9] = 1.5811388300841895*fSkin[73]-1.224744871391589*fSkin[24]+0.7071067811865475*fSkin[10]; 
  fC_l[10] = 1.5811388300841895*fSkin[74]-1.224744871391589*fSkin[25]+0.7071067811865475*fSkin[11]; 
  fC_l[11] = 1.5811388300841898*fSkin[75]-1.224744871391589*fSkin[27]+0.7071067811865475*fSkin[16]; 
  fC_l[12] = 1.5811388300841898*fSkin[76]-1.224744871391589*fSkin[28]+0.7071067811865475*fSkin[17]; 
  fC_l[13] = 1.5811388300841898*fSkin[77]-1.224744871391589*fSkin[29]+0.7071067811865475*fSkin[18]; 
  fC_l[14] = 1.5811388300841898*fSkin[78]-1.224744871391589*fSkin[30]+0.7071067811865475*fSkin[19]; 
  fC_l[15] = 1.5811388300841895*fSkin[79]-1.224744871391589*fSkin[31]+0.7071067811865475*fSkin[26]; 
  ...
  out[4] += 0.35355339059327373*GhatL[4]*dv_inv; 
  out[5] += -(0.6123724356957945*GhatL[0]*dv_inv); 
  out[6] += 0.35355339059327373*GhatL[5]*dv_inv; 
  out[7] += 0.35355339059327373*GhatL[6]*dv_inv; 
  out[8] += 0.35355339059327373*GhatL[7]*dv_inv; 
  out[9] += 0.35355339059327373*GhatL[8]*dv_inv; 
  out[10] += 0.35355339059327373*GhatL[9]*dv_inv; 
  out[11] += 0.35355339059327373*GhatL[10]*dv_inv; 
  out[12] += -(0.6123724356957945*GhatL[1]*dv_inv); 
  out[13] += -(0.6123724356957945*GhatL[2]*dv_inv); 
  out[14] += -(0.6123724356957945*GhatL[3]*dv_inv); 
  out[15] += -(0.6123724356957945*GhatL[4]*dv_inv); 
  out[16] += 0.35355339059327373*GhatL[11]*dv_inv; 
  out[17] += 0.35355339059327373*GhatL[12]*dv_inv; 
  out[18] += 0.35355339059327373*GhatL[13]*dv_inv; 
  out[19] += 0.35355339059327373*GhatL[14]*dv_inv; 
  out[20] += -(0.6123724356957945*GhatL[5]*dv_inv); 
  out[21] += -(0.6123724356957945*GhatL[6]*dv_inv); 
  out[22] += -(0.6123724356957945*GhatL[7]*dv_inv); 
  ...
  out[26] += 0.35355339059327373*GhatL[15]*dv_inv; 
  out[27] += -(0.6123724356957945*GhatL[11]*dv_inv); 
  ...
  out[64] += 0.7905694150420948*GhatL[0]*dv_inv; 
  out[65] += 0.7905694150420949*GhatL[1]*dv_inv; 
  out[66] += 0.7905694150420949*GhatL[2]*dv_inv; 
  out[67] += 0.7905694150420949*GhatL[3]*dv_inv; 
  out[68] += 0.7905694150420949*GhatL[4]*dv_inv; 
  out[69] += 0.7905694150420948*GhatL[5]*dv_inv; 
  out[70] += 0.7905694150420948*GhatL[6]*dv_inv; 
  out[71] += 0.7905694150420948*GhatL[7]*dv_inv; 
  out[72] += 0.7905694150420948*GhatL[8]*dv_inv; 
  out[73] += 0.7905694150420948*GhatL[9]*dv_inv; 
  out[74] += 0.7905694150420948*GhatL[10]*dv_inv; 
  out[75] += 0.7905694150420949*GhatL[11]*dv_inv; 
  out[76] += 0.7905694150420949*GhatL[12]*dv_inv; 
  out[77] += 0.7905694150420949*GhatL[13]*dv_inv; 
  out[78] += 0.7905694150420949*GhatL[14]*dv_inv; 
  out[79] += 0.7905694150420948*GhatL[15]*dv_inv; 
