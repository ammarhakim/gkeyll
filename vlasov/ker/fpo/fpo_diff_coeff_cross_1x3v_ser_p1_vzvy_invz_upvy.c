...
GKYL_CU_DH void fpo_diff_coeff_cross_1x3v_vzvy_ser_p1_invz_upvy(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = -(0.11785113019775789*(GTL[10]+GBL[10]))+0.11785113019775789*(GTC[10]+GBC[10])+0.2357022603955158*GCL[10]-0.2357022603955158*GCC[10]-0.10206207261596573*(GTL[4]+GTC[4]+GBL[4]+GBC[4]+GTC[3]+GBL[3])+0.20412414523193148*(GCL[4]+GCC[4])+0.10206207261596573*(GTL[3]+GBC[3])+0.0883883476483184*(GTL[0]+GTC[0])-0.0883883476483184*(GBL[0]+GBC[0]); 
  surft1_lo[1] = -(0.11785113019775789*(GTL[13]+GBL[13]))+0.11785113019775789*(GTC[13]+GBC[13])+0.2357022603955158*GCL[13]-0.2357022603955158*GCC[13]-0.10206207261596573*(GTL[8]+GTC[8]+GBL[8]+GBC[8]+GTC[6]+GBL[6])+0.20412414523193148*(GCL[8]+GCC[8])+0.10206207261596573*(GTL[6]+GBC[6])+0.0883883476483184*(GTL[1]+GTC[1])-0.0883883476483184*(GBL[1]+GBC[1]); 
  surft1_lo[2] = -(0.11785113019775789*(GTL[14]+GBL[14]))+0.11785113019775789*(GTC[14]+GBC[14])+0.2357022603955158*GCL[14]-0.2357022603955158*GCC[14]-0.10206207261596573*(GTL[9]+GTC[9]+GBL[9]+GBC[9]+GTC[7]+GBL[7])+0.20412414523193148*(GCL[9]+GCC[9])+0.10206207261596573*(GTL[7]+GBC[7])+0.0883883476483184*(GTL[2]+GTC[2])-0.0883883476483184*(GBL[2]+GBC[2]); 
  surft1_lo[3] = -(0.20412414523193148*(GTL[10]+GBC[10]))+0.20412414523193148*(GTC[10]+GBL[10])-0.1767766952966368*(GTL[4]+GTC[4]+GTC[3]+GBC[3])+0.1767766952966368*(GBL[4]+GBC[4]+GTL[3]+GBL[3])-0.3535533905932737*GCL[3]+0.3535533905932737*GCC[3]+0.15309310892394856*(GTL[0]+GTC[0]+GBL[0]+GBC[0])-0.3061862178478971*(GCL[0]+GCC[0]); 
  surft1_lo[4] = -(0.11785113019775789*(GTL[15]+GBL[15]))+0.11785113019775789*(GTC[15]+GBC[15])+0.2357022603955158*GCL[15]-0.2357022603955158*GCC[15]-0.10206207261596573*(GTL[12]+GTC[12]+GBL[12]+GBC[12]+GTC[11]+GBL[11])+0.20412414523193148*(GCL[12]+GCC[12])+0.10206207261596573*(GTL[11]+GBC[11])+0.0883883476483184*(GTL[5]+GTC[5])-0.0883883476483184*(GBL[5]+GBC[5]); 
  surft1_lo[5] = -(0.20412414523193148*(GTL[13]+GBC[13]))+0.20412414523193148*(GTC[13]+GBL[13])-0.1767766952966368*(GTL[8]+GTC[8]+GTC[6]+GBC[6])+0.1767766952966368*(GBL[8]+GBC[8]+GTL[6]+GBL[6])-0.3535533905932737*GCL[6]+0.3535533905932737*GCC[6]+0.15309310892394856*(GTL[1]+GTC[1]+GBL[1]+GBC[1])-0.3061862178478971*(GCL[1]+GCC[1]); 
  surft1_lo[6] = -(0.20412414523193148*(GTL[14]+GBC[14]))+0.20412414523193148*(GTC[14]+GBL[14])-0.1767766952966368*(GTL[9]+GTC[9]+GTC[7]+GBC[7])+0.1767766952966368*(GBL[9]+GBC[9]+GTL[7]+GBL[7])-0.3535533905932737*GCL[7]+0.3535533905932737*GCC[7]+0.15309310892394856*(GTL[2]+GTC[2]+GBL[2]+GBC[2])-0.3061862178478971*(GCL[2]+GCC[2]); 
  surft1_lo[7] = -(0.20412414523193148*(GTL[15]+GBC[15]))+0.20412414523193148*(GTC[15]+GBL[15])-0.1767766952966368*(GTL[12]+GTC[12]+GTC[11]+GBC[11])+0.1767766952966368*(GBL[12]+GBC[12]+GTL[11]+GBL[11])-0.3535533905932737*GCL[11]+0.3535533905932737*GCC[11]+0.15309310892394856*(GTL[5]+GTC[5]+GBL[5]+GBC[5])-0.3061862178478971*(GCL[5]+GCC[5]); 
