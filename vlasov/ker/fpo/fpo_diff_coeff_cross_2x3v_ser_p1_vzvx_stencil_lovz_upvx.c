...
GKYL_CU_DH void fpo_diff_coeff_cross_2x3v_vzvx_ser_p1_lovz_upvx(const double *dxv, const double *gamma, const double* fpo_g_stencil[9], const double* fpo_g_surf_stencil[9], const double* fpo_dgdv_surf, double *diff_coeff) { 
  ...
  surft1_lo[0] = 0.7071067811865475*GCL[14]-0.7071067811865475*GCC[14]+0.6123724356957944*(GCL[5]+GCC[5]); 
  surft1_lo[1] = 0.7071067811865475*GCL[21]-0.7071067811865475*GCC[21]+0.6123724356957944*(GCL[12]+GCC[12]); 
  surft1_lo[2] = 0.7071067811865475*GCL[22]-0.7071067811865475*GCC[22]+0.6123724356957944*(GCL[13]+GCC[13]); 
  surft1_lo[3] = 0.7071067811865475*GCL[25]-0.7071067811865475*GCC[25]+0.6123724356957944*(GCL[15]+GCC[15]); 
  surft1_lo[5] = 0.7071067811865475*GCL[27]-0.7071067811865475*GCC[27]+0.6123724356957944*(GCL[20]+GCC[20]); 
  surft1_lo[6] = 0.7071067811865475*GCL[29]-0.7071067811865475*GCC[29]+0.6123724356957944*(GCL[23]+GCC[23]); 
  surft1_lo[7] = 0.7071067811865475*GCL[30]-0.7071067811865475*GCC[30]+0.6123724356957944*(GCL[24]+GCC[24]); 
  surft1_lo[11] = 0.7071067811865475*GCL[31]-0.7071067811865475*GCC[31]+0.6123724356957944*(GCL[28]+GCC[28]); 
