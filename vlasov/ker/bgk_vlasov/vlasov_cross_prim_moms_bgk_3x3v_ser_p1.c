...
{ 
  ...
  dU[6] = u_r[6] - u_s[6]; 
  dU[7] = u_r[7] - u_s[7]; 
  binop_mul_3d_ser_p1(dU, dU, dUSq); 
  dUSq_sum[0] += dUSq[0]; 
  dUSq_sum[1] += dUSq[1]; 
  dUSq_sum[2] += dUSq[2]; 
  dUSq_sum[3] += dUSq[3]; 
  ...
  dUSq_sum[6] += dUSq[6]; 
  dUSq_sum[7] += dUSq[7]; 
  u_sr[16] = u_s[16] + 0.5*deltaTbetap1*dU[0]; 
  u_sr[17] = u_s[17] + 0.5*deltaTbetap1*dU[1]; 
  u_sr[18] = u_s[18] + 0.5*deltaTbetap1*dU[2]; 
  u_sr[19] = u_s[19] + 0.5*deltaTbetap1*dU[3]; 
  u_sr[20] = u_s[20] + 0.5*deltaTbetap1*dU[4]; 
  u_sr[21] = u_s[21] + 0.5*deltaTbetap1*dU[5]; 
  u_sr[22] = u_s[22] + 0.5*deltaTbetap1*dU[6]; 
  u_sr[23] = u_s[23] + 0.5*deltaTbetap1*dU[7]; 
