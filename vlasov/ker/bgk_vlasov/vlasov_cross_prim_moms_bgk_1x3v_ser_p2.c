...
{ 
  ...
  dUSq_sum[1] += dUSq[1]; 
  dUSq_sum[2] += dUSq[2]; 
  u_sr[6] = u_s[6] + 0.5*deltaTbetap1*dU[0]; 
  u_sr[7] = u_s[7] + 0.5*deltaTbetap1*dU[1]; 
  u_sr[8] = u_s[8] + 0.5*deltaTbetap1*dU[2]; 
