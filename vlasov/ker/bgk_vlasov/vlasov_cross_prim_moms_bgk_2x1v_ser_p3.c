...
{ 
  ...
  dU[10] = u_r[10] - u_s[10]; 
  dU[11] = u_r[11] - u_s[11]; 
  binop_mul_2d_ser_p3(dU, dU, dUSq); 
  dUSq_sum[0] += dUSq[0]; 
  dUSq_sum[1] += dUSq[1]; 
  dUSq_sum[2] += dUSq[2]; 
  dUSq_sum[3] += dUSq[3]; 
  ...
  if (0.5*(4.58257569495584*(vtsq_sr[11]+vtsq_sr[10])-2.6457513110645907*(vtsq_sr[9]+vtsq_sr[8])-3.872983346207417*(vtsq_sr[7]+vtsq_sr[6])+2.23606797749979*(vtsq_sr[5]+vtsq_sr[4])+3.0*vtsq_sr[3]-1.7320508075688772*(vtsq_sr[2]+vtsq_sr[1])+vtsq_sr[0]) < 0.0) negative_cross_temp = true; 
  if (-(0.5*(4.58257569495584*(vtsq_sr[11]+vtsq_sr[10])+2.6457513110645907*vtsq_sr[9]-2.6457513110645907*vtsq_sr[8]-3.872983346207417*vtsq_sr[7]+3.872983346207417*vtsq_sr[6]-2.23606797749979*(vtsq_sr[5]+vtsq_sr[4])+3.0*vtsq_sr[3]+1.7320508075688772*vtsq_sr[2]-1.7320508075688772*vtsq_sr[1]-1.0*vtsq_sr[0])) < 0.0) negative_cross_temp = true; 
  if (-(0.5*(4.58257569495584*(vtsq_sr[11]+vtsq_sr[10])-2.6457513110645907*vtsq_sr[9]+2.6457513110645907*vtsq_sr[8]+3.872983346207417*vtsq_sr[7]-3.872983346207417*vtsq_sr[6]-2.23606797749979*(vtsq_sr[5]+vtsq_sr[4])+3.0*vtsq_sr[3]-1.7320508075688772*vtsq_sr[2]+1.7320508075688772*vtsq_sr[1]-1.0*vtsq_sr[0])) < 0.0) negative_cross_temp = true; 
  if (0.5*(4.58257569495584*(vtsq_sr[11]+vtsq_sr[10])+2.6457513110645907*(vtsq_sr[9]+vtsq_sr[8])+3.872983346207417*(vtsq_sr[7]+vtsq_sr[6])+2.23606797749979*(vtsq_sr[5]+vtsq_sr[4])+3.0*vtsq_sr[3]+1.7320508075688772*(vtsq_sr[2]+vtsq_sr[1])+vtsq_sr[0]) < 0.0) negative_cross_temp = true; 
