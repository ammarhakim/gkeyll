...
{ 
  ...
  out_1[2] += (1.5811388300841895*Fhat_l_nodal_1[0]-1.5811388300841895*Fhat_r_nodal_1[0])*dx10; 
  ...
  out_2[2] += (1.5811388300841895*Fhat_l_nodal_2[0]-1.5811388300841895*Fhat_r_nodal_2[0])*dx10; 
  ...
  out_3[2] += (1.5811388300841895*Fhat_l_nodal_3[0]-1.5811388300841895*Fhat_r_nodal_3[0])*dx10; 
  ...
  out_4[2] += (1.5811388300841895*Fhat_l_nodal_4[0]-1.5811388300841895*Fhat_r_nodal_4[0])*dx10; 
  ...
  out_5[2] += (1.5811388300841895*Fhat_l_nodal_5[0]-1.5811388300841895*Fhat_r_nodal_5[0])*dx10; 
