...
{ 
  ...
  flux_l_quad[0] = 0.16666666666666666*(0.6*(5.0*Hx_l_n[2]-10.0*Hx_l_n[1]+5.0*Hx_l_n[0])-0.7745966692414833*(3.872983346207417*Hx_l_n[2]-3.872983346207417*Hx_l_n[0])+6.0*Hx_l_n[1]); 
  flux_r_quad[0] = 0.16666666666666666*(0.6*(5.0*Hx_r_n[2]-10.0*Hx_r_n[1]+5.0*Hx_r_n[0])-0.7745966692414833*(3.872983346207417*Hx_r_n[2]-3.872983346207417*Hx_r_n[0])+6.0*Hx_r_n[1]); 
  flux_l_quad[1] = Hx_l_n[1]; 
  flux_r_quad[1] = Hx_r_n[1]; 
  flux_l_quad[2] = 0.16666666666666666*(0.6*(5.0*Hx_l_n[2]-10.0*Hx_l_n[1]+5.0*Hx_l_n[0])+0.7745966692414833*(3.872983346207417*Hx_l_n[2]-3.872983346207417*Hx_l_n[0])+6.0*Hx_l_n[1]); 
  flux_r_quad[2] = 0.16666666666666666*(0.6*(5.0*Hx_r_n[2]-10.0*Hx_r_n[1]+5.0*Hx_r_n[0])+0.7745966692414833*(3.872983346207417*Hx_r_n[2]-3.872983346207417*Hx_r_n[0])+6.0*Hx_r_n[1]); 
  ...
  flux_l_quad[0] = -(0.16666666666666666*(0.6*(5.0*Ex_l_n[2]-10.0*Ex_l_n[1]+5.0*Ex_l_n[0])-0.7745966692414833*(3.872983346207417*Ex_l_n[2]-3.872983346207417*Ex_l_n[0])+6.0*Ex_l_n[1])); 
  flux_r_quad[0] = -(0.16666666666666666*(0.6*(5.0*Ex_r_n[2]-10.0*Ex_r_n[1]+5.0*Ex_r_n[0])-0.7745966692414833*(3.872983346207417*Ex_r_n[2]-3.872983346207417*Ex_r_n[0])+6.0*Ex_r_n[1])); 
  flux_l_quad[1] = -(1.0*Ex_l_n[1]); 
  flux_r_quad[1] = -(1.0*Ex_r_n[1]); 
  flux_l_quad[2] = -(0.16666666666666666*(0.6*(5.0*Ex_l_n[2]-10.0*Ex_l_n[1]+5.0*Ex_l_n[0])+0.7745966692414833*(3.872983346207417*Ex_l_n[2]-3.872983346207417*Ex_l_n[0])+6.0*Ex_l_n[1])); 
  flux_r_quad[2] = -(0.16666666666666666*(0.6*(5.0*Ex_r_n[2]-10.0*Ex_r_n[1]+5.0*Ex_r_n[0])+0.7745966692414833*(3.872983346207417*Ex_r_n[2]-3.872983346207417*Ex_r_n[0])+6.0*Ex_r_n[1])); 
