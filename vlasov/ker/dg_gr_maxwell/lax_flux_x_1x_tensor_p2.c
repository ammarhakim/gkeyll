...
{ 
  ...
  for (int i=0; i<8; ++i) {
    em_l = &field_con_l[i*3]; 
    em_r = &field_con_r[i*3]; 
    em_no_J_l = &field_no_J_con_l[i*3]; 
    em_no_J_r = &field_no_J_con_r[i*3]; 
    ...
    Q_l_quad = 1.5811388300841895*em_l[2]+1.224744871391589*em_l[1]+0.7071067811865475*em_l[0]; 
    Q_r_quad = 1.5811388300841895*em_r[2]-1.224744871391589*em_r[1]+0.7071067811865475*em_r[0]; 
