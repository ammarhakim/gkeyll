...
GKYL_CU_DH void dg_gr_maxwell_lorentz_conf_2x3v_tensor_p2(const gkyl_dg_gr_maxwell_inp *meq, const double *dx, const double *lapse_nodal, const double *shift_nodal,
    ...
    const double *vierb_con_nodal, double* GKYL_RESTRICT E_conf_for_force, double* GKYL_RESTRICT B_conf_for_force)
{
  ...
  const double *JDy = &fields[9];
  const double *JDz = &fields[18];
  const double *JBx = &fields[27];
  const double *JBy = &fields[36];
  const double *JBz = &fields[45];

  JDx_con_n[0] = 0.4*JDx[8]-0.5999999999999995*JDx[7]-0.5999999999999999*JDx[6]+0.4472135954999579*JDx[5]+0.4472135954999579*JDx[4]+0.9*JDx[3]-0.6708203932499369*JDx[2]-0.6708203932499369*JDx[1]+0.5*JDx[0];
  JDy_con_n[0] = 0.4*JDy[8]-0.5999999999999995*JDy[7]-0.5999999999999999*JDy[6]+0.4472135954999579*JDy[5]+0.4472135954999579*JDy[4]+0.9*JDy[3]-0.6708203932499369*JDy[2]-0.6708203932499369*JDy[1]+0.5*JDy[0];
  JDz_con_n[0] = 0.4*JDz[8]-0.5999999999999995*JDz[7]-0.5999999999999999*JDz[6]+0.4472135954999579*JDz[5]+0.4472135954999579*JDz[4]+0.9*JDz[3]-0.6708203932499369*JDz[2]-0.6708203932499369*JDz[1]+0.5*JDz[0];
  JBx_con_n[0] = 0.4*JBx[8]-0.5999999999999995*JBx[7]-0.5999999999999999*JBx[6]+0.4472135954999579*JBx[5]+0.4472135954999579*JBx[4]+0.9*JBx[3]-0.6708203932499369*JBx[2]-0.6708203932499369*JBx[1]+0.5*JBx[0];
  JBy_con_n[0] = 0.4*JBy[8]-0.5999999999999995*JBy[7]-0.5999999999999999*JBy[6]+0.4472135954999579*JBy[5]+0.4472135954999579*JBy[4]+0.9*JBy[3]-0.6708203932499369*JBy[2]-0.6708203932499369*JBy[1]+0.5*JBy[0];
  JBz_con_n[0] = 0.4*JBz[8]-0.5999999999999995*JBz[7]-0.5999999999999999*JBz[6]+0.4472135954999579*JBz[5]+0.4472135954999579*JBz[4]+0.9*JBz[3]-0.6708203932499369*JBz[2]-0.6708203932499369*JBz[1]+0.5*JBz[0];

  JDx_con_n[1] = -(0.5*JDx[8])+0.75*JDx[7]-0.5590169943749475*JDx[5]+0.4472135954999579*JDx[4]-0.6708203932499369*JDx[1]+0.5*JDx[0];
  JDy_con_n[1] = -(0.5*JDy[8])+0.75*JDy[7]-0.5590169943749475*JDy[5]+0.4472135954999579*JDy[4]-0.6708203932499369*JDy[1]+0.5*JDy[0];
  JDz_con_n[1] = -(0.5*JDz[8])+0.75*JDz[7]-0.5590169943749475*JDz[5]+0.4472135954999579*JDz[4]-0.6708203932499369*JDz[1]+0.5*JDz[0];
  JBx_con_n[1] = -(0.5*JBx[8])+0.75*JBx[7]-0.5590169943749475*JBx[5]+0.4472135954999579*JBx[4]-0.6708203932499369*JBx[1]+0.5*JBx[0];
  JBy_con_n[1] = -(0.5*JBy[8])+0.75*JBy[7]-0.5590169943749475*JBy[5]+0.4472135954999579*JBy[4]-0.6708203932499369*JBy[1]+0.5*JBy[0];
  JBz_con_n[1] = -(0.5*JBz[8])+0.75*JBz[7]-0.5590169943749475*JBz[5]+0.4472135954999579*JBz[4]-0.6708203932499369*JBz[1]+0.5*JBz[0];

  JDx_con_n[2] = 0.4*JDx[8]-0.5999999999999995*JDx[7]+0.5999999999999999*JDx[6]+0.4472135954999579*JDx[5]+0.4472135954999579*JDx[4]-0.9*JDx[3]+0.6708203932499369*JDx[2]-0.6708203932499369*JDx[1]+0.5*JDx[0];
  JDy_con_n[2] = 0.4*JDy[8]-0.5999999999999995*JDy[7]+0.5999999999999999*JDy[6]+0.4472135954999579*JDy[5]+0.4472135954999579*JDy[4]-0.9*JDy[3]+0.6708203932499369*JDy[2]-0.6708203932499369*JDy[1]+0.5*JDy[0];
  JDz_con_n[2] = 0.4*JDz[8]-0.5999999999999995*JDz[7]+0.5999999999999999*JDz[6]+0.4472135954999579*JDz[5]+0.4472135954999579*JDz[4]-0.9*JDz[3]+0.6708203932499369*JDz[2]-0.6708203932499369*JDz[1]+0.5*JDz[0];
  JBx_con_n[2] = 0.4*JBx[8]-0.5999999999999995*JBx[7]+0.5999999999999999*JBx[6]+0.4472135954999579*JBx[5]+0.4472135954999579*JBx[4]-0.9*JBx[3]+0.6708203932499369*JBx[2]-0.6708203932499369*JBx[1]+0.5*JBx[0];
  JBy_con_n[2] = 0.4*JBy[8]-0.5999999999999995*JBy[7]+0.5999999999999999*JBy[6]+0.4472135954999579*JBy[5]+0.4472135954999579*JBy[4]-0.9*JBy[3]+0.6708203932499369*JBy[2]-0.6708203932499369*JBy[1]+0.5*JBy[0];
  JBz_con_n[2] = 0.4*JBz[8]-0.5999999999999995*JBz[7]+0.5999999999999999*JBz[6]+0.4472135954999579*JBz[5]+0.4472135954999579*JBz[4]-0.9*JBz[3]+0.6708203932499369*JBz[2]-0.6708203932499369*JBz[1]+0.5*JBz[0];

  JDx_con_n[3] = -(0.5*JDx[8])+0.75*JDx[6]+0.4472135954999579*JDx[5]-0.5590169943749475*JDx[4]-0.6708203932499369*JDx[2]+0.5*JDx[0];
  JDy_con_n[3] = -(0.5*JDy[8])+0.75*JDy[6]+0.4472135954999579*JDy[5]-0.5590169943749475*JDy[4]-0.6708203932499369*JDy[2]+0.5*JDy[0];
  JDz_con_n[3] = -(0.5*JDz[8])+0.75*JDz[6]+0.4472135954999579*JDz[5]-0.5590169943749475*JDz[4]-0.6708203932499369*JDz[2]+0.5*JDz[0];
  JBx_con_n[3] = -(0.5*JBx[8])+0.75*JBx[6]+0.4472135954999579*JBx[5]-0.5590169943749475*JBx[4]-0.6708203932499369*JBx[2]+0.5*JBx[0];
  JBy_con_n[3] = -(0.5*JBy[8])+0.75*JBy[6]+0.4472135954999579*JBy[5]-0.5590169943749475*JBy[4]-0.6708203932499369*JBy[2]+0.5*JBy[0];
  JBz_con_n[3] = -(0.5*JBz[8])+0.75*JBz[6]+0.4472135954999579*JBz[5]-0.5590169943749475*JBz[4]-0.6708203932499369*JBz[2]+0.5*JBz[0];

  JDx_con_n[4] = 0.625*JDx[8]-0.5590169943749475*JDx[5]-0.5590169943749475*JDx[4]+0.5*JDx[0];
  JDy_con_n[4] = 0.625*JDy[8]-0.5590169943749475*JDy[5]-0.5590169943749475*JDy[4]+0.5*JDy[0];
  JDz_con_n[4] = 0.625*JDz[8]-0.5590169943749475*JDz[5]-0.5590169943749475*JDz[4]+0.5*JDz[0];
  JBx_con_n[4] = 0.625*JBx[8]-0.5590169943749475*JBx[5]-0.5590169943749475*JBx[4]+0.5*JBx[0];
  JBy_con_n[4] = 0.625*JBy[8]-0.5590169943749475*JBy[5]-0.5590169943749475*JBy[4]+0.5*JBy[0];
  JBz_con_n[4] = 0.625*JBz[8]-0.5590169943749475*JBz[5]-0.5590169943749475*JBz[4]+0.5*JBz[0];

  JDx_con_n[5] = -(0.5*JDx[8])-0.75*JDx[6]+0.4472135954999579*JDx[5]-0.5590169943749475*JDx[4]+0.6708203932499369*JDx[2]+0.5*JDx[0];
  JDy_con_n[5] = -(0.5*JDy[8])-0.75*JDy[6]+0.4472135954999579*JDy[5]-0.5590169943749475*JDy[4]+0.6708203932499369*JDy[2]+0.5*JDy[0];
  JDz_con_n[5] = -(0.5*JDz[8])-0.75*JDz[6]+0.4472135954999579*JDz[5]-0.5590169943749475*JDz[4]+0.6708203932499369*JDz[2]+0.5*JDz[0];
  JBx_con_n[5] = -(0.5*JBx[8])-0.75*JBx[6]+0.4472135954999579*JBx[5]-0.5590169943749475*JBx[4]+0.6708203932499369*JBx[2]+0.5*JBx[0];
  JBy_con_n[5] = -(0.5*JBy[8])-0.75*JBy[6]+0.4472135954999579*JBy[5]-0.5590169943749475*JBy[4]+0.6708203932499369*JBy[2]+0.5*JBy[0];
  JBz_con_n[5] = -(0.5*JBz[8])-0.75*JBz[6]+0.4472135954999579*JBz[5]-0.5590169943749475*JBz[4]+0.6708203932499369*JBz[2]+0.5*JBz[0];

  JDx_con_n[6] = 0.4*JDx[8]+0.5999999999999995*JDx[7]-0.5999999999999999*JDx[6]+0.4472135954999579*JDx[5]+0.4472135954999579*JDx[4]-0.9*JDx[3]-0.6708203932499369*JDx[2]+0.6708203932499369*JDx[1]+0.5*JDx[0];
  JDy_con_n[6] = 0.4*JDy[8]+0.5999999999999995*JDy[7]-0.5999999999999999*JDy[6]+0.4472135954999579*JDy[5]+0.4472135954999579*JDy[4]-0.9*JDy[3]-0.6708203932499369*JDy[2]+0.6708203932499369*JDy[1]+0.5*JDy[0];
  JDz_con_n[6] = 0.4*JDz[8]+0.5999999999999995*JDz[7]-0.5999999999999999*JDz[6]+0.4472135954999579*JDz[5]+0.4472135954999579*JDz[4]-0.9*JDz[3]-0.6708203932499369*JDz[2]+0.6708203932499369*JDz[1]+0.5*JDz[0];
  JBx_con_n[6] = 0.4*JBx[8]+0.5999999999999995*JBx[7]-0.5999999999999999*JBx[6]+0.4472135954999579*JBx[5]+0.4472135954999579*JBx[4]-0.9*JBx[3]-0.6708203932499369*JBx[2]+0.6708203932499369*JBx[1]+0.5*JBx[0];
  JBy_con_n[6] = 0.4*JBy[8]+0.5999999999999995*JBy[7]-0.5999999999999999*JBy[6]+0.4472135954999579*JBy[5]+0.4472135954999579*JBy[4]-0.9*JBy[3]-0.6708203932499369*JBy[2]+0.6708203932499369*JBy[1]+0.5*JBy[0];
  JBz_con_n[6] = 0.4*JBz[8]+0.5999999999999995*JBz[7]-0.5999999999999999*JBz[6]+0.4472135954999579*JBz[5]+0.4472135954999579*JBz[4]-0.9*JBz[3]-0.6708203932499369*JBz[2]+0.6708203932499369*JBz[1]+0.5*JBz[0];

  JDx_con_n[7] = -(0.5*JDx[8])-0.75*JDx[7]-0.5590169943749475*JDx[5]+0.4472135954999579*JDx[4]+0.6708203932499369*JDx[1]+0.5*JDx[0];
  JDy_con_n[7] = -(0.5*JDy[8])-0.75*JDy[7]-0.5590169943749475*JDy[5]+0.4472135954999579*JDy[4]+0.6708203932499369*JDy[1]+0.5*JDy[0];
  JDz_con_n[7] = -(0.5*JDz[8])-0.75*JDz[7]-0.5590169943749475*JDz[5]+0.4472135954999579*JDz[4]+0.6708203932499369*JDz[1]+0.5*JDz[0];
  JBx_con_n[7] = -(0.5*JBx[8])-0.75*JBx[7]-0.5590169943749475*JBx[5]+0.4472135954999579*JBx[4]+0.6708203932499369*JBx[1]+0.5*JBx[0];
  JBy_con_n[7] = -(0.5*JBy[8])-0.75*JBy[7]-0.5590169943749475*JBy[5]+0.4472135954999579*JBy[4]+0.6708203932499369*JBy[1]+0.5*JBy[0];
  JBz_con_n[7] = -(0.5*JBz[8])-0.75*JBz[7]-0.5590169943749475*JBz[5]+0.4472135954999579*JBz[4]+0.6708203932499369*JBz[1]+0.5*JBz[0];

  JDx_con_n[8] = 0.4*JDx[8]+0.5999999999999995*JDx[7]+0.5999999999999999*JDx[6]+0.4472135954999579*JDx[5]+0.4472135954999579*JDx[4]+0.9*JDx[3]+0.6708203932499369*JDx[2]+0.6708203932499369*JDx[1]+0.5*JDx[0];
  JDy_con_n[8] = 0.4*JDy[8]+0.5999999999999995*JDy[7]+0.5999999999999999*JDy[6]+0.4472135954999579*JDy[5]+0.4472135954999579*JDy[4]+0.9*JDy[3]+0.6708203932499369*JDy[2]+0.6708203932499369*JDy[1]+0.5*JDy[0];
  JDz_con_n[8] = 0.4*JDz[8]+0.5999999999999995*JDz[7]+0.5999999999999999*JDz[6]+0.4472135954999579*JDz[5]+0.4472135954999579*JDz[4]+0.9*JDz[3]+0.6708203932499369*JDz[2]+0.6708203932499369*JDz[1]+0.5*JDz[0];
  JBx_con_n[8] = 0.4*JBx[8]+0.5999999999999995*JBx[7]+0.5999999999999999*JBx[6]+0.4472135954999579*JBx[5]+0.4472135954999579*JBx[4]+0.9*JBx[3]+0.6708203932499369*JBx[2]+0.6708203932499369*JBx[1]+0.5*JBx[0];
  JBy_con_n[8] = 0.4*JBy[8]+0.5999999999999995*JBy[7]+0.5999999999999999*JBy[6]+0.4472135954999579*JBy[5]+0.4472135954999579*JBy[4]+0.9*JBy[3]+0.6708203932499369*JBy[2]+0.6708203932499369*JBy[1]+0.5*JBy[0];
  JBz_con_n[8] = 0.4*JBz[8]+0.5999999999999995*JBz[7]+0.5999999999999999*JBz[6]+0.4472135954999579*JBz[5]+0.4472135954999579*JBz[4]+0.9*JBz[3]+0.6708203932499369*JBz[2]+0.6708203932499369*JBz[1]+0.5*JBz[0];
  ...
  const double *vierb_xz_cov_nodal = &vierb_cov_nodal[18];
  const double *vierb_yx_cov_nodal = &vierb_cov_nodal[27];
  const double *vierb_yy_cov_nodal = &vierb_cov_nodal[36];
  const double *vierb_yz_cov_nodal = &vierb_cov_nodal[45];
  const double *vierb_zx_cov_nodal = &vierb_cov_nodal[54];
  const double *vierb_zy_cov_nodal = &vierb_cov_nodal[63];
  const double *vierb_zz_cov_nodal = &vierb_cov_nodal[72];
  ...
  E_conf_for_force_comp[8] = 0.12345679012345678*E_conf_for_force_n[8]-0.24691358024691357*E_conf_for_force_n[7]+0.12345679012345678*E_conf_for_force_n[6]-0.24691358024691357*E_conf_for_force_n[5]+0.49382716049382713*E_conf_for_force_n[4]-0.24691358024691357*E_conf_for_force_n[3]+0.12345679012345678*E_conf_for_force_n[2]-0.24691358024691357*E_conf_for_force_n[1]+0.12345679012345678*E_conf_for_force_n[0];

  E_conf_for_force_comp = &E_conf_for_force[9];
  ...
  E_conf_for_force_comp[8] = 0.12345679012345678*E_conf_for_force_n[17]-0.24691358024691357*E_conf_for_force_n[16]+0.12345679012345678*E_conf_for_force_n[15]-0.24691358024691357*E_conf_for_force_n[14]+0.49382716049382713*E_conf_for_force_n[13]-0.24691358024691357*E_conf_for_force_n[12]+0.12345679012345678*E_conf_for_force_n[11]-0.24691358024691357*E_conf_for_force_n[10]+0.12345679012345678*E_conf_for_force_n[9];

  E_conf_for_force_comp = &E_conf_for_force[18];
  ...
  E_conf_for_force_comp[8] = 0.12345679012345678*E_conf_for_force_n[26]-0.24691358024691357*E_conf_for_force_n[25]+0.12345679012345678*E_conf_for_force_n[24]-0.24691358024691357*E_conf_for_force_n[23]+0.49382716049382713*E_conf_for_force_n[22]-0.24691358024691357*E_conf_for_force_n[21]+0.12345679012345678*E_conf_for_force_n[20]-0.24691358024691357*E_conf_for_force_n[19]+0.12345679012345678*E_conf_for_force_n[18];
  ...
  B_conf_for_force_comp[8] = 0.12345679012345678*B_conf_for_force_n[8]-0.24691358024691357*B_conf_for_force_n[7]+0.12345679012345678*B_conf_for_force_n[6]-0.24691358024691357*B_conf_for_force_n[5]+0.49382716049382713*B_conf_for_force_n[4]-0.24691358024691357*B_conf_for_force_n[3]+0.12345679012345678*B_conf_for_force_n[2]-0.24691358024691357*B_conf_for_force_n[1]+0.12345679012345678*B_conf_for_force_n[0];

  B_conf_for_force_comp = &B_conf_for_force[9];
  ...
  B_conf_for_force_comp[8] = 0.12345679012345678*B_conf_for_force_n[17]-0.24691358024691357*B_conf_for_force_n[16]+0.12345679012345678*B_conf_for_force_n[15]-0.24691358024691357*B_conf_for_force_n[14]+0.49382716049382713*B_conf_for_force_n[13]-0.24691358024691357*B_conf_for_force_n[12]+0.12345679012345678*B_conf_for_force_n[11]-0.24691358024691357*B_conf_for_force_n[10]+0.12345679012345678*B_conf_for_force_n[9];

  B_conf_for_force_comp = &B_conf_for_force[18];
  ...
  B_conf_for_force_comp[8] = 0.12345679012345678*B_conf_for_force_n[26]-0.24691358024691357*B_conf_for_force_n[25]+0.12345679012345678*B_conf_for_force_n[24]-0.24691358024691357*B_conf_for_force_n[23]+0.49382716049382713*B_conf_for_force_n[22]-0.24691358024691357*B_conf_for_force_n[21]+0.12345679012345678*B_conf_for_force_n[20]-0.24691358024691357*B_conf_for_force_n[19]+0.12345679012345678*B_conf_for_force_n[18];
