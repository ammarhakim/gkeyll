    ...
    const double *vierb_con_nodal, double* GKYL_RESTRICT E_conf_for_force, double* GKYL_RESTRICT B_conf_for_force)
{
  ...
  const double vierb_xz_cov_nodal[4] = {0.0};
  const double *vierb_yx_cov_nodal = &vierb_cov_nodal[8];
  const double *vierb_yy_cov_nodal = &vierb_cov_nodal[12];
  const double vierb_yz_cov_nodal[4] = {0.0};
  const double vierb_zx_cov_nodal[4] = {0.0};
  const double vierb_zy_cov_nodal[4] = {0.0};
  double vierb_zz_cov_nodal[4] = {0.0};
  const double *vierb_xx_con_nodal = &vierb_con_nodal[0];
  const double *vierb_xy_con_nodal = &vierb_con_nodal[4];
  const double vierb_xz_con_nodal[4] = {0.0};
  const double *vierb_yx_con_nodal = &vierb_con_nodal[8];
  const double *vierb_yy_con_nodal = &vierb_con_nodal[12];
  const double vierb_yz_con_nodal[4] = {0.0};
  const double vierb_zx_con_nodal[4] = {0.0};
  const double vierb_zy_con_nodal[4] = {0.0};
  double vierb_zz_con_nodal[4] = {0.0};
  for (int i=0; i<4; ++i) {
