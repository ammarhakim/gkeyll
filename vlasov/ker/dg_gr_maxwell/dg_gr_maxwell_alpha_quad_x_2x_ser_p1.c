...
{ 
  ...
  Jphi_l_n[0] = -(0.8660254037844386*Jphi_l[3])-0.5*Jphi_l[2]+0.8660254037844386*Jphi_l[1]+0.5*Jphi_l[0];
  Jpsi_l_n[0] = -(0.8660254037844386*Jpsi_l[3])-0.5*Jpsi_l[2]+0.8660254037844386*Jpsi_l[1]+0.5*Jpsi_l[0];
  ...
  Jphi_l_n[1] = 0.8660254037844386*Jphi_l[3]+0.5*Jphi_l[2]+0.8660254037844386*Jphi_l[1]+0.5*Jphi_l[0];
  Jpsi_l_n[1] = 0.8660254037844386*Jpsi_l[3]+0.5*Jpsi_l[2]+0.8660254037844386*Jpsi_l[1]+0.5*Jpsi_l[0];
  ...
  phi_l_n[0] = -(0.8660254037844386*phi_l[3])-0.5*phi_l[2]+0.8660254037844386*phi_l[1]+0.5*phi_l[0];
  psi_l_n[0] = -(0.8660254037844386*psi_l[3])-0.5*psi_l[2]+0.8660254037844386*psi_l[1]+0.5*psi_l[0];
  ...
  phi_l_n[1] = 0.8660254037844386*phi_l[3]+0.5*phi_l[2]+0.8660254037844386*phi_l[1]+0.5*phi_l[0];
  psi_l_n[1] = 0.8660254037844386*psi_l[3]+0.5*psi_l[2]+0.8660254037844386*psi_l[1]+0.5*psi_l[0];
  ...
  Jphi_r_n[0] = 0.8660254037844386*Jphi_r[3]-0.5*Jphi_r[2]-0.8660254037844386*Jphi_r[1]+0.5*Jphi_r[0];
  Jpsi_r_n[0] = 0.8660254037844386*Jpsi_r[3]-0.5*Jpsi_r[2]-0.8660254037844386*Jpsi_r[1]+0.5*Jpsi_r[0];
  ...
  Jphi_r_n[1] = -(0.8660254037844386*Jphi_r[3])+0.5*Jphi_r[2]-0.8660254037844386*Jphi_r[1]+0.5*Jphi_r[0];
  Jpsi_r_n[1] = -(0.8660254037844386*Jpsi_r[3])+0.5*Jpsi_r[2]-0.8660254037844386*Jpsi_r[1]+0.5*Jpsi_r[0];
  ...
  phi_r_n[0] = 0.8660254037844386*phi_r[3]-0.5*phi_r[2]-0.8660254037844386*phi_r[1]+0.5*phi_r[0];
  psi_r_n[0] = 0.8660254037844386*psi_r[3]-0.5*psi_r[2]-0.8660254037844386*psi_r[1]+0.5*psi_r[0];
  ...
  phi_r_n[1] = -(0.8660254037844386*phi_r[3])+0.5*phi_r[2]-0.8660254037844386*phi_r[1]+0.5*phi_r[0];
  psi_r_n[1] = -(0.8660254037844386*psi_r[3])+0.5*psi_r[2]-0.8660254037844386*psi_r[1]+0.5*psi_r[0];
