...
GKYL_CU_DH void dg_gr_maxwell_lorentz_conf_2x2v_tensor_p2(const gkyl_dg_gr_maxwell_inp *meq, const double *dx, const double *lapse_nodal, const double *shift_nodal,
