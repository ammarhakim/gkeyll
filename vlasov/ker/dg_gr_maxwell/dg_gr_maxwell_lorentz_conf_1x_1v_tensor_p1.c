    ...
    const double *vierb_con_nodal, double* GKYL_RESTRICT E_conf_for_force, double* GKYL_RESTRICT B_conf_for_force)
{
  ...
  const double vierb_xy_cov_nodal[2] = {0.0};
  const double vierb_xz_cov_nodal[2] = {0.0};
  const double vierb_yx_cov_nodal[2] = {0.0};
  double vierb_yy_cov_nodal[2] = {0.0};
  const double vierb_yz_cov_nodal[2] = {0.0};
  const double vierb_zx_cov_nodal[2] = {0.0};
  const double vierb_zy_cov_nodal[2] = {0.0};
  double vierb_zz_cov_nodal[2] = {0.0};
  const double *vierb_xx_con_nodal = &vierb_con_nodal[0];
  const double vierb_xy_con_nodal[2] = {0.0};
  const double vierb_xz_con_nodal[2] = {0.0};
  const double vierb_yx_con_nodal[2] = {0.0};
  double vierb_yy_con_nodal[2] = {0.0};
  const double vierb_yz_con_nodal[2] = {0.0};
  const double vierb_zx_con_nodal[2] = {0.0};
  const double vierb_zy_con_nodal[2] = {0.0};
  double vierb_zz_con_nodal[2] = {0.0};
  for (int i=0; i<2; ++i) {
    vierb_yy_cov_nodal[i] = 1.0;
    vierb_zz_cov_nodal[i] = 1.0;
    vierb_yy_con_nodal[i] = 1.0;
