    ...
    const double *vierb_con_nodal, double* GKYL_RESTRICT E_conf_for_force, double* GKYL_RESTRICT B_conf_for_force)
{
  ...
  const double *vierb_yx_cov_nodal = &vierb_cov_nodal[4];
  const double *vierb_yy_cov_nodal = &vierb_cov_nodal[6];
  ...
  const double *vierb_yx_con_nodal = &vierb_con_nodal[4];
  const double *vierb_yy_con_nodal = &vierb_con_nodal[6];
