...
{ 
  ...
  f_comp_no_J = &fields_no_J[i*8];
    ...
    fields_no_J_nodal[0] = 1.0/J[0]*(-(0.5999999999999994*Jf_comp[7])-0.5999999999999999*Jf_comp[6]+0.4472135954999579*Jf_comp[5]+0.4472135954999579*Jf_comp[4]+0.9*Jf_comp[3]-0.6708203932499369*Jf_comp[2]-0.6708203932499369*Jf_comp[1]+0.5*Jf_comp[0]);
    fields_no_J_nodal[1] = 1.0/J[1]*(0.75*Jf_comp[7]-0.5590169943749475*Jf_comp[5]+0.4472135954999579*Jf_comp[4]-0.6708203932499369*Jf_comp[1]+0.5*Jf_comp[0]);
    fields_no_J_nodal[2] = 1.0/J[2]*(-(0.5999999999999994*Jf_comp[7])+0.5999999999999999*Jf_comp[6]+0.4472135954999579*Jf_comp[5]+0.4472135954999579*Jf_comp[4]-0.9*Jf_comp[3]+0.6708203932499369*Jf_comp[2]-0.6708203932499369*Jf_comp[1]+0.5*Jf_comp[0]);
    fields_no_J_nodal[3] = 1.0/J[3]*(0.75*Jf_comp[6]+0.4472135954999579*Jf_comp[5]-0.5590169943749475*Jf_comp[4]-0.6708203932499369*Jf_comp[2]+0.5*Jf_comp[0]);
    fields_no_J_nodal[4] = 1.0/J[4]*(-(0.5590169943749475*Jf_comp[5])-0.5590169943749475*Jf_comp[4]+0.5*Jf_comp[0]);
    fields_no_J_nodal[5] = 1.0/J[5]*(-(0.75*Jf_comp[6])+0.4472135954999579*Jf_comp[5]-0.5590169943749475*Jf_comp[4]+0.6708203932499369*Jf_comp[2]+0.5*Jf_comp[0]);
    fields_no_J_nodal[6] = 1.0/J[6]*(0.5999999999999994*Jf_comp[7]-0.5999999999999999*Jf_comp[6]+0.4472135954999579*Jf_comp[5]+0.4472135954999579*Jf_comp[4]-0.9*Jf_comp[3]-0.6708203932499369*Jf_comp[2]+0.6708203932499369*Jf_comp[1]+0.5*Jf_comp[0]);
    fields_no_J_nodal[7] = 1.0/J[7]*(-(0.75*Jf_comp[7])-0.5590169943749475*Jf_comp[5]+0.4472135954999579*Jf_comp[4]+0.6708203932499369*Jf_comp[1]+0.5*Jf_comp[0]);
    fields_no_J_nodal[8] = 1.0/J[8]*(0.5999999999999994*Jf_comp[7]+0.5999999999999999*Jf_comp[6]+0.4472135954999579*Jf_comp[5]+0.4472135954999579*Jf_comp[4]+0.9*Jf_comp[3]+0.6708203932499369*Jf_comp[2]+0.6708203932499369*Jf_comp[1]+0.5*Jf_comp[0]);
