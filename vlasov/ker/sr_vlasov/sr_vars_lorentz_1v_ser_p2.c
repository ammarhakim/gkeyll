...
{ 
  ...
  gamma_nodal[0] = sqrt(1.0 + 1.5811388300841895*p0_sq[2]-1.224744871391589*p0_sq[1]+0.7071067811865475*p0_sq[0]);
  ...
  gamma_nodal[2] = sqrt(1.0 + 1.5811388300841895*p0_sq[2]+1.224744871391589*p0_sq[1]+0.7071067811865475*p0_sq[0]);
  ...
  gamma_inv[2] = 0.21081851067789195*gamma_inv_nodal[2]-0.421637021355784*gamma_inv_nodal[1]+0.21081851067789195*gamma_inv_nodal[0]; 
} 
