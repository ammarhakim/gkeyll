...
{ 
  ...
  temp[7] = 1.4142135623730951*V_0[4]*wx1; 
  temp[8] = 1.4142135623730951*V_0[5]*wx1; 
  temp[10] = 0.408248290463863*V_0[3]*dv1; 
  temp[11] = 1.4142135623730951*V_0[6]*wx1; 
  temp[12] = 1.4142135623730951*V_0[7]*wx1; 
  temp[13] = 0.40824829046386296*V_0[4]*dv1; 
  temp[14] = 0.40824829046386296*V_0[5]*dv1; 
  temp[17] = 0.40824829046386296*V_0[6]*dv1; 
  temp[18] = 0.40824829046386296*V_0[7]*dv1; 
  ...
  temp_sq[7] = 1.4142135623730951*V_0_sq[4]*wx1_sq+0.11785113019775789*V_0_sq[4]*dv1_sq; 
  temp_sq[8] = 1.4142135623730951*V_0_sq[5]*wx1_sq+0.11785113019775789*V_0_sq[5]*dv1_sq; 
  temp_sq[9] = 0.10540925533894596*V_0_sq[0]*dv1_sq; 
  temp_sq[10] = 0.8164965809277261*V_0_sq[3]*dv1*wx1; 
  temp_sq[11] = 1.4142135623730951*V_0_sq[6]*wx1_sq+0.11785113019775789*V_0_sq[6]*dv1_sq; 
  temp_sq[12] = 1.4142135623730951*V_0_sq[7]*wx1_sq+0.11785113019775789*V_0_sq[7]*dv1_sq; 
  temp_sq[13] = 0.816496580927726*V_0_sq[4]*dv1*wx1; 
  temp_sq[14] = 0.816496580927726*V_0_sq[5]*dv1*wx1; 
  temp_sq[15] = 0.105409255338946*V_0_sq[1]*dv1_sq; 
  temp_sq[16] = 0.105409255338946*V_0_sq[2]*dv1_sq; 
  temp_sq[17] = 0.816496580927726*V_0_sq[6]*dv1*wx1; 
  temp_sq[18] = 0.816496580927726*V_0_sq[7]*dv1*wx1; 
  temp_sq[19] = 0.10540925533894596*V_0_sq[3]*dv1_sq; 
  ...
  p_fac[1] = 0.7071067811865475*gamma_inv[2]*temp_sq[15]-1.0000000000000002*GammaV[5]*temp[12]-0.8944271909999161*GammaV[3]*temp[11]-1.0000000000000002*GammaV[7]*temp[8]-0.8944271909999159*GammaV[1]*temp[7]-0.8944271909999161*temp[4]*GammaV[6]+0.7071067811865475*gamma_inv[1]*temp_sq[5]-1.0*GammaV[2]*temp[4]-0.8944271909999159*temp[1]*GammaV[4]-1.0*temp[2]*GammaV[3]+0.7071067811865475*gamma_inv[0]*temp_sq[1]-1.0*GammaV[0]*temp[1]+gamma[0]*GammaV_sq[1]-1.0*temp[0]*GammaV[1]; 
  p_fac[2] = 0.7071067811865475*gamma_inv[2]*temp_sq[16]-0.8944271909999161*GammaV[3]*temp[12]-1.0000000000000002*GammaV[4]*temp[11]-0.8944271909999159*GammaV[2]*temp[8]-1.0000000000000002*GammaV[6]*temp[7]-0.8944271909999161*temp[4]*GammaV[7]+0.7071067811865475*gamma_inv[1]*temp_sq[6]-0.8944271909999159*temp[2]*GammaV[5]-1.0*GammaV[1]*temp[4]-1.0*temp[1]*GammaV[3]+0.7071067811865475*gamma_inv[0]*temp_sq[2]-1.0*GammaV[0]*temp[2]+gamma[0]*GammaV_sq[2]-1.0*temp[0]*GammaV[2]; 
  p_fac[3] = -(1.0000000000000002*GammaV[7]*temp[18])-1.0000000000000002*GammaV[6]*temp[17]-1.0000000000000002*GammaV[5]*temp[14]-1.0000000000000002*GammaV[4]*temp[13]-1.0*GammaV[3]*temp[10]+0.6324555320336759*gamma_inv[1]*temp_sq[9]-1.0*GammaV[2]*temp[6]-1.0*GammaV[1]*temp[5]+0.6324555320336759*gamma_inv[2]*temp_sq[3]+0.7071067811865475*gamma_inv[0]*temp_sq[3]-1.0*GammaV[0]*temp[3]+GammaV_sq[0]*gamma[1]+0.7071067811865475*temp_sq[0]*gamma_inv[1]-2.0*gamma_inv[1]; 
  ...
  p_fac[7] = 0.7071067811865475*gamma_inv[1]*temp_sq[13]-0.8944271909999159*GammaV[7]*temp[12]-0.6388765649999399*GammaV[6]*temp[11]-1.0000000000000002*GammaV[2]*temp[11]+0.7071067811865475*gamma_inv[0]*temp_sq[7]-0.6388765649999399*GammaV[4]*temp[7]-1.0*GammaV[0]*temp[7]-1.0000000000000002*temp[2]*GammaV[6]-0.8944271909999159*GammaV[3]*temp[4]+gamma[0]*GammaV_sq[4]-1.0*temp[0]*GammaV[4]-0.8944271909999159*GammaV[1]*temp[1]; 
  p_fac[8] = 0.7071067811865475*gamma_inv[1]*temp_sq[14]-0.6388765649999399*GammaV[7]*temp[12]-1.0000000000000002*GammaV[1]*temp[12]-0.8944271909999159*GammaV[6]*temp[11]+0.7071067811865475*gamma_inv[0]*temp_sq[8]-0.6388765649999399*GammaV[5]*temp[8]-1.0*GammaV[0]*temp[8]-1.0000000000000002*temp[1]*GammaV[7]+gamma[0]*GammaV_sq[5]-1.0*temp[0]*GammaV[5]-0.8944271909999159*GammaV[3]*temp[4]-0.8944271909999159*GammaV[2]*temp[2]; 
  p_fac[9] = 0.45175395145262565*gamma_inv[2]*temp_sq[9]+0.7071067811865475*gamma_inv[0]*temp_sq[9]+0.6324555320336759*gamma_inv[1]*temp_sq[3]+GammaV_sq[0]*gamma[2]+0.7071067811865475*temp_sq[0]*gamma_inv[2]-2.0*gamma_inv[2]; 
  ...
  p_fac[11] = 0.7071067811865475*gamma_inv[1]*temp_sq[17]-0.8*GammaV[3]*temp[12]+0.7071067811865475*gamma_inv[0]*temp_sq[11]-0.8944271909999159*GammaV[5]*temp[11]-0.6388765649999399*GammaV[4]*temp[11]-1.0*GammaV[0]*temp[11]-0.8944271909999159*GammaV[6]*temp[8]-0.6388765649999399*GammaV[6]*temp[7]-1.0000000000000002*GammaV[2]*temp[7]-0.8*temp[4]*GammaV[7]+gamma[0]*GammaV_sq[6]-1.0*temp[0]*GammaV[6]-0.8944271909999161*GammaV[1]*temp[4]-1.0000000000000002*temp[2]*GammaV[4]-0.8944271909999161*temp[1]*GammaV[3]; 
  p_fac[12] = 0.7071067811865475*gamma_inv[1]*temp_sq[18]+0.7071067811865475*gamma_inv[0]*temp_sq[12]-0.6388765649999399*GammaV[5]*temp[12]-0.8944271909999159*GammaV[4]*temp[12]-1.0*GammaV[0]*temp[12]-0.8*GammaV[3]*temp[11]-0.6388765649999399*GammaV[7]*temp[8]-1.0000000000000002*GammaV[1]*temp[8]-0.8944271909999159*GammaV[7]*temp[7]+gamma[0]*GammaV_sq[7]-1.0*temp[0]*GammaV[7]-0.8*temp[4]*GammaV[6]-1.0000000000000002*temp[1]*GammaV[5]-0.8944271909999161*GammaV[2]*temp[4]-0.8944271909999161*temp[2]*GammaV[3]; 
  p_fac[13] = -(0.8944271909999159*GammaV[7]*temp[18])-0.6388765649999399*GammaV[6]*temp[17]-1.0000000000000002*GammaV[2]*temp[17]+0.6324555320336759*gamma_inv[2]*temp_sq[13]+0.7071067811865475*gamma_inv[0]*temp_sq[13]-0.6388765649999399*GammaV[4]*temp[13]-1.0*GammaV[0]*temp[13]-0.8944271909999161*GammaV[3]*temp[10]+0.7071067811865475*gamma_inv[1]*temp_sq[7]-1.0*GammaV[6]*temp[6]-0.8944271909999161*GammaV[1]*temp[5]+1.0000000000000002*gamma[1]*GammaV_sq[4]-1.0000000000000002*temp[3]*GammaV[4]; 
  p_fac[14] = -(0.6388765649999399*GammaV[7]*temp[18])-1.0000000000000002*GammaV[1]*temp[18]-0.8944271909999159*GammaV[6]*temp[17]+0.6324555320336759*gamma_inv[2]*temp_sq[14]+0.7071067811865475*gamma_inv[0]*temp_sq[14]-0.6388765649999399*GammaV[5]*temp[14]-1.0*GammaV[0]*temp[14]-0.8944271909999161*GammaV[3]*temp[10]+0.7071067811865475*gamma_inv[1]*temp_sq[8]-1.0*temp[5]*GammaV[7]-0.8944271909999161*GammaV[2]*temp[6]+1.0000000000000002*gamma[1]*GammaV_sq[5]-1.0000000000000002*temp[3]*GammaV[5]; 
  p_fac[15] = 0.45175395145262565*gamma_inv[2]*temp_sq[15]+0.7071067811865475*gamma_inv[0]*temp_sq[15]+0.632455532033676*gamma_inv[1]*temp_sq[5]+1.0000000000000002*GammaV_sq[1]*gamma[2]+0.7071067811865475*temp_sq[1]*gamma_inv[2]; 
  p_fac[16] = 0.45175395145262565*gamma_inv[2]*temp_sq[16]+0.7071067811865475*gamma_inv[0]*temp_sq[16]+0.632455532033676*gamma_inv[1]*temp_sq[6]+1.0000000000000002*GammaV_sq[2]*gamma[2]+0.7071067811865475*gamma_inv[2]*temp_sq[2]; 
  p_fac[17] = -(0.8*GammaV[3]*temp[18])+0.6324555320336759*gamma_inv[2]*temp_sq[17]+0.7071067811865475*gamma_inv[0]*temp_sq[17]-0.8944271909999159*GammaV[5]*temp[17]-0.6388765649999399*GammaV[4]*temp[17]-1.0*GammaV[0]*temp[17]-0.8944271909999159*GammaV[6]*temp[14]-0.6388765649999399*GammaV[6]*temp[13]-1.0000000000000002*GammaV[2]*temp[13]+0.7071067811865475*gamma_inv[1]*temp_sq[11]-0.8*GammaV[7]*temp[10]-0.8944271909999159*GammaV[1]*temp[10]-1.0*GammaV[4]*temp[6]+1.0000000000000002*gamma[1]*GammaV_sq[6]-1.0000000000000002*temp[3]*GammaV[6]-0.8944271909999159*GammaV[3]*temp[5]; 
  p_fac[18] = 0.6324555320336759*gamma_inv[2]*temp_sq[18]+0.7071067811865475*gamma_inv[0]*temp_sq[18]-0.6388765649999399*GammaV[5]*temp[18]-0.8944271909999159*GammaV[4]*temp[18]-1.0*GammaV[0]*temp[18]-0.8*GammaV[3]*temp[17]-0.6388765649999399*GammaV[7]*temp[14]-1.0000000000000002*GammaV[1]*temp[14]-0.8944271909999159*GammaV[7]*temp[13]+0.7071067811865475*gamma_inv[1]*temp_sq[12]-0.8*GammaV[6]*temp[10]-0.8944271909999159*GammaV[2]*temp[10]+1.0000000000000002*gamma[1]*GammaV_sq[7]-1.0000000000000002*temp[3]*GammaV[7]-0.8944271909999159*GammaV[3]*temp[6]-1.0*GammaV[5]*temp[5]; 
  p_fac[19] = 0.45175395145262565*gamma_inv[2]*temp_sq[19]+0.7071067811865475*gamma_inv[0]*temp_sq[19]+0.6324555320336759*gamma_inv[1]*temp_sq[10]+0.7071067811865475*gamma_inv[2]*temp_sq[4]+gamma[2]*GammaV_sq[3]; 
  ...
  sr_pressure[1] += (0.5000000000000001*f[16]*p_fac[19]+0.5000000000000001*p_fac[16]*f[19]+0.5000000000000001*f[14]*p_fac[18]+0.5000000000000001*p_fac[14]*f[18]+0.4472135954999579*f[10]*p_fac[17]+0.4472135954999579*p_fac[10]*f[17]+0.5000000000000001*f[9]*p_fac[15]+0.5000000000000001*p_fac[9]*f[15]+0.44721359549995804*f[5]*p_fac[13]+0.44721359549995804*p_fac[5]*f[13]+0.5000000000000001*f[8]*p_fac[12]+0.5000000000000001*p_fac[8]*f[12]+0.44721359549995804*f[4]*p_fac[11]+0.44721359549995804*p_fac[4]*f[11]+0.5*f[6]*p_fac[10]+0.5*p_fac[6]*f[10]+0.4472135954999579*f[1]*p_fac[7]+0.4472135954999579*p_fac[1]*f[7]+0.5*f[3]*p_fac[5]+0.5*p_fac[3]*f[5]+0.5*f[2]*p_fac[4]+0.5*p_fac[2]*f[4]+0.5*f[0]*p_fac[1]+0.5*p_fac[0]*f[1])*volFact; 
  sr_pressure[2] += (0.5000000000000001*f[15]*p_fac[19]+0.5000000000000001*p_fac[15]*f[19]+0.4472135954999579*f[10]*p_fac[18]+0.4472135954999579*p_fac[10]*f[18]+0.5000000000000001*f[13]*p_fac[17]+0.5000000000000001*p_fac[13]*f[17]+0.5000000000000001*f[9]*p_fac[16]+0.5000000000000001*p_fac[9]*f[16]+0.44721359549995804*f[6]*p_fac[14]+0.44721359549995804*p_fac[6]*f[14]+0.44721359549995804*f[4]*p_fac[12]+0.44721359549995804*p_fac[4]*f[12]+0.5000000000000001*f[7]*p_fac[11]+0.5000000000000001*p_fac[7]*f[11]+0.5*f[5]*p_fac[10]+0.5*p_fac[5]*f[10]+0.4472135954999579*f[2]*p_fac[8]+0.4472135954999579*p_fac[2]*f[8]+0.5*f[3]*p_fac[6]+0.5*p_fac[3]*f[6]+0.5*f[1]*p_fac[4]+0.5*p_fac[1]*f[4]+0.5*f[0]*p_fac[2]+0.5*p_fac[0]*f[2])*volFact; 
  sr_pressure[3] += (0.5*f[9]*p_fac[19]+0.5*p_fac[9]*f[19]+0.4*f[17]*p_fac[18]+0.4472135954999579*f[6]*p_fac[18]+0.4*p_fac[17]*f[18]+0.4472135954999579*p_fac[6]*f[18]+0.4472135954999579*f[5]*p_fac[17]+0.4472135954999579*p_fac[5]*f[17]+0.5*f[15]*p_fac[16]+0.5*p_fac[15]*f[16]+0.44721359549995804*f[10]*p_fac[14]+0.44721359549995804*p_fac[10]*f[14]+0.44721359549995804*f[10]*p_fac[13]+0.44721359549995804*p_fac[10]*f[13]+0.4*f[11]*p_fac[12]+0.44721359549995804*f[2]*p_fac[12]+0.4*p_fac[11]*f[12]+0.44721359549995804*p_fac[2]*f[12]+0.44721359549995804*f[1]*p_fac[11]+0.44721359549995804*p_fac[1]*f[11]+0.5*f[3]*p_fac[10]+0.5*p_fac[3]*f[10]+0.4472135954999579*f[4]*p_fac[8]+0.4472135954999579*p_fac[4]*f[8]+0.4472135954999579*f[4]*p_fac[7]+0.4472135954999579*p_fac[4]*f[7]+0.5*f[5]*p_fac[6]+0.5*p_fac[5]*f[6]+0.5*f[0]*p_fac[4]+0.5*p_fac[0]*f[4]+0.5*f[1]*p_fac[2]+0.5*p_fac[1]*f[2])*volFact; 
  sr_pressure[4] += (0.4472135954999579*f[19]*p_fac[19]+0.4472135954999579*f[18]*p_fac[18]+0.31943828249996997*f[17]*p_fac[17]+0.5*f[6]*p_fac[17]+0.5*p_fac[6]*f[17]+0.4472135954999579*f[15]*p_fac[15]+0.31943828249996997*f[13]*p_fac[13]+0.5000000000000001*f[3]*p_fac[13]+0.5000000000000001*p_fac[3]*f[13]+0.4472135954999579*f[12]*p_fac[12]+0.31943828249996997*f[11]*p_fac[11]+0.5000000000000001*f[2]*p_fac[11]+0.5000000000000001*p_fac[2]*f[11]+0.4472135954999579*f[10]*p_fac[10]+0.31943828249996997*f[7]*p_fac[7]+0.5*f[0]*p_fac[7]+0.5*p_fac[0]*f[7]+0.4472135954999579*f[5]*p_fac[5]+0.4472135954999579*f[4]*p_fac[4]+0.4472135954999579*f[1]*p_fac[1])*volFact; 
  sr_pressure[5] += (0.4472135954999579*f[19]*p_fac[19]+0.31943828249996997*f[18]*p_fac[18]+0.5*f[5]*p_fac[18]+0.5*p_fac[5]*f[18]+0.4472135954999579*f[17]*p_fac[17]+0.4472135954999579*f[16]*p_fac[16]+0.31943828249996997*f[14]*p_fac[14]+0.5000000000000001*f[3]*p_fac[14]+0.5000000000000001*p_fac[3]*f[14]+0.31943828249996997*f[12]*p_fac[12]+0.5000000000000001*f[1]*p_fac[12]+0.5000000000000001*p_fac[1]*f[12]+0.4472135954999579*f[11]*p_fac[11]+0.4472135954999579*f[10]*p_fac[10]+0.31943828249996997*f[8]*p_fac[8]+0.5*f[0]*p_fac[8]+0.5*p_fac[0]*f[8]+0.4472135954999579*f[6]*p_fac[6]+0.4472135954999579*f[4]*p_fac[4]+0.4472135954999579*f[2]*p_fac[2])*volFact; 
  sr_pressure[6] += (0.4472135954999579*f[15]*p_fac[19]+0.4472135954999579*p_fac[15]*f[19]+0.4*f[10]*p_fac[18]+0.4*p_fac[10]*f[18]+0.4472135954999579*f[14]*p_fac[17]+0.31943828249996997*f[13]*p_fac[17]+0.5000000000000001*f[3]*p_fac[17]+0.4472135954999579*p_fac[14]*f[17]+0.31943828249996997*p_fac[13]*f[17]+0.5000000000000001*p_fac[3]*f[17]+0.5*f[6]*p_fac[13]+0.5*p_fac[6]*f[13]+0.4*f[4]*p_fac[12]+0.4*p_fac[4]*f[12]+0.4472135954999579*f[8]*p_fac[11]+0.31943828249996997*f[7]*p_fac[11]+0.5*f[0]*p_fac[11]+0.4472135954999579*p_fac[8]*f[11]+0.31943828249996997*p_fac[7]*f[11]+0.5*p_fac[0]*f[11]+0.44721359549995804*f[5]*p_fac[10]+0.44721359549995804*p_fac[5]*f[10]+0.5000000000000001*f[2]*p_fac[7]+0.5000000000000001*p_fac[2]*f[7]+0.44721359549995804*f[1]*p_fac[4]+0.44721359549995804*p_fac[1]*f[4])*volFact; 
  sr_pressure[7] += (0.4472135954999579*f[16]*p_fac[19]+0.4472135954999579*p_fac[16]*f[19]+0.31943828249996997*f[14]*p_fac[18]+0.4472135954999579*f[13]*p_fac[18]+0.5000000000000001*f[3]*p_fac[18]+0.31943828249996997*p_fac[14]*f[18]+0.4472135954999579*p_fac[13]*f[18]+0.5000000000000001*p_fac[3]*f[18]+0.4*f[10]*p_fac[17]+0.4*p_fac[10]*f[17]+0.5*f[5]*p_fac[14]+0.5*p_fac[5]*f[14]+0.31943828249996997*f[8]*p_fac[12]+0.4472135954999579*f[7]*p_fac[12]+0.5*f[0]*p_fac[12]+0.31943828249996997*p_fac[8]*f[12]+0.4472135954999579*p_fac[7]*f[12]+0.5*p_fac[0]*f[12]+0.4*f[4]*p_fac[11]+0.4*p_fac[4]*f[11]+0.44721359549995804*f[6]*p_fac[10]+0.44721359549995804*p_fac[6]*f[10]+0.5000000000000001*f[1]*p_fac[8]+0.5000000000000001*p_fac[1]*f[8]+0.44721359549995804*f[2]*p_fac[4]+0.44721359549995804*p_fac[2]*f[4])*volFact; 
} 
