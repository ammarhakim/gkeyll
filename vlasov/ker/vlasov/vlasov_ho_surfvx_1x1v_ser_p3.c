...
{ 
  ...
  out[10] += ((-0.2719936356805793*(Fhat_r_nodal_c[4]+Fhat_l_nodal_c[4]))+0.4577329594307796*(Fhat_r_nodal_c[3]+Fhat_l_nodal_c[3])-0.4577329594307796*(Fhat_r_nodal_c[1]+Fhat_l_nodal_c[1])+0.2719936356805793*(Fhat_r_nodal_c[0]+Fhat_l_nodal_c[0]))*dv10; 
  out[11] += ((-0.4919357619275829*(Fhat_r_nodal_c[4]+Fhat_l_nodal_c[4]))-0.5905263993751261*(Fhat_r_nodal_c[3]+Fhat_l_nodal_c[3])+0.5905263993751261*(Fhat_r_nodal_c[1]+Fhat_l_nodal_c[1])+0.4919357619275829*(Fhat_r_nodal_c[0]+Fhat_l_nodal_c[0]))*dv10; 
