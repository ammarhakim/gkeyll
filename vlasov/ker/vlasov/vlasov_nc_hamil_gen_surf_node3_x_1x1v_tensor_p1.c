...
{ 
  ...
  alpha_l_quad = (0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1])*(4.084728180770504*hamil[2]+1.224744871391589*hamil[1])*dv10; 
  alpha_r_quad = (1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0])*(4.084728180770504*hamil[2]+1.224744871391589*hamil[1])*dv10; 
