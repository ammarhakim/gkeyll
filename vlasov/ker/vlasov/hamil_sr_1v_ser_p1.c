...
{ 
  ...
  hamil_nodal[1] = sqrt(1.0 + pow(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0));
  ...
  hamil_inv[0] = 0.7071067811865475*hamil_inv_nodal[1]+0.7071067811865475*hamil_inv_nodal[0]; 
  hamil_inv[1] = 0.408248290463863*hamil_inv_nodal[1]-0.408248290463863*hamil_inv_nodal[0]; 
