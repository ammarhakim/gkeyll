...
GKYL_CU_DH void vlasov_boundary_surfx_1x2v_ser_p1_mode(int m, int edge, double dx10,
...
{ 
  ...
  if (edge == -1) { 
    out[m] += dx10*vst_1x2v_ser_p1_prj_x0_pm_cr[m]*g; 
  } else { 
    out[m] += dx10*vst_1x2v_ser_p1_prj_x0_pm_cl[m]*g; 
  } 
} 
