...
{ 
  ...
  out[5] += (2.449489742783178*rad_vx[1]*f[5]+2.449489742783178*f[2]*rad_vx[2]+2.738612787525831*rad_vx[0]*f[2]+2.738612787525831*f[0]*rad_vx[1])*dv10; 
  out[6] += (1.224744871391589*rad_vx[1]*f[6]+1.224744871391589*rad_vx[0]*f[4])*dv10; 
  out[7] += (2.449489742783178*rad_vx[1]*f[7]+2.449489742783178*rad_vx[2]*f[3]+2.738612787525831*rad_vx[0]*f[3]+2.738612787525831*f[1]*rad_vx[1])*dv10; 
