...
GKYL_CU_DH void vlasov_surfvy_2x2v_tensor_p2_mode(int m, double dv11,
...
{ 
  ...
  out[m] += dv11*(vst_2x2v_tensor_p2_prj_v1_pm_cl[m]*g_l + vst_2x2v_tensor_p2_prj_v1_pm_cr[m]*g_r); 
} 
