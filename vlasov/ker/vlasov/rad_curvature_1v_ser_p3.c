...
GKYL_CU_DH void rad_curvature_1v_ser_p3(const double *w, const double *dxv, const double *vmap, 
...
{ 
  ...
  rad_nodal_vx[1] = -1.0/t_cool*(pow(0.7071067811865475*vmap_vx[0]-0.5477225575051661*vmap_vx[1], 3.0)*fabs(0.7071067811865475*vmap_vx[0]-0.5477225575051661*vmap_vx[1]));

  rad_nodal_vx[2] = -1.0/t_cool*(pow(0.5477225575051661*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 3.0)*fabs(0.5477225575051661*vmap_vx[1]+0.7071067811865475*vmap_vx[0]));
