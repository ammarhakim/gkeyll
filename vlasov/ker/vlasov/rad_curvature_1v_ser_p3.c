...
{ 
  ...
  rad_nodal_vx[1] = -1.0/t_cool*(pow(wx1-0.22360679774997896*dv1, 3.0)*fabs(wx1-0.22360679774997896*dv1));

  rad_nodal_vx[2] = -1.0/t_cool*(pow(wx1+0.22360679774997896*dv1, 3.0)*fabs(wx1+0.22360679774997896*dv1));
