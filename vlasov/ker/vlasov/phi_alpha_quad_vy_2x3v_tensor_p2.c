...
{ 
  ...
  force_quad = (-2.32379000772445*phi[8])+3.485685011586675*phi[7]+0.7745966692414833*phi[6]-2.598076211353316*phi[5]-1.161895003862225*phi[3]+0.8660254037844386*phi[2];
  ...
  force_quad = 2.904737509655563*phi[8]-0.9682458365518543*phi[6]-2.598076211353316*phi[5]+0.8660254037844386*phi[2];
