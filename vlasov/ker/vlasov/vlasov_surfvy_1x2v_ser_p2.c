...
{ 
  ...
  out[9] += (1.5811388300841895*Ghat_l[0]-1.5811388300841895*Ghat_r[0])*dv11; 
  ...
  out[15] += (1.5811388300841898*Ghat_l[1]-1.5811388300841898*Ghat_r[1])*dv11; 
  out[16] += (1.5811388300841898*Ghat_l[2]-1.5811388300841898*Ghat_r[2])*dv11; 
  out[17] += -(1.224744871391589*(Ghat_r[6]+Ghat_l[6])*dv11); 
  out[18] += -(1.224744871391589*(Ghat_r[7]+Ghat_l[7])*dv11); 
  out[19] += (1.5811388300841895*Ghat_l[3]-1.5811388300841895*Ghat_r[3])*dv11; 
