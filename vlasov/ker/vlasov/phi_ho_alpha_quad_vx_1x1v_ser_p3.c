...
GKYL_CU_DH void phi_ho_alpha_quad_vx_1x1v_ser_p3(const double *dxv, const double *phi, double* GKYL_RESTRICT alpha_quad) 
{ 
  ...
  force_quad = 1.262096553198939*phi[3]-2.554184205050222*phi[2]+1.224744871391589*phi[1];
