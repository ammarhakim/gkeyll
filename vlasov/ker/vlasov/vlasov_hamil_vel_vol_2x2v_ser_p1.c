...
{ 
  ...
  out[5] += (1.5*hamil[3]*f[9]+1.5*hamil[1]*f[2])*dv10*dx10; 
  out[6] += (1.5*hamil[3]*f[10]+1.5*hamil[1]*f[3])*dv10*dx10; 
  out[8] += (1.5*hamil[1]*f[4]+1.5*f[0]*hamil[3])*dv10*dx10; 
  out[11] += (1.5*hamil[3]*f[14]+1.5*hamil[1]*f[7])*dv10*dx10; 
  out[12] += (1.5*hamil[1]*f[9]+1.5*f[2]*hamil[3])*dv10*dx10; 
  out[13] += (1.5*hamil[1]*f[10]+1.5*f[3]*hamil[3])*dv10*dx10; 
  out[15] += (1.5*hamil[1]*f[14]+1.5*hamil[3]*f[7])*dv10*dx10; 
