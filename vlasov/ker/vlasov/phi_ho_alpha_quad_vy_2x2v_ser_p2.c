...
{ 
  ...
  force_quad = jacob_cy_inv*(4.308049588470176*phi[7]+1.1857789576832338*phi[6]-2.888338995926613*phi[5]-1.291704467391079*phi[3]+0.8660254037844386*phi[2]);
  alpha_quad[0] -= dx11*force_quad;
  alpha_quad[1] -= dx11*force_quad;
  alpha_quad[2] -= dx11*force_quad;
  alpha_quad[3] -= dx11*force_quad;

  force_quad = jacob_cy_inv*(1.7008401285415227*phi[7]+1.1857789576832338*phi[6]-1.140331086775586*phi[5]-1.291704467391079*phi[3]+0.8660254037844386*phi[2]);
  ...
  force_quad = jacob_cy_inv*(1.7008401285415227*phi[7]-0.6324956225107456*phi[6]-2.888338995926613*phi[5]-0.5099715653772844*phi[3]+0.8660254037844386*phi[2]);
  alpha_quad[16] -= dx11*force_quad;
  alpha_quad[17] -= dx11*force_quad;
  alpha_quad[18] -= dx11*force_quad;
  alpha_quad[19] -= dx11*force_quad;

  force_quad = jacob_cy_inv*(0.6715004280822172*phi[7]-0.6324956225107456*phi[6]-1.140331086775586*phi[5]-0.5099715653772844*phi[3]+0.8660254037844386*phi[2]);
