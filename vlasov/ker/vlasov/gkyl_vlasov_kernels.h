...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x1v_ser_p1(const double *w, const double *dxv, 
...
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_1x1v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_1x1v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_1x1v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_phase_surfx_1x1v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_alpha_quad_x_1x1v_ser_p1(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_1x1v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
...
GKYL_CU_DH void B_dense_alpha_quad_vx_1x1v_ser_p1(const double *dxv, const double *jacob_vel, 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x1v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_1x1v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_1x1v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_1x1v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_1x1v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_ho_surfx_1x1v_ser_p2(const double *w, const double *dxv,
        const double *flux_l, const double *flux_r, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_ho_surfx_1x1v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_1x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_1x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_1x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_1x1v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vx_1x1v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vx_1x1v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvx_1x1v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vx_1x1v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x1v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x1v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_1x1v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_1x1v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x1v_ser_p3(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_1x1v_ser_p3(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_vel_dense_surfx_1x1v_ser_p3(const double *w, const double *dxv, 
    const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
    const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_1x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_1x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_1x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvx_1x1v_ser_p3(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vx_1x1v_ser_p3(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x1v_ser_p3(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x1v_ser_p3(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_1x1v_ser_p3(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_1x1v_ser_p3(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x2v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_1x2v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_1x2v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_1x2v_ser_p1(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_1x2v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_1x2v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_1x2v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_1x2v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_1x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_1x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x2v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x2v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_1x2v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_1x2v_ser_p1(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_1x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_surfvy_1x2v_ser_p1(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vy_1x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_1x2v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_1x2v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_1x2v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x2v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_1x2v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_1x2v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_1x2v_ser_p2(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_1x2v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_1x2v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_1x2v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_ho_surfx_1x2v_ser_p2(const double *w, const double *dxv,
        const double *flux_l, const double *flux_r, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_ho_surfx_1x2v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_1x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_1x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_1x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_ho_alpha_quad_x_1x2v_ser_p2(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vx_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vx_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_1x2v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vx_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_1x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vx_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_ho_alpha_quad_vx_1x2v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vy_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vy_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vy_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vy_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvy_1x2v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vy_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_1x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vy_1x2v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vy_1x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vy_1x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vy_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vy_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x3v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_1x3v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_1x3v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_1x3v_ser_p1(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_1x3v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_1x3v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_1x3v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_1x3v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_alpha_quad_x_1x3v_ser_p1(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_1x3v_ser_p1(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vy_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_surfvy_1x3v_ser_p1(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vy_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_1x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vy_1x3v_ser_p1(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vz_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vz_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_surfvz_1x3v_ser_p1(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vz_1x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vz_1x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vz_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vz_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x3v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_1x3v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_1x3v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_1x3v_ser_p2(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_1x3v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_1x3v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_1x3v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_ho_surfx_1x3v_ser_p2(const double *w, const double *dxv,
        const double *flux_l, const double *flux_r, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_ho_surfx_1x3v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_1x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_1x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_1x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_ho_alpha_quad_x_1x3v_ser_p2(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vx_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vx_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvx_1x3v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vx_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_1x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vx_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_ho_alpha_quad_vx_1x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vy_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vy_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vy_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vy_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvy_1x3v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vy_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_1x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vy_1x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vy_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vy_1x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vy_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vy_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_ho_alpha_quad_vy_1x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vz_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vz_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vz_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vz_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vz_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvz_1x3v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vz_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vz_1x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vz_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vz_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vz_1x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vz_1x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vz_1x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vz_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vz_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x1v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_2x1v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_vel_dense_surfx_2x1v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
    const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_2x1v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_vel_dense_surfy_2x1v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
    const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_2x1v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_boundary_surfvx_2x1v_ser_p1(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vx_2x1v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x1v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x1v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x1v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_2x1v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_vel_dense_surfx_2x1v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
    const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_2x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_2x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_2x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_vel_dense_surfy_2x1v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
    const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_2x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfy_2x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfy_2x1v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x1v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x1v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_2x1v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vx_2x1v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_2x1v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_2x1v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x1v_ser_p3(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_2x1v_ser_p3(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_vel_dense_surfx_2x1v_ser_p3(const double *w, const double *dxv, 
    const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
    const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_2x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_2x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_2x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_hamil_vel_dense_surfy_2x1v_ser_p3(const double *w, const double *dxv, 
    const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
    const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_2x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfy_2x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfy_2x1v_ser_p3(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x1v_ser_p3(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x1v_ser_p3(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_2x1v_ser_p3(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vx_2x1v_ser_p3(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_2x1v_ser_p3(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_2x1v_ser_p3(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x2v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_2x2v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_2x2v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_2x2v_ser_p1(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_2x2v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_2x2v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_2x2v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_2x2v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfy_2x2v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_2x2v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_alpha_quad_y_2x2v_ser_p1(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_2x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_2x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x2v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x2v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_2x2v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_2x2v_ser_p1(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_2x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vy_2x2v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_2x2v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_2x2v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_2x2v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x2v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_2x2v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_2x2v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_2x2v_ser_p2(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_2x2v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_2x2v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_2x2v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_ho_surfx_2x2v_ser_p2(const double *w, const double *dxv,
        const double *flux_l, const double *flux_r, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_ho_surfx_2x2v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_2x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_2x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_2x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfy_2x2v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_ho_surfy_2x2v_ser_p2(const double *w, const double *dxv,
        const double *flux_l, const double *flux_r, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_ho_surfy_2x2v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_2x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfy_2x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfy_2x2v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_ho_alpha_quad_y_2x2v_ser_p2(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vx_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vx_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vx_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvx_2x2v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vx_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_2x2v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vx_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_2x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vx_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_ho_alpha_quad_vx_2x2v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vy_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vy_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vy_2x2v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_2x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vy_2x2v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vy_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vy_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x3v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_2x3v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_2x3v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_2x3v_ser_p1(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_2x3v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_2x3v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_2x3v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_2x3v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfy_2x3v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_2x3v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_alpha_quad_y_2x3v_ser_p1(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_2x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_2x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_surfvx_2x3v_ser_p1(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vx_2x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_2x3v_ser_p1(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_2x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_2x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vz_2x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vz_2x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_surfvz_2x3v_ser_p1(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vz_2x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vz_2x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vz_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vz_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x3v_ser_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_2x3v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_2x3v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_2x3v_ser_p2(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_2x3v_ser_p2(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_2x3v_ser_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_2x3v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_ho_surfx_2x3v_ser_p2(const double *w, const double *dxv,
        const double *flux_l, const double *flux_r, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_ho_surfx_2x3v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_2x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfx_2x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfx_2x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfy_2x3v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_ho_surfy_2x3v_ser_p2(const double *w, const double *dxv,
        const double *flux_l, const double *flux_r, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_ho_surfy_2x3v_ser_p2(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_2x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_boundary_surfy_2x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_edge, const double *jacob_pos_skin, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const int edge, const double *fedge, const double *fskin, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_ho_surfy_2x3v_ser_p2(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_ho_alpha_quad_y_2x3v_ser_p2(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vx_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vx_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vx_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_2x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vx_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vx_2x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vx_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vx_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_ho_alpha_quad_vx_2x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vy_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vy_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vy_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vy_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvy_2x3v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vy_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_2x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vy_2x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vy_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vy_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_ho_alpha_quad_vy_2x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vz_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vz_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_ho_alpha_quad_vz_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_ho_alpha_quad_vz_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_phase_alpha_quad_vz_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf, 
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_ho_surfvz_2x3v_ser_p2(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vz_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vz_2x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vz_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vz_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vz_2x3v_ser_p2(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void hamil_phase_ho_alpha_quad_vz_2x3v_ser_p2(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_ho_alpha_quad_vz_2x3v_ser_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_ho_alpha_quad_vz_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_ho_alpha_quad_vz_2x3v_ser_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_3x3v_ser_p1(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_3x3v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_dense_vol_3x3v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_vel_sparse_vol_3x3v_ser_p1(const double *w, const double *dxv,
        const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_phase_vol_3x3v_ser_p1(const double *w, const double *dxv,
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_phase_vol_3x3v_ser_p1(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfx_3x3v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfx_3x3v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfy_3x3v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfy_3x3v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH double vlasov_nc_hamil_gen_boundary_surfz_3x3v_ser_p1(const double *w, const double *dxv,
        const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH double vlasov_hamil_phase_surfz_3x3v_ser_p1(const double *w, const double *dxv, 
        const double *jacob_pos_l, const double *jacob_pos_c, const double *jacob_pos_r, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, 
        const double *fl, const double *fc, const double *fr, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void hamil_phase_alpha_quad_z_3x3v_ser_p1(const double *w, const double *dxv, const int hamil_pt_edge,
      const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vx_3x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vx_3x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_3x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vx_3x3v_ser_p1(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vy_3x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vy_3x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_3x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void rad_alpha_quad_vy_3x3v_ser_p1(const double *dxv, 
      const double *rad, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_dense_alpha_quad_vz_3x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void nc_hamil_vel_sparse_alpha_quad_vz_3x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf, 
          const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH double vlasov_boundary_surfvz_3x3v_ser_p1(const double *w, const double *dxv,
      const int edge, const double *flux, double* GKYL_RESTRICT out); 
GKYL_CU_DH void hamil_phase_alpha_quad_vz_3x3v_ser_p1(const double *w, const double *dxv, const double *poisson_tensor_conf,
        const double *hamil, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vz_3x3v_ser_p1(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vz_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vz_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x1v_tensor_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x1v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x1v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x1v_tensor_p3(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x1v_tensor_p3(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x1v_tensor_p3(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x2v_tensor_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_1x2v_tensor_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x2v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_1x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_1x2v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_1x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_1x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_1x3v_tensor_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_1x3v_tensor_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_1x3v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_1x3v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vz_1x3v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vz_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vz_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x1v_tensor_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x1v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x1v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x1v_tensor_p3(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x1v_tensor_p3(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x2v_tensor_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_2x2v_tensor_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x2v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_2x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_2x2v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_2x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_2x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void vlasov_hamil_vel_dense_vol_2x3v_tensor_p2(const double *w, const double *dxv, 
    const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_hamil_vel_sparse_vol_2x3v_tensor_p2(const double *w, const double *dxv, 
      const double *jacob_pos, const double *jacob_vel, const double *poisson_tensor_conf, const double *hamil, const double *f, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void E_alpha_quad_vx_2x3v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vx_2x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vx_2x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vy_2x3v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vy_2x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vy_2x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void E_alpha_quad_vz_2x3v_tensor_p2(const double *dxv, 
      const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_dense_alpha_quad_vz_2x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
      const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void B_sparse_alpha_quad_vz_2x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
        const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
