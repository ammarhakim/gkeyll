...
GKYL_CU_DH void EB_alpha_quad_vx_1x1v_ser_p1(const double *dxv, const double *jacob_vel, 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x1v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x1v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x2v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x2v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x2v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x2v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x2v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x2v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x2v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_1x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_1x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x3v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x3v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_1x3v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_1x3v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x1v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x1v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x1v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x1v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x2v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x2v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_2x2v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_2x2v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x2v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_2x2v_ser_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_2x2v_ser_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_2x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_2x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_2x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_3x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_3x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_3x3v_ser_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_3x3v_ser_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x1v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x1v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x1v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x1v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x2v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x2v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x2v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x2v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x2v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x2v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_1x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_1x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_1x3v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_1x3v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_1x3v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_1x3v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x1v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x1v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x1v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x1v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x2v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x2v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_2x2v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_2x2v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x2v_tensor_p2(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x2v_tensor_p2(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_2x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_2x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_2x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_2x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_2x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_2x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vx_3x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vx_3x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vy_3x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vy_3x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
...
GKYL_CU_DH void phi_alpha_quad_vz_3x3v_tensor_p1(const double *dxv, 
    const double *phi, double* GKYL_RESTRICT alpha_quad); 
GKYL_CU_DH void EB_alpha_quad_vz_3x3v_tensor_p1(const double *dxv, const double *jacob_vel, 
    const double *hamil, const double *qmem, double* GKYL_RESTRICT alpha_quad); 
