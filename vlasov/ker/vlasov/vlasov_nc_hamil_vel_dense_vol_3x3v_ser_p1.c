...
GKYL_CU_DH static void dot_pb_3x3v_ser_p1(const double *list_1, const double *list_2, double* GKYL_RESTRICT out) 
{ 
...
{ 
  ...
  for (int dir = 0; dir<6; ++dir) { 
    ...
    zero_pb_list(alphai); 
    vlasov_nc_hamil_vel_dense_vol_alpha_3x3v_ser_p1(w, dxv, dir, vmap, jacob_pos, jacob_vel, poisson_tensor_conf, hamil, alphai); 
