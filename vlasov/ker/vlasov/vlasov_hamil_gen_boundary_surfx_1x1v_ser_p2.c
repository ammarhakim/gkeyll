...
{ 
  ...
  double f_l_quad = 0.0; 
  double f_r_quad = 0.0; 
  alpha_quad = -(5.002749890427371*hamil[7])+1.9364916731037085*hamil[6]-2.888338995926613*hamil[5]+1.5*hamil[3]+0.8660254037844386*hamil[2]; 
  f_l_quad = 1.1857789576832338*fskin[7]-1.6675832968091233*fskin[6]+0.6846098004178088*fskin[5]+1.118033988749895*fskin[4]-1.291704467391079*fskin[3]-0.7457659219616816*fskin[2]+0.8660254037844386*fskin[1]+0.5*fskin[0]; 
  f_r_quad = -(1.1857789576832338*fedge[7])-1.6675832968091233*fedge[6]+0.6846098004178088*fedge[5]+1.118033988749895*fedge[4]+1.291704467391079*fedge[3]-0.7457659219616816*fedge[2]-0.8660254037844386*fedge[1]+0.5*fedge[0]; 
  Ghat_nodal[0] = 0.5*(alpha_quad*(f_r_quad + f_l_quad) - fabs(alpha_quad)*(f_r_quad - f_l_quad)); 

  alpha_quad = -(1.9751113797455495*hamil[7])+1.9364916731037085*hamil[6]-1.140331086775586*hamil[5]+1.5*hamil[3]+0.8660254037844386*hamil[2]; 
  ...
  Ghat[0] = 0.24597051986529*Ghat_nodal[3]+0.46113626132125757*Ghat_nodal[2]+0.46113626132125757*Ghat_nodal[1]+0.24597051986529*Ghat_nodal[0]; 
  ...
  double f_r_quad = 0.0; 
  alpha_quad = 5.002749890427371*hamil[7]+1.9364916731037085*hamil[6]-2.888338995926613*hamil[5]-1.5*hamil[3]+0.8660254037844386*hamil[2]; 
  f_l_quad = 1.1857789576832338*fedge[7]-1.6675832968091233*fedge[6]+0.6846098004178088*fedge[5]+1.118033988749895*fedge[4]-1.291704467391079*fedge[3]-0.7457659219616816*fedge[2]+0.8660254037844386*fedge[1]+0.5*fedge[0]; 
  f_r_quad = -(1.1857789576832338*fskin[7])-1.6675832968091233*fskin[6]+0.6846098004178088*fskin[5]+1.118033988749895*fskin[4]+1.291704467391079*fskin[3]-0.7457659219616816*fskin[2]-0.8660254037844386*fskin[1]+0.5*fskin[0]; 
  Ghat_nodal[0] = 0.5*(alpha_quad*(f_r_quad + f_l_quad) - fabs(alpha_quad)*(f_r_quad - f_l_quad)); 
