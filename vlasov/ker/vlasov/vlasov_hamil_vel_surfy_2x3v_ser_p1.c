...
{ 
  ...
  fUpwind_r[0] = (1.224744871391589*fc[2]+0.7071067811865475*fc[0])*jacob_vy_inv; 
  fUpwind_r[1] = (1.224744871391589*fc[6]+0.7071067811865475*fc[1])*jacob_vy_inv; 
  fUpwind_r[2] = (1.224744871391589*fc[8]+0.7071067811865475*fc[3])*jacob_vy_inv; 
  fUpwind_r[3] = (1.224744871391589*fc[10]+0.7071067811865475*fc[4])*jacob_vy_inv; 
  fUpwind_r[4] = (1.224744871391589*fc[13]+0.7071067811865475*fc[5])*jacob_vy_inv; 
  fUpwind_r[5] = (1.224744871391589*fc[16]+0.7071067811865475*fc[7])*jacob_vy_inv; 
  fUpwind_r[6] = (1.224744871391589*fc[17]+0.7071067811865475*fc[9])*jacob_vy_inv; 
  fUpwind_r[7] = (1.224744871391589*fc[19]+0.7071067811865475*fc[11])*jacob_vy_inv; 
  fUpwind_r[8] = (1.224744871391589*fc[20]+0.7071067811865475*fc[12])*jacob_vy_inv; 
  fUpwind_r[9] = (1.224744871391589*fc[22]+0.7071067811865475*fc[14])*jacob_vy_inv; 
  fUpwind_r[10] = (1.224744871391589*fc[24]+0.7071067811865475*fc[15])*jacob_vy_inv; 
  fUpwind_r[11] = (1.224744871391589*fc[26]+0.7071067811865475*fc[18])*jacob_vy_inv; 
  fUpwind_r[12] = (1.224744871391589*fc[27]+0.7071067811865475*fc[21])*jacob_vy_inv; 
  fUpwind_r[13] = (1.224744871391589*fc[28]+0.7071067811865475*fc[23])*jacob_vy_inv; 
  fUpwind_r[14] = (1.224744871391589*fc[30]+0.7071067811865475*fc[25])*jacob_vy_inv; 
  fUpwind_r[15] = (1.224744871391589*fc[31]+0.7071067811865475*fc[29])*jacob_vy_inv; 

  fUpwind_l[0] = (1.224744871391589*fl[2]+0.7071067811865475*fl[0])*jacob_vy_inv; 
  fUpwind_l[1] = (1.224744871391589*fl[6]+0.7071067811865475*fl[1])*jacob_vy_inv; 
  fUpwind_l[2] = (1.224744871391589*fl[8]+0.7071067811865475*fl[3])*jacob_vy_inv; 
  fUpwind_l[3] = (1.224744871391589*fl[10]+0.7071067811865475*fl[4])*jacob_vy_inv; 
  fUpwind_l[4] = (1.224744871391589*fl[13]+0.7071067811865475*fl[5])*jacob_vy_inv; 
  fUpwind_l[5] = (1.224744871391589*fl[16]+0.7071067811865475*fl[7])*jacob_vy_inv; 
  fUpwind_l[6] = (1.224744871391589*fl[17]+0.7071067811865475*fl[9])*jacob_vy_inv; 
  fUpwind_l[7] = (1.224744871391589*fl[19]+0.7071067811865475*fl[11])*jacob_vy_inv; 
  fUpwind_l[8] = (1.224744871391589*fl[20]+0.7071067811865475*fl[12])*jacob_vy_inv; 
  fUpwind_l[9] = (1.224744871391589*fl[22]+0.7071067811865475*fl[14])*jacob_vy_inv; 
  fUpwind_l[10] = (1.224744871391589*fl[24]+0.7071067811865475*fl[15])*jacob_vy_inv; 
  fUpwind_l[11] = (1.224744871391589*fl[26]+0.7071067811865475*fl[18])*jacob_vy_inv; 
  fUpwind_l[12] = (1.224744871391589*fl[27]+0.7071067811865475*fl[21])*jacob_vy_inv; 
  fUpwind_l[13] = (1.224744871391589*fl[28]+0.7071067811865475*fl[23])*jacob_vy_inv; 
  fUpwind_l[14] = (1.224744871391589*fl[30]+0.7071067811865475*fl[25])*jacob_vy_inv; 
  fUpwind_l[15] = (1.224744871391589*fl[31]+0.7071067811865475*fl[29])*jacob_vy_inv; 

  } else { 

  fUpwind_r[0] = (0.7071067811865475*fr[0]-1.224744871391589*fr[2])*jacob_vy_inv; 
  fUpwind_r[1] = (0.7071067811865475*fr[1]-1.224744871391589*fr[6])*jacob_vy_inv; 
  fUpwind_r[2] = (0.7071067811865475*fr[3]-1.224744871391589*fr[8])*jacob_vy_inv; 
  fUpwind_r[3] = (0.7071067811865475*fr[4]-1.224744871391589*fr[10])*jacob_vy_inv; 
  fUpwind_r[4] = (0.7071067811865475*fr[5]-1.224744871391589*fr[13])*jacob_vy_inv; 
  fUpwind_r[5] = (0.7071067811865475*fr[7]-1.224744871391589*fr[16])*jacob_vy_inv; 
  fUpwind_r[6] = (0.7071067811865475*fr[9]-1.224744871391589*fr[17])*jacob_vy_inv; 
  fUpwind_r[7] = (0.7071067811865475*fr[11]-1.224744871391589*fr[19])*jacob_vy_inv; 
  fUpwind_r[8] = (0.7071067811865475*fr[12]-1.224744871391589*fr[20])*jacob_vy_inv; 
  fUpwind_r[9] = (0.7071067811865475*fr[14]-1.224744871391589*fr[22])*jacob_vy_inv; 
  fUpwind_r[10] = (0.7071067811865475*fr[15]-1.224744871391589*fr[24])*jacob_vy_inv; 
  fUpwind_r[11] = (0.7071067811865475*fr[18]-1.224744871391589*fr[26])*jacob_vy_inv; 
  fUpwind_r[12] = (0.7071067811865475*fr[21]-1.224744871391589*fr[27])*jacob_vy_inv; 
  fUpwind_r[13] = (0.7071067811865475*fr[23]-1.224744871391589*fr[28])*jacob_vy_inv; 
  fUpwind_r[14] = (0.7071067811865475*fr[25]-1.224744871391589*fr[30])*jacob_vy_inv; 
  fUpwind_r[15] = (0.7071067811865475*fr[29]-1.224744871391589*fr[31])*jacob_vy_inv; 

  fUpwind_l[0] = (0.7071067811865475*fc[0]-1.224744871391589*fc[2])*jacob_vy_inv; 
  fUpwind_l[1] = (0.7071067811865475*fc[1]-1.224744871391589*fc[6])*jacob_vy_inv; 
  fUpwind_l[2] = (0.7071067811865475*fc[3]-1.224744871391589*fc[8])*jacob_vy_inv; 
  fUpwind_l[3] = (0.7071067811865475*fc[4]-1.224744871391589*fc[10])*jacob_vy_inv; 
  fUpwind_l[4] = (0.7071067811865475*fc[5]-1.224744871391589*fc[13])*jacob_vy_inv; 
  fUpwind_l[5] = (0.7071067811865475*fc[7]-1.224744871391589*fc[16])*jacob_vy_inv; 
  fUpwind_l[6] = (0.7071067811865475*fc[9]-1.224744871391589*fc[17])*jacob_vy_inv; 
  fUpwind_l[7] = (0.7071067811865475*fc[11]-1.224744871391589*fc[19])*jacob_vy_inv; 
  fUpwind_l[8] = (0.7071067811865475*fc[12]-1.224744871391589*fc[20])*jacob_vy_inv; 
  fUpwind_l[9] = (0.7071067811865475*fc[14]-1.224744871391589*fc[22])*jacob_vy_inv; 
  fUpwind_l[10] = (0.7071067811865475*fc[15]-1.224744871391589*fc[24])*jacob_vy_inv; 
  fUpwind_l[11] = (0.7071067811865475*fc[18]-1.224744871391589*fc[26])*jacob_vy_inv; 
  fUpwind_l[12] = (0.7071067811865475*fc[21]-1.224744871391589*fc[27])*jacob_vy_inv; 
  fUpwind_l[13] = (0.7071067811865475*fc[23]-1.224744871391589*fc[28])*jacob_vy_inv; 
  fUpwind_l[14] = (0.7071067811865475*fc[25]-1.224744871391589*fc[30])*jacob_vy_inv; 
  fUpwind_l[15] = (0.7071067811865475*fc[29]-1.224744871391589*fc[31])*jacob_vy_inv; 
  ...
  return fabs(0.5303300858899105*dv11*dx11*(1.7320508075688772*hamil[2]*jacob_vy_inv));
