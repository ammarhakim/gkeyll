...
GKYL_CU_DH void vlasov_boundary_ho_surfvy_2x3v_ser_p2_mode(int m, int edge, double dv11,
...
{ 
  ...
  if (edge == -1) { 
    out[m] += dv11*vst_2x3v_ser_p2_ho_prj_v1_pm_cr[m]*g; 
  } else { 
    out[m] += dv11*vst_2x3v_ser_p2_ho_prj_v1_pm_cl[m]*g; 
  } 
} 
