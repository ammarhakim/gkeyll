...
{ 
  ...
  fUpwind_r[1] = (1.224744871391589*fc[5]+0.7071067811865475*fc[2])*jacob_vx_inv; 
  fUpwind_r[2] = (1.224744871391589*fc[6]+0.7071067811865475*fc[3])*jacob_vx_inv; 
  fUpwind_r[3] = (1.224744871391589*fc[8]+0.7071067811865475*fc[4])*jacob_vx_inv; 
  fUpwind_r[4] = (1.224744871391589*fc[11]+0.7071067811865475*fc[7])*jacob_vx_inv; 
  fUpwind_r[5] = (1.224744871391589*fc[12]+0.7071067811865475*fc[9])*jacob_vx_inv; 
  fUpwind_r[6] = (1.224744871391589*fc[13]+0.7071067811865475*fc[10])*jacob_vx_inv; 
  fUpwind_r[7] = (1.224744871391589*fc[15]+0.7071067811865475*fc[14])*jacob_vx_inv; 

  fUpwind_l[0] = (1.224744871391589*fl[1]+0.7071067811865475*fl[0])*jacob_vx_inv; 
  fUpwind_l[1] = (1.224744871391589*fl[5]+0.7071067811865475*fl[2])*jacob_vx_inv; 
  fUpwind_l[2] = (1.224744871391589*fl[6]+0.7071067811865475*fl[3])*jacob_vx_inv; 
  fUpwind_l[3] = (1.224744871391589*fl[8]+0.7071067811865475*fl[4])*jacob_vx_inv; 
  fUpwind_l[4] = (1.224744871391589*fl[11]+0.7071067811865475*fl[7])*jacob_vx_inv; 
  fUpwind_l[5] = (1.224744871391589*fl[12]+0.7071067811865475*fl[9])*jacob_vx_inv; 
  fUpwind_l[6] = (1.224744871391589*fl[13]+0.7071067811865475*fl[10])*jacob_vx_inv; 
  fUpwind_l[7] = (1.224744871391589*fl[15]+0.7071067811865475*fl[14])*jacob_vx_inv; 

  } else { 

  fUpwind_r[0] = (0.7071067811865475*fr[0]-1.224744871391589*fr[1])*jacob_vx_inv; 
  fUpwind_r[1] = (0.7071067811865475*fr[2]-1.224744871391589*fr[5])*jacob_vx_inv; 
  fUpwind_r[2] = (0.7071067811865475*fr[3]-1.224744871391589*fr[6])*jacob_vx_inv; 
  fUpwind_r[3] = (0.7071067811865475*fr[4]-1.224744871391589*fr[8])*jacob_vx_inv; 
  fUpwind_r[4] = (0.7071067811865475*fr[7]-1.224744871391589*fr[11])*jacob_vx_inv; 
  fUpwind_r[5] = (0.7071067811865475*fr[9]-1.224744871391589*fr[12])*jacob_vx_inv; 
  fUpwind_r[6] = (0.7071067811865475*fr[10]-1.224744871391589*fr[13])*jacob_vx_inv; 
  fUpwind_r[7] = (0.7071067811865475*fr[14]-1.224744871391589*fr[15])*jacob_vx_inv; 

  fUpwind_l[0] = (0.7071067811865475*fc[0]-1.224744871391589*fc[1])*jacob_vx_inv; 
  fUpwind_l[1] = (0.7071067811865475*fc[2]-1.224744871391589*fc[5])*jacob_vx_inv; 
  fUpwind_l[2] = (0.7071067811865475*fc[3]-1.224744871391589*fc[6])*jacob_vx_inv; 
  fUpwind_l[3] = (0.7071067811865475*fc[4]-1.224744871391589*fc[8])*jacob_vx_inv; 
  fUpwind_l[4] = (0.7071067811865475*fc[7]-1.224744871391589*fc[11])*jacob_vx_inv; 
  fUpwind_l[5] = (0.7071067811865475*fc[9]-1.224744871391589*fc[12])*jacob_vx_inv; 
  fUpwind_l[6] = (0.7071067811865475*fc[10]-1.224744871391589*fc[13])*jacob_vx_inv; 
  fUpwind_l[7] = (0.7071067811865475*fc[14]-1.224744871391589*fc[15])*jacob_vx_inv; 
