...
{ 
  ...
  out[3] += -(1.224744871391589*flux[1]*dv10); 
  out[4] += -(0.7071067811865475*flux[2]*dv10); 
  out[5] += -(1.5811388300841895*flux[0]*dv10); 
  out[6] += -(1.224744871391589*flux[2]*dv10); 
  out[7] += -(1.5811388300841898*flux[1]*dv10); 
  out[8] += -(1.5811388300841895*flux[2]*dv10); 
