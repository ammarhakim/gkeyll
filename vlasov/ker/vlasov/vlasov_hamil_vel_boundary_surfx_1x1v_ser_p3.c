...
{ 
  ...
  fUpwind[0] = (1.8708286933869707*fskin[8]+1.5811388300841895*fskin[4]+1.224744871391589*fskin[1]+0.7071067811865475*fskin[0])*jacob_vx_inv; 
  fUpwind[1] = (1.8708286933869707*fskin[10]+1.5811388300841898*fskin[6]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[2])*jacob_vx_inv; 
  fUpwind[2] = (1.224744871391589*fskin[7]+0.7071067811865475*fskin[5])*jacob_vx_inv; 
  fUpwind[3] = (1.2247448713915887*fskin[11]+0.7071067811865475*fskin[9])*jacob_vx_inv; 

  } else { 

  fUpwind[0] = (-(1.8708286933869707*fedge[8])+1.5811388300841895*fedge[4]-1.224744871391589*fedge[1]+0.7071067811865475*fedge[0])*jacob_vx_inv; 
  fUpwind[1] = (-(1.8708286933869707*fedge[10])+1.5811388300841898*fedge[6]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[2])*jacob_vx_inv; 
  fUpwind[2] = (0.7071067811865475*fedge[5]-1.224744871391589*fedge[7])*jacob_vx_inv; 
  fUpwind[3] = (0.7071067811865475*fedge[9]-1.2247448713915887*fedge[11])*jacob_vx_inv; 
  ...
  fUpwind[0] = (1.8708286933869707*fedge[8]+1.5811388300841895*fedge[4]+1.224744871391589*fedge[1]+0.7071067811865475*fedge[0])*jacob_vx_inv; 
  fUpwind[1] = (1.8708286933869707*fedge[10]+1.5811388300841898*fedge[6]+1.224744871391589*fedge[3]+0.7071067811865475*fedge[2])*jacob_vx_inv; 
  fUpwind[2] = (1.224744871391589*fedge[7]+0.7071067811865475*fedge[5])*jacob_vx_inv; 
  fUpwind[3] = (1.2247448713915887*fedge[11]+0.7071067811865475*fedge[9])*jacob_vx_inv; 

  } else { 

  fUpwind[0] = (-(1.8708286933869707*fskin[8])+1.5811388300841895*fskin[4]-1.224744871391589*fskin[1]+0.7071067811865475*fskin[0])*jacob_vx_inv; 
  fUpwind[1] = (-(1.8708286933869707*fskin[10])+1.5811388300841898*fskin[6]-1.224744871391589*fskin[3]+0.7071067811865475*fskin[2])*jacob_vx_inv; 
  fUpwind[2] = (0.7071067811865475*fskin[5]-1.224744871391589*fskin[7])*jacob_vx_inv; 
  fUpwind[3] = (0.7071067811865475*fskin[9]-1.2247448713915887*fskin[11])*jacob_vx_inv; 
