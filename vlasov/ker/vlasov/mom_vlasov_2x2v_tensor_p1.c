...
GKYL_CU_DH void mom_vlasov_M0_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_M1i_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[2]*dxv[3]/4; 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_M1i_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[2]*dxv[3]/4; 
  const double dv10 = 2.0/dxv[2]; 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_M2_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[2]*dxv[3]/4; 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_M2_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[2]*dxv[3]/4; 
...
GKYL_CU_DH void mom_vlasov_M2ij_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
  const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
...
GKYL_CU_DH void mom_vlasov_M3ijk_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
  const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  const double volFact = dxv[2]*dxv[3]/4; 
  const double wx1 = w[2], dv1 = dxv[2]; 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_five_moments_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[2]*dxv[3]/4; 
  const double dv10 = 2.0/dxv[2]; 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_five_moments_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[2]*dxv[3]/4; 
  const double dv10 = 2.0/dxv[2]; 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_int_five_moments_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_int_five_moments_2x2v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  const double volFact = dxv[0]*dxv[1]*dxv[2]*dxv[3]*0.0625; 
  const double dv10 = 2.0/dxv[2]; 
