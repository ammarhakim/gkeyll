...
{ 
  ...
  rad_nodal_vx[1] = -1.0/t_cool*(0.7071067811865475*vmap_vx[0]-0.5477225575051661*vmap_vx[1] - p0);

  rad_nodal_vx[2] = -1.0/t_cool*(0.5477225575051661*vmap_vx[1]+0.7071067811865475*vmap_vx[0] - p0);
