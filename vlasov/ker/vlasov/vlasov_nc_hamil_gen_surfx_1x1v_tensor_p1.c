...
{ 
  ...
  alpha_l_quad = (0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1])*(1.224744871391589*hamil[1]-2.738612787525831*hamil[2])*dv10; 
  alpha_r_quad = (1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0])*(1.224744871391589*hamil[1]-2.738612787525831*hamil[2])*dv10; 
  ...
  alpha_l_quad = (0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1])*(2.738612787525831*hamil[2]+1.224744871391589*hamil[1])*dv10; 
  alpha_r_quad = (1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0])*(2.738612787525831*hamil[2]+1.224744871391589*hamil[1])*dv10; 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  f_lr_quad = 0.8660254037844386*fl[3]+0.5*fl[2]+0.8660254037844386*fl[1]+0.5*fl[0]; 
  f_cl_quad = (-0.8660254037844386*fc[3])+0.5*fc[2]-0.8660254037844386*fc[1]+0.5*fc[0]; 
  f_cr_quad = 0.8660254037844386*fc[3]+0.5*fc[2]+0.8660254037844386*fc[1]+0.5*fc[0]; 
