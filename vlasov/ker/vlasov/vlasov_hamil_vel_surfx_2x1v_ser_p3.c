...
{ 
  ...
  fUpwind_r[0] = (1.8708286933869707*fc[17]+1.5811388300841895*fc[7]+1.224744871391589*fc[1]+0.7071067811865475*fc[0])*jacob_vx_inv; 
  fUpwind_r[1] = (1.8708286933869707*fc[23]+1.5811388300841898*fc[11]+1.224744871391589*fc[4]+0.7071067811865475*fc[2])*jacob_vx_inv; 
  fUpwind_r[2] = (1.8708286933869707*fc[25]+1.5811388300841898*fc[13]+1.224744871391589*fc[5]+0.7071067811865475*fc[3])*jacob_vx_inv; 
  fUpwind_r[3] = (1.8708286933869707*fc[29]+1.5811388300841895*fc[20]+1.224744871391589*fc[10]+0.7071067811865475*fc[6])*jacob_vx_inv; 
  ...
  fUpwind_r[6] = (1.224744871391589*fc[21]+0.7071067811865475*fc[14])*jacob_vx_inv; 
  fUpwind_r[7] = (1.224744871391589*fc[22]+0.7071067811865475*fc[16])*jacob_vx_inv; 
  fUpwind_r[8] = (1.2247448713915887*fc[24]+0.7071067811865475*fc[18])*jacob_vx_inv; 
  fUpwind_r[9] = (1.2247448713915887*fc[27]+0.7071067811865475*fc[19])*jacob_vx_inv; 
  fUpwind_r[10] = (1.2247448713915887*fc[30]+0.7071067811865475*fc[26])*jacob_vx_inv; 
  fUpwind_r[11] = (1.2247448713915887*fc[31]+0.7071067811865475*fc[28])*jacob_vx_inv; 

  fUpwind_l[0] = (1.8708286933869707*fl[17]+1.5811388300841895*fl[7]+1.224744871391589*fl[1]+0.7071067811865475*fl[0])*jacob_vx_inv; 
  fUpwind_l[1] = (1.8708286933869707*fl[23]+1.5811388300841898*fl[11]+1.224744871391589*fl[4]+0.7071067811865475*fl[2])*jacob_vx_inv; 
  fUpwind_l[2] = (1.8708286933869707*fl[25]+1.5811388300841898*fl[13]+1.224744871391589*fl[5]+0.7071067811865475*fl[3])*jacob_vx_inv; 
  fUpwind_l[3] = (1.8708286933869707*fl[29]+1.5811388300841895*fl[20]+1.224744871391589*fl[10]+0.7071067811865475*fl[6])*jacob_vx_inv; 
  ...
  fUpwind_l[6] = (1.224744871391589*fl[21]+0.7071067811865475*fl[14])*jacob_vx_inv; 
  fUpwind_l[7] = (1.224744871391589*fl[22]+0.7071067811865475*fl[16])*jacob_vx_inv; 
  fUpwind_l[8] = (1.2247448713915887*fl[24]+0.7071067811865475*fl[18])*jacob_vx_inv; 
  fUpwind_l[9] = (1.2247448713915887*fl[27]+0.7071067811865475*fl[19])*jacob_vx_inv; 
  fUpwind_l[10] = (1.2247448713915887*fl[30]+0.7071067811865475*fl[26])*jacob_vx_inv; 
  fUpwind_l[11] = (1.2247448713915887*fl[31]+0.7071067811865475*fl[28])*jacob_vx_inv; 

  } else { 

  fUpwind_r[0] = (-(1.8708286933869707*fr[17])+1.5811388300841895*fr[7]-1.224744871391589*fr[1]+0.7071067811865475*fr[0])*jacob_vx_inv; 
  fUpwind_r[1] = (-(1.8708286933869707*fr[23])+1.5811388300841898*fr[11]-1.224744871391589*fr[4]+0.7071067811865475*fr[2])*jacob_vx_inv; 
  fUpwind_r[2] = (-(1.8708286933869707*fr[25])+1.5811388300841898*fr[13]-1.224744871391589*fr[5]+0.7071067811865475*fr[3])*jacob_vx_inv; 
  fUpwind_r[3] = (-(1.8708286933869707*fr[29])+1.5811388300841895*fr[20]-1.224744871391589*fr[10]+0.7071067811865475*fr[6])*jacob_vx_inv; 
  ...
  fUpwind_r[6] = (0.7071067811865475*fr[14]-1.224744871391589*fr[21])*jacob_vx_inv; 
  fUpwind_r[7] = (0.7071067811865475*fr[16]-1.224744871391589*fr[22])*jacob_vx_inv; 
  fUpwind_r[8] = (0.7071067811865475*fr[18]-1.2247448713915887*fr[24])*jacob_vx_inv; 
  fUpwind_r[9] = (0.7071067811865475*fr[19]-1.2247448713915887*fr[27])*jacob_vx_inv; 
  fUpwind_r[10] = (0.7071067811865475*fr[26]-1.2247448713915887*fr[30])*jacob_vx_inv; 
  fUpwind_r[11] = (0.7071067811865475*fr[28]-1.2247448713915887*fr[31])*jacob_vx_inv; 

  fUpwind_l[0] = (-(1.8708286933869707*fc[17])+1.5811388300841895*fc[7]-1.224744871391589*fc[1]+0.7071067811865475*fc[0])*jacob_vx_inv; 
  fUpwind_l[1] = (-(1.8708286933869707*fc[23])+1.5811388300841898*fc[11]-1.224744871391589*fc[4]+0.7071067811865475*fc[2])*jacob_vx_inv; 
  fUpwind_l[2] = (-(1.8708286933869707*fc[25])+1.5811388300841898*fc[13]-1.224744871391589*fc[5]+0.7071067811865475*fc[3])*jacob_vx_inv; 
  fUpwind_l[3] = (-(1.8708286933869707*fc[29])+1.5811388300841895*fc[20]-1.224744871391589*fc[10]+0.7071067811865475*fc[6])*jacob_vx_inv; 
  ...
  fUpwind_l[6] = (0.7071067811865475*fc[14]-1.224744871391589*fc[21])*jacob_vx_inv; 
  fUpwind_l[7] = (0.7071067811865475*fc[16]-1.224744871391589*fc[22])*jacob_vx_inv; 
  fUpwind_l[8] = (0.7071067811865475*fc[18]-1.2247448713915887*fc[24])*jacob_vx_inv; 
  fUpwind_l[9] = (0.7071067811865475*fc[19]-1.2247448713915887*fc[27])*jacob_vx_inv; 
  fUpwind_l[10] = (0.7071067811865475*fc[26]-1.2247448713915887*fc[30])*jacob_vx_inv; 
  fUpwind_l[11] = (0.7071067811865475*fc[28]-1.2247448713915887*fc[31])*jacob_vx_inv; 
