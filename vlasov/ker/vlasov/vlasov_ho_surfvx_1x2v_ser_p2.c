...
GKYL_CU_DH void vlasov_ho_surfvx_1x2v_ser_p2_mode(int m, double dv10,
...
{ 
  ...
  out[m] += dv10*(vst_1x2v_ser_p2_ho_prj_v0_pm_cl[m]*g_l + vst_1x2v_ser_p2_ho_prj_v0_pm_cr[m]*g_r); 
} 
