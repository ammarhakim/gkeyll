...
{ 
  ...
  double f_l_quad = 0.0; 
  double f_r_quad = 0.0; 
  alpha_quad = 1.224744871391589*hamil[1]*(1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  ...
  double f_l_quad = 0.0; 
  double f_r_quad = 0.0; 
  alpha_quad = 1.224744871391589*hamil[1]*(0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1]); 
