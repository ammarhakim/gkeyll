...
{ 
  ...
  fUpwind_r[0] = (1.8708286933869707*fc[8]+1.5811388300841895*fc[4]+1.224744871391589*fc[1]+0.7071067811865475*fc[0])*jacob_vx_inv; 
  fUpwind_r[1] = (1.8708286933869707*fc[10]+1.5811388300841898*fc[6]+1.224744871391589*fc[3]+0.7071067811865475*fc[2])*jacob_vx_inv; 
  fUpwind_r[2] = (1.224744871391589*fc[7]+0.7071067811865475*fc[5])*jacob_vx_inv; 
  fUpwind_r[3] = (1.2247448713915887*fc[11]+0.7071067811865475*fc[9])*jacob_vx_inv; 

  fUpwind_l[0] = (1.8708286933869707*fl[8]+1.5811388300841895*fl[4]+1.224744871391589*fl[1]+0.7071067811865475*fl[0])*jacob_vx_inv; 
  fUpwind_l[1] = (1.8708286933869707*fl[10]+1.5811388300841898*fl[6]+1.224744871391589*fl[3]+0.7071067811865475*fl[2])*jacob_vx_inv; 
  fUpwind_l[2] = (1.224744871391589*fl[7]+0.7071067811865475*fl[5])*jacob_vx_inv; 
  fUpwind_l[3] = (1.2247448713915887*fl[11]+0.7071067811865475*fl[9])*jacob_vx_inv; 

  } else { 

  fUpwind_r[0] = (-(1.8708286933869707*fr[8])+1.5811388300841895*fr[4]-1.224744871391589*fr[1]+0.7071067811865475*fr[0])*jacob_vx_inv; 
  fUpwind_r[1] = (-(1.8708286933869707*fr[10])+1.5811388300841898*fr[6]-1.224744871391589*fr[3]+0.7071067811865475*fr[2])*jacob_vx_inv; 
  fUpwind_r[2] = (0.7071067811865475*fr[5]-1.224744871391589*fr[7])*jacob_vx_inv; 
  fUpwind_r[3] = (0.7071067811865475*fr[9]-1.2247448713915887*fr[11])*jacob_vx_inv; 

  fUpwind_l[0] = (-(1.8708286933869707*fc[8])+1.5811388300841895*fc[4]-1.224744871391589*fc[1]+0.7071067811865475*fc[0])*jacob_vx_inv; 
  fUpwind_l[1] = (-(1.8708286933869707*fc[10])+1.5811388300841898*fc[6]-1.224744871391589*fc[3]+0.7071067811865475*fc[2])*jacob_vx_inv; 
  fUpwind_l[2] = (0.7071067811865475*fc[5]-1.224744871391589*fc[7])*jacob_vx_inv; 
  fUpwind_l[3] = (0.7071067811865475*fc[9]-1.2247448713915887*fc[11])*jacob_vx_inv; 
  ...
  return fabs(2.474873734152916*dv10*dx10*(2.6457513110645907*hamil[3]*jacob_vx_inv+1.7320508075688772*hamil[1]*jacob_vx_inv));
