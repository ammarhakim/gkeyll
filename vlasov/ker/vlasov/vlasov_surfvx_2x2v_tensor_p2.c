...
GKYL_CU_DH void vlasov_surfvx_2x2v_tensor_p2_mode(int m, double dv10,
...
{ 
  ...
  out[m] += dv10*(vst_2x2v_tensor_p2_prj_v0_pm_cl[m]*g_l + vst_2x2v_tensor_p2_prj_v0_pm_cr[m]*g_r); 
} 
