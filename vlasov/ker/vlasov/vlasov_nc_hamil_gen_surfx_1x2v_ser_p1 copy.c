...
{ 
  ...
  alpha_l_quad = (0.7071067811865475*poisson_tensor_conf_1[0]-1.224744871391589*poisson_tensor_conf_1[1])*(0.8660254037844386*hamil[2]-0.8660254037844386*hamil[3])+(0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1])*(0.8660254037844386*hamil[1]-0.8660254037844386*hamil[3]); 
  alpha_r_quad = (1.224744871391589*poisson_tensor_conf_1[1]+0.7071067811865475*poisson_tensor_conf_1[0])*(0.8660254037844386*hamil[2]-0.8660254037844386*hamil[3])+(1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0])*(0.8660254037844386*hamil[1]-0.8660254037844386*hamil[3]); 
  ...
  alpha_l_quad = (0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[1])+(0.7071067811865475*poisson_tensor_conf_1[0]-1.224744871391589*poisson_tensor_conf_1[1])*(0.8660254037844386*hamil[2]-0.8660254037844386*hamil[3]); 
  alpha_r_quad = (1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[1])+(1.224744871391589*poisson_tensor_conf_1[1]+0.7071067811865475*poisson_tensor_conf_1[0])*(0.8660254037844386*hamil[2]-0.8660254037844386*hamil[3]); 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  f_lr_quad = (-0.6123724356957944*fl[7])-0.3535533905932737*fl[6]+0.6123724356957944*fl[5]-0.6123724356957944*fl[4]+0.3535533905932737*fl[3]-0.3535533905932737*fl[2]+0.6123724356957944*fl[1]+0.3535533905932737*fl[0]; 
  f_cl_quad = 0.6123724356957944*fc[7]-0.3535533905932737*fc[6]-0.6123724356957944*fc[5]+0.6123724356957944*fc[4]+0.3535533905932737*fc[3]-0.3535533905932737*fc[2]-0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  f_cr_quad = (-0.6123724356957944*fc[7])-0.3535533905932737*fc[6]+0.6123724356957944*fc[5]-0.6123724356957944*fc[4]+0.3535533905932737*fc[3]-0.3535533905932737*fc[2]+0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  ...
  alpha_l_quad = (0.7071067811865475*poisson_tensor_conf_1[0]-1.224744871391589*poisson_tensor_conf_1[1])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[2])+(0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1])*(0.8660254037844386*hamil[1]-0.8660254037844386*hamil[3]); 
  alpha_r_quad = (1.224744871391589*poisson_tensor_conf_1[1]+0.7071067811865475*poisson_tensor_conf_1[0])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[2])+(1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0])*(0.8660254037844386*hamil[1]-0.8660254037844386*hamil[3]); 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  f_lr_quad = (-0.6123724356957944*fl[7])-0.3535533905932737*fl[6]-0.6123724356957944*fl[5]+0.6123724356957944*fl[4]-0.3535533905932737*fl[3]+0.3535533905932737*fl[2]+0.6123724356957944*fl[1]+0.3535533905932737*fl[0]; 
  f_cl_quad = 0.6123724356957944*fc[7]-0.3535533905932737*fc[6]+0.6123724356957944*fc[5]-0.6123724356957944*fc[4]-0.3535533905932737*fc[3]+0.3535533905932737*fc[2]-0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  f_cr_quad = (-0.6123724356957944*fc[7])-0.3535533905932737*fc[6]-0.6123724356957944*fc[5]+0.6123724356957944*fc[4]-0.3535533905932737*fc[3]+0.3535533905932737*fc[2]+0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  ...
  alpha_l_quad = (0.7071067811865475*poisson_tensor_conf_1[0]-1.224744871391589*poisson_tensor_conf_1[1])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[2])+(0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[1]); 
  alpha_r_quad = (1.224744871391589*poisson_tensor_conf_1[1]+0.7071067811865475*poisson_tensor_conf_1[0])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[2])+(1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0])*(0.8660254037844386*hamil[3]+0.8660254037844386*hamil[1]); 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  f_lr_quad = 0.6123724356957944*fl[7]+0.3535533905932737*fl[6]+0.6123724356957944*fl[5]+0.6123724356957944*fl[4]+0.3535533905932737*fl[3]+0.3535533905932737*fl[2]+0.6123724356957944*fl[1]+0.3535533905932737*fl[0]; 
  f_cl_quad = (-0.6123724356957944*fc[7])+0.3535533905932737*fc[6]-0.6123724356957944*fc[5]-0.6123724356957944*fc[4]+0.3535533905932737*fc[3]+0.3535533905932737*fc[2]-0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
  f_cr_quad = 0.6123724356957944*fc[7]+0.3535533905932737*fc[6]+0.6123724356957944*fc[5]+0.6123724356957944*fc[4]+0.3535533905932737*fc[3]+0.3535533905932737*fc[2]+0.6123724356957944*fc[1]+0.3535533905932737*fc[0]; 
