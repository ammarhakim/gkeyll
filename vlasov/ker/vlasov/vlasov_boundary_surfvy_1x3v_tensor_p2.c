...
{ 
  ...
  out[45] += -(1.5811388300841895*Ghat[7]*dv11); 
  out[46] += -(1.5811388300841895*Ghat[8]*dv11); 
  ...
  out[52] += -(1.5811388300841898*Ghat[10]*dv11); 
  out[53] += -(1.224744871391589*Ghat[19]*dv11); 
  out[54] += -(1.224744871391589*Ghat[20]*dv11); 
  out[55] += -(1.5811388300841898*Ghat[11]*dv11); 
  out[56] += -(1.5811388300841898*Ghat[12]*dv11); 
  out[57] += -(0.7071067811865475*Ghat[23]*dv11); 
  out[58] += -(1.5811388300841898*Ghat[13]*dv11); 
  out[59] += -(1.5811388300841898*Ghat[14]*dv11); 
