...
GKYL_CU_DH void vlasov_boundary_surfvy_1x3v_tensor_p2_mode(int m, int edge, double dv11,
...
{ 
  ...
  if (edge == -1) { 
    out[m] += dv11*vst_1x3v_tensor_p2_prj_v1_pm_cr[m]*g; 
  } else { 
    out[m] += dv11*vst_1x3v_tensor_p2_prj_v1_pm_cl[m]*g; 
  } 
} 
