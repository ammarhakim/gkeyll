...
{ 
  ...
  out[36] += 0.4330127018922193*alpha[36]*dv11; 
  out[37] += 0.4330127018922193*alpha[37]*dv11; 
  out[38] += 0.4330127018922193*alpha[38]*dv11; 
  out[39] += 0.4330127018922193*alpha[39]*dv11; 
  out[40] += 0.4330127018922193*alpha[40]*dv11; 
  out[41] += 0.4330127018922193*alpha[41]*dv11; 
  out[42] += 0.4330127018922193*alpha[42]*dv11; 
  out[43] += 0.4330127018922193*alpha[43]*dv11; 
  out[44] += 0.4330127018922193*alpha[44]*dv11; 
  out[45] += 0.4330127018922193*alpha[45]*dv11; 
  out[46] += 0.4330127018922193*alpha[46]*dv11; 
  out[47] += 0.4330127018922193*alpha[47]*dv11; 
  out[48] += 0.4330127018922193*alpha[48]*dv11; 
  out[49] += 0.4330127018922193*alpha[49]*dv11; 
  out[50] += 0.4330127018922193*alpha[50]*dv11; 
  out[51] += 0.4330127018922193*alpha[51]*dv11; 
  out[52] += 0.4330127018922193*alpha[52]*dv11; 
  out[53] += 0.4330127018922193*alpha[53]*dv11; 
  } 
