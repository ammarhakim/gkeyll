...
{ 
  ...
  alpha_l_quad = 1.060660171779821*hamil[7]-0.6123724356957944*hamil[6]-1.060660171779821*hamil[5]+0.6123724356957944*hamil[3]; 
  alpha_r_quad = -(1.060660171779821*hamil[7])-0.6123724356957944*hamil[6]+1.060660171779821*hamil[5]+0.6123724356957944*hamil[3]; 
