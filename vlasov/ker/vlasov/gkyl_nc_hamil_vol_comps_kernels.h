...
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_alpha_1x3v_ser_p2(const double *w, const double *dxv, const int dir,
...
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_alpha_2x3v_ser_p2(const double *w, const double *dxv, const int dir,
     const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT out); 
