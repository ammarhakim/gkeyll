...
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp0_1x1v_tensor_p1(const double *w, const double *dxv, const int dir,
...
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp1_1x1v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp2_1x1v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp3_1x1v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_alpha_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *poisson_tensor_conf, const double *hamil, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp0_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp1_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp2_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp3_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp4_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp5_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
...
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp8_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp9_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp10_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp11_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp12_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp13_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp14_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp15_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp16_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
GKYL_CU_DH void vlasov_nc_hamil_gen_vol_comp17_1x2v_tensor_p1(const double *w, const double *dxv, const int dir,
     const double *alpha, double* GKYL_RESTRICT out); 
