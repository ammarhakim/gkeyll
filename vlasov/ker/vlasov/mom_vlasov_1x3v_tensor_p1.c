...
GKYL_CU_DH void mom_vlasov_M0_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_M1i_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_M1i_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
  double dv10 = 2.0/dxv[1]; 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_M2_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_M2_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
...
GKYL_CU_DH void mom_vlasov_M2ij_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
  const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
  ...
  double wx3 = w[3], dv3 = dxv[3]; 
  double wx3_sq = wx3*wx3, dv3_sq = dv3*dv3; 
...
GKYL_CU_DH void mom_vlasov_M3ijk_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
  const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
  double wx1 = w[1], dv1 = dxv[1]; 
  ...
  double wx3 = w[3], dv3 = dxv[3]; 
  double wx3_sq = wx3*wx3, dv3_sq = dv3*dv3; 
  double wx3_cu = wx3*wx3*wx3, dv3_cu = dv3*dv3*dv3; 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_five_moments_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
  double dv10 = 2.0/dxv[1]; 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_five_moments_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[1]*dxv[2]*dxv[3]/8; 
  double dv10 = 2.0/dxv[1]; 
...
GKYL_CU_DH void mom_vlasov_hamil_vel_int_five_moments_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
...
GKYL_CU_DH void mom_vlasov_hamil_gen_int_five_moments_1x3v_tensor_p1(const double *w, const double *dxv, const int *idx, 
    const double *hamil, const double *f, double* GKYL_RESTRICT out) 
{ 
  double volFact = dxv[0]*dxv[1]*dxv[2]*dxv[3]*0.0625; 
  double dv10 = 2.0/dxv[1]; 
