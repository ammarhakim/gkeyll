...
{ 
  ...
  out[10] += ((-0.2428941897088658*Fhat_nodal[3])+0.6152254973630996*Fhat_nodal[2]-0.6152254973630996*Fhat_nodal[1]+0.2428941897088658*Fhat_nodal[0])*dv10; 
  out[11] += ((-0.6863562790104827*Fhat_nodal[3])-0.5080174454972501*Fhat_nodal[2]+0.5080174454972501*Fhat_nodal[1]+0.6863562790104827*Fhat_nodal[0])*dv10; 
