...
{ 
  ...
  force_quad = (-3.954770367080585*phi[8])+4.308049588470176*phi[7]+1.185778957683234*phi[6]-2.888338995926613*phi[5]-1.291704467391079*phi[3]+0.8660254037844386*phi[2];
  alpha_quad[0] -= dx11*force_quad;
  alpha_quad[1] -= dx11*force_quad;
  alpha_quad[2] -= dx11*force_quad;
  alpha_quad[3] -= dx11*force_quad;

  force_quad = (-1.561363675455314*phi[8])+1.700840128541523*phi[7]+1.185778957683234*phi[6]-1.140331086775586*phi[5]-1.291704467391079*phi[3]+0.8660254037844386*phi[2];
  ...
  force_quad = 2.109478270807616*phi[8]+1.700840128541523*phi[7]-0.6324956225107456*phi[6]-2.888338995926613*phi[5]-0.5099715653772844*phi[3]+0.8660254037844386*phi[2];
