...
{ 
  ...
  out[44] += (1.5811388300841895*Ghat_l[7]-1.5811388300841895*Ghat_r[7])*dv10; 
  ...
  out[61] += (1.5811388300841898*Ghat_l[15]-1.5811388300841898*Ghat_r[15])*dv10; 
  out[62] += (0.7071067811865475*Ghat_l[24]-0.7071067811865475*Ghat_r[24])*dv10; 
  out[63] += (1.5811388300841898*Ghat_l[16]-1.5811388300841898*Ghat_r[16])*dv10; 
  out[64] += (0.7071067811865475*Ghat_l[25]-0.7071067811865475*Ghat_r[25])*dv10; 
  out[65] += -(1.224744871391589*(Ghat_r[22]+Ghat_l[22])*dv10); 
  out[66] += (1.5811388300841895*Ghat_l[17]-1.5811388300841895*Ghat_r[17])*dv10; 
  ...
  out[70] += (1.5811388300841895*Ghat_l[19]-1.5811388300841895*Ghat_r[19])*dv10; 
  out[71] += -(1.224744871391589*(Ghat_r[25]+Ghat_l[25])*dv10); 
  out[72] += (1.5811388300841895*Ghat_l[20]-1.5811388300841895*Ghat_r[20])*dv10; 
  out[73] += (1.5811388300841895*Ghat_l[21]-1.5811388300841895*Ghat_r[21])*dv10; 
  ...
  out[77] += (1.5811388300841898*Ghat_l[24]-1.5811388300841898*Ghat_r[24])*dv10; 
