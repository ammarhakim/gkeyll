...
GKYL_CU_DH void phi_alpha_quad_vx_2x2v_tensor_p2(const double *dxv, const double *jacob_pos, const double *phi, double* GKYL_RESTRICT alpha_quad) 
{ 
  ...
  force_quad = jacob_cx_inv*(-(3.9547703670805854*phi[8])+1.1857789576832338*phi[7]+4.308049588470176*phi[6]-2.888338995926613*phi[4]-1.291704467391079*phi[3]+0.8660254037844386*phi[1]);
  alpha_quad[0] -= dx10*force_quad;
  alpha_quad[1] -= dx10*force_quad;
  alpha_quad[2] -= dx10*force_quad;
  alpha_quad[3] -= dx10*force_quad;

  force_quad = jacob_cx_inv*(2.1094782708076156*phi[8]-0.6324956225107456*phi[7]+1.7008401285415227*phi[6]-2.888338995926613*phi[4]-0.5099715653772844*phi[3]+0.8660254037844386*phi[1]);
  ...
  force_quad = jacob_cx_inv*(-(1.5613636754553137*phi[8])+1.1857789576832338*phi[7]+1.7008401285415227*phi[6]-1.140331086775586*phi[4]-1.291704467391079*phi[3]+0.8660254037844386*phi[1]);
  alpha_quad[16] -= dx10*force_quad;
  alpha_quad[17] -= dx10*force_quad;
  alpha_quad[18] -= dx10*force_quad;
  alpha_quad[19] -= dx10*force_quad;

  force_quad = jacob_cx_inv*(0.8328328677734793*phi[8]-0.6324956225107456*phi[7]+0.6715004280822172*phi[6]-1.140331086775586*phi[4]-0.5099715653772844*phi[3]+0.8660254037844386*phi[1]);
