...
{ 
  ...
  force_quad = (-3.954770367080585*phi[8])+1.185778957683234*phi[7]+4.308049588470176*phi[6]-2.888338995926613*phi[4]-1.291704467391079*phi[3]+0.8660254037844386*phi[1];
  alpha_quad[0] -= dx10*force_quad;
  alpha_quad[1] -= dx10*force_quad;
  alpha_quad[2] -= dx10*force_quad;
  alpha_quad[3] -= dx10*force_quad;

  force_quad = 2.109478270807616*phi[8]-0.6324956225107456*phi[7]+1.700840128541523*phi[6]-2.888338995926613*phi[4]-0.5099715653772844*phi[3]+0.8660254037844386*phi[1];
  ...
  force_quad = (-1.561363675455314*phi[8])+1.185778957683234*phi[7]+1.700840128541523*phi[6]-1.140331086775586*phi[4]-1.291704467391079*phi[3]+0.8660254037844386*phi[1];
