...
{ 
  ...
  alpha_l_quad = (1.224744871391589*hamil[1]-4.084728180770504*hamil[2])*(1.58113883008419*poisson_tensor_conf_0[2]-1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  alpha_r_quad = (1.224744871391589*hamil[1]-4.084728180770504*hamil[2])*(1.58113883008419*poisson_tensor_conf_0[2]+1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  ...
  alpha_l_quad = (1.224744871391589*hamil[1]-1.612671688513684*hamil[2])*(1.58113883008419*poisson_tensor_conf_0[2]-1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  alpha_r_quad = (1.224744871391589*hamil[1]-1.612671688513684*hamil[2])*(1.58113883008419*poisson_tensor_conf_0[2]+1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  ...
  alpha_l_quad = (1.612671688513684*hamil[2]+1.224744871391589*hamil[1])*(1.58113883008419*poisson_tensor_conf_0[2]-1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  alpha_r_quad = (1.612671688513684*hamil[2]+1.224744871391589*hamil[1])*(1.58113883008419*poisson_tensor_conf_0[2]+1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  f_lr_quad = (-0.6324956225107456*fl[7])+0.6583704599151832*fl[6]-0.3651715179178389*fl[5]+1.118033988749895*fl[4]+0.5099715653772844*fl[3]+0.29443222054963*fl[2]+0.8660254037844386*fl[1]+0.5*fl[0]; 
  f_cl_quad = 0.6324956225107456*fc[7]+0.6583704599151832*fc[6]-0.3651715179178389*fc[5]+1.118033988749895*fc[4]-0.5099715653772844*fc[3]+0.29443222054963*fc[2]-0.8660254037844386*fc[1]+0.5*fc[0]; 
  f_cr_quad = (-0.6324956225107456*fc[7])+0.6583704599151832*fc[6]-0.3651715179178389*fc[5]+1.118033988749895*fc[4]+0.5099715653772844*fc[3]+0.29443222054963*fc[2]+0.8660254037844386*fc[1]+0.5*fc[0]; 
  ...
  alpha_l_quad = (4.084728180770504*hamil[2]+1.224744871391589*hamil[1])*(1.58113883008419*poisson_tensor_conf_0[2]-1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  alpha_r_quad = (4.084728180770504*hamil[2]+1.224744871391589*hamil[1])*(1.58113883008419*poisson_tensor_conf_0[2]+1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  f_lr_quad = 1.185778957683234*fl[7]+1.667583296809123*fl[6]+0.6846098004178088*fl[5]+1.118033988749895*fl[4]+1.291704467391079*fl[3]+0.7457659219616816*fl[2]+0.8660254037844386*fl[1]+0.5*fl[0]; 
  f_cl_quad = (-1.185778957683234*fc[7])+1.667583296809123*fc[6]+0.6846098004178088*fc[5]+1.118033988749895*fc[4]-1.291704467391079*fc[3]+0.7457659219616816*fc[2]-0.8660254037844386*fc[1]+0.5*fc[0]; 
  f_cr_quad = 1.185778957683234*fc[7]+1.667583296809123*fc[6]+0.6846098004178088*fc[5]+1.118033988749895*fc[4]+1.291704467391079*fc[3]+0.7457659219616816*fc[2]+0.8660254037844386*fc[1]+0.5*fc[0]; 
