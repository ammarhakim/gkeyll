...
GKYL_CU_DH void vlasov_boundary_surfvx_2x3v_ser_p2_mode(int m, int edge, double dv10,
...
{ 
  ...
  if (edge == -1) { 
    out[m] += dv10*vst_2x3v_ser_p2_prj_v0_pm_cr[m]*g; 
  } else { 
    out[m] += dv10*vst_2x3v_ser_p2_prj_v0_pm_cl[m]*g; 
  } 
} 
