...
GKYL_CU_DH double ho_lax_flux_nodal_to_modal_vx_1x1v_ser_p2(const double *dxv, const double *jacob_vel_surf, 
...
{ 
  ...
  f_l_quad = (-1.667583296809123*f_l[7])+1.185778957683234*f_l[6]+1.118033988749895*f_l[5]+0.6846098004178088*f_l[4]-1.291704467391079*f_l[3]+0.8660254037844386*f_l[2]-0.7457659219616816*f_l[1]+0.5*f_l[0]; 
  f_r_quad = (-1.667583296809123*f_r[7])-1.185778957683234*f_r[6]+1.118033988749895*f_r[5]+0.6846098004178088*f_r[4]+1.291704467391079*f_r[3]-0.8660254037844386*f_r[2]-0.7457659219616816*f_r[1]+0.5*f_r[0]; 
