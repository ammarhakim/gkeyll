...
GKYL_CU_DH void E_alpha_quad_vy_2x3v_tensor_p2(const double *dxv, const double *qmem, double* GKYL_RESTRICT alpha_quad) 
{ 
  const double *Ey = &qmem[9]; 

  double force_quad = 0.0;
  force_quad = 0.4*Ey[8]-0.5999999999999995*Ey[7]-0.5999999999999999*Ey[6]+0.4472135954999579*Ey[5]+0.4472135954999579*Ey[4]+0.9*Ey[3]-0.6708203932499369*Ey[2]-0.6708203932499369*Ey[1]+0.5*Ey[0];
  ...
  force_quad = (-0.5*Ey[8])+0.75*Ey[7]-0.5590169943749475*Ey[5]+0.4472135954999579*Ey[4]-0.6708203932499369*Ey[1]+0.5*Ey[0];
  ...
  force_quad = (-0.5*Ey[8])+0.75*Ey[6]+0.4472135954999579*Ey[5]-0.5590169943749475*Ey[4]-0.6708203932499369*Ey[2]+0.5*Ey[0];
  ...
  force_quad = 0.625*Ey[8]-0.5590169943749475*Ey[5]-0.5590169943749475*Ey[4]+0.5*Ey[0];
