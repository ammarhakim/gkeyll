...
{ 
  ...
  const double *Ghat_l = &flux_l[9]; 
  const double *Ghat_r = &flux_r[9]; 
  ...
  out[21] += (1.5811388300841895*Ghat_l[4]-1.5811388300841895*Ghat_r[4])*dv11; 
  out[22] += (1.5811388300841895*Ghat_l[5]-1.5811388300841895*Ghat_r[5])*dv11; 
  out[23] += -(1.224744871391589*(Ghat_r[8]+Ghat_l[8])*dv11); 
  out[24] += (1.5811388300841898*Ghat_l[6]-1.5811388300841898*Ghat_r[6])*dv11; 
  out[25] += (1.5811388300841898*Ghat_l[7]-1.5811388300841898*Ghat_r[7])*dv11; 
  out[26] += (1.5811388300841895*Ghat_l[8]-1.5811388300841895*Ghat_r[8])*dv11; 
