...
{ 
  ...
  out[11] += -(1.5*phi[3]*f[7]*dv11*dx11)-1.5*phi[2]*f[3]*dv11*dx11; 
  out[15] += -(1.5*phi[3]*f[12]*dv11*dx11)-1.5*phi[2]*f[5]*dv11*dx11; 
  out[17] += -(1.5*phi[2]*f[6]*dv11*dx11)-1.5*f[2]*phi[3]*dv11*dx11; 
  out[18] += -(1.5*phi[2]*f[7]*dv11*dx11)-1.5*f[3]*phi[3]*dv11*dx11; 
  out[19] += -(1.5*phi[3]*f[16]*dv11*dx11)-1.5*phi[2]*f[8]*dv11*dx11; 
  out[23] += -(1.5*phi[2]*f[12]*dv11*dx11)-1.5*phi[3]*f[5]*dv11*dx11; 
  out[24] += -(1.5*phi[3]*f[20]*dv11*dx11)-1.5*phi[2]*f[13]*dv11*dx11; 
  out[25] += -(1.5*phi[3]*f[21]*dv11*dx11)-1.5*phi[2]*f[14]*dv11*dx11; 
  out[26] += -(1.5*phi[2]*f[16]*dv11*dx11)-1.5*phi[3]*f[8]*dv11*dx11; 
  out[28] += -(1.5*phi[2]*f[20]*dv11*dx11)-1.5*phi[3]*f[13]*dv11*dx11; 
  out[29] += -(1.5*phi[2]*f[21]*dv11*dx11)-1.5*phi[3]*f[14]*dv11*dx11; 
  out[30] += -(1.5*phi[3]*f[27]*dv11*dx11)-1.5*phi[2]*f[22]*dv11*dx11; 
  out[31] += -(1.5*phi[2]*f[27]*dv11*dx11)-1.5*phi[3]*f[22]*dv11*dx11; 
