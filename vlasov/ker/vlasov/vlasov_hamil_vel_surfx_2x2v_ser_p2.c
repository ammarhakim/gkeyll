...
{ 
  ...
  Ghat_l[0] = 0.8660254037844387*hamil[7]*fUpwind_l[9]+1.9364916731037085*(fUpwind_l[6]*hamil[6]+fUpwind_l[2]*hamil[4])+0.8660254037844386*(fUpwind_l[3]*hamil[3]+fUpwind_l[0]*hamil[1]); 
  Ghat_l[1] = 0.8660254037844386*hamil[7]*fUpwind_l[15]+1.9364916731037085*hamil[6]*fUpwind_l[10]+0.8660254037844386*hamil[3]*fUpwind_l[5]+1.9364916731037085*fUpwind_l[4]*hamil[4]+0.8660254037844386*fUpwind_l[1]*hamil[1]; 
  Ghat_l[2] = 0.8660254037844386*hamil[7]*fUpwind_l[16]+1.7320508075688772*(hamil[6]*fUpwind_l[14]+hamil[4]*fUpwind_l[8])+1.9364916731037085*fUpwind_l[3]*hamil[6]+0.8660254037844386*hamil[3]*fUpwind_l[6]+1.9364916731037085*fUpwind_l[0]*hamil[4]+0.8660254037844386*hamil[1]*fUpwind_l[2]; 
  Ghat_l[3] = 1.7320508075688772*hamil[6]*fUpwind_l[16]+0.7745966692414833*hamil[3]*fUpwind_l[9]+0.7745966692414834*fUpwind_l[3]*hamil[7]+1.9364916731037085*(fUpwind_l[2]*hamil[6]+hamil[4]*fUpwind_l[6])+0.8660254037844386*(fUpwind_l[0]*hamil[3]+hamil[1]*fUpwind_l[3]); 
  Ghat_l[4] = 0.8660254037844387*hamil[7]*fUpwind_l[19]+1.7320508075688774*(hamil[6]*fUpwind_l[18]+hamil[4]*fUpwind_l[12])+0.8660254037844386*hamil[3]*fUpwind_l[10]+1.9364916731037085*(fUpwind_l[5]*hamil[6]+fUpwind_l[1]*hamil[4])+0.8660254037844386*hamil[1]*fUpwind_l[4]; 
  Ghat_l[5] = 1.7320508075688774*hamil[6]*fUpwind_l[19]+0.7745966692414834*hamil[3]*fUpwind_l[15]+1.9364916731037085*hamil[4]*fUpwind_l[10]+0.7745966692414834*fUpwind_l[5]*hamil[7]+1.9364916731037085*fUpwind_l[4]*hamil[6]+0.8660254037844386*(hamil[1]*fUpwind_l[5]+fUpwind_l[1]*hamil[3]); 
  Ghat_l[6] = 0.7745966692414834*hamil[3]*fUpwind_l[16]+1.7320508075688774*(hamil[4]*fUpwind_l[14]+hamil[6]*(fUpwind_l[9]+fUpwind_l[8]))+0.7745966692414834*fUpwind_l[6]*hamil[7]+1.9364916731037085*fUpwind_l[0]*hamil[6]+0.8660254037844386*hamil[1]*fUpwind_l[6]+1.9364916731037085*fUpwind_l[3]*hamil[4]+0.8660254037844386*fUpwind_l[2]*hamil[3]; 
  Ghat_l[7] = 1.9364916731037085*hamil[6]*fUpwind_l[17]+0.8660254037844387*hamil[3]*fUpwind_l[13]+1.9364916731037085*hamil[4]*fUpwind_l[11]+0.8660254037844386*hamil[1]*fUpwind_l[7]; 
  Ghat_l[8] = 0.8660254037844387*hamil[3]*fUpwind_l[14]+0.8660254037844386*hamil[1]*fUpwind_l[8]+1.7320508075688774*fUpwind_l[6]*hamil[6]+1.7320508075688772*fUpwind_l[2]*hamil[4]; 
  Ghat_l[9] = 1.9364916731037085*hamil[4]*fUpwind_l[16]+(0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[9]+0.8660254037844387*fUpwind_l[0]*hamil[7]+1.7320508075688774*fUpwind_l[6]*hamil[6]+0.7745966692414833*fUpwind_l[3]*hamil[3]; 
  Ghat_l[10] = 0.7745966692414833*hamil[3]*fUpwind_l[19]+1.7320508075688772*(hamil[4]*fUpwind_l[18]+hamil[6]*(fUpwind_l[15]+fUpwind_l[12]))+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[10]+1.9364916731037085*(fUpwind_l[1]*hamil[6]+hamil[4]*fUpwind_l[5])+0.8660254037844386*hamil[3]*fUpwind_l[4]; 
  Ghat_l[11] = 0.8660254037844387*hamil[3]*fUpwind_l[17]+1.9364916731037085*hamil[6]*fUpwind_l[13]+0.8660254037844386*hamil[1]*fUpwind_l[11]+1.9364916731037085*hamil[4]*fUpwind_l[7]; 
  Ghat_l[12] = 0.8660254037844387*hamil[3]*fUpwind_l[18]+0.8660254037844386*hamil[1]*fUpwind_l[12]+1.7320508075688772*hamil[6]*fUpwind_l[10]+1.7320508075688774*fUpwind_l[4]*hamil[4]; 
  Ghat_l[13] = 1.9364916731037085*hamil[4]*fUpwind_l[17]+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[13]+1.9364916731037085*hamil[6]*fUpwind_l[11]+0.8660254037844387*hamil[3]*fUpwind_l[7]; 
  Ghat_l[14] = 1.5491933384829668*hamil[6]*fUpwind_l[16]+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[14]+0.8660254037844387*hamil[3]*fUpwind_l[8]+1.7320508075688772*fUpwind_l[2]*hamil[6]+1.7320508075688774*hamil[4]*fUpwind_l[6]; 
  Ghat_l[15] = 1.9364916731037085*hamil[4]*fUpwind_l[19]+(0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[15]+1.7320508075688772*hamil[6]*fUpwind_l[10]+0.8660254037844386*fUpwind_l[1]*hamil[7]+0.7745966692414834*hamil[3]*fUpwind_l[5]; 
  Ghat_l[16] = (0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[16]+1.5491933384829668*hamil[6]*fUpwind_l[14]+1.9364916731037085*hamil[4]*fUpwind_l[9]+0.8660254037844386*fUpwind_l[2]*hamil[7]+1.7320508075688772*fUpwind_l[3]*hamil[6]+0.7745966692414834*hamil[3]*fUpwind_l[6]; 
  Ghat_l[17] = (0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[17]+1.9364916731037085*hamil[4]*fUpwind_l[13]+0.8660254037844387*hamil[3]*fUpwind_l[11]+1.9364916731037085*hamil[6]*fUpwind_l[7]; 
  Ghat_l[18] = 1.5491933384829668*hamil[6]*fUpwind_l[19]+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[18]+0.8660254037844387*hamil[3]*fUpwind_l[12]+1.7320508075688772*hamil[4]*fUpwind_l[10]+1.7320508075688774*fUpwind_l[4]*hamil[6]; 
  Ghat_l[19] = (0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_l[19]+1.5491933384829668*hamil[6]*fUpwind_l[18]+1.9364916731037085*hamil[4]*fUpwind_l[15]+0.7745966692414833*hamil[3]*fUpwind_l[10]+0.8660254037844387*fUpwind_l[4]*hamil[7]+1.7320508075688774*fUpwind_l[5]*hamil[6]; 

  Ghat_r[0] = 0.8660254037844387*hamil[7]*fUpwind_r[9]+1.9364916731037085*(fUpwind_r[6]*hamil[6]+fUpwind_r[2]*hamil[4])+0.8660254037844386*(fUpwind_r[3]*hamil[3]+fUpwind_r[0]*hamil[1]); 
  Ghat_r[1] = 0.8660254037844386*hamil[7]*fUpwind_r[15]+1.9364916731037085*hamil[6]*fUpwind_r[10]+0.8660254037844386*hamil[3]*fUpwind_r[5]+1.9364916731037085*fUpwind_r[4]*hamil[4]+0.8660254037844386*fUpwind_r[1]*hamil[1]; 
  Ghat_r[2] = 0.8660254037844386*hamil[7]*fUpwind_r[16]+1.7320508075688772*(hamil[6]*fUpwind_r[14]+hamil[4]*fUpwind_r[8])+1.9364916731037085*fUpwind_r[3]*hamil[6]+0.8660254037844386*hamil[3]*fUpwind_r[6]+1.9364916731037085*fUpwind_r[0]*hamil[4]+0.8660254037844386*hamil[1]*fUpwind_r[2]; 
  Ghat_r[3] = 1.7320508075688772*hamil[6]*fUpwind_r[16]+0.7745966692414833*hamil[3]*fUpwind_r[9]+0.7745966692414834*fUpwind_r[3]*hamil[7]+1.9364916731037085*(fUpwind_r[2]*hamil[6]+hamil[4]*fUpwind_r[6])+0.8660254037844386*(fUpwind_r[0]*hamil[3]+hamil[1]*fUpwind_r[3]); 
  Ghat_r[4] = 0.8660254037844387*hamil[7]*fUpwind_r[19]+1.7320508075688774*(hamil[6]*fUpwind_r[18]+hamil[4]*fUpwind_r[12])+0.8660254037844386*hamil[3]*fUpwind_r[10]+1.9364916731037085*(fUpwind_r[5]*hamil[6]+fUpwind_r[1]*hamil[4])+0.8660254037844386*hamil[1]*fUpwind_r[4]; 
  Ghat_r[5] = 1.7320508075688774*hamil[6]*fUpwind_r[19]+0.7745966692414834*hamil[3]*fUpwind_r[15]+1.9364916731037085*hamil[4]*fUpwind_r[10]+0.7745966692414834*fUpwind_r[5]*hamil[7]+1.9364916731037085*fUpwind_r[4]*hamil[6]+0.8660254037844386*(hamil[1]*fUpwind_r[5]+fUpwind_r[1]*hamil[3]); 
  Ghat_r[6] = 0.7745966692414834*hamil[3]*fUpwind_r[16]+1.7320508075688774*(hamil[4]*fUpwind_r[14]+hamil[6]*(fUpwind_r[9]+fUpwind_r[8]))+0.7745966692414834*fUpwind_r[6]*hamil[7]+1.9364916731037085*fUpwind_r[0]*hamil[6]+0.8660254037844386*hamil[1]*fUpwind_r[6]+1.9364916731037085*fUpwind_r[3]*hamil[4]+0.8660254037844386*fUpwind_r[2]*hamil[3]; 
  Ghat_r[7] = 1.9364916731037085*hamil[6]*fUpwind_r[17]+0.8660254037844387*hamil[3]*fUpwind_r[13]+1.9364916731037085*hamil[4]*fUpwind_r[11]+0.8660254037844386*hamil[1]*fUpwind_r[7]; 
  Ghat_r[8] = 0.8660254037844387*hamil[3]*fUpwind_r[14]+0.8660254037844386*hamil[1]*fUpwind_r[8]+1.7320508075688774*fUpwind_r[6]*hamil[6]+1.7320508075688772*fUpwind_r[2]*hamil[4]; 
  Ghat_r[9] = 1.9364916731037085*hamil[4]*fUpwind_r[16]+(0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[9]+0.8660254037844387*fUpwind_r[0]*hamil[7]+1.7320508075688774*fUpwind_r[6]*hamil[6]+0.7745966692414833*fUpwind_r[3]*hamil[3]; 
  Ghat_r[10] = 0.7745966692414833*hamil[3]*fUpwind_r[19]+1.7320508075688772*(hamil[4]*fUpwind_r[18]+hamil[6]*(fUpwind_r[15]+fUpwind_r[12]))+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[10]+1.9364916731037085*(fUpwind_r[1]*hamil[6]+hamil[4]*fUpwind_r[5])+0.8660254037844386*hamil[3]*fUpwind_r[4]; 
  Ghat_r[11] = 0.8660254037844387*hamil[3]*fUpwind_r[17]+1.9364916731037085*hamil[6]*fUpwind_r[13]+0.8660254037844386*hamil[1]*fUpwind_r[11]+1.9364916731037085*hamil[4]*fUpwind_r[7]; 
  Ghat_r[12] = 0.8660254037844387*hamil[3]*fUpwind_r[18]+0.8660254037844386*hamil[1]*fUpwind_r[12]+1.7320508075688772*hamil[6]*fUpwind_r[10]+1.7320508075688774*fUpwind_r[4]*hamil[4]; 
  Ghat_r[13] = 1.9364916731037085*hamil[4]*fUpwind_r[17]+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[13]+1.9364916731037085*hamil[6]*fUpwind_r[11]+0.8660254037844387*hamil[3]*fUpwind_r[7]; 
  Ghat_r[14] = 1.5491933384829668*hamil[6]*fUpwind_r[16]+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[14]+0.8660254037844387*hamil[3]*fUpwind_r[8]+1.7320508075688772*fUpwind_r[2]*hamil[6]+1.7320508075688774*hamil[4]*fUpwind_r[6]; 
  Ghat_r[15] = 1.9364916731037085*hamil[4]*fUpwind_r[19]+(0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[15]+1.7320508075688772*hamil[6]*fUpwind_r[10]+0.8660254037844386*fUpwind_r[1]*hamil[7]+0.7745966692414834*hamil[3]*fUpwind_r[5]; 
  Ghat_r[16] = (0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[16]+1.5491933384829668*hamil[6]*fUpwind_r[14]+1.9364916731037085*hamil[4]*fUpwind_r[9]+0.8660254037844386*fUpwind_r[2]*hamil[7]+1.7320508075688772*fUpwind_r[3]*hamil[6]+0.7745966692414834*hamil[3]*fUpwind_r[6]; 
  Ghat_r[17] = (0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[17]+1.9364916731037085*hamil[4]*fUpwind_r[13]+0.8660254037844387*hamil[3]*fUpwind_r[11]+1.9364916731037085*hamil[6]*fUpwind_r[7]; 
  Ghat_r[18] = 1.5491933384829668*hamil[6]*fUpwind_r[19]+(0.7745966692414834*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[18]+0.8660254037844387*hamil[3]*fUpwind_r[12]+1.7320508075688772*hamil[4]*fUpwind_r[10]+1.7320508075688774*fUpwind_r[4]*hamil[6]; 
  Ghat_r[19] = (0.5532833351724881*hamil[7]+0.8660254037844386*hamil[1])*fUpwind_r[19]+1.5491933384829668*hamil[6]*fUpwind_r[18]+1.9364916731037085*hamil[4]*fUpwind_r[15]+0.7745966692414833*hamil[3]*fUpwind_r[10]+0.8660254037844387*fUpwind_r[4]*hamil[7]+1.7320508075688774*fUpwind_r[5]*hamil[6]; 
