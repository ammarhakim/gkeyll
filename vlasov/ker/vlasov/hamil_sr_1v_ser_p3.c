...
{ 
  ...
  hamil_nodal[1] = sqrt(1.0 + pow(wx1-0.22360679774997896*dv1, 2.0));
  hamil_inv_nodal[1] = 1.0/hamil_nodal[1];
  hamil_nodal[2] = sqrt(1.0 + pow(wx1+0.22360679774997896*dv1, 2.0));
  hamil_inv_nodal[2] = 1.0/hamil_nodal[2];
  hamil_nodal[3] = sqrt(1.0 + pow(wx1+0.5*dv1, 2.0));
