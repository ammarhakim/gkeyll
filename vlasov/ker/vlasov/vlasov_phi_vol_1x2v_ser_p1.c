...
{ 
  ...
  out[4] += dv10*dx10*(-(2.1213203435596424*f[1]*phi[1]*jacob_vx_inv)); 
  out[6] += dv10*dx10*(-(2.1213203435596424*phi[1]*f[3]*jacob_vx_inv)); 
  out[7] += dv10*dx10*(-(2.1213203435596424*phi[1]*f[5]*jacob_vx_inv)); 
