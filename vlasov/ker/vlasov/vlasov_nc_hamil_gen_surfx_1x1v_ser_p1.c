...
{ 
  ...
  alpha_l_quad = 1.224744871391589*hamil[1]*(0.7071067811865475*poisson_tensor_conf_0[0]-1.224744871391589*poisson_tensor_conf_0[1]); 
  alpha_r_quad = 1.224744871391589*hamil[1]*(1.224744871391589*poisson_tensor_conf_0[1]+0.7071067811865475*poisson_tensor_conf_0[0]); 
