...
{ 
  ...
  out[6] += -(1.224744871391589*flux[1]*dv11); 
  out[7] += -(1.224744871391589*flux[2]*dv11); 
  out[8] += -(0.7071067811865475*flux[5]*dv11); 
  out[9] += -(0.7071067811865475*flux[6]*dv11); 
  out[10] += -(1.224744871391589*flux[3]*dv11); 
  out[11] += -(1.224744871391589*flux[4]*dv11); 
  out[12] += -(0.7071067811865475*flux[7]*dv11); 
