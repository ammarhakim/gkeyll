...
{ 
  ...
  fUpwind_r[0] = (1.5811388300841895*fc[11]+1.224744871391589*fc[1]+0.7071067811865475*fc[0])*jacob_vx_inv; 
  fUpwind_r[1] = (1.5811388300841898*fc[19]+1.224744871391589*fc[5]+0.7071067811865475*fc[2])*jacob_vx_inv; 
  fUpwind_r[2] = (1.5811388300841898*fc[21]+1.224744871391589*fc[6]+0.7071067811865475*fc[3])*jacob_vx_inv; 
  fUpwind_r[3] = (1.5811388300841898*fc[25]+1.224744871391589*fc[8]+0.7071067811865475*fc[4])*jacob_vx_inv; 
  fUpwind_r[4] = (1.5811388300841895*fc[32]+1.224744871391589*fc[15]+0.7071067811865475*fc[7])*jacob_vx_inv; 
  fUpwind_r[5] = (1.5811388300841895*fc[35]+1.224744871391589*fc[16]+0.7071067811865475*fc[9])*jacob_vx_inv; 
  fUpwind_r[6] = (1.5811388300841895*fc[37]+1.224744871391589*fc[17]+0.7071067811865475*fc[10])*jacob_vx_inv; 
  fUpwind_r[7] = (1.224744871391589*fc[20]+0.7071067811865475*fc[12])*jacob_vx_inv; 
  fUpwind_r[8] = (1.224744871391589*fc[23]+0.7071067811865475*fc[13])*jacob_vx_inv; 
  fUpwind_r[9] = (1.224744871391589*fc[28]+0.7071067811865475*fc[14])*jacob_vx_inv; 
  fUpwind_r[10] = (1.5811388300841898*fc[44]+1.224744871391589*fc[31]+0.7071067811865475*fc[18])*jacob_vx_inv; 
  fUpwind_r[11] = (1.224744871391589*fc[33]+0.7071067811865475*fc[22])*jacob_vx_inv; 
  fUpwind_r[12] = (1.224744871391589*fc[34]+0.7071067811865475*fc[24])*jacob_vx_inv; 
  fUpwind_r[13] = (1.224744871391589*fc[36]+0.7071067811865475*fc[26])*jacob_vx_inv; 
  fUpwind_r[14] = (1.224744871391589*fc[39]+0.7071067811865475*fc[27])*jacob_vx_inv; 
  fUpwind_r[15] = (1.224744871391589*fc[41]+0.7071067811865475*fc[29])*jacob_vx_inv; 
  fUpwind_r[16] = (1.224744871391589*fc[42]+0.7071067811865475*fc[30])*jacob_vx_inv; 
  fUpwind_r[17] = (1.224744871391589*fc[45]+0.7071067811865475*fc[38])*jacob_vx_inv; 
  fUpwind_r[18] = (1.224744871391589*fc[46]+0.7071067811865475*fc[40])*jacob_vx_inv; 
  fUpwind_r[19] = (1.224744871391589*fc[47]+0.7071067811865475*fc[43])*jacob_vx_inv; 

  fUpwind_l[0] = (1.5811388300841895*fl[11]+1.224744871391589*fl[1]+0.7071067811865475*fl[0])*jacob_vx_inv; 
  fUpwind_l[1] = (1.5811388300841898*fl[19]+1.224744871391589*fl[5]+0.7071067811865475*fl[2])*jacob_vx_inv; 
  fUpwind_l[2] = (1.5811388300841898*fl[21]+1.224744871391589*fl[6]+0.7071067811865475*fl[3])*jacob_vx_inv; 
  fUpwind_l[3] = (1.5811388300841898*fl[25]+1.224744871391589*fl[8]+0.7071067811865475*fl[4])*jacob_vx_inv; 
  fUpwind_l[4] = (1.5811388300841895*fl[32]+1.224744871391589*fl[15]+0.7071067811865475*fl[7])*jacob_vx_inv; 
  fUpwind_l[5] = (1.5811388300841895*fl[35]+1.224744871391589*fl[16]+0.7071067811865475*fl[9])*jacob_vx_inv; 
  fUpwind_l[6] = (1.5811388300841895*fl[37]+1.224744871391589*fl[17]+0.7071067811865475*fl[10])*jacob_vx_inv; 
  fUpwind_l[7] = (1.224744871391589*fl[20]+0.7071067811865475*fl[12])*jacob_vx_inv; 
  fUpwind_l[8] = (1.224744871391589*fl[23]+0.7071067811865475*fl[13])*jacob_vx_inv; 
  fUpwind_l[9] = (1.224744871391589*fl[28]+0.7071067811865475*fl[14])*jacob_vx_inv; 
  fUpwind_l[10] = (1.5811388300841898*fl[44]+1.224744871391589*fl[31]+0.7071067811865475*fl[18])*jacob_vx_inv; 
  fUpwind_l[11] = (1.224744871391589*fl[33]+0.7071067811865475*fl[22])*jacob_vx_inv; 
  fUpwind_l[12] = (1.224744871391589*fl[34]+0.7071067811865475*fl[24])*jacob_vx_inv; 
  fUpwind_l[13] = (1.224744871391589*fl[36]+0.7071067811865475*fl[26])*jacob_vx_inv; 
  fUpwind_l[14] = (1.224744871391589*fl[39]+0.7071067811865475*fl[27])*jacob_vx_inv; 
  fUpwind_l[15] = (1.224744871391589*fl[41]+0.7071067811865475*fl[29])*jacob_vx_inv; 
  fUpwind_l[16] = (1.224744871391589*fl[42]+0.7071067811865475*fl[30])*jacob_vx_inv; 
  fUpwind_l[17] = (1.224744871391589*fl[45]+0.7071067811865475*fl[38])*jacob_vx_inv; 
  fUpwind_l[18] = (1.224744871391589*fl[46]+0.7071067811865475*fl[40])*jacob_vx_inv; 
  fUpwind_l[19] = (1.224744871391589*fl[47]+0.7071067811865475*fl[43])*jacob_vx_inv; 

  } else { 

  fUpwind_r[0] = (1.5811388300841895*fr[11]-1.224744871391589*fr[1]+0.7071067811865475*fr[0])*jacob_vx_inv; 
  fUpwind_r[1] = (1.5811388300841898*fr[19]-1.224744871391589*fr[5]+0.7071067811865475*fr[2])*jacob_vx_inv; 
  fUpwind_r[2] = (1.5811388300841898*fr[21]-1.224744871391589*fr[6]+0.7071067811865475*fr[3])*jacob_vx_inv; 
  fUpwind_r[3] = (1.5811388300841898*fr[25]-1.224744871391589*fr[8]+0.7071067811865475*fr[4])*jacob_vx_inv; 
  fUpwind_r[4] = (1.5811388300841895*fr[32]-1.224744871391589*fr[15]+0.7071067811865475*fr[7])*jacob_vx_inv; 
  fUpwind_r[5] = (1.5811388300841895*fr[35]-1.224744871391589*fr[16]+0.7071067811865475*fr[9])*jacob_vx_inv; 
  fUpwind_r[6] = (1.5811388300841895*fr[37]-1.224744871391589*fr[17]+0.7071067811865475*fr[10])*jacob_vx_inv; 
  fUpwind_r[7] = (0.7071067811865475*fr[12]-1.224744871391589*fr[20])*jacob_vx_inv; 
  fUpwind_r[8] = (0.7071067811865475*fr[13]-1.224744871391589*fr[23])*jacob_vx_inv; 
  fUpwind_r[9] = (0.7071067811865475*fr[14]-1.224744871391589*fr[28])*jacob_vx_inv; 
  fUpwind_r[10] = (1.5811388300841898*fr[44]-1.224744871391589*fr[31]+0.7071067811865475*fr[18])*jacob_vx_inv; 
  fUpwind_r[11] = (0.7071067811865475*fr[22]-1.224744871391589*fr[33])*jacob_vx_inv; 
  fUpwind_r[12] = (0.7071067811865475*fr[24]-1.224744871391589*fr[34])*jacob_vx_inv; 
  fUpwind_r[13] = (0.7071067811865475*fr[26]-1.224744871391589*fr[36])*jacob_vx_inv; 
  fUpwind_r[14] = (0.7071067811865475*fr[27]-1.224744871391589*fr[39])*jacob_vx_inv; 
  fUpwind_r[15] = (0.7071067811865475*fr[29]-1.224744871391589*fr[41])*jacob_vx_inv; 
  fUpwind_r[16] = (0.7071067811865475*fr[30]-1.224744871391589*fr[42])*jacob_vx_inv; 
  fUpwind_r[17] = (0.7071067811865475*fr[38]-1.224744871391589*fr[45])*jacob_vx_inv; 
  fUpwind_r[18] = (0.7071067811865475*fr[40]-1.224744871391589*fr[46])*jacob_vx_inv; 
  fUpwind_r[19] = (0.7071067811865475*fr[43]-1.224744871391589*fr[47])*jacob_vx_inv; 

  fUpwind_l[0] = (1.5811388300841895*fc[11]-1.224744871391589*fc[1]+0.7071067811865475*fc[0])*jacob_vx_inv; 
  fUpwind_l[1] = (1.5811388300841898*fc[19]-1.224744871391589*fc[5]+0.7071067811865475*fc[2])*jacob_vx_inv; 
  fUpwind_l[2] = (1.5811388300841898*fc[21]-1.224744871391589*fc[6]+0.7071067811865475*fc[3])*jacob_vx_inv; 
  fUpwind_l[3] = (1.5811388300841898*fc[25]-1.224744871391589*fc[8]+0.7071067811865475*fc[4])*jacob_vx_inv; 
  fUpwind_l[4] = (1.5811388300841895*fc[32]-1.224744871391589*fc[15]+0.7071067811865475*fc[7])*jacob_vx_inv; 
  fUpwind_l[5] = (1.5811388300841895*fc[35]-1.224744871391589*fc[16]+0.7071067811865475*fc[9])*jacob_vx_inv; 
  fUpwind_l[6] = (1.5811388300841895*fc[37]-1.224744871391589*fc[17]+0.7071067811865475*fc[10])*jacob_vx_inv; 
  fUpwind_l[7] = (0.7071067811865475*fc[12]-1.224744871391589*fc[20])*jacob_vx_inv; 
  fUpwind_l[8] = (0.7071067811865475*fc[13]-1.224744871391589*fc[23])*jacob_vx_inv; 
  fUpwind_l[9] = (0.7071067811865475*fc[14]-1.224744871391589*fc[28])*jacob_vx_inv; 
  fUpwind_l[10] = (1.5811388300841898*fc[44]-1.224744871391589*fc[31]+0.7071067811865475*fc[18])*jacob_vx_inv; 
  fUpwind_l[11] = (0.7071067811865475*fc[22]-1.224744871391589*fc[33])*jacob_vx_inv; 
  fUpwind_l[12] = (0.7071067811865475*fc[24]-1.224744871391589*fc[34])*jacob_vx_inv; 
  fUpwind_l[13] = (0.7071067811865475*fc[26]-1.224744871391589*fc[36])*jacob_vx_inv; 
  fUpwind_l[14] = (0.7071067811865475*fc[27]-1.224744871391589*fc[39])*jacob_vx_inv; 
  fUpwind_l[15] = (0.7071067811865475*fc[29]-1.224744871391589*fc[41])*jacob_vx_inv; 
  fUpwind_l[16] = (0.7071067811865475*fc[30]-1.224744871391589*fc[42])*jacob_vx_inv; 
  fUpwind_l[17] = (0.7071067811865475*fc[38]-1.224744871391589*fc[45])*jacob_vx_inv; 
  fUpwind_l[18] = (0.7071067811865475*fc[40]-1.224744871391589*fc[46])*jacob_vx_inv; 
  fUpwind_l[19] = (0.7071067811865475*fc[43]-1.224744871391589*fc[47])*jacob_vx_inv; 
  ...
  return fabs(0.8838834764831842*dv10*dx10*(1.7320508075688772*hamil[1]*jacob_vx_inv));
