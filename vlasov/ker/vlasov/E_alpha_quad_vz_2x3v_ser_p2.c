...
GKYL_CU_DH void E_alpha_quad_vz_2x3v_ser_p2(const double *dxv, const double *qmem, double* GKYL_RESTRICT alpha_quad) 
{ 
  const double *Ez = &qmem[16]; 

  double force_quad = 0.0;
  force_quad = (-0.5999999999999995*Ez[7])-0.5999999999999999*Ez[6]+0.4472135954999579*Ez[5]+0.4472135954999579*Ez[4]+0.9*Ez[3]-0.6708203932499369*Ez[2]-0.6708203932499369*Ez[1]+0.5*Ez[0];
  ...
  force_quad = 0.75*Ez[7]-0.5590169943749475*Ez[5]+0.4472135954999579*Ez[4]-0.6708203932499369*Ez[1]+0.5*Ez[0];
  ...
  force_quad = 0.75*Ez[6]+0.4472135954999579*Ez[5]-0.5590169943749475*Ez[4]-0.6708203932499369*Ez[2]+0.5*Ez[0];
  ...
  force_quad = (-0.5590169943749475*Ez[5])-0.5590169943749475*Ez[4]+0.5*Ez[0];
