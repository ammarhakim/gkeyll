...
{ 
  ...
  out[0] += volFact*(1.224744871391589*f[2]*dv1*wx1_sq+1.414213562373095*f[0]*wx1_cu+0.3162277660168379*f[5]*dv1_sq*wx1+0.3535533905932737*f[0]*dv1_sq*wx1+0.06123724356957942*f[2]*dv1_cu); 
  out[1] += volFact*(1.224744871391589*f[3]*dv1*wx1_sq+1.414213562373095*f[1]*wx1_cu+0.3162277660168379*f[7]*dv1_sq*wx1+0.3535533905932737*f[1]*dv1_sq*wx1+0.06123724356957942*f[3]*dv1_cu); 
  out[2] += volFact*(1.224744871391589*f[6]*dv1*wx1_sq+1.414213562373095*f[4]*wx1_cu+0.3162277660168379*f[8]*dv1_sq*wx1+0.3535533905932737*f[4]*dv1_sq*wx1+0.06123724356957942*f[6]*dv1_cu); 
} 
...
{ 
  ...
  out[0] += ((1.290994448735806*hamil[2]*f[5]+0.4303314829119353*hamil[1]*f[5]+1.936491673103709*f[2]*hamil[2]+1.443375672974065*f[0]*hamil[2]+0.6454972243679029*hamil[1]*f[2]+0.4811252243246882*f[0]*hamil[1])*dv10*volFact)/jacob_vx[2]+(((-1.290994448735806*hamil[2]*f[5])+0.4303314829119353*hamil[1]*f[5]+1.936491673103709*f[2]*hamil[2]-1.443375672974065*f[0]*hamil[2]-0.6454972243679029*hamil[1]*f[2]+0.4811252243246882*f[0]*hamil[1])*dv10*volFact)/jacob_vx[0]+((0.7698003589195012*f[0]*hamil[1]-0.8606629658238706*hamil[1]*f[5])*dv10*volFact)/jacob_vx[1]; 
  out[1] += ((1.290994448735806*hamil[2]*f[7]+0.4303314829119352*hamil[1]*f[7]+1.936491673103709*hamil[2]*f[3]+0.6454972243679029*hamil[1]*f[3]+1.443375672974065*f[1]*hamil[2]+0.4811252243246882*f[1]*hamil[1])*dv10*volFact)/jacob_vx[2]+(((-1.290994448735806*hamil[2]*f[7])+0.4303314829119352*hamil[1]*f[7]+1.936491673103709*hamil[2]*f[3]-0.6454972243679029*hamil[1]*f[3]-1.443375672974065*f[1]*hamil[2]+0.4811252243246882*f[1]*hamil[1])*dv10*volFact)/jacob_vx[0]+((0.7698003589195012*f[1]*hamil[1]-0.8606629658238704*hamil[1]*f[7])*dv10*volFact)/jacob_vx[1]; 
  out[2] += ((1.290994448735806*hamil[2]*f[8]+0.4303314829119353*hamil[1]*f[8]+1.936491673103709*hamil[2]*f[6]+0.6454972243679028*hamil[1]*f[6]+1.443375672974065*hamil[2]*f[4]+0.4811252243246882*hamil[1]*f[4])*dv10*volFact)/jacob_vx[2]+(((-1.290994448735806*hamil[2]*f[8])+0.4303314829119353*hamil[1]*f[8]+1.936491673103709*hamil[2]*f[6]-0.6454972243679028*hamil[1]*f[6]-1.443375672974065*hamil[2]*f[4]+0.4811252243246882*hamil[1]*f[4])*dv10*volFact)/jacob_vx[0]+((0.7698003589195012*hamil[1]*f[4]-0.8606629658238706*hamil[1]*f[8])*dv10*volFact)/jacob_vx[1]; 
} 
...
{ 
  ...
  out[1] += (1.0*hamil[2]*f[7]+hamil[1]*f[3]+hamil[0]*f[1])*volFact; 
  out[2] += (hamil[2]*f[8]+1.0*hamil[1]*f[6]+hamil[0]*f[4])*volFact; 
} 
...
{ 
  ...
  out[1] += 1.414213562373095*f[1]*volFact; 
  out[2] += 1.414213562373095*f[4]*volFact; 
  out[3] += ((1.290994448735806*hamil[2]*f[5]+0.4303314829119353*hamil[1]*f[5]+1.936491673103709*f[2]*hamil[2]+1.443375672974065*f[0]*hamil[2]+0.6454972243679029*hamil[1]*f[2]+0.4811252243246882*f[0]*hamil[1])*dv10*volFact)/jacob_vx[2]+(((-1.290994448735806*hamil[2]*f[5])+0.4303314829119353*hamil[1]*f[5]+1.936491673103709*f[2]*hamil[2]-1.443375672974065*f[0]*hamil[2]-0.6454972243679029*hamil[1]*f[2]+0.4811252243246882*f[0]*hamil[1])*dv10*volFact)/jacob_vx[0]+((0.7698003589195012*f[0]*hamil[1]-0.8606629658238706*hamil[1]*f[5])*dv10*volFact)/jacob_vx[1]; 
  out[4] += ((1.290994448735806*hamil[2]*f[7]+0.4303314829119352*hamil[1]*f[7]+1.936491673103709*hamil[2]*f[3]+0.6454972243679029*hamil[1]*f[3]+1.443375672974065*f[1]*hamil[2]+0.4811252243246882*f[1]*hamil[1])*dv10*volFact)/jacob_vx[2]+(((-1.290994448735806*hamil[2]*f[7])+0.4303314829119352*hamil[1]*f[7]+1.936491673103709*hamil[2]*f[3]-0.6454972243679029*hamil[1]*f[3]-1.443375672974065*f[1]*hamil[2]+0.4811252243246882*f[1]*hamil[1])*dv10*volFact)/jacob_vx[0]+((0.7698003589195012*f[1]*hamil[1]-0.8606629658238704*hamil[1]*f[7])*dv10*volFact)/jacob_vx[1]; 
  out[5] += ((1.290994448735806*hamil[2]*f[8]+0.4303314829119353*hamil[1]*f[8]+1.936491673103709*hamil[2]*f[6]+0.6454972243679028*hamil[1]*f[6]+1.443375672974065*hamil[2]*f[4]+0.4811252243246882*hamil[1]*f[4])*dv10*volFact)/jacob_vx[2]+(((-1.290994448735806*hamil[2]*f[8])+0.4303314829119353*hamil[1]*f[8]+1.936491673103709*hamil[2]*f[6]-0.6454972243679028*hamil[1]*f[6]-1.443375672974065*hamil[2]*f[4]+0.4811252243246882*hamil[1]*f[4])*dv10*volFact)/jacob_vx[0]+((0.7698003589195012*hamil[1]*f[4]-0.8606629658238706*hamil[1]*f[8])*dv10*volFact)/jacob_vx[1]; 
  out[6] += (hamil[2]*f[5]+hamil[1]*f[2]+f[0]*hamil[0])*volFact; 
  out[7] += (1.0*hamil[2]*f[7]+hamil[1]*f[3]+hamil[0]*f[1])*volFact; 
  out[8] += (hamil[2]*f[8]+1.0*hamil[1]*f[6]+hamil[0]*f[4])*volFact; 
} 
...
{ 
  ...
  out[1] += ((1.825741858350554*hamil[2]*f[5]+0.6085806194501847*hamil[1]*f[5]+2.738612787525831*f[2]*hamil[2]+2.041241452319315*f[0]*hamil[2]+0.9128709291752769*hamil[1]*f[2]+0.6804138174397718*f[0]*hamil[1])*dv10*volFact)/jacob_vx[2]+(((-1.825741858350554*hamil[2]*f[5])+0.6085806194501847*hamil[1]*f[5]+2.738612787525831*f[2]*hamil[2]-2.041241452319315*f[0]*hamil[2]-0.9128709291752769*hamil[1]*f[2]+0.6804138174397718*f[0]*hamil[1])*dv10*volFact)/jacob_vx[0]+((1.088662107903635*f[0]*hamil[1]-1.21716123890037*hamil[1]*f[5])*dv10*volFact)/jacob_vx[1]; 
  out[2] += (1.414213562373095*hamil[2]*f[5]+1.414213562373095*hamil[1]*f[2]+1.414213562373095*f[0]*hamil[0])*volFact; 
} 
