...
GKYL_CU_DH void rad_curvature_1v_tensor_p3(const double *w, const double *dxv, const double *vmap, 
...
{ 
  ...
  rad_nodal_vx[1] = -1.0/t_cool*(pow(0.8366600265340755*vmap_vx[3]-0.3162277660168379*vmap_vx[2]-0.5477225575051661*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 3.0)*fabs(0.8366600265340755*vmap_vx[3]-0.3162277660168379*vmap_vx[2]-0.5477225575051661*vmap_vx[1]+0.7071067811865475*vmap_vx[0]));

  rad_nodal_vx[2] = -1.0/t_cool*(pow(-(0.8366600265340755*vmap_vx[3])-0.3162277660168379*vmap_vx[2]+0.5477225575051661*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 3.0)*fabs(-(0.8366600265340755*vmap_vx[3])-0.3162277660168379*vmap_vx[2]+0.5477225575051661*vmap_vx[1]+0.7071067811865475*vmap_vx[0]));

  rad_nodal_vx[3] = -1.0/t_cool*(pow(1.8708286933869707*vmap_vx[3]+1.5811388300841895*vmap_vx[2]+1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 3.0)*fabs(1.8708286933869707*vmap_vx[3]+1.5811388300841895*vmap_vx[2]+1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0]));
