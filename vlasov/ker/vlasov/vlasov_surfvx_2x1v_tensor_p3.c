...
GKYL_CU_DH void vlasov_surfvx_2x1v_tensor_p3_mode(int m, double dv10,
...
{ 
  ...
  out[m] += dv10*(vst_2x1v_tensor_p3_prj_v0_pm_cl[m]*g_l + vst_2x1v_tensor_p3_prj_v0_pm_cr[m]*g_r); 
} 
