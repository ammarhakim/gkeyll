...
GKYL_CU_DH void vlasov_ho_surfvz_2x3v_ser_p2_mode(int m, double dv12,
...
{ 
  ...
  out[m] += dv12*(vst_2x3v_ser_p2_ho_prj_v2_pm_cl[m]*g_l + vst_2x3v_ser_p2_ho_prj_v2_pm_cr[m]*g_r); 
} 
