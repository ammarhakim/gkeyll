...
GKYL_CU_DH void vlasov_ho_surfx_2x3v_ser_p2_mode(int m, double dx10,
...
{ 
  ...
  out[m] += dx10*(vst_2x3v_ser_p2_ho_prj_x0_pm_cl[m]*g_l + vst_2x3v_ser_p2_ho_prj_x0_pm_cr[m]*g_r); 
} 
