...
{ 
  ...
  alpha_quad[4] += 0.8660254037844386*rad_vy[3]-0.8660254037844386*rad_vy[2]-0.5*rad_vy[1]+0.5*rad_vy[0]; 
  alpha_quad[5] += -(0.8660254037844386*rad_vy[3])-0.8660254037844386*rad_vy[2]+0.5*rad_vy[1]+0.5*rad_vy[0]; 
  alpha_quad[6] += 0.8660254037844386*rad_vy[3]-0.8660254037844386*rad_vy[2]-0.5*rad_vy[1]+0.5*rad_vy[0]; 
  alpha_quad[7] += -(0.8660254037844386*rad_vy[3])-0.8660254037844386*rad_vy[2]+0.5*rad_vy[1]+0.5*rad_vy[0]; 
