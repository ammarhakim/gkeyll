...
GKYL_CU_DH void rad_curvature_1v_tensor_p2(const double *w, const double *dxv, const double *vmap, 
...
{ 
  ...
  rad_nodal_vx[1] = -1.0/t_cool*(pow(0.7071067811865475*vmap_vx[0]-0.7905694150420947*vmap_vx[2], 3.0)*fabs(0.7071067811865475*vmap_vx[0]-0.7905694150420947*vmap_vx[2]));

  rad_nodal_vx[2] = -1.0/t_cool*(pow(1.8708286933869707*vmap_vx[3]+1.5811388300841895*vmap_vx[2]+1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 3.0)*fabs(1.8708286933869707*vmap_vx[3]+1.5811388300841895*vmap_vx[2]+1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0]));
