...
{ 
  ...
  alpha_quad[9] += 1.58113883008419*rad_vx[2]-1.224744871391589*rad_vx[1]+0.7071067811865475*rad_vx[0]; 
  alpha_quad[10] += 1.58113883008419*rad_vx[2]-1.224744871391589*rad_vx[1]+0.7071067811865475*rad_vx[0]; 
  alpha_quad[11] += 1.58113883008419*rad_vx[2]-1.224744871391589*rad_vx[1]+0.7071067811865475*rad_vx[0]; 
  alpha_quad[12] += 1.58113883008419*rad_vx[2]-1.224744871391589*rad_vx[1]+0.7071067811865475*rad_vx[0]; 
  alpha_quad[13] += 1.58113883008419*rad_vx[2]-1.224744871391589*rad_vx[1]+0.7071067811865475*rad_vx[0]; 
  alpha_quad[14] += 1.58113883008419*rad_vx[2]-1.224744871391589*rad_vx[1]+0.7071067811865475*rad_vx[0]; 
  alpha_quad[15] += 1.58113883008419*rad_vx[2]-1.224744871391589*rad_vx[1]+0.7071067811865475*rad_vx[0]; 
