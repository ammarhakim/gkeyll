...
{ 
  ...
  alpha_quad[4] += 0.8660254037844386*rad_vx[3]-0.5*rad_vx[2]-0.8660254037844386*rad_vx[1]+0.5*rad_vx[0]; 
  alpha_quad[5] += -(0.8660254037844386*rad_vx[3])+0.5*rad_vx[2]-0.8660254037844386*rad_vx[1]+0.5*rad_vx[0]; 
  alpha_quad[6] += 0.8660254037844386*rad_vx[3]-0.5*rad_vx[2]-0.8660254037844386*rad_vx[1]+0.5*rad_vx[0]; 
  alpha_quad[7] += -(0.8660254037844386*rad_vx[3])+0.5*rad_vx[2]-0.8660254037844386*rad_vx[1]+0.5*rad_vx[0]; 
