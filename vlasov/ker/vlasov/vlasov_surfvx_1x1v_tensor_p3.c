...
{ 
  ...
  out[10] += ((-0.5325080420189123*Fhat_r_nodal_c[3])+0.5325080420189123*(Fhat_l_nodal_c[3]+Fhat_r_nodal_c[2])-0.5325080420189123*Fhat_l_nodal_c[2]+0.5325080420189123*Fhat_r_nodal_c[1]-0.5325080420189123*(Fhat_l_nodal_c[1]+Fhat_r_nodal_c[0])+0.5325080420189123*Fhat_l_nodal_c[0])*dv10; 
  out[11] += ((-0.2428941897088658*(Fhat_r_nodal_c[3]+Fhat_l_nodal_c[3]))+0.6152254973630996*(Fhat_r_nodal_c[2]+Fhat_l_nodal_c[2])-0.6152254973630996*(Fhat_r_nodal_c[1]+Fhat_l_nodal_c[1])+0.2428941897088658*(Fhat_r_nodal_c[0]+Fhat_l_nodal_c[0]))*dv10; 
  out[12] += ((-0.6863562790104827*(Fhat_r_nodal_c[3]+Fhat_l_nodal_c[3]))-0.5080174454972501*(Fhat_r_nodal_c[2]+Fhat_l_nodal_c[2])+0.5080174454972501*(Fhat_r_nodal_c[1]+Fhat_l_nodal_c[1])+0.6863562790104827*(Fhat_r_nodal_c[0]+Fhat_l_nodal_c[0]))*dv10; 
  out[13] += ((-0.3135750505443275*Fhat_r_nodal_c[3])+0.3135750505443275*Fhat_l_nodal_c[3]+0.7942527018164868*Fhat_r_nodal_c[2]-0.7942527018164868*(Fhat_l_nodal_c[2]+Fhat_r_nodal_c[1])+0.7942527018164868*Fhat_l_nodal_c[1]+0.3135750505443275*Fhat_r_nodal_c[0]-0.3135750505443275*Fhat_l_nodal_c[0])*dv10; 
  out[14] += ((-0.6300720123452096*(Fhat_r_nodal_c[3]+Fhat_l_nodal_c[3]))+0.6300720123452096*(Fhat_r_nodal_c[2]+Fhat_l_nodal_c[2]+Fhat_r_nodal_c[1]+Fhat_l_nodal_c[1])-0.6300720123452096*(Fhat_r_nodal_c[0]+Fhat_l_nodal_c[0]))*dv10; 
  out[15] += ((-0.3710270034019472*(Fhat_r_nodal_c[3]+Fhat_l_nodal_c[3]))+0.9397724703777529*(Fhat_r_nodal_c[2]+Fhat_l_nodal_c[2])-0.9397724703777529*(Fhat_r_nodal_c[1]+Fhat_l_nodal_c[1])+0.3710270034019472*(Fhat_r_nodal_c[0]+Fhat_l_nodal_c[0]))*dv10; 
