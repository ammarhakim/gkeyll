...
{ 
  ...
  out[10] += -(1.5*phi[3]*f[6]*dv11*dx11)-1.5*phi[2]*f[3]*dv11*dx11; 
  out[12] += -(1.5*phi[2]*f[5]*dv11*dx11)-1.5*f[2]*phi[3]*dv11*dx11; 
  out[13] += -(1.5*phi[2]*f[6]*dv11*dx11)-1.5*f[3]*phi[3]*dv11*dx11; 
  out[14] += -(1.5*phi[3]*f[11]*dv11*dx11)-1.5*phi[2]*f[7]*dv11*dx11; 
  out[15] += -(1.5*phi[2]*f[11]*dv11*dx11)-1.5*phi[3]*f[7]*dv11*dx11; 
