...
{ 
  ...
  fUpwind[0] = (1.5811388300841895*fskin[4]+1.224744871391589*fskin[1]+0.7071067811865475*fskin[0])*jacob_vx_inv; 
  fUpwind[1] = (1.5811388300841898*fskin[6]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[2])*jacob_vx_inv; 
  fUpwind[2] = (1.224744871391589*fskin[7]+0.7071067811865475*fskin[5])*jacob_vx_inv; 

  } else { 

  fUpwind[0] = (1.5811388300841895*fedge[4]-1.224744871391589*fedge[1]+0.7071067811865475*fedge[0])*jacob_vx_inv; 
  fUpwind[1] = (1.5811388300841898*fedge[6]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[2])*jacob_vx_inv; 
