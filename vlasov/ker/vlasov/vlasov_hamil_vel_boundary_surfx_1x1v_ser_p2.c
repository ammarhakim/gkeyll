...
{ 
  ...
  fUpwind[0] = 1.58113883008419*fskin[4]+1.224744871391589*fskin[1]+0.7071067811865475*fskin[0]; 
  fUpwind[1] = 1.58113883008419*fskin[6]+1.224744871391589*fskin[3]+0.7071067811865475*fskin[2]; 
  fUpwind[2] = 1.224744871391589*fskin[7]+0.7071067811865475*fskin[5]; 

  } else { 

  fUpwind[0] = 1.58113883008419*fedge[4]-1.224744871391589*fedge[1]+0.7071067811865475*fedge[0]; 
  fUpwind[1] = 1.58113883008419*fedge[6]-1.224744871391589*fedge[3]+0.7071067811865475*fedge[2]; 
  fUpwind[2] = 0.7071067811865475*fedge[5]-1.224744871391589*fedge[7]; 

  } 
  Ghat[0] = 2.738612787525831*fUpwind[1]*hamil[2]+1.224744871391589*fUpwind[0]*hamil[1]; 
  Ghat[1] = 2.449489742783178*fUpwind[2]*hamil[2]+2.738612787525831*fUpwind[0]*hamil[2]+1.224744871391589*fUpwind[1]*hamil[1]; 
  Ghat[2] = 2.449489742783178*fUpwind[1]*hamil[2]+1.224744871391589*hamil[1]*fUpwind[2]; 
