...
{ 
  ...
  hamil_nodal[0] = 0.5*(pow(0.7071067811865475*vmap_vx[0]-1.224744871391589*vmap_vx[1], 2.0) + pow(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1], 2.0) + pow(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1], 2.0));
  hamil_inv_nodal[0] = 1.0/hamil_nodal[0];
  hamil_nodal[1] = 0.5*(pow(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1], 2.0) + pow(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1], 2.0));
  hamil_inv_nodal[1] = 1.0/hamil_nodal[1];
  hamil_nodal[2] = 0.5*(pow(0.7071067811865475*vmap_vx[0]-1.224744871391589*vmap_vx[1], 2.0) + pow(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0) + pow(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1], 2.0));
  hamil_inv_nodal[2] = 1.0/hamil_nodal[2];
  hamil_nodal[3] = 0.5*(pow(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0) + pow(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1], 2.0));
  hamil_inv_nodal[3] = 1.0/hamil_nodal[3];
  hamil_nodal[4] = 0.5*(pow(0.7071067811865475*vmap_vx[0]-1.224744871391589*vmap_vx[1], 2.0) + pow(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1], 2.0) + pow(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0], 2.0));
  hamil_inv_nodal[4] = 1.0/hamil_nodal[4];
  hamil_nodal[5] = 0.5*(pow(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1], 2.0) + pow(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0], 2.0));
  hamil_inv_nodal[5] = 1.0/hamil_nodal[5];
  hamil_nodal[6] = 0.5*(pow(0.7071067811865475*vmap_vx[0]-1.224744871391589*vmap_vx[1], 2.0) + pow(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0) + pow(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0], 2.0));
  hamil_inv_nodal[6] = 1.0/hamil_nodal[6];
  hamil_nodal[7] = 0.5*(pow(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0) + pow(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0], 2.0));
