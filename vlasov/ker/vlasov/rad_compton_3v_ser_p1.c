...
{ 
  ...
  rad_nodal_vy[0] = -1.0/t_cool*(wx2-0.5*dv2 - p0);
  rad_nodal_vz[0] = -1.0/t_cool*(wx3-0.5*dv3 - p0);

  rad_nodal_vx[1] = -1.0/t_cool*(wx1+0.5*dv1 - p0);
  rad_nodal_vy[1] = -1.0/t_cool*(wx2-0.5*dv2 - p0);
  rad_nodal_vz[1] = -1.0/t_cool*(wx3-0.5*dv3 - p0);

  rad_nodal_vx[2] = -1.0/t_cool*(wx1-0.5*dv1 - p0);
  rad_nodal_vy[2] = -1.0/t_cool*(wx2+0.5*dv2 - p0);
  rad_nodal_vz[2] = -1.0/t_cool*(wx3-0.5*dv3 - p0);

  rad_nodal_vx[3] = -1.0/t_cool*(wx1+0.5*dv1 - p0);
  rad_nodal_vy[3] = -1.0/t_cool*(wx2+0.5*dv2 - p0);
  rad_nodal_vz[3] = -1.0/t_cool*(wx3-0.5*dv3 - p0);

  rad_nodal_vx[4] = -1.0/t_cool*(wx1-0.5*dv1 - p0);
  rad_nodal_vy[4] = -1.0/t_cool*(wx2-0.5*dv2 - p0);
  rad_nodal_vz[4] = -1.0/t_cool*(wx3+0.5*dv3 - p0);

  rad_nodal_vx[5] = -1.0/t_cool*(wx1+0.5*dv1 - p0);
  rad_nodal_vy[5] = -1.0/t_cool*(wx2-0.5*dv2 - p0);
  rad_nodal_vz[5] = -1.0/t_cool*(wx3+0.5*dv3 - p0);

  rad_nodal_vx[6] = -1.0/t_cool*(wx1-0.5*dv1 - p0);
  rad_nodal_vy[6] = -1.0/t_cool*(wx2+0.5*dv2 - p0);
  rad_nodal_vz[6] = -1.0/t_cool*(wx3+0.5*dv3 - p0);

  rad_nodal_vx[7] = -1.0/t_cool*(wx1+0.5*dv1 - p0);
  rad_nodal_vy[7] = -1.0/t_cool*(wx2+0.5*dv2 - p0);
  rad_nodal_vz[7] = -1.0/t_cool*(wx3+0.5*dv3 - p0);
