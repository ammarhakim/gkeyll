...
GKYL_CU_DH void rad_compton_3v_ser_p1(const double *w, const double *dxv, const double *vmap, 
...
{ 
  ...
  rad_nodal_vy[0] = -1.0/t_cool*(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1] - p0);
  rad_nodal_vz[0] = -1.0/t_cool*(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1] - p0);

  rad_nodal_vx[1] = -1.0/t_cool*(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0] - p0);
  rad_nodal_vy[1] = -1.0/t_cool*(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1] - p0);
  rad_nodal_vz[1] = -1.0/t_cool*(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1] - p0);

  rad_nodal_vx[2] = -1.0/t_cool*(0.7071067811865475*vmap_vx[0]-1.224744871391589*vmap_vx[1] - p0);
  rad_nodal_vy[2] = -1.0/t_cool*(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0] - p0);
  rad_nodal_vz[2] = -1.0/t_cool*(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1] - p0);

  rad_nodal_vx[3] = -1.0/t_cool*(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0] - p0);
  rad_nodal_vy[3] = -1.0/t_cool*(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0] - p0);
  rad_nodal_vz[3] = -1.0/t_cool*(0.7071067811865475*vmap_vz[0]-1.224744871391589*vmap_vz[1] - p0);

  rad_nodal_vx[4] = -1.0/t_cool*(0.7071067811865475*vmap_vx[0]-1.224744871391589*vmap_vx[1] - p0);
  rad_nodal_vy[4] = -1.0/t_cool*(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1] - p0);
  rad_nodal_vz[4] = -1.0/t_cool*(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0] - p0);

  rad_nodal_vx[5] = -1.0/t_cool*(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0] - p0);
  rad_nodal_vy[5] = -1.0/t_cool*(0.7071067811865475*vmap_vy[0]-1.224744871391589*vmap_vy[1] - p0);
  rad_nodal_vz[5] = -1.0/t_cool*(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0] - p0);

  rad_nodal_vx[6] = -1.0/t_cool*(0.7071067811865475*vmap_vx[0]-1.224744871391589*vmap_vx[1] - p0);
  rad_nodal_vy[6] = -1.0/t_cool*(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0] - p0);
  rad_nodal_vz[6] = -1.0/t_cool*(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0] - p0);

  rad_nodal_vx[7] = -1.0/t_cool*(1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0] - p0);
  rad_nodal_vy[7] = -1.0/t_cool*(1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0] - p0);
  rad_nodal_vz[7] = -1.0/t_cool*(1.224744871391589*vmap_vz[1]+0.7071067811865475*vmap_vz[0] - p0);
