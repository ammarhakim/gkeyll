...
{ 
  ...
  out[9] += dv10*dv12*By[1]*(0.75*jacob_vy[0]*hamil[1]*f[5]-0.75*jacob_vy[0]*hamil[3]*f[8]);
  out[9] += dv10*dv12*By[0]*(0.75*jacob_vy[0]*hamil[1]*f[2]-0.75*jacob_vy[0]*hamil[3]*f[4]);
  ...
  out[12] += dv10*dv12*By[0]*(0.75*jacob_vy[0]*hamil[1]*f[5]-0.75*jacob_vy[0]*hamil[3]*f[8]);
  out[12] += dv10*dv12*By[1]*(0.75*jacob_vy[0]*hamil[1]*f[2]-0.75*jacob_vy[0]*hamil[3]*f[4]);
  out[13] += dv10*dv12*0.75*By[0]*jacob_vy[0]*hamil[1]*f[6];
  out[13] += dv10*dv12*0.75*jacob_vy[0]*By[1]*hamil[1]*f[3];
  out[14] += dv10*dv12*By[1]*(0.75*jacob_vy[0]*hamil[1]*f[11]-0.75*jacob_vy[0]*hamil[3]*f[13]);
  out[14] += dv10*dv12*By[0]*(0.75*jacob_vy[0]*hamil[1]*f[7]-0.75*jacob_vy[0]*hamil[3]*f[10]);
  out[15] += dv10*dv12*By[0]*(0.75*jacob_vy[0]*hamil[1]*f[11]-0.75*jacob_vy[0]*hamil[3]*f[13]);
  out[15] += dv10*dv12*By[1]*(0.75*jacob_vy[0]*hamil[1]*f[7]-0.75*jacob_vy[0]*hamil[3]*f[10]);
