...
{ 
  ...
  force_quad = 0.9373811576562242*Ey[8]-1.02111731798518*Ey[7]-1.02111731798518*Ey[6]+0.6846098004178088*Ey[5]+0.6846098004178088*Ey[4]+1.112333620718714*Ey[3]-0.7457659219616816*Ey[2]-0.7457659219616816*Ey[1]+0.5*Ey[0];
  alpha_quad[0] += force_quad;
  alpha_quad[1] += force_quad;
  alpha_quad[2] += force_quad;
  alpha_quad[3] += force_quad;

  force_quad = (-0.5*Ey[8])+0.5446649474682878*Ey[7]-0.4031423674941089*Ey[6]-0.3651715179178389*Ey[5]+0.6846098004178088*Ey[4]+0.4391550328268399*Ey[3]-0.29443222054963*Ey[2]-0.7457659219616816*Ey[1]+0.5*Ey[0];
  ...
  force_quad = (-0.5*Ey[8])-0.4031423674941089*Ey[7]+0.5446649474682878*Ey[6]+0.6846098004178088*Ey[5]-0.3651715179178389*Ey[4]+0.4391550328268399*Ey[3]-0.7457659219616816*Ey[2]-0.29443222054963*Ey[1]+0.5*Ey[0];
  alpha_quad[16] += force_quad;
  alpha_quad[17] += force_quad;
  alpha_quad[18] += force_quad;
  alpha_quad[19] += force_quad;

  force_quad = 0.2667004749968371*Ey[8]+0.2150365218040566*Ey[7]+0.2150365218040566*Ey[6]-0.3651715179178389*Ey[5]-0.3651715179178389*Ey[4]+0.1733806649955719*Ey[3]-0.29443222054963*Ey[2]-0.29443222054963*Ey[1]+0.5*Ey[0];
