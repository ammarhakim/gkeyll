...
{ 
  ...
  alpha_l_quad = 1.9751113797455495*hamil[7]+1.9364916731037085*hamil[6]-1.140331086775586*hamil[5]-1.5*hamil[3]+0.8660254037844386*hamil[2]; 
  alpha_r_quad = -(1.9751113797455495*hamil[7])+1.9364916731037085*hamil[6]-1.140331086775586*hamil[5]+1.5*hamil[3]+0.8660254037844386*hamil[2]; 
  alpha_max = fmax(alpha_max, fmax(fabs(alpha_l_quad), fabs(alpha_r_quad))); 
  ...
  f_cr_quad = -(0.6324956225107456*fl[7])-0.6583704599151832*fl[6]-0.3651715179178389*fl[5]+1.118033988749895*fl[4]-0.5099715653772844*fl[3]-0.29443222054963*fl[2]+0.8660254037844386*fl[1]+0.5*fl[0]; 
  ...
  Ghat_l[0] = 0.24597051986529*Ghat_l_nodal[3]+0.46113626132125757*Ghat_l_nodal[2]+0.46113626132125757*Ghat_l_nodal[1]+0.24597051986529*Ghat_l_nodal[0]; 
  ...
  Ghat_r[0] = 0.24597051986529*Ghat_r_nodal[3]+0.46113626132125757*Ghat_r_nodal[2]+0.46113626132125757*Ghat_r_nodal[1]+0.24597051986529*Ghat_r_nodal[0]; 
  ...
  return 2.5*dv10*dx10*alpha_max;
