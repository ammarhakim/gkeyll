...
{ 
  ...
  f_cr_quad = 1.1857789576832338*fc[7]-1.6675832968091233*fc[6]+0.6846098004178088*fc[5]+1.118033988749895*fc[4]-1.291704467391079*fc[3]-0.7457659219616816*fc[2]+0.8660254037844386*fc[1]+0.5*fc[0]; 
