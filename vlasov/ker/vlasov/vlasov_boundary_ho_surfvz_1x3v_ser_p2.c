...
GKYL_CU_DH void vlasov_boundary_ho_surfvz_1x3v_ser_p2_mode(int m, int edge, double dv12,
...
{ 
  ...
  if (edge == -1) { 
    out[m] += dv12*vst_1x3v_ser_p2_ho_prj_v2_pm_cr[m]*g; 
  } else { 
    out[m] += dv12*vst_1x3v_ser_p2_ho_prj_v2_pm_cl[m]*g; 
  } 
} 
