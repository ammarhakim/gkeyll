...
{ 
  ...
  out[10] += -(1.5811388300841895*Ghat[2]*dv10); 
  out[11] += -(1.2247448713915887*Ghat[3]*dv10); 
  out[12] += -(1.8708286933869707*Ghat[1]*dv10); 
  out[13] += -(1.5811388300841895*Ghat[3]*dv10); 
  out[14] += -(1.8708286933869704*Ghat[2]*dv10); 
  out[15] += -(1.8708286933869707*Ghat[3]*dv10); 
