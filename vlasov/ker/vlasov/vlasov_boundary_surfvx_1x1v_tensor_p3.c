...
{ 
  ...
  out[8] += ((-0.1402350258130098*Fhat_nodal[3])+0.355200606514907*Fhat_nodal[2]-0.355200606514907*Fhat_nodal[1]+0.1402350258130098*Fhat_nodal[0])*dv10; 
  out[9] += ((-0.4601687062912942*Fhat_nodal[3])-0.8627069492410011*(Fhat_nodal[2]+Fhat_nodal[1])-0.4601687062912942*Fhat_nodal[0])*dv10; 
  out[10] += ((-0.5325080420189123*Fhat_nodal[3])+0.5325080420189123*(Fhat_nodal[2]+Fhat_nodal[1])-0.5325080420189123*Fhat_nodal[0])*dv10; 
  out[11] += ((-0.2428941897088658*Fhat_nodal[3])+0.6152254973630996*Fhat_nodal[2]-0.6152254973630996*Fhat_nodal[1]+0.2428941897088658*Fhat_nodal[0])*dv10; 
  out[12] += ((-0.6863562790104827*Fhat_nodal[3])-0.5080174454972501*Fhat_nodal[2]+0.5080174454972501*Fhat_nodal[1]+0.6863562790104827*Fhat_nodal[0])*dv10; 
  out[13] += ((-0.3135750505443275*Fhat_nodal[3])+0.7942527018164868*Fhat_nodal[2]-0.7942527018164868*Fhat_nodal[1]+0.3135750505443275*Fhat_nodal[0])*dv10; 
  out[14] += ((-0.6300720123452096*Fhat_nodal[3])+0.6300720123452096*(Fhat_nodal[2]+Fhat_nodal[1])-0.6300720123452096*Fhat_nodal[0])*dv10; 
  out[15] += ((-0.3710270034019472*Fhat_nodal[3])+0.9397724703777529*Fhat_nodal[2]-0.9397724703777529*Fhat_nodal[1]+0.3710270034019472*Fhat_nodal[0])*dv10; 
