...
GKYL_CU_DH void phi_alpha_quad_vx_2x1v_ser_p2(const double *dxv, const double *phi, double* GKYL_RESTRICT alpha_quad) 
{ 
  double dx10 = 2.0/dxv[0]; 

  double force_quad = 0.0;
  force_quad = 0.7745966692414833*phi[7]+3.485685011586675*phi[6]-2.598076211353316*phi[4]-1.161895003862225*phi[3]+0.8660254037844386*phi[1];
  alpha_quad[0] -= dx10*force_quad;

  force_quad = (-0.9682458365518543*phi[7])-2.598076211353316*phi[4]+0.8660254037844386*phi[1];
