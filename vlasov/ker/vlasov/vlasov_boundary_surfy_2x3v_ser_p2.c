...
GKYL_CU_DH void vlasov_boundary_surfy_2x3v_ser_p2_mode(int m, int edge, double dx11,
...
{ 
  ...
  if (edge == -1) { 
    out[m] += dx11*vst_2x3v_ser_p2_prj_x1_pm_cr[m]*g; 
  } else { 
    out[m] += dx11*vst_2x3v_ser_p2_prj_x1_pm_cl[m]*g; 
  } 
} 
