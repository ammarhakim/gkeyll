...
GKYL_CU_DH void phi_alpha_quad_vy_2x3v_ser_p2(const double *dxv, const double *jacob_pos, const double *phi, double* GKYL_RESTRICT alpha_quad) 
{ 
  ...
  force_quad = jacob_cy_inv*(3.4856850115866753*phi[7]+0.7745966692414833*phi[6]-2.5980762113533156*phi[5]-1.1618950038622249*phi[3]+0.8660254037844386*phi[2]);
  ...
  force_quad = jacob_cy_inv*(0.7745966692414833*phi[6]-1.1618950038622249*phi[3]+0.8660254037844386*phi[2]);
  ...
  force_quad = jacob_cy_inv*(-(0.9682458365518543*phi[6])-2.5980762113533156*phi[5]+0.8660254037844386*phi[2]);
  ...
  force_quad = jacob_cy_inv*(0.8660254037844386*phi[2]-0.9682458365518543*phi[6]);
