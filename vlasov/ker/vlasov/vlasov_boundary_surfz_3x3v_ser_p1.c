...
GKYL_CU_DH void vlasov_boundary_surfz_3x3v_ser_p1_mode(int m, int edge, double dx12,
...
{ 
  ...
  if (edge == -1) { 
    out[m] += dx12*vst_3x3v_ser_p1_prj_x2_pm_cr[m]*g; 
  } else { 
    out[m] += dx12*vst_3x3v_ser_p1_prj_x2_pm_cl[m]*g; 
  } 
} 
