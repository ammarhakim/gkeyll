...
{ 
  ...
  hamil_nodal[0] = sqrt(1.0 + pow((-1.870828693386971*vmap_vx[3])+1.58113883008419*vmap_vx[2]-1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow((-1.870828693386971*vmap_vy[3])+1.58113883008419*vmap_vy[2]-1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0));
  hamil_inv_nodal[0] = 1.0/hamil_nodal[0];
  hamil_nodal[1] = sqrt(1.0 + pow(0.7071067811865475*vmap_vx[0]-0.7905694150420947*vmap_vx[2], 2.0) + pow((-1.870828693386971*vmap_vy[3])+1.58113883008419*vmap_vy[2]-1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0));
  hamil_inv_nodal[1] = 1.0/hamil_nodal[1];
  hamil_nodal[2] = sqrt(1.0 + pow(1.870828693386971*vmap_vx[3]+1.58113883008419*vmap_vx[2]+1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow((-1.870828693386971*vmap_vy[3])+1.58113883008419*vmap_vy[2]-1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0));
  hamil_inv_nodal[2] = 1.0/hamil_nodal[2];
  hamil_nodal[3] = sqrt(1.0 + pow((-1.870828693386971*vmap_vx[3])+1.58113883008419*vmap_vx[2]-1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(0.7071067811865475*vmap_vy[0]-0.7905694150420947*vmap_vy[2], 2.0));
  ...
  hamil_nodal[5] = sqrt(1.0 + pow(1.870828693386971*vmap_vx[3]+1.58113883008419*vmap_vx[2]+1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(0.7071067811865475*vmap_vy[0]-0.7905694150420947*vmap_vy[2], 2.0));
  hamil_inv_nodal[5] = 1.0/hamil_nodal[5];
  hamil_nodal[6] = sqrt(1.0 + pow((-1.870828693386971*vmap_vx[3])+1.58113883008419*vmap_vx[2]-1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(1.870828693386971*vmap_vy[3]+1.58113883008419*vmap_vy[2]+1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0));
  hamil_inv_nodal[6] = 1.0/hamil_nodal[6];
  hamil_nodal[7] = sqrt(1.0 + pow(0.7071067811865475*vmap_vx[0]-0.7905694150420947*vmap_vx[2], 2.0) + pow(1.870828693386971*vmap_vy[3]+1.58113883008419*vmap_vy[2]+1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0));
  hamil_inv_nodal[7] = 1.0/hamil_nodal[7];
  hamil_nodal[8] = sqrt(1.0 + pow(1.870828693386971*vmap_vx[3]+1.58113883008419*vmap_vx[2]+1.224744871391589*vmap_vx[1]+0.7071067811865475*vmap_vx[0], 2.0) + pow(1.870828693386971*vmap_vy[3]+1.58113883008419*vmap_vy[2]+1.224744871391589*vmap_vy[1]+0.7071067811865475*vmap_vy[0], 2.0));
