...
{ 
  ...
  const double *Ghat_l = &flux_l[27]; 
  const double *Ghat_r = &flux_r[27]; 
  ...
  out[13] += (1.5811388300841895*Ghat_l[0]-1.5811388300841895*Ghat_r[0])*dv11; 
  ...
  out[23] += (1.5811388300841898*Ghat_l[1]-1.5811388300841898*Ghat_r[1])*dv11; 
  out[24] += (1.5811388300841898*Ghat_l[2]-1.5811388300841898*Ghat_r[2])*dv11; 
  ...
  out[34] += (1.5811388300841895*Ghat_l[4]-1.5811388300841895*Ghat_r[4])*dv11; 
  ...
  out[39] += (1.5811388300841895*Ghat_l[5]-1.5811388300841895*Ghat_r[5])*dv11; 
  out[40] += (1.5811388300841895*Ghat_l[6]-1.5811388300841895*Ghat_r[6])*dv11; 
  ...
  out[45] += (1.5811388300841895*Ghat_l[7]-1.5811388300841895*Ghat_r[7])*dv11; 
  out[46] += (1.5811388300841895*Ghat_l[8]-1.5811388300841895*Ghat_r[8])*dv11; 
  ...
  out[49] += (1.5811388300841895*Ghat_l[9]-1.5811388300841895*Ghat_r[9])*dv11; 
  out[50] += -(1.224744871391589*(Ghat_r[17]+Ghat_l[17])*dv11); 
  out[51] += -(1.224744871391589*(Ghat_r[18]+Ghat_l[18])*dv11); 
  out[52] += (1.5811388300841898*Ghat_l[10]-1.5811388300841898*Ghat_r[10])*dv11; 
  out[53] += -(1.224744871391589*(Ghat_r[19]+Ghat_l[19])*dv11); 
  out[54] += -(1.224744871391589*(Ghat_r[20]+Ghat_l[20])*dv11); 
  out[55] += (1.5811388300841898*Ghat_l[11]-1.5811388300841898*Ghat_r[11])*dv11; 
  out[56] += (1.5811388300841898*Ghat_l[12]-1.5811388300841898*Ghat_r[12])*dv11; 
  out[57] += (0.7071067811865475*Ghat_l[23]-0.7071067811865475*Ghat_r[23])*dv11; 
  out[58] += (1.5811388300841898*Ghat_l[13]-1.5811388300841898*Ghat_r[13])*dv11; 
  out[59] += (1.5811388300841898*Ghat_l[14]-1.5811388300841898*Ghat_r[14])*dv11; 
  ...
  out[64] += (1.5811388300841898*Ghat_l[15]-1.5811388300841898*Ghat_r[15])*dv11; 
  out[65] += (1.5811388300841898*Ghat_l[16]-1.5811388300841898*Ghat_r[16])*dv11; 
  out[66] += -(1.224744871391589*(Ghat_r[23]+Ghat_l[23])*dv11); 
  out[67] += (1.5811388300841895*Ghat_l[17]-1.5811388300841895*Ghat_r[17])*dv11; 
  out[68] += (1.5811388300841895*Ghat_l[18]-1.5811388300841895*Ghat_r[18])*dv11; 
  out[69] += -(1.224744871391589*(Ghat_r[24]+Ghat_l[24])*dv11); 
  out[70] += -(1.224744871391589*(Ghat_r[25]+Ghat_l[25])*dv11); 
  out[71] += (1.5811388300841895*Ghat_l[19]-1.5811388300841895*Ghat_r[19])*dv11; 
  out[72] += (1.5811388300841895*Ghat_l[20]-1.5811388300841895*Ghat_r[20])*dv11; 
  out[73] += (0.7071067811865475*Ghat_l[26]-0.7071067811865475*Ghat_r[26])*dv11; 
  out[74] += (1.5811388300841895*Ghat_l[21]-1.5811388300841895*Ghat_r[21])*dv11; 
  out[75] += (1.5811388300841895*Ghat_l[22]-1.5811388300841895*Ghat_r[22])*dv11; 
  out[76] += (1.5811388300841898*Ghat_l[23]-1.5811388300841898*Ghat_r[23])*dv11; 
  out[77] += -(1.224744871391589*(Ghat_r[26]+Ghat_l[26])*dv11); 
  out[78] += (1.5811388300841898*Ghat_l[24]-1.5811388300841898*Ghat_r[24])*dv11; 
  out[79] += (1.5811388300841898*Ghat_l[25]-1.5811388300841898*Ghat_r[25])*dv11; 
  out[80] += (1.5811388300841895*Ghat_l[26]-1.5811388300841895*Ghat_r[26])*dv11; 
