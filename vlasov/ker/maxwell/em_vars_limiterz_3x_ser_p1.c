...
GKYL_CU_DH void em_vars_limiterz_3x_ser_p1(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, 
...
{ 
  ...
  ex_c[3] = slope[0]*norm[0] + slope[1]*tau1[0] + slope[2]*tau2[0]; 
  ey_c[3] = slope[0]*norm[1] + slope[1]*tau1[1] + slope[2]*tau2[1]; 
  ez_c[3] = slope[0]*norm[2] + slope[1]*tau1[2] + slope[2]*tau2[2]; 
  bx_c[3] = slope[3]*norm[0] + slope[4]*tau1[0] + slope[5]*tau2[0]; 
  by_c[3] = slope[3]*norm[1] + slope[4]*tau1[1] + slope[5]*tau2[1]; 
  bz_c[3] = slope[3]*norm[2] + slope[4]*tau1[2] + slope[5]*tau2[2]; 
  phi_c[3] = slope[6]; 
  psi_c[3] = slope[7]; 
  for (int i = 0; i < 6; ++i) { 
