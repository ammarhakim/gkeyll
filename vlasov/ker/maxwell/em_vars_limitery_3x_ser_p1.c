...
GKYL_CU_DH void em_vars_limitery_3x_ser_p1(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, 
...
{ 
  ...
  double *by_l = &em_l[32]; 
  double *bz_l = &em_l[40]; 
  double *phi_l = &em_l[48]; 
  double *psi_l = &em_l[56]; 
  ...
  double *by_c = &em_c[32]; 
  double *bz_c = &em_c[40]; 
  double *phi_c = &em_c[48]; 
  double *psi_c = &em_c[56]; 
  ...
  double *by_r = &em_r[32]; 
  double *bz_r = &em_r[40]; 
  double *phi_r = &em_r[48]; 
  double *psi_r = &em_r[56]; 
