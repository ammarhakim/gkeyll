...
GKYL_CU_DH void em_vars_limiterx_1x_ser_p1(double limiter_fac, const struct gkyl_wv_eqn *wv_eqn, 
...
{ 
  ...
  double *by_l = &em_l[8]; 
  double *bz_l = &em_l[10]; 
  double *phi_l = &em_l[12]; 
  double *psi_l = &em_l[14]; 
  ...
  double *by_c = &em_c[8]; 
  double *bz_c = &em_c[10]; 
  double *phi_c = &em_c[12]; 
  double *psi_c = &em_c[14]; 
  ...
  double *by_r = &em_r[8]; 
  double *bz_r = &em_r[10]; 
  double *phi_r = &em_r[12]; 
  double *psi_r = &em_r[14]; 
