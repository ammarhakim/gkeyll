...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvx_2x2v_tensor_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf[20] = -(0.7071067811865475*(2.0*sumNuUx[8]+(-(2.0*w[2])-1.0*dxv[2])*nuSum[8])); 
  ...
  alphaDrSurf[20] = -(0.7071067811865475*(2.0*sumNuUx[8]+(dxv[2]-2.0*w[2])*nuSum[8])); 
