...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvz_2x3v_ser_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  out[103] += 1.5811388300841898*Ghat[15]*rdv2; 
  out[104] += 1.5811388300841898*Ghat[16]*rdv2; 
  out[105] += 1.5811388300841898*Ghat[17]*rdv2; 
  out[106] += 1.5811388300841898*Ghat[18]*rdv2; 
  ...
  out[111] += 1.5811388300841895*Ghat[31]*rdv2; 
