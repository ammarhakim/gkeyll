...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvx_2x2v_ser_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  if (-(0.42426406871192823*alphaDrSurf[12])-0.42426406871192857*alphaDrSurf[11]+0.31622776601683783*alphaDrSurf[8]+0.31622776601683783*alphaDrSurf[7]+0.6363961030678927*alphaDrSurf[4]-0.4743416490252568*alphaDrSurf[2]-0.4743416490252568*alphaDrSurf[1]+0.3535533905932734*alphaDrSurf[0] < 0) { 
  ...
  if (0.5303300858899102*alphaDrSurf[12]-0.3952847075210471*alphaDrSurf[8]+0.31622776601683783*alphaDrSurf[7]-0.4743416490252568*alphaDrSurf[1]+0.3535533905932734*alphaDrSurf[0] < 0) { 
  ...
  if (0.5303300858899102*alphaDrSurf[11]+0.31622776601683783*alphaDrSurf[8]-0.3952847075210471*alphaDrSurf[7]-0.4743416490252568*alphaDrSurf[2]+0.3535533905932734*alphaDrSurf[0] < 0) { 
  ...
  if (-(0.3952847075210471*alphaDrSurf[8])-0.3952847075210471*alphaDrSurf[7]+0.3535533905932734*alphaDrSurf[0] < 0) { 
  ...
  out[46] += 1.5811388300841898*Ghat[10]*rdv2; 
