...
GKYL_CU_DH double lbo_vlasov_diff_boundary_surfvy_1x2v_tensor_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  vol_incr[9] = 4.743416490252569*facDiff[2]*fSkin[7]+4.743416490252569*fSkin[1]*facDiff[1]+4.743416490252569*fSkin[0]*facDiff[0]; 
  vol_incr[15] = 4.242640687119286*facDiff[1]*fSkin[7]+4.242640687119286*fSkin[1]*facDiff[2]+4.743416490252569*fSkin[0]*facDiff[1]+4.743416490252569*facDiff[0]*fSkin[1]; 
  vol_incr[16] = 4.743416490252569*facDiff[2]*fSkin[11]+4.743416490252569*facDiff[1]*fSkin[4]+4.743416490252569*facDiff[0]*fSkin[2]; 
  vol_incr[19] = 4.242640687119286*facDiff[1]*fSkin[11]+4.242640687119286*facDiff[2]*fSkin[4]+4.743416490252569*facDiff[0]*fSkin[4]+4.743416490252569*facDiff[1]*fSkin[2]; 
  vol_incr[21] = 3.0304576336566322*facDiff[2]*fSkin[7]+4.743416490252569*facDiff[0]*fSkin[7]+4.743416490252569*fSkin[0]*facDiff[2]+4.242640687119286*fSkin[1]*facDiff[1]; 
  vol_incr[22] = 4.743416490252569*facDiff[2]*fSkin[20]+4.743416490252569*facDiff[1]*fSkin[12]+4.743416490252569*facDiff[0]*fSkin[8]; 
  vol_incr[24] = 3.0304576336566327*facDiff[2]*fSkin[11]+4.743416490252569*facDiff[0]*fSkin[11]+4.242640687119286*facDiff[1]*fSkin[4]+4.743416490252569*fSkin[2]*facDiff[2]; 
  vol_incr[25] = 4.242640687119286*facDiff[1]*fSkin[20]+4.242640687119286*facDiff[2]*fSkin[12]+4.743416490252569*facDiff[0]*fSkin[12]+4.743416490252569*facDiff[1]*fSkin[8]; 
  vol_incr[26] = 3.0304576336566322*facDiff[2]*fSkin[20]+4.743416490252569*facDiff[0]*fSkin[20]+4.242640687119286*facDiff[1]*fSkin[12]+4.743416490252569*facDiff[2]*fSkin[8]; 
  ...
  edgeSurf[0] = -(0.6708203932499369*fSkin[9])+0.6708203932499369*fEdge[9]-1.190784930203603*fSkin[3]-1.190784930203603*fEdge[3]-0.9375*fSkin[0]+0.9375*fEdge[0]; 
  edgeSurf[1] = -(0.6708203932499369*fSkin[15])+0.6708203932499369*fEdge[15]-1.190784930203603*fSkin[5]-1.190784930203603*fEdge[5]-0.9375*fSkin[1]+0.9375*fEdge[1]; 
  edgeSurf[2] = -(0.6708203932499369*fSkin[16])+0.6708203932499369*fEdge[16]-1.190784930203603*fSkin[6]-1.190784930203603*fEdge[6]-0.9375*fSkin[2]+0.9375*fEdge[2]; 
  edgeSurf[3] = -(1.5855025573536612*fSkin[9])+0.7382874503707888*fEdge[9]-2.671875*fSkin[3]-1.453125*fEdge[3]-2.0568103339880417*fSkin[0]+1.190784930203603*fEdge[0]; 
  ...
  edgeSurf[5] = -(1.5855025573536612*fSkin[15])+0.7382874503707888*fEdge[15]-2.671875*fSkin[5]-1.453125*fEdge[5]-2.0568103339880417*fSkin[1]+1.190784930203603*fEdge[1]; 
  edgeSurf[6] = -(1.5855025573536612*fSkin[16])+0.7382874503707888*fEdge[16]-2.671875*fSkin[6]-1.453125*fEdge[6]-2.0568103339880417*fSkin[2]+1.190784930203603*fEdge[2]; 
  edgeSurf[7] = -(0.6708203932499369*fSkin[21])+0.6708203932499369*fEdge[21]-1.190784930203603*fSkin[13]-1.190784930203603*fEdge[13]-0.9375*fSkin[7]+0.9375*fEdge[7]; 
  edgeSurf[8] = -(0.6708203932499369*fSkin[22])+0.6708203932499369*fEdge[22]-1.190784930203603*fSkin[14]-1.190784930203603*fEdge[14]-0.9375*fSkin[8]+0.9375*fEdge[8]; 
  edgeSurf[9] = -(3.140625*fSkin[9])-0.140625*fEdge[9]-5.022775277112744*fSkin[3]-0.3025768239224545*fEdge[3]-3.7733647120308955*fSkin[0]+0.4192627457812106*fEdge[0]; 
  edgeSurf[10] = -(1.5855025573536612*fSkin[19])+0.7382874503707888*fEdge[19]-2.671875*fSkin[10]-1.453125*fEdge[10]-2.0568103339880417*fSkin[4]+1.190784930203603*fEdge[4]; 
  edgeSurf[11] = -(0.6708203932499369*fSkin[24])+0.6708203932499369*fEdge[24]-1.190784930203603*fSkin[17]-1.190784930203603*fEdge[17]-0.9375*fSkin[11]+0.9375*fEdge[11]; 
  edgeSurf[12] = -(0.6708203932499369*fSkin[25])+0.6708203932499369*fEdge[25]-1.190784930203603*fSkin[18]-1.190784930203603*fEdge[18]-0.9375*fSkin[12]+0.9375*fEdge[12]; 
  edgeSurf[13] = -(1.5855025573536612*fSkin[21])+0.7382874503707888*fEdge[21]-2.671875*fSkin[13]-1.453125*fEdge[13]-2.0568103339880417*fSkin[7]+1.190784930203603*fEdge[7]; 
  edgeSurf[14] = -(1.5855025573536612*fSkin[22])+0.7382874503707888*fEdge[22]-2.671875*fSkin[14]-1.453125*fEdge[14]-2.0568103339880417*fSkin[8]+1.190784930203603*fEdge[8]; 
  edgeSurf[15] = -(3.140625*fSkin[15])-0.140625*fEdge[15]-5.022775277112744*fSkin[5]-0.30257682392245444*fEdge[5]-3.773364712030894*fSkin[1]+0.41926274578121053*fEdge[1]; 
  edgeSurf[16] = -(3.140625*fSkin[16])-0.140625*fEdge[16]-5.022775277112744*fSkin[6]-0.30257682392245444*fEdge[6]-3.773364712030894*fSkin[2]+0.41926274578121053*fEdge[2]; 
  edgeSurf[17] = -(1.5855025573536612*fSkin[24])+0.7382874503707888*fEdge[24]-2.671875*fSkin[17]-1.453125*fEdge[17]-2.0568103339880417*fSkin[11]+1.190784930203603*fEdge[11]; 
  edgeSurf[18] = -(1.5855025573536612*fSkin[25])+0.7382874503707888*fEdge[25]-2.671875*fSkin[18]-1.453125*fEdge[18]-2.0568103339880417*fSkin[12]+1.190784930203603*fEdge[12]; 
  edgeSurf[19] = -(3.140625*fSkin[19])-0.140625*fEdge[19]-5.022775277112744*fSkin[10]-0.3025768239224545*fEdge[10]-3.7733647120308955*fSkin[4]+0.4192627457812106*fEdge[4]; 
  edgeSurf[20] = -(0.6708203932499369*fSkin[26])+0.6708203932499369*fEdge[26]-1.190784930203603*fSkin[23]-1.190784930203603*fEdge[23]-0.9375*fSkin[20]+0.9375*fEdge[20]; 
  edgeSurf[21] = -(3.140625*fSkin[21])-0.140625*fEdge[21]-5.022775277112744*fSkin[13]-0.30257682392245444*fEdge[13]-3.7733647120308955*fSkin[7]+0.4192627457812106*fEdge[7]; 
  edgeSurf[22] = -(3.140625*fSkin[22])-0.140625*fEdge[22]-5.022775277112744*fSkin[14]-0.30257682392245444*fEdge[14]-3.7733647120308955*fSkin[8]+0.4192627457812106*fEdge[8]; 
  edgeSurf[23] = -(1.5855025573536612*fSkin[26])+0.7382874503707888*fEdge[26]-2.671875*fSkin[23]-1.453125*fEdge[23]-2.0568103339880417*fSkin[20]+1.190784930203603*fEdge[20]; 
  edgeSurf[24] = -(3.140625*fSkin[24])-0.140625*fEdge[24]-5.022775277112744*fSkin[17]-0.3025768239224545*fEdge[17]-3.773364712030894*fSkin[11]+0.41926274578121053*fEdge[11]; 
  edgeSurf[25] = -(3.140625*fSkin[25])-0.140625*fEdge[25]-5.022775277112744*fSkin[18]-0.3025768239224545*fEdge[18]-3.773364712030894*fSkin[12]+0.41926274578121053*fEdge[12]; 
  edgeSurf[26] = -(3.140625*fSkin[26])-0.140625*fEdge[26]-5.022775277112744*fSkin[23]-0.3025768239224545*fEdge[23]-3.7733647120308955*fSkin[20]+0.4192627457812106*fEdge[20]; 

  double boundSurf[27] = {0.0}; 
  boundSurf[3] = 1.9364916731037085*fSkin[9]-1.5*fSkin[3]+0.8660254037844386*fSkin[0]; 
  boundSurf[5] = 1.9364916731037085*fSkin[15]-1.5*fSkin[5]+0.8660254037844386*fSkin[1]; 
  boundSurf[6] = 1.9364916731037085*fSkin[16]-1.5*fSkin[6]+0.8660254037844386*fSkin[2]; 
  boundSurf[9] = -(7.5*fSkin[9])+5.809475019311125*fSkin[3]-3.3541019662496847*fSkin[0]; 
  boundSurf[10] = 1.9364916731037085*fSkin[19]-1.5*fSkin[10]+0.8660254037844386*fSkin[4]; 
  boundSurf[13] = 1.9364916731037085*fSkin[21]-1.5*fSkin[13]+0.8660254037844387*fSkin[7]; 
  boundSurf[14] = 1.9364916731037085*fSkin[22]-1.5*fSkin[14]+0.8660254037844387*fSkin[8]; 
  boundSurf[15] = -(7.5*fSkin[15])+5.809475019311126*fSkin[5]-3.3541019662496843*fSkin[1]; 
  boundSurf[16] = -(7.5*fSkin[16])+5.809475019311126*fSkin[6]-3.3541019662496843*fSkin[2]; 
  boundSurf[17] = 1.9364916731037085*fSkin[24]-1.5*fSkin[17]+0.8660254037844387*fSkin[11]; 
  boundSurf[18] = 1.9364916731037085*fSkin[25]-1.5*fSkin[18]+0.8660254037844387*fSkin[12]; 
  boundSurf[19] = -(7.5*fSkin[19])+5.809475019311125*fSkin[10]-3.3541019662496847*fSkin[4]; 
  boundSurf[21] = -(7.5*fSkin[21])+5.809475019311126*fSkin[13]-3.3541019662496847*fSkin[7]; 
  boundSurf[22] = -(7.5*fSkin[22])+5.809475019311126*fSkin[14]-3.3541019662496847*fSkin[8]; 
  boundSurf[23] = 1.9364916731037085*fSkin[26]-1.5*fSkin[23]+0.8660254037844386*fSkin[20]; 
  boundSurf[24] = -(7.5*fSkin[24])+5.809475019311125*fSkin[17]-3.3541019662496843*fSkin[11]; 
  boundSurf[25] = -(7.5*fSkin[25])+5.809475019311125*fSkin[18]-3.3541019662496843*fSkin[12]; 
  boundSurf[26] = -(7.5*fSkin[26])+5.809475019311125*fSkin[23]-3.3541019662496847*fSkin[20]; 
