...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvz_1x3v_tensor_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf[7] = nuSum[2]*(2.0*w[3]+dxv[3])-2.0*sumNuUz[2]; 
  ...
  alphaDrSurf[7] = nuSum[2]*(2.0*w[3]-1.0*dxv[3])-2.0*sumNuUz[2]; 
