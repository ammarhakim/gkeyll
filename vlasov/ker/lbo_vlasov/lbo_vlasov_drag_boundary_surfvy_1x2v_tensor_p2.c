...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvy_1x2v_tensor_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  alphaDrSurf[0] = 0.5*(nuSum[0]*(2.8284271247461907*w[2]+1.4142135623730951*dxv[2])-2.8284271247461907*sumNuUy[0]); 
  alphaDrSurf[1] = 0.5*(nuSum[1]*(2.8284271247461907*w[2]+1.4142135623730951*dxv[2])-2.8284271247461907*sumNuUy[1]); 
  alphaDrSurf[4] = 0.5*(2.8284271247461907*nuSum[2]*w[2]-2.8284271247461907*sumNuUy[2]+1.4142135623730951*dxv[2]*nuSum[2]); 
