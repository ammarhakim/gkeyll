...
GKYL_CU_DH void vlasov_self_prim_moments_2x2v_ser_p2(struct gkyl_mat *A, struct gkyl_mat *rhs, const double *moms, const double *boundary_corrections, const double *nu) 
{ 
  ...
  if (notCellAvg && (-(0.5*(3.872983346207417*(moms[31]+moms[30])-2.23606797749979*(moms[29]+moms[28])-3.0*moms[27]+1.7320508075688772*(moms[26]+moms[25])-1.0*moms[24])) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.872983346207417*moms[31]-3.872983346207417*moms[30]+2.23606797749979*(moms[29]+moms[28])-3.0*moms[27]-1.7320508075688772*moms[26]+1.7320508075688772*moms[25]+moms[24]) < 0)) notCellAvg = false; 
  if (notCellAvg && (-(0.5*(3.872983346207417*moms[31]-3.872983346207417*moms[30]-2.23606797749979*(moms[29]+moms[28])+3.0*moms[27]-1.7320508075688772*moms[26]+1.7320508075688772*moms[25]-1.0*moms[24])) < 0)) notCellAvg = false; 
  if (notCellAvg && (0.5*(3.872983346207417*(moms[31]+moms[30])+2.23606797749979*(moms[29]+moms[28])+3.0*moms[27]+1.7320508075688772*(moms[26]+moms[25])+moms[24]) < 0)) notCellAvg = false; 
  ...
  if (notCellAvg) { 
    ...
    gkyl_mat_set(rhs,16,0,2.0*moms[24]); 
    gkyl_mat_set(rhs,17,0,2.0*moms[25]); 
    gkyl_mat_set(rhs,18,0,2.0*moms[26]); 
    gkyl_mat_set(rhs,19,0,2.0*moms[27]); 
    gkyl_mat_set(rhs,20,0,2.0*moms[28]); 
    gkyl_mat_set(rhs,21,0,2.0*moms[29]); 
    gkyl_mat_set(rhs,22,0,2.0*moms[30]); 
    gkyl_mat_set(rhs,23,0,2.0*moms[31]); 
  } else { 
    m0r[0] = moms[0]; 
    m0r[1] = 0.0; 
    m0r[2] = 0.0; 
  ...
  gkyl_mat_set(A,1,22,-(0.44721359549995804*cMr[3])); 
  ...
  gkyl_mat_set(A,2,23,-(0.44721359549995804*cMr[3])); 
  ...
  gkyl_mat_set(A,3,22,-(0.4*cMr[7])-0.44721359549995804*cMr[1]); 
  gkyl_mat_set(A,3,23,-(0.4*cMr[6])-0.44721359549995804*cMr[2]); 
  ...
  gkyl_mat_set(A,6,17,-(0.44721359549995804*cMr[3])); 
  gkyl_mat_set(A,6,18,-(0.5000000000000001*cMr[4])); 
  gkyl_mat_set(A,6,19,-(0.4*cMr[7])-0.44721359549995804*cMr[1]); 
  gkyl_mat_set(A,6,20,-(0.31943828249996997*cMr[6])-0.5000000000000001*cMr[2]); 
  gkyl_mat_set(A,6,21,-(0.4472135954999579*cMr[6])); 
  gkyl_mat_set(A,6,22,-(0.4472135954999579*cMr[5])-0.31943828249996997*cMr[4]-0.5*cMr[0]); 
  gkyl_mat_set(A,6,23,-(0.4*cMr[3])); 
  gkyl_mat_set(A,7,16,-(0.5*cMr[7])); 
  gkyl_mat_set(A,7,17,-(0.5000000000000001*cMr[5])); 
  gkyl_mat_set(A,7,18,-(0.44721359549995804*cMr[3])); 
  gkyl_mat_set(A,7,19,-(0.4*cMr[6])-0.44721359549995804*cMr[2]); 
  ...
  gkyl_mat_set(A,7,23,-(0.31943828249996997*cMr[5])-0.4472135954999579*cMr[4]-0.5*cMr[0]); 
  ...
  gkyl_mat_set(A,17,6,0.44721359549995804*m1r[3]); 
  ...
  gkyl_mat_set(A,18,7,0.44721359549995804*m1r[3]); 
  ...
  gkyl_mat_set(A,19,6,0.4*m1r[7]+0.44721359549995804*m1r[1]); 
  gkyl_mat_set(A,19,7,0.4*m1r[6]+0.44721359549995804*m1r[2]); 
  ...
  gkyl_mat_set(A,22,1,0.44721359549995804*m1r[3]); 
  gkyl_mat_set(A,22,2,0.5000000000000001*m1r[4]); 
  gkyl_mat_set(A,22,3,0.4*m1r[7]+0.44721359549995804*m1r[1]); 
  gkyl_mat_set(A,22,4,0.31943828249996997*m1r[6]+0.5000000000000001*m1r[2]); 
  gkyl_mat_set(A,22,5,0.4472135954999579*m1r[6]); 
  gkyl_mat_set(A,22,6,0.4472135954999579*m1r[5]+0.31943828249996997*m1r[4]+0.5*m1r[0]); 
  gkyl_mat_set(A,22,7,0.4*m1r[3]); 
  gkyl_mat_set(A,23,0,0.5*m1r[7]); 
  gkyl_mat_set(A,23,1,0.5000000000000001*m1r[5]); 
  gkyl_mat_set(A,23,2,0.44721359549995804*m1r[3]); 
  gkyl_mat_set(A,23,3,0.4*m1r[6]+0.44721359549995804*m1r[2]); 
  ...
  gkyl_mat_set(A,23,7,0.31943828249996997*m1r[5]+0.4472135954999579*m1r[4]+0.5*m1r[0]); 
  ...
  gkyl_mat_set(A,9,19,-(0.44721359549995804*cMr[14])-0.5*cMr[10]); 
  gkyl_mat_set(A,9,20,-(0.4472135954999579*cMr[9])); 
  gkyl_mat_set(A,9,21,-(0.5000000000000001*cMr[15])); 
  gkyl_mat_set(A,9,22,-(0.44721359549995804*cMr[11])); 
  ...
  gkyl_mat_set(A,10,19,-(0.44721359549995804*cMr[15])-0.5*cMr[9]); 
  ...
  gkyl_mat_set(A,10,23,-(0.44721359549995804*cMr[11])); 
  gkyl_mat_set(A,11,16,-(0.5*cMr[11])); 
  gkyl_mat_set(A,11,17,-(0.44721359549995804*cMr[14])-0.5*cMr[10]); 
  gkyl_mat_set(A,11,18,-(0.44721359549995804*cMr[15])-0.5*cMr[9]); 
  ...
  gkyl_mat_set(A,11,22,-(0.4*cMr[15])-0.44721359549995804*cMr[9]); 
  gkyl_mat_set(A,11,23,-(0.4*cMr[14])-0.44721359549995804*cMr[10]); 
  ...
  gkyl_mat_set(A,12,20,-(0.31943828249996997*cMr[12])-0.5*cMr[8]); 
  gkyl_mat_set(A,12,22,-(0.31943828249996997*cMr[14])-0.5000000000000001*cMr[10]); 
  ...
  gkyl_mat_set(A,13,23,-(0.31943828249996997*cMr[15])-0.5000000000000001*cMr[9]); 
  gkyl_mat_set(A,14,16,-(0.5*cMr[14])); 
  gkyl_mat_set(A,14,17,-(0.44721359549995804*cMr[11])); 
  gkyl_mat_set(A,14,18,-(0.5000000000000001*cMr[12])); 
  gkyl_mat_set(A,14,19,-(0.4*cMr[15])-0.44721359549995804*cMr[9]); 
  gkyl_mat_set(A,14,20,-(0.31943828249996997*cMr[14])-0.5000000000000001*cMr[10]); 
  gkyl_mat_set(A,14,21,-(0.4472135954999579*cMr[14])); 
  gkyl_mat_set(A,14,22,-(0.4472135954999579*cMr[13])-0.31943828249996997*cMr[12]-0.5*cMr[8]); 
  gkyl_mat_set(A,14,23,-(0.4*cMr[11])); 
  gkyl_mat_set(A,15,16,-(0.5*cMr[15])); 
  gkyl_mat_set(A,15,17,-(0.5000000000000001*cMr[13])); 
  gkyl_mat_set(A,15,18,-(0.44721359549995804*cMr[11])); 
  gkyl_mat_set(A,15,19,-(0.4*cMr[14])-0.44721359549995804*cMr[10]); 
  gkyl_mat_set(A,15,20,-(0.4472135954999579*cMr[15])); 
  gkyl_mat_set(A,15,21,-(0.31943828249996997*cMr[15])-0.5000000000000001*cMr[9]); 
  gkyl_mat_set(A,15,22,-(0.4*cMr[11])); 
  gkyl_mat_set(A,15,23,-(0.31943828249996997*cMr[13])-0.4472135954999579*cMr[12]-0.5*cMr[8]); 
  ...
  gkyl_mat_set(A,17,11,0.44721359549995804*m1r[14]+0.5*m1r[10]); 
  gkyl_mat_set(A,17,12,0.4472135954999579*m1r[9]); 
  gkyl_mat_set(A,17,13,0.5000000000000001*m1r[15]); 
  gkyl_mat_set(A,17,14,0.44721359549995804*m1r[11]); 
  ...
  gkyl_mat_set(A,18,11,0.44721359549995804*m1r[15]+0.5*m1r[9]); 
  ...
  gkyl_mat_set(A,18,15,0.44721359549995804*m1r[11]); 
  gkyl_mat_set(A,19,8,0.5*m1r[11]); 
  gkyl_mat_set(A,19,9,0.44721359549995804*m1r[14]+0.5*m1r[10]); 
  gkyl_mat_set(A,19,10,0.44721359549995804*m1r[15]+0.5*m1r[9]); 
  ...
  gkyl_mat_set(A,19,14,0.4*m1r[15]+0.44721359549995804*m1r[9]); 
  gkyl_mat_set(A,19,15,0.4*m1r[14]+0.44721359549995804*m1r[10]); 
  ...
  gkyl_mat_set(A,20,12,0.31943828249996997*m1r[12]+0.5*m1r[8]); 
  gkyl_mat_set(A,20,14,0.31943828249996997*m1r[14]+0.5000000000000001*m1r[10]); 
  ...
  gkyl_mat_set(A,21,15,0.31943828249996997*m1r[15]+0.5000000000000001*m1r[9]); 
  gkyl_mat_set(A,22,8,0.5*m1r[14]); 
  gkyl_mat_set(A,22,9,0.44721359549995804*m1r[11]); 
  gkyl_mat_set(A,22,10,0.5000000000000001*m1r[12]); 
  gkyl_mat_set(A,22,11,0.4*m1r[15]+0.44721359549995804*m1r[9]); 
  gkyl_mat_set(A,22,12,0.31943828249996997*m1r[14]+0.5000000000000001*m1r[10]); 
  gkyl_mat_set(A,22,13,0.4472135954999579*m1r[14]); 
  gkyl_mat_set(A,22,14,0.4472135954999579*m1r[13]+0.31943828249996997*m1r[12]+0.5*m1r[8]); 
  gkyl_mat_set(A,22,15,0.4*m1r[11]); 
  gkyl_mat_set(A,23,8,0.5*m1r[15]); 
  gkyl_mat_set(A,23,9,0.5000000000000001*m1r[13]); 
  gkyl_mat_set(A,23,10,0.44721359549995804*m1r[11]); 
  gkyl_mat_set(A,23,11,0.4*m1r[14]+0.44721359549995804*m1r[10]); 
  gkyl_mat_set(A,23,12,0.4472135954999579*m1r[15]); 
  gkyl_mat_set(A,23,13,0.31943828249996997*m1r[15]+0.5000000000000001*m1r[9]); 
  gkyl_mat_set(A,23,14,0.4*m1r[11]); 
  gkyl_mat_set(A,23,15,0.31943828249996997*m1r[13]+0.4472135954999579*m1r[12]+0.5*m1r[8]); 
  ...
  gkyl_mat_set(A,17,19,0.8944271909999161*m0r[6]-0.44721359549995804*cEr[6]+m0r[2]-0.5*cEr[2]); 
  gkyl_mat_set(A,17,20,0.8944271909999159*m0r[1]-0.4472135954999579*cEr[1]); 
  gkyl_mat_set(A,17,21,1.0000000000000002*m0r[7]-0.5000000000000001*cEr[7]); 
  gkyl_mat_set(A,17,22,0.8944271909999161*m0r[3]-0.44721359549995804*cEr[3]); 
  gkyl_mat_set(A,17,23,1.0000000000000002*m0r[5]-0.5000000000000001*cEr[5]); 
  ...
  gkyl_mat_set(A,18,19,0.8944271909999161*m0r[7]-0.44721359549995804*cEr[7]+m0r[1]-0.5*cEr[1]); 
  gkyl_mat_set(A,18,20,1.0000000000000002*m0r[6]-0.5000000000000001*cEr[6]); 
  gkyl_mat_set(A,18,21,0.8944271909999159*m0r[2]-0.4472135954999579*cEr[2]); 
  gkyl_mat_set(A,18,22,1.0000000000000002*m0r[4]-0.5000000000000001*cEr[4]); 
  gkyl_mat_set(A,18,23,0.8944271909999161*m0r[3]-0.44721359549995804*cEr[3]); 
  gkyl_mat_set(A,19,16,m0r[3]-0.5*cEr[3]); 
  gkyl_mat_set(A,19,17,0.8944271909999161*m0r[6]-0.44721359549995804*cEr[6]+m0r[2]-0.5*cEr[2]); 
  gkyl_mat_set(A,19,18,0.8944271909999161*m0r[7]-0.44721359549995804*cEr[7]+m0r[1]-0.5*cEr[1]); 
  ...
  gkyl_mat_set(A,19,22,0.8*m0r[7]-0.4*cEr[7]+0.8944271909999161*m0r[1]-0.44721359549995804*cEr[1]); 
  gkyl_mat_set(A,19,23,0.8*m0r[6]-0.4*cEr[6]+0.8944271909999161*m0r[2]-0.44721359549995804*cEr[2]); 
  gkyl_mat_set(A,20,16,m0r[4]-0.5*cEr[4]); 
  gkyl_mat_set(A,20,17,0.8944271909999159*m0r[1]-0.4472135954999579*cEr[1]); 
  gkyl_mat_set(A,20,18,1.0000000000000002*m0r[6]-0.5000000000000001*cEr[6]); 
  gkyl_mat_set(A,20,19,0.8944271909999159*m0r[3]-0.4472135954999579*cEr[3]); 
  gkyl_mat_set(A,20,20,0.6388765649999399*m0r[4]-0.31943828249996997*cEr[4]+m0r[0]-0.5*cEr[0]); 
  gkyl_mat_set(A,20,22,0.6388765649999399*m0r[6]-0.31943828249996997*cEr[6]+1.0000000000000002*m0r[2]-0.5000000000000001*cEr[2]); 
  gkyl_mat_set(A,20,23,0.8944271909999159*m0r[7]-0.4472135954999579*cEr[7]); 
  gkyl_mat_set(A,21,16,m0r[5]-0.5*cEr[5]); 
  gkyl_mat_set(A,21,17,1.0000000000000002*m0r[7]-0.5000000000000001*cEr[7]); 
  ...
  gkyl_mat_set(A,21,21,0.6388765649999399*m0r[5]-0.31943828249996997*cEr[5]+m0r[0]-0.5*cEr[0]); 
  gkyl_mat_set(A,21,22,0.8944271909999159*m0r[6]-0.4472135954999579*cEr[6]); 
  gkyl_mat_set(A,21,23,0.6388765649999399*m0r[7]-0.31943828249996997*cEr[7]+1.0000000000000002*m0r[1]-0.5000000000000001*cEr[1]); 
  gkyl_mat_set(A,22,16,m0r[6]-0.5*cEr[6]); 
  gkyl_mat_set(A,22,17,0.8944271909999161*m0r[3]-0.44721359549995804*cEr[3]); 
  gkyl_mat_set(A,22,18,1.0000000000000002*m0r[4]-0.5000000000000001*cEr[4]); 
  gkyl_mat_set(A,22,19,0.8*m0r[7]-0.4*cEr[7]+0.8944271909999161*m0r[1]-0.44721359549995804*cEr[1]); 
  gkyl_mat_set(A,22,20,0.6388765649999399*m0r[6]-0.31943828249996997*cEr[6]+1.0000000000000002*m0r[2]-0.5000000000000001*cEr[2]); 
  gkyl_mat_set(A,22,21,0.8944271909999159*m0r[6]-0.4472135954999579*cEr[6]); 
  gkyl_mat_set(A,22,22,0.8944271909999159*m0r[5]-0.4472135954999579*cEr[5]+0.6388765649999399*m0r[4]-0.31943828249996997*cEr[4]+m0r[0]-0.5*cEr[0]); 
  gkyl_mat_set(A,22,23,0.8*m0r[3]-0.4*cEr[3]); 
  gkyl_mat_set(A,23,16,m0r[7]-0.5*cEr[7]); 
  gkyl_mat_set(A,23,17,1.0000000000000002*m0r[5]-0.5000000000000001*cEr[5]); 
  gkyl_mat_set(A,23,18,0.8944271909999161*m0r[3]-0.44721359549995804*cEr[3]); 
  gkyl_mat_set(A,23,19,0.8*m0r[6]-0.4*cEr[6]+0.8944271909999161*m0r[2]-0.44721359549995804*cEr[2]); 
  gkyl_mat_set(A,23,20,0.8944271909999159*m0r[7]-0.4472135954999579*cEr[7]); 
  gkyl_mat_set(A,23,21,0.6388765649999399*m0r[7]-0.31943828249996997*cEr[7]+1.0000000000000002*m0r[1]-0.5000000000000001*cEr[1]); 
  gkyl_mat_set(A,23,22,0.8*m0r[3]-0.4*cEr[3]); 
  gkyl_mat_set(A,23,23,0.6388765649999399*m0r[5]-0.31943828249996997*cEr[5]+0.8944271909999159*m0r[4]-0.4472135954999579*cEr[4]+m0r[0]-0.5*cEr[0]); 
