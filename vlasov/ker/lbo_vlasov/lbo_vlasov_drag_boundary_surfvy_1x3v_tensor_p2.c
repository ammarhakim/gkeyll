...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvy_1x3v_tensor_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  out[13] += 1.5811388300841895*Ghat[0]*rdv2; 
  ...
  out[23] += 1.5811388300841898*Ghat[1]*rdv2; 
  out[24] += 1.5811388300841898*Ghat[2]*rdv2; 
  out[25] += 0.7071067811865475*Ghat[13]*rdv2; 
  out[26] += 0.7071067811865475*Ghat[14]*rdv2; 
  out[27] += 1.5811388300841898*Ghat[3]*rdv2; 
  ...
  out[34] += 1.5811388300841895*Ghat[4]*rdv2; 
  ...
  out[39] += 1.5811388300841895*Ghat[5]*rdv2; 
  out[40] += 1.5811388300841895*Ghat[6]*rdv2; 
  ...
  out[45] += 1.5811388300841895*Ghat[7]*rdv2; 
  ...
  out[67] += 1.5811388300841895*Ghat[17]*rdv2; 
