...
{ 
  ...
  if (-(0.6*alphaDrSurf_l[7])-0.6*alphaDrSurf_l[6]+0.44721359549995715*alphaDrSurf_l[5]+0.44721359549995715*alphaDrSurf_l[4]+0.9*alphaDrSurf_l[3]-0.6708203932499357*alphaDrSurf_l[2]-0.6708203932499357*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] < 0) { 
    fUpwindQuad_l[0] = ser_3x_p2_surfx3_eval_quad_node_0_r(fl); 
  } else { 
    fUpwindQuad_l[0] = ser_3x_p2_surfx3_eval_quad_node_0_l(fc); 
  } 
  if (-(0.6*alphaDrSurf_r[7])-0.6*alphaDrSurf_r[6]+0.44721359549995715*alphaDrSurf_r[5]+0.44721359549995715*alphaDrSurf_r[4]+0.9*alphaDrSurf_r[3]-0.6708203932499357*alphaDrSurf_r[2]-0.6708203932499357*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] < 0) { 
    fUpwindQuad_r[0] = ser_3x_p2_surfx3_eval_quad_node_0_r(fc); 
  } else { 
    fUpwindQuad_r[0] = ser_3x_p2_surfx3_eval_quad_node_0_l(fr); 
  } 
  if (0.75*alphaDrSurf_l[7]-0.5590169943749465*alphaDrSurf_l[5]+0.44721359549995715*alphaDrSurf_l[4]-0.6708203932499357*alphaDrSurf_l[1]+0.5*alphaDrSurf_l[0] < 0) { 
    fUpwindQuad_l[1] = ser_3x_p2_surfx3_eval_quad_node_1_r(fl); 
  } else { 
    fUpwindQuad_l[1] = ser_3x_p2_surfx3_eval_quad_node_1_l(fc); 
  } 
  if (0.75*alphaDrSurf_r[7]-0.5590169943749465*alphaDrSurf_r[5]+0.44721359549995715*alphaDrSurf_r[4]-0.6708203932499357*alphaDrSurf_r[1]+0.5*alphaDrSurf_r[0] < 0) { 
  ...
  if (0.75*alphaDrSurf_l[6]+0.44721359549995715*alphaDrSurf_l[5]-0.5590169943749465*alphaDrSurf_l[4]-0.6708203932499357*alphaDrSurf_l[2]+0.5*alphaDrSurf_l[0] < 0) { 
    fUpwindQuad_l[3] = ser_3x_p2_surfx3_eval_quad_node_3_r(fl); 
  } else { 
    fUpwindQuad_l[3] = ser_3x_p2_surfx3_eval_quad_node_3_l(fc); 
  } 
  if (0.75*alphaDrSurf_r[6]+0.44721359549995715*alphaDrSurf_r[5]-0.5590169943749465*alphaDrSurf_r[4]-0.6708203932499357*alphaDrSurf_r[2]+0.5*alphaDrSurf_r[0] < 0) { 
  ...
  Ghat_l[1] = 0.5000000000000001*alphaDrSurf_l[5]*fUpwind_l[7]+0.5000000000000001*fUpwind_l[5]*alphaDrSurf_l[7]+0.44721359549995804*alphaDrSurf_l[3]*fUpwind_l[6]+0.44721359549995804*fUpwind_l[3]*alphaDrSurf_l[6]+0.4472135954999579*alphaDrSurf_l[1]*fUpwind_l[4]+0.4472135954999579*fUpwind_l[1]*alphaDrSurf_l[4]+0.5*alphaDrSurf_l[2]*fUpwind_l[3]+0.5*fUpwind_l[2]*alphaDrSurf_l[3]+0.5*alphaDrSurf_l[0]*fUpwind_l[1]+0.5*fUpwind_l[0]*alphaDrSurf_l[1]; 
  Ghat_l[2] = 0.44721359549995804*alphaDrSurf_l[3]*fUpwind_l[7]+0.44721359549995804*fUpwind_l[3]*alphaDrSurf_l[7]+0.5000000000000001*alphaDrSurf_l[4]*fUpwind_l[6]+0.5000000000000001*fUpwind_l[4]*alphaDrSurf_l[6]+0.4472135954999579*alphaDrSurf_l[2]*fUpwind_l[5]+0.4472135954999579*fUpwind_l[2]*alphaDrSurf_l[5]+0.5*alphaDrSurf_l[1]*fUpwind_l[3]+0.5*fUpwind_l[1]*alphaDrSurf_l[3]+0.5*alphaDrSurf_l[0]*fUpwind_l[2]+0.5*fUpwind_l[0]*alphaDrSurf_l[2]; 
  Ghat_l[3] = 0.4*alphaDrSurf_l[6]*fUpwind_l[7]+0.44721359549995804*alphaDrSurf_l[2]*fUpwind_l[7]+0.4*fUpwind_l[6]*alphaDrSurf_l[7]+0.44721359549995804*fUpwind_l[2]*alphaDrSurf_l[7]+0.44721359549995804*alphaDrSurf_l[1]*fUpwind_l[6]+0.44721359549995804*fUpwind_l[1]*alphaDrSurf_l[6]+0.4472135954999579*alphaDrSurf_l[3]*fUpwind_l[5]+0.4472135954999579*fUpwind_l[3]*alphaDrSurf_l[5]+0.4472135954999579*alphaDrSurf_l[3]*fUpwind_l[4]+0.4472135954999579*fUpwind_l[3]*alphaDrSurf_l[4]+0.5*alphaDrSurf_l[0]*fUpwind_l[3]+0.5*fUpwind_l[0]*alphaDrSurf_l[3]+0.5*alphaDrSurf_l[1]*fUpwind_l[2]+0.5*fUpwind_l[1]*alphaDrSurf_l[2]; 
  Ghat_l[4] = 0.4472135954999579*alphaDrSurf_l[7]*fUpwind_l[7]+0.31943828249996997*alphaDrSurf_l[6]*fUpwind_l[6]+0.5000000000000001*alphaDrSurf_l[2]*fUpwind_l[6]+0.5000000000000001*fUpwind_l[2]*alphaDrSurf_l[6]+0.31943828249996997*alphaDrSurf_l[4]*fUpwind_l[4]+0.5*alphaDrSurf_l[0]*fUpwind_l[4]+0.5*fUpwind_l[0]*alphaDrSurf_l[4]+0.4472135954999579*alphaDrSurf_l[3]*fUpwind_l[3]+0.4472135954999579*alphaDrSurf_l[1]*fUpwind_l[1]; 
  Ghat_l[5] = 0.31943828249996997*alphaDrSurf_l[7]*fUpwind_l[7]+0.5000000000000001*alphaDrSurf_l[1]*fUpwind_l[7]+0.5000000000000001*fUpwind_l[1]*alphaDrSurf_l[7]+0.4472135954999579*alphaDrSurf_l[6]*fUpwind_l[6]+0.31943828249996997*alphaDrSurf_l[5]*fUpwind_l[5]+0.5*alphaDrSurf_l[0]*fUpwind_l[5]+0.5*fUpwind_l[0]*alphaDrSurf_l[5]+0.4472135954999579*alphaDrSurf_l[3]*fUpwind_l[3]+0.4472135954999579*alphaDrSurf_l[2]*fUpwind_l[2]; 
  Ghat_l[6] = 0.4*alphaDrSurf_l[3]*fUpwind_l[7]+0.4*fUpwind_l[3]*alphaDrSurf_l[7]+0.4472135954999579*alphaDrSurf_l[5]*fUpwind_l[6]+0.31943828249996997*alphaDrSurf_l[4]*fUpwind_l[6]+0.5*alphaDrSurf_l[0]*fUpwind_l[6]+0.4472135954999579*fUpwind_l[5]*alphaDrSurf_l[6]+0.31943828249996997*fUpwind_l[4]*alphaDrSurf_l[6]+0.5*fUpwind_l[0]*alphaDrSurf_l[6]+0.5000000000000001*alphaDrSurf_l[2]*fUpwind_l[4]+0.5000000000000001*fUpwind_l[2]*alphaDrSurf_l[4]+0.44721359549995804*alphaDrSurf_l[1]*fUpwind_l[3]+0.44721359549995804*fUpwind_l[1]*alphaDrSurf_l[3]; 
  Ghat_l[7] = 0.31943828249996997*alphaDrSurf_l[5]*fUpwind_l[7]+0.4472135954999579*alphaDrSurf_l[4]*fUpwind_l[7]+0.5*alphaDrSurf_l[0]*fUpwind_l[7]+0.31943828249996997*fUpwind_l[5]*alphaDrSurf_l[7]+0.4472135954999579*fUpwind_l[4]*alphaDrSurf_l[7]+0.5*fUpwind_l[0]*alphaDrSurf_l[7]+0.4*alphaDrSurf_l[3]*fUpwind_l[6]+0.4*fUpwind_l[3]*alphaDrSurf_l[6]+0.5000000000000001*alphaDrSurf_l[1]*fUpwind_l[5]+0.5000000000000001*fUpwind_l[1]*alphaDrSurf_l[5]+0.44721359549995804*alphaDrSurf_l[2]*fUpwind_l[3]+0.44721359549995804*fUpwind_l[2]*alphaDrSurf_l[3]; 
  ...
  Ghat_r[1] = 0.5000000000000001*alphaDrSurf_r[5]*fUpwind_r[7]+0.5000000000000001*fUpwind_r[5]*alphaDrSurf_r[7]+0.44721359549995804*alphaDrSurf_r[3]*fUpwind_r[6]+0.44721359549995804*fUpwind_r[3]*alphaDrSurf_r[6]+0.4472135954999579*alphaDrSurf_r[1]*fUpwind_r[4]+0.4472135954999579*fUpwind_r[1]*alphaDrSurf_r[4]+0.5*alphaDrSurf_r[2]*fUpwind_r[3]+0.5*fUpwind_r[2]*alphaDrSurf_r[3]+0.5*alphaDrSurf_r[0]*fUpwind_r[1]+0.5*fUpwind_r[0]*alphaDrSurf_r[1]; 
  Ghat_r[2] = 0.44721359549995804*alphaDrSurf_r[3]*fUpwind_r[7]+0.44721359549995804*fUpwind_r[3]*alphaDrSurf_r[7]+0.5000000000000001*alphaDrSurf_r[4]*fUpwind_r[6]+0.5000000000000001*fUpwind_r[4]*alphaDrSurf_r[6]+0.4472135954999579*alphaDrSurf_r[2]*fUpwind_r[5]+0.4472135954999579*fUpwind_r[2]*alphaDrSurf_r[5]+0.5*alphaDrSurf_r[1]*fUpwind_r[3]+0.5*fUpwind_r[1]*alphaDrSurf_r[3]+0.5*alphaDrSurf_r[0]*fUpwind_r[2]+0.5*fUpwind_r[0]*alphaDrSurf_r[2]; 
  Ghat_r[3] = 0.4*alphaDrSurf_r[6]*fUpwind_r[7]+0.44721359549995804*alphaDrSurf_r[2]*fUpwind_r[7]+0.4*fUpwind_r[6]*alphaDrSurf_r[7]+0.44721359549995804*fUpwind_r[2]*alphaDrSurf_r[7]+0.44721359549995804*alphaDrSurf_r[1]*fUpwind_r[6]+0.44721359549995804*fUpwind_r[1]*alphaDrSurf_r[6]+0.4472135954999579*alphaDrSurf_r[3]*fUpwind_r[5]+0.4472135954999579*fUpwind_r[3]*alphaDrSurf_r[5]+0.4472135954999579*alphaDrSurf_r[3]*fUpwind_r[4]+0.4472135954999579*fUpwind_r[3]*alphaDrSurf_r[4]+0.5*alphaDrSurf_r[0]*fUpwind_r[3]+0.5*fUpwind_r[0]*alphaDrSurf_r[3]+0.5*alphaDrSurf_r[1]*fUpwind_r[2]+0.5*fUpwind_r[1]*alphaDrSurf_r[2]; 
  Ghat_r[4] = 0.4472135954999579*alphaDrSurf_r[7]*fUpwind_r[7]+0.31943828249996997*alphaDrSurf_r[6]*fUpwind_r[6]+0.5000000000000001*alphaDrSurf_r[2]*fUpwind_r[6]+0.5000000000000001*fUpwind_r[2]*alphaDrSurf_r[6]+0.31943828249996997*alphaDrSurf_r[4]*fUpwind_r[4]+0.5*alphaDrSurf_r[0]*fUpwind_r[4]+0.5*fUpwind_r[0]*alphaDrSurf_r[4]+0.4472135954999579*alphaDrSurf_r[3]*fUpwind_r[3]+0.4472135954999579*alphaDrSurf_r[1]*fUpwind_r[1]; 
  Ghat_r[5] = 0.31943828249996997*alphaDrSurf_r[7]*fUpwind_r[7]+0.5000000000000001*alphaDrSurf_r[1]*fUpwind_r[7]+0.5000000000000001*fUpwind_r[1]*alphaDrSurf_r[7]+0.4472135954999579*alphaDrSurf_r[6]*fUpwind_r[6]+0.31943828249996997*alphaDrSurf_r[5]*fUpwind_r[5]+0.5*alphaDrSurf_r[0]*fUpwind_r[5]+0.5*fUpwind_r[0]*alphaDrSurf_r[5]+0.4472135954999579*alphaDrSurf_r[3]*fUpwind_r[3]+0.4472135954999579*alphaDrSurf_r[2]*fUpwind_r[2]; 
  Ghat_r[6] = 0.4*alphaDrSurf_r[3]*fUpwind_r[7]+0.4*fUpwind_r[3]*alphaDrSurf_r[7]+0.4472135954999579*alphaDrSurf_r[5]*fUpwind_r[6]+0.31943828249996997*alphaDrSurf_r[4]*fUpwind_r[6]+0.5*alphaDrSurf_r[0]*fUpwind_r[6]+0.4472135954999579*fUpwind_r[5]*alphaDrSurf_r[6]+0.31943828249996997*fUpwind_r[4]*alphaDrSurf_r[6]+0.5*fUpwind_r[0]*alphaDrSurf_r[6]+0.5000000000000001*alphaDrSurf_r[2]*fUpwind_r[4]+0.5000000000000001*fUpwind_r[2]*alphaDrSurf_r[4]+0.44721359549995804*alphaDrSurf_r[1]*fUpwind_r[3]+0.44721359549995804*fUpwind_r[1]*alphaDrSurf_r[3]; 
  Ghat_r[7] = 0.31943828249996997*alphaDrSurf_r[5]*fUpwind_r[7]+0.4472135954999579*alphaDrSurf_r[4]*fUpwind_r[7]+0.5*alphaDrSurf_r[0]*fUpwind_r[7]+0.31943828249996997*fUpwind_r[5]*alphaDrSurf_r[7]+0.4472135954999579*fUpwind_r[4]*alphaDrSurf_r[7]+0.5*fUpwind_r[0]*alphaDrSurf_r[7]+0.4*alphaDrSurf_r[3]*fUpwind_r[6]+0.4*fUpwind_r[3]*alphaDrSurf_r[6]+0.5000000000000001*alphaDrSurf_r[1]*fUpwind_r[5]+0.5000000000000001*fUpwind_r[1]*alphaDrSurf_r[5]+0.44721359549995804*alphaDrSurf_r[2]*fUpwind_r[3]+0.44721359549995804*fUpwind_r[2]*alphaDrSurf_r[3]; 
