...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvx_2x1v_ser_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  if (-(0.6*alphaDrSurf[7])-0.6*alphaDrSurf[6]+0.44721359549995715*alphaDrSurf[5]+0.44721359549995715*alphaDrSurf[4]+0.9*alphaDrSurf[3]-0.6708203932499357*alphaDrSurf[2]-0.6708203932499357*alphaDrSurf[1]+0.5*alphaDrSurf[0] < 0) { 
    fUpwindQuad[0] = ser_3x_p2_surfx3_eval_quad_node_0_r(fSkin); 
  } else { 
    fUpwindQuad[0] = ser_3x_p2_surfx3_eval_quad_node_0_l(fEdge); 
  } 
  if (0.75*alphaDrSurf[7]-0.5590169943749465*alphaDrSurf[5]+0.44721359549995715*alphaDrSurf[4]-0.6708203932499357*alphaDrSurf[1]+0.5*alphaDrSurf[0] < 0) { 
  ...
  if (0.75*alphaDrSurf[6]+0.44721359549995715*alphaDrSurf[5]-0.5590169943749465*alphaDrSurf[4]-0.6708203932499357*alphaDrSurf[2]+0.5*alphaDrSurf[0] < 0) { 
  ...
  Ghat[4] = 0.4472135954999579*alphaDrSurf[7]*fUpwind[7]+0.31943828249996997*alphaDrSurf[6]*fUpwind[6]+0.5000000000000001*alphaDrSurf[2]*fUpwind[6]+0.5000000000000001*fUpwind[2]*alphaDrSurf[6]+0.31943828249996997*alphaDrSurf[4]*fUpwind[4]+0.5*alphaDrSurf[0]*fUpwind[4]+0.5*fUpwind[0]*alphaDrSurf[4]+0.4472135954999579*alphaDrSurf[3]*fUpwind[3]+0.4472135954999579*alphaDrSurf[1]*fUpwind[1]; 
  Ghat[5] = 0.31943828249996997*alphaDrSurf[7]*fUpwind[7]+0.5000000000000001*alphaDrSurf[1]*fUpwind[7]+0.5000000000000001*fUpwind[1]*alphaDrSurf[7]+0.4472135954999579*alphaDrSurf[6]*fUpwind[6]+0.31943828249996997*alphaDrSurf[5]*fUpwind[5]+0.5*alphaDrSurf[0]*fUpwind[5]+0.5*fUpwind[0]*alphaDrSurf[5]+0.4472135954999579*alphaDrSurf[3]*fUpwind[3]+0.4472135954999579*alphaDrSurf[2]*fUpwind[2]; 
