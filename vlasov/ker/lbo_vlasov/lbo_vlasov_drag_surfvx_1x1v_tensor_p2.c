...
{ 
  ...
  Ghat_l[2] = 0.45175395145262565*alphaDrSurf_l[2]*fUpwind_l[2]+0.7071067811865475*alphaDrSurf_l[0]*fUpwind_l[2]+0.7071067811865475*fUpwind_l[0]*alphaDrSurf_l[2]+0.6324555320336759*alphaDrSurf_l[1]*fUpwind_l[1]; 
  ...
  Ghat_r[2] = 0.45175395145262565*alphaDrSurf_r[2]*fUpwind_r[2]+0.7071067811865475*alphaDrSurf_r[0]*fUpwind_r[2]+0.7071067811865475*fUpwind_r[0]*alphaDrSurf_r[2]+0.6324555320336759*alphaDrSurf_r[1]*fUpwind_r[1]; 
  ...
  out[8] += 1.5811388300841895*Ghat_r[2]*rdv2-1.5811388300841895*Ghat_l[2]*rdv2; 
