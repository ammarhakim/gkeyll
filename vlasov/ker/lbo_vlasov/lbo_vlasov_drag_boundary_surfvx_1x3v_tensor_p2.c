...
GKYL_CU_DH double lbo_vlasov_drag_boundary_surfvx_1x3v_tensor_p2(const double *w, const double *dxv, const double *nuSum, const double *nuPrimMomsSum, const int edge, const double *fSkin, const double *fEdge, double* GKYL_RESTRICT out) 
{ 
  ...
  if (0.31622776601683783*alphaDrSurf[7]-0.4743416490252568*alphaDrSurf[1]+0.3535533905932734*alphaDrSurf[0] < 0) { 
  ...
  if (0.3535533905932734*alphaDrSurf[0]-0.3952847075210471*alphaDrSurf[7] < 0) { 
  ...
  Ghat[4] = 0.31622776601683794*alphaDrSurf[1]*fUpwind[11]+0.3162277660168379*fUpwind[4]*alphaDrSurf[7]+0.3535533905932737*alphaDrSurf[0]*fUpwind[4]+0.3535533905932737*alphaDrSurf[1]*fUpwind[2]; 
  Ghat[5] = 0.31622776601683794*alphaDrSurf[1]*fUpwind[13]+0.3162277660168379*fUpwind[5]*alphaDrSurf[7]+0.3535533905932737*alphaDrSurf[0]*fUpwind[5]+0.3535533905932737*alphaDrSurf[1]*fUpwind[3]; 
  ...
  Ghat[7] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[7]+0.3535533905932737*alphaDrSurf[0]*fUpwind[7]+0.3535533905932737*fUpwind[0]*alphaDrSurf[7]+0.3162277660168379*alphaDrSurf[1]*fUpwind[1]; 
  ...
  Ghat[11] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[11]+0.3535533905932737*alphaDrSurf[0]*fUpwind[11]+0.3535533905932737*fUpwind[2]*alphaDrSurf[7]+0.31622776601683794*alphaDrSurf[1]*fUpwind[4]; 
  Ghat[12] = 0.31622776601683794*alphaDrSurf[1]*fUpwind[20]+0.3162277660168379*alphaDrSurf[7]*fUpwind[12]+0.3535533905932737*alphaDrSurf[0]*fUpwind[12]+0.3535533905932737*alphaDrSurf[1]*fUpwind[8]; 
  Ghat[13] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[13]+0.3535533905932737*alphaDrSurf[0]*fUpwind[13]+0.3535533905932737*fUpwind[3]*alphaDrSurf[7]+0.31622776601683794*alphaDrSurf[1]*fUpwind[5]; 
  ...
  Ghat[15] = 0.31622776601683794*alphaDrSurf[1]*fUpwind[21]+0.3162277660168379*alphaDrSurf[7]*fUpwind[15]+0.3535533905932737*alphaDrSurf[0]*fUpwind[15]+0.3535533905932737*alphaDrSurf[1]*fUpwind[9]; 
  ...
  Ghat[17] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[17]+0.3535533905932737*alphaDrSurf[0]*fUpwind[17]+0.3162277660168379*alphaDrSurf[1]*fUpwind[10]+0.3535533905932737*fUpwind[6]*alphaDrSurf[7]; 
  ...
  Ghat[20] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[20]+0.3535533905932737*alphaDrSurf[0]*fUpwind[20]+0.31622776601683794*alphaDrSurf[1]*fUpwind[12]+0.3535533905932737*alphaDrSurf[7]*fUpwind[8]; 
  Ghat[21] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[21]+0.3535533905932737*alphaDrSurf[0]*fUpwind[21]+0.31622776601683794*alphaDrSurf[1]*fUpwind[15]+0.3535533905932737*alphaDrSurf[7]*fUpwind[9]; 
  ...
  Ghat[23] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[23]+0.3535533905932737*alphaDrSurf[0]*fUpwind[23]+0.3162277660168379*alphaDrSurf[1]*fUpwind[18]+0.3535533905932737*alphaDrSurf[7]*fUpwind[14]; 
  Ghat[24] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[24]+0.3535533905932737*alphaDrSurf[0]*fUpwind[24]+0.3162277660168379*alphaDrSurf[1]*fUpwind[19]+0.3535533905932737*alphaDrSurf[7]*fUpwind[16]; 
  ...
  Ghat[26] = 0.22587697572631277*alphaDrSurf[7]*fUpwind[26]+0.3535533905932737*alphaDrSurf[0]*fUpwind[26]+0.3162277660168379*alphaDrSurf[1]*fUpwind[25]+0.3535533905932737*alphaDrSurf[7]*fUpwind[22]; 
  ...
  out[9] += 1.224744871391589*Ghat[3]*rdv2; 
  out[10] += 0.7071067811865475*Ghat[6]*rdv2; 
  out[11] += 0.7071067811865475*Ghat[7]*rdv2; 
  out[12] += 1.5811388300841895*Ghat[0]*rdv2; 
  out[13] += 0.7071067811865475*Ghat[8]*rdv2; 
  out[14] += 0.7071067811865475*Ghat[9]*rdv2; 
  out[15] += 1.224744871391589*Ghat[4]*rdv2; 
  out[16] += 1.224744871391589*Ghat[5]*rdv2; 
  out[17] += 0.7071067811865475*Ghat[10]*rdv2; 
  out[18] += 1.224744871391589*Ghat[6]*rdv2; 
  out[19] += 1.224744871391589*Ghat[7]*rdv2; 
  out[20] += 1.5811388300841898*Ghat[1]*rdv2; 
  out[21] += 0.7071067811865475*Ghat[11]*rdv2; 
  out[22] += 1.5811388300841898*Ghat[2]*rdv2; 
  out[23] += 0.7071067811865475*Ghat[12]*rdv2; 
  out[24] += 1.224744871391589*Ghat[8]*rdv2; 
  out[25] += 0.7071067811865475*Ghat[13]*rdv2; 
  out[26] += 1.5811388300841898*Ghat[3]*rdv2; 
  out[27] += 0.7071067811865475*Ghat[14]*rdv2; 
  out[28] += 0.7071067811865475*Ghat[15]*rdv2; 
  out[29] += 1.224744871391589*Ghat[9]*rdv2; 
  out[30] += 0.7071067811865475*Ghat[16]*rdv2; 
  out[31] += 1.224744871391589*Ghat[10]*rdv2; 
  out[32] += 1.224744871391589*Ghat[11]*rdv2; 
  out[33] += 1.5811388300841895*Ghat[4]*rdv2; 
  out[34] += 1.224744871391589*Ghat[12]*rdv2; 
  out[35] += 1.224744871391589*Ghat[13]*rdv2; 
  out[36] += 1.5811388300841895*Ghat[5]*rdv2; 
  out[37] += 0.7071067811865475*Ghat[17]*rdv2; 
  out[38] += 1.5811388300841895*Ghat[6]*rdv2; 
  out[39] += 0.7071067811865475*Ghat[18]*rdv2; 
  out[40] += 1.224744871391589*Ghat[14]*rdv2; 
  out[41] += 1.224744871391589*Ghat[15]*rdv2; 
  out[42] += 0.7071067811865475*Ghat[19]*rdv2; 
  out[43] += 1.224744871391589*Ghat[16]*rdv2; 
  out[44] += 1.5811388300841895*Ghat[7]*rdv2; 
  out[45] += 0.7071067811865475*Ghat[20]*rdv2; 
  out[46] += 1.5811388300841895*Ghat[8]*rdv2; 
  out[47] += 0.7071067811865475*Ghat[21]*rdv2; 
  out[48] += 1.5811388300841895*Ghat[9]*rdv2; 
  out[49] += 0.7071067811865475*Ghat[22]*rdv2; 
  out[50] += 1.224744871391589*Ghat[17]*rdv2; 
  out[51] += 1.5811388300841898*Ghat[10]*rdv2; 
  out[52] += 1.224744871391589*Ghat[18]*rdv2; 
  out[53] += 1.224744871391589*Ghat[19]*rdv2; 
  out[54] += 1.5811388300841898*Ghat[11]*rdv2; 
  out[55] += 1.224744871391589*Ghat[20]*rdv2; 
  out[56] += 1.5811388300841898*Ghat[12]*rdv2; 
  out[57] += 1.5811388300841898*Ghat[13]*rdv2; 
  out[58] += 0.7071067811865475*Ghat[23]*rdv2; 
  out[59] += 1.5811388300841898*Ghat[14]*rdv2; 
  out[60] += 1.224744871391589*Ghat[21]*rdv2; 
  out[61] += 1.5811388300841898*Ghat[15]*rdv2; 
  out[62] += 0.7071067811865475*Ghat[24]*rdv2; 
  out[63] += 1.5811388300841898*Ghat[16]*rdv2; 
  out[64] += 0.7071067811865475*Ghat[25]*rdv2; 
  out[65] += 1.224744871391589*Ghat[22]*rdv2; 
  out[66] += 1.5811388300841895*Ghat[17]*rdv2; 
  out[67] += 1.224744871391589*Ghat[23]*rdv2; 
  out[68] += 1.5811388300841895*Ghat[18]*rdv2; 
  out[69] += 1.224744871391589*Ghat[24]*rdv2; 
  out[70] += 1.5811388300841895*Ghat[19]*rdv2; 
  out[71] += 1.224744871391589*Ghat[25]*rdv2; 
  out[72] += 1.5811388300841895*Ghat[20]*rdv2; 
  out[73] += 1.5811388300841895*Ghat[21]*rdv2; 
  out[74] += 0.7071067811865475*Ghat[26]*rdv2; 
  out[75] += 1.5811388300841895*Ghat[22]*rdv2; 
  out[76] += 1.5811388300841898*Ghat[23]*rdv2; 
  out[77] += 1.5811388300841898*Ghat[24]*rdv2; 
  out[78] += 1.224744871391589*Ghat[26]*rdv2; 
