...
vlasovApp = Vlasov.App.new {
  ...
  neut = Vlasov.Species.new {
    ...
    useHo = false, -- Use higher order intergation for surface terms 

    -- vals_ij = e_{x} . \sigma_{x}
    covTangentBasis = function (t, xn)
      local q_x = xn[1]

      local e_xx = 1 -- Covariant Tangent Basis Coefficients (x-x coefficient).
    ...
    triadBasis = function (t, xn)
      ...
      local sigma_xx = 1 -- Triad Basis Coefficients (x-x coefficient).
