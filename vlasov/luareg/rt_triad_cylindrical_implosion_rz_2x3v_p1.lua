...
V_theta_drift_l = 1.0 -- Left/inner drift velocity (angular direction).
...
V_theta_drift_r = 1.0 -- Right/outer drift velocity (angular direction).
...
r_spherical_region = 0.2 -- Radius of the high-density intial sphere.
z0_spherical_region = 0.4 -- Height of the sperical region.
    ...
    projections = {
      {
        ...
        densityInit = function (t, xn)
          ...
          local r_from_spherical_center = math.sqrt( (r - r0_spherical_region) * (r - r0_spherical_region) 
            + (z - z0_spherical_region) * (z - z0_spherical_region) )

          local n = 0.0
          if r_from_spherical_center < r_spherical_region then
