...
Nr = 4 -- 64 -- Cell count (configuration space: radial direction).
Nvr = 8 -- 96 -- Cell count (velocity space: radial direction).
Nvtheta = 8 -- 96 --Cell count (velocity space: theta direction).
Nvphi = 8 -- 96 --Cell count (velocity space: angular direction).
