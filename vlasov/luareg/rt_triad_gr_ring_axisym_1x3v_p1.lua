...
Nvr = 64 -- Cell count (velocity space: radial direction).
Nvtheta =  64 --Cell count (velocity space: theta direction).
Nvphi = 64 --Cell count (velocity space: angular direction).
