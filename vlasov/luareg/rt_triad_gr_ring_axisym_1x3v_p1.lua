...
Nr = 8 --64 -- Cell count (configuration space: radial direction).
Nvr = 12 -- 64 -- Cell count (velocity space: radial direction).
Nvtheta =  12 -- 64 --Cell count (velocity space: theta direction).
Nvphi = 12 -- 64 --Cell count (velocity space: angular direction).
