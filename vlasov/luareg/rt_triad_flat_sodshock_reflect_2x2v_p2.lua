...
Nvx = 12 -- Cell count (velocity space: x direction).
Nvy = 12 -- Cell count (velocity space: y direction).
...
vlasovApp = Vlasov.App.new {
  ...
  periodicDirs = { 2 }, -- Periodic directions (y - dire).
  ...
  neut = Vlasov.Species.new {
    ...
    triadBasisGradient = function (t, xn)
      ...
      return d_sigma_xx_dx, d_sigma_xy_dx, d_sigma_yx_dx, d_sigma_yy_dx, d_sigma_xx_dy, d_sigma_xy_dy, d_sigma_yx_dy, d_sigma_yy_dy
    end,
