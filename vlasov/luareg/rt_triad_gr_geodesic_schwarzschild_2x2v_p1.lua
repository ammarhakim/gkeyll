...
Ntheta = 12 -- Cell count (configuration space: radial direction).
...
vtheta_max = 0.5 * vt -- Domain boundary (velocity space: angular direction).
poly_order = 1 -- Polynomial order.
basis_type = "serendipity" -- Basis function set.
time_stepper = "rk3" -- Time integrator.
cfl_frac = 1.0 -- CFL coefficient.

t_end = 0.1 -- 20.0 -- Final simulation time.
    ...
    projections = {
      {
        ...
        init = function (t, xn)
          ...
          local sigma_r = 0.005
          local sigma_phi = 0.005
          local sigma_pr = 0.005
          local sigma_pphi = 0.005
