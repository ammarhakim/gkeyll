...
Ntheta = 12 -- 48 -- Cell count (configuration space: radial direction).
Nvr = 12 -- 94 -- Cell count (velocity space: radial direction).
Nvtheta = 12 -- 64 -- Cell count (velocity space: angular direction).
