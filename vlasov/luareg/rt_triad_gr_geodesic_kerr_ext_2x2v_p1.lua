...
Ntheta = 56  -- Cell count (configuration space: radial direction).
Nvr = 256  -- Cell count (velocity space: radial direction).
Nvtheta = 256 -- Cell count (velocity space: angular direction).
...
spinBH = 0.999 -- Spin parameter, a = J/M, of the Kerr-Schild black hole
...
vlasovApp = Vlasov.App.new {
  ...
  decompCuts = { 4, 4 }, -- Cuts in each coodinate direction (x-direction only).
    ...
    projections = {
      {
        ...
        init = function (t, xn)
          ...
          local sigma_r = 0.0025 
          local sigma_phi = 0.00125 
          local sigma_pr = 0.0005
          local sigma_pphi = 0.0005

          -- Peak location (at the geodesic we aim to follow)
          local r0 = 2.5
          local phi0 = 7.0*math.pi/8.0
          local pr0 = 10.0
          local pphi0 = 0.0
