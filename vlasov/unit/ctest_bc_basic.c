...
test_bc(int cdim, int vdim, int poly_order, char *boundary_type, bool useGPU)
{
  ...
  if (cdim == 1 && vdim == 1) {
    projDistf = gkyl_proj_on_basis_new(&grid, &basis, poly_order + 1, 1, evalFunc_1x1v, NULL);
  } else if (cdim == 1 && vdim == 2) {
    projDistf = gkyl_proj_on_basis_new(&grid, &basis, poly_order + 1, 1, evalFunc_1x2v, NULL);
  } else if (cdim == 2 && vdim == 2) {
    projDistf = gkyl_proj_on_basis_new(&grid, &basis, poly_order + 1, 1, evalFunc_2x2v, NULL);
  } else if (cdim == 3 && vdim == 2) {
    projDistf = gkyl_proj_on_basis_new(&grid, &basis, poly_order + 1, 1, evalFunc_3x2v, NULL);
  }
...
void
test_bc_absorb_3x2v_p1()
{
  test_bc(3, 2, 1, "absorb", false);
}
void
test_bc_absorb_1x1v_p2()
{
  test_bc(1, 1, 2, "absorb", false);
}
void
test_bc_absorb_1x2v_p2()
{
  test_bc(1, 2, 2, "absorb", false);
}
void
test_bc_absorb_2x2v_p2()
{
  test_bc(2, 2, 2, "absorb", false);
}
void
test_bc_absorb_3x2v_p2()
{
...
#ifdef GKYL_HAVE_CUDA
void
test_bc_reflect_1x1v_p1_gpu()
{
  test_bc(1, 1, 1, "reflect", true);
}
void
test_bc_reflect_1x2v_p1_gpu()
{
  test_bc(1, 2, 1, "reflect", true);
}
void
test_bc_reflect_2x2v_p1_gpu()
{
  test_bc(2, 2, 1, "reflect", true);
}
void
test_bc_reflect_3x2v_p1_gpu()
{
  test_bc(3, 2, 1, "reflect", true);
}
void
test_bc_reflect_1x1v_p2_gpu()
{
  test_bc(1, 1, 2, "reflect", true);
}
void
test_bc_reflect_1x2v_p2_gpu()
{
  test_bc(1, 2, 2, "reflect", true);
}
void
test_bc_reflect_2x2v_p2_gpu()
{
  test_bc(2, 2, 2, "reflect", true);
}
void
test_bc_reflect_3x2v_p2_gpu()
{
  test_bc(3, 2, 2, "reflect", true);
}

void
test_bc_absorb_1x1v_p1_gpu()
{
  test_bc(1, 1, 1, "absorb", true);
}
void
test_bc_absorb_1x2v_p1_gpu()
{
  test_bc(1, 2, 1, "absorb", true);
}
void
test_bc_absorb_2x2v_p1_gpu()
{
  test_bc(2, 2, 1, "absorb", true);
}
void
test_bc_absorb_3x2v_p1_gpu()
{
  test_bc(3, 2, 1, "absorb", true);
}
void
test_bc_absorb_1x1v_p2_gpu()
{
  test_bc(1, 1, 2, "absorb", true);
}
void
test_bc_absorb_1x2v_p2_gpu()
{
  test_bc(1, 2, 2, "absorb", true);
}
void
test_bc_absorb_2x2v_p2_gpu()
{
  test_bc(2, 2, 2, "absorb", true);
}
void
test_bc_absorb_3x2v_p2_gpu()
{
