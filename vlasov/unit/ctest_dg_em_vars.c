...
void test_1x_p1_ho() { test(1, 8, 1, 1.0e-12, 0, 0, false); }
void test_2x_p1_ho() { test(2, 8, 1, 1.0e-12, 0, 0, false); }
void test_3x_p1_ho() { test(3, 4, 1, 1.0e-12, 0, 0, false); }

void test_1x_p2_ho() { test(1, 8, 2, 1.0e-12, 0, 0, false); }
// Higher dimensions, p=2, *only* testing is b . b = 1 like we expect
void test_2x_tensor_p2_ho() { test(2, 8, 2, 1.0e-12, 1, 0, false); }
void test_3x_tensor_p2_ho() { test(3, 8, 2, 1.0e-12, 1, 0, false); }

#ifdef GKYL_HAVE_CUDA
void test_1x_p1_dev() { test(1, 8, 1, 1.0e-12, 0, 0, true); }
void test_2x_p1_dev() { test(2, 8, 1, 1.0e-12, 0, 0, true); }
void test_3x_p1_dev() { test(3, 8, 1, 1.0e-12, 0, 0, true); }

void test_1x_p2_dev() { test(1, 8, 2, 1.0e-12, 0, 0, true); }
void test_2x_tensor_p2_dev() { test(2, 8, 2, 1.0e-12, 1, 0, true); }
void test_3x_tensor_p2_dev() { test(3, 8, 2, 1.0e-12, 1, 0, true); }


#endif

TEST_LIST = {
  { "test_1x_p1_ho", test_1x_p1_ho },
  { "test_2x_p1_ho", test_2x_p1_ho },
  { "test_3x_p1_ho", test_3x_p1_ho },

  { "test_1x_p2_ho", test_1x_p2_ho },
  ...
  // { "test_2x_tensor_p2_ho", test_2x_tensor_p2_ho },
  // { "test_3x_tensor_p2_ho", test_3x_tensor_p2_ho },

#ifdef GKYL_HAVE_CUDA
  { "test_1x_p1_dev", test_1x_p1_dev },
  { "test_2x_p1_dev", test_2x_p1_dev },
  { "test_3x_p1_dev", test_3x_p1_dev },

  { "test_1x_p2_dev", test_1x_p2_dev },
  // Disabled for the same positivity-fallback reason as the CPU tensor tests.
  // { "test_2x_tensor_p2_dev", test_2x_tensor_p2_dev },
  // { "test_3x_tensor_p2_dev", test_3x_tensor_p2_dev },
