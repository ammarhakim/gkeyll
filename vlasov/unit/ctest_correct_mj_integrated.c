...
test_1x1v(int poly_order)
{
  ...
  // Write the output
  char fname[1024];
  sprintf(fname, "ctest_correct_mj_integrated_1x1v_p%d_uncorr_distf.gkyl", poly_order);
  ...
  // Write the output
  sprintf(fname, "ctest_correct_mj_integrated_1x1v_p%d_corr_distf.gkyl", poly_order);
  gkyl_grid_sub_array_write(&grid, &local, 0, distf, fname);
...
test_1x3v(int poly_order)
{
  ...
  // values to compare  at index (1, 17) [remember, lower-left index is (1,1)]
  double p2_vals[] = {1.5819390031975651e-03, 2.5720183988446416e-18, 1.0700876394730175e-03,
    8.5629879470571998e-04, 6.4850905637726692e-04, 5.2208519720261811e-19, 1.5937726187875011e-19,
    5.9809665816689588e-04, 2.8612227216605725e-19, 4.6013135572977617e-04, 3.7638909621631869e-04,
    -9.0978497646911868e-19, 2.7373220001829511e-04, 1.3912287294472883e-04, 3.7394857991064584e-05,
    -4.6844789069773746e-19, -3.5977793929054813e-19, -3.8849419038681649e-19, 2.7693785965765609e-04,
    3.3882905954359150e-18, -2.8930461286108444e-19, 3.1182397469327343e-18, 1.5898273151337966e-04,
    -3.8855485385224933e-19, 1.0203890575745039e-04, 2.5928046875002281e-18, 1.2453624918103262e-04,
    6.7739291669182834e-05, -1.4181501209037920e-19, 3.1281638798776470e-05, 2.7334617642704901e-05,
    -5.6222572788803068e-19, 4.3344051651469733e-18, -3.6156368224189595e-19, -2.9456325469804248e-19,
    3.5869051706599038e-18, -2.7815004973246546e-19, 3.0007801591913052e-18, 7.8511777661375827e-05,
    -3.4939469370485203e-19, 5.2823582280710985e-05, -1.1154548622058598e-19, -1.6612583507209721e-19,
    2.3639425073886631e-05, 3.0460970432768787e-18, -2.4795666424908292e-19, -2.9542550463487416e-19,
    -1.6013775096808432e-19};
