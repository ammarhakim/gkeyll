...
__global__ static void gkyl_fpo_vlasov_diff_set_auxfields_cu_kernel(const struct gkyl_dg_eqn *eqn,
...
dg_fpo_vlasov_diff_set_cu_dev_ptrs(struct dg_fpo_vlasov_diff *fpo_vlasov_diff,
                                                       ...
                                                       const struct gkyl_range *phase_range)
{
  ...
  gkyl_cu_memcpy(fpo_vlasov_diff_cu, fpo_vlasov_diff, sizeof(struct dg_fpo_vlasov_diff),
                 GKYL_CU_MEMCPY_H2D);

  dg_fpo_vlasov_diff_set_cu_dev_ptrs<<<1, 1> > >(fpo_vlasov_diff_cu, pbasis->b_type, cdim,
                                                 poly_order);
