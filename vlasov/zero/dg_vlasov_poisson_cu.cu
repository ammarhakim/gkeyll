                                                         ...
                                                         enum gkyl_field_id field_id)
{
  ...
  const gkyl_dg_vlasov_poisson_stream_surf_kern_list *stream_surf_x_kernels, *stream_surf_y_kernels,
    *stream_surf_z_kernels;
  const gkyl_dg_vlasov_poisson_accel_surf_kern_list *accel_surf_vx_kernels, *accel_surf_vy_kernels,
                                                      ...
                                                      enum gkyl_field_id field_id)
{
  ...
  struct dg_vlasov_poisson *vlasov_cu =
