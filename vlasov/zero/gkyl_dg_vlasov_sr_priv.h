...
} gkyl_dg_vlasov_sr_stream_vol_kern_list;
typedef struct {
  vol_termf_t kernels[3];
} gkyl_dg_vlasov_sr_vol_kern_list;
typedef struct {
  vlasov_sr_stream_surf_t kernels[3];
} gkyl_dg_vlasov_sr_stream_surf_kern_list;
typedef struct {
  vlasov_sr_accel_surf_t kernels[3];
} gkyl_dg_vlasov_sr_accel_surf_kern_list;
typedef struct {
  vlasov_sr_accel_boundary_surf_t kernels[3];
} gkyl_dg_vlasov_sr_accel_boundary_surf_kern_list;
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_1x1v_ser_p1(
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_1x1v_ser_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_1x2v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_1x2v_ser_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_1x3v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_1x3v_ser_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_2x2v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_2x2v_ser_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_2x3v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_2x3v_ser_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}
  ...
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_sr_stream_vol_3x3v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov_sr->auxfields.gamma, vidx), 0, qIn, qRhsOut);
}

// Volume kernel list for relativistic streaming only
GKYL_CU_D static const gkyl_dg_vlasov_sr_stream_vol_kern_list ser_stream_vol_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_vol_kern_list ser_vol_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_stream_surf_kern_list ser_stream_surf_x_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_stream_surf_kern_list ser_stream_surf_y_kernels[] = {
  // 1x kernels
  {NULL, NULL, NULL}, // 0
  {NULL, NULL, NULL}, // 1
  {NULL, NULL, NULL}, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_stream_surf_kern_list ser_stream_surf_z_kernels[] = {
  // 1x kernels
  {NULL, NULL, NULL}, // 0
  {NULL, NULL, NULL}, // 1
  {NULL, NULL, NULL}, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_accel_surf_kern_list ser_accel_surf_vx_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_accel_surf_kern_list ser_accel_surf_vy_kernels[] = {
  // 1x kernels
  {NULL, NULL, NULL}, // 0
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_accel_surf_kern_list ser_accel_surf_vz_kernels[] = {
  // 1x kernels
  {NULL, NULL, NULL}, // 0
  {NULL, NULL, NULL}, // 1
...
GKYL_CU_D static const gkyl_dg_vlasov_sr_accel_boundary_surf_kern_list
