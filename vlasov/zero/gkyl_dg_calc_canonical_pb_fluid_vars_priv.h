...
typedef struct {
  canonical_pb_fluid_alpha_surf_t kernels[3];
} gkyl_dg_canonical_pb_fluid_alpha_surf_kern_list;
typedef struct {
  canonical_pb_fluid_source_t kernels[3];
} gkyl_dg_canonical_pb_fluid_source_kern_list;
typedef struct {
  canonical_pb_fluid_subtract_zonal_t kernels[3];
} gkyl_dg_canonical_pb_fluid_subtract_zonal_kern_list;
...
struct gkyl_dg_calc_canonical_pb_fluid_vars {
  ...
  canonical_pb_fluid_alpha_surf_t
    alpha_surf[3]; // kernel for computing surface expansion of configuration space flux alpha
  canonical_pb_fluid_alpha_surf_t
    alpha_edge_surf[3]; // kernel for computing surface expansion of configuration space flux alpha
  // at upper configuration space edge

  canonical_pb_fluid_source_t
    canonical_pb_fluid_source; // Canonical pb fluid variables source function
