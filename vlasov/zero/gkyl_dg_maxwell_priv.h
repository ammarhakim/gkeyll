...
} gkyl_dg_maxwell_vol_kern_list;
typedef struct {
  maxwell_surf_t kernels[4];
} gkyl_dg_maxwell_surf_kern_list;
...
GKYL_CU_D static const gkyl_dg_maxwell_vol_kern_list ser_vol_kernels[] = {
  { NULL, kernel_maxwell_vol_1x_ser_p1, kernel_maxwell_vol_1x_ser_p2,
    kernel_maxwell_vol_1x_ser_p3 }, // 0
  { NULL, kernel_maxwell_vol_2x_ser_p1, kernel_maxwell_vol_2x_ser_p2,
    kernel_maxwell_vol_2x_ser_p3 }, // 1
  { NULL, kernel_maxwell_vol_3x_ser_p1, kernel_maxwell_vol_3x_ser_p2, NULL } // 2
};

// Volume kernel list (Tensor basis)
GKYL_CU_D static const gkyl_dg_maxwell_vol_kern_list ten_vol_kernels[] = {
  { NULL, kernel_maxwell_vol_1x_ser_p1, kernel_maxwell_vol_1x_ser_p2,
    kernel_maxwell_vol_1x_ser_p3 }, // 0
...
GKYL_CU_D static const gkyl_dg_maxwell_surf_kern_list ser_surf_x_kernels[] = {
...
GKYL_CU_D static const gkyl_dg_maxwell_surf_kern_list ten_surf_x_kernels[] = {
  { NULL, maxwell_surfx_1x_ser_p1, maxwell_surfx_1x_ser_p2, maxwell_surfx_1x_ser_p3 }, // 0
...
GKYL_CU_D static const gkyl_dg_maxwell_surf_kern_list ser_surf_y_kernels[] = {
...
GKYL_CU_D static const gkyl_dg_maxwell_surf_kern_list ten_surf_y_kernels[] = {
  { NULL, NULL, NULL, NULL }, // 0
...
GKYL_CU_D static const gkyl_dg_maxwell_surf_kern_list ser_surf_z_kernels[] = {
  { NULL, NULL, NULL, NULL }, // 0
...
GKYL_CU_D static const gkyl_dg_maxwell_surf_kern_list ten_surf_z_kernels[] = {
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL, NULL }, // 1
