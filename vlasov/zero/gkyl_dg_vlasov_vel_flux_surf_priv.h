...
static const gkyl_vel_flux_surf_kern_list vel_flux_surf_kernels[] = {
  // 1x kernels
  { NULL, vel_flux_surf_1x1v_p1, vel_flux_surf_1x1v_p2, vel_flux_surf_1x1v_p3 }, // 0
  { NULL, vel_flux_surf_1x2v_p1, vel_flux_surf_1x2v_p2, NULL }, // 1
  { NULL, vel_flux_surf_1x3v_p1, vel_flux_surf_1x3v_p2, NULL }, // 2
  // 2x kernels
  { NULL, vel_flux_surf_2x1v_p1, vel_flux_surf_2x1v_p2, vel_flux_surf_2x1v_p3 }, // 3
...
static const gkyl_lax_flux_nodal_to_modal_kern_list ser_lax_flux_nodal_to_modal_vx_kernels[] = {
  // 1x kernels
  { NULL, lax_flux_nodal_to_modal_vx_1x1v_ser_p1, lax_flux_nodal_to_modal_vx_1x1v_ser_p2, lax_flux_nodal_to_modal_vx_1x1v_ser_p3 }, // 0
  ...
  // 2x kernels
  { NULL, lax_flux_nodal_to_modal_vx_2x1v_ser_p1, lax_flux_nodal_to_modal_vx_2x1v_ser_p2, lax_flux_nodal_to_modal_vx_2x1v_ser_p3 }, // 3
...
static const gkyl_lax_flux_nodal_to_modal_kern_list tensor_lax_flux_nodal_to_modal_vx_kernels[] = {
  // 1x kernels
  { NULL, NULL, lax_flux_nodal_to_modal_vx_1x1v_tensor_p2, lax_flux_nodal_to_modal_vx_1x1v_tensor_p3 }, // 0
...
static const gkyl_hamil_alpha_quad_kern_list ser_hamil_alpha_quad_vx_kernels[] = {
  // 1x kernels
  { NULL, hamil_alpha_quad_vx_1x1v_ser_p1, hamil_alpha_quad_vx_1x1v_ser_p2, hamil_alpha_quad_vx_1x1v_ser_p3 }, // 0
...
GKYL_CU_D
static const gkyl_hamil_alpha_quad_kern_list ser_nc_hamil_vel_alpha_quad_vx_kernels[] = {
  // 1x kernels
  { NULL, nc_hamil_vel_alpha_quad_vx_1x1v_ser_p1, nc_hamil_vel_alpha_quad_vx_1x1v_ser_p2, NULL }, // 0
  { NULL, nc_hamil_vel_alpha_quad_vx_1x2v_ser_p1, nc_hamil_vel_alpha_quad_vx_1x2v_ser_p2, NULL }, // 1
  { NULL, nc_hamil_vel_alpha_quad_vx_1x3v_ser_p1, nc_hamil_vel_alpha_quad_vx_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, nc_hamil_vel_alpha_quad_vx_2x2v_ser_p1, nc_hamil_vel_alpha_quad_vx_2x2v_ser_p2, NULL }, // 4
  { NULL, nc_hamil_vel_alpha_quad_vx_2x3v_ser_p1, nc_hamil_vel_alpha_quad_vx_2x3v_ser_p2, NULL }, // 5
  // 3x kernels
  { NULL, nc_hamil_vel_alpha_quad_vx_3x3v_ser_p1, NULL, NULL }, // 6
};

GKYL_CU_D
static const gkyl_hamil_alpha_quad_kern_list ser_nc_hamil_vel_alpha_quad_vy_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, nc_hamil_vel_alpha_quad_vy_1x2v_ser_p1, nc_hamil_vel_alpha_quad_vy_1x2v_ser_p2, NULL }, // 1
  { NULL, nc_hamil_vel_alpha_quad_vy_1x3v_ser_p1, nc_hamil_vel_alpha_quad_vy_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, nc_hamil_vel_alpha_quad_vy_2x2v_ser_p1, nc_hamil_vel_alpha_quad_vy_2x2v_ser_p2, NULL }, // 4
  { NULL, nc_hamil_vel_alpha_quad_vy_2x3v_ser_p1, nc_hamil_vel_alpha_quad_vy_2x3v_ser_p2, NULL }, // 5
  // 3x kernels
  { NULL, nc_hamil_vel_alpha_quad_vy_3x3v_ser_p1, NULL, NULL }, // 6
};

GKYL_CU_D
static const gkyl_hamil_alpha_quad_kern_list ser_nc_hamil_vel_alpha_quad_vz_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL, NULL }, // 1
  { NULL, nc_hamil_vel_alpha_quad_vz_1x3v_ser_p1, nc_hamil_vel_alpha_quad_vz_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, NULL, NULL, NULL }, // 4
  { NULL, nc_hamil_vel_alpha_quad_vz_2x3v_ser_p1, nc_hamil_vel_alpha_quad_vz_2x3v_ser_p2, NULL }, // 5
  // 3x kernels
  { NULL, nc_hamil_vel_alpha_quad_vz_3x3v_ser_p1, NULL, NULL }, // 6
};

// alpha_v evaluated at quadrature points for Hamil (NC) - vel dependance only - Hamiltonian forces (Serendipity basis).
// high-order intergation used (_ho)
GKYL_CU_D
static const gkyl_hamil_alpha_quad_kern_list ser_nc_hamil_vel_ho_alpha_quad_vx_kernels[] = {
  // 1x kernels
  { NULL, nc_hamil_vel_alpha_quad_vx_1x1v_ser_p1, nc_hamil_vel_ho_alpha_quad_vx_1x1v_ser_p2, NULL }, // 0
  { NULL, nc_hamil_vel_alpha_quad_vx_1x2v_ser_p1, nc_hamil_vel_ho_alpha_quad_vx_1x2v_ser_p2, NULL }, // 1
  { NULL, nc_hamil_vel_alpha_quad_vx_1x3v_ser_p1, nc_hamil_vel_ho_alpha_quad_vx_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, nc_hamil_vel_alpha_quad_vx_2x2v_ser_p1, nc_hamil_vel_ho_alpha_quad_vx_2x2v_ser_p2, NULL }, // 4
  { NULL, nc_hamil_vel_alpha_quad_vx_2x3v_ser_p1, NULL, NULL }, // 5
  // 3x kernels
  { NULL, nc_hamil_vel_alpha_quad_vx_3x3v_ser_p1, NULL, NULL }, // 6
};

GKYL_CU_D
static const gkyl_hamil_alpha_quad_kern_list ser_nc_hamil_vel_ho_alpha_quad_vy_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, nc_hamil_vel_alpha_quad_vy_1x2v_ser_p1, nc_hamil_vel_ho_alpha_quad_vy_1x2v_ser_p2, NULL }, // 1
  { NULL, nc_hamil_vel_alpha_quad_vy_1x3v_ser_p1, nc_hamil_vel_ho_alpha_quad_vy_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, nc_hamil_vel_alpha_quad_vy_2x2v_ser_p1, nc_hamil_vel_ho_alpha_quad_vy_2x2v_ser_p2, NULL }, // 4
  { NULL, nc_hamil_vel_alpha_quad_vy_2x3v_ser_p1, NULL, NULL }, // 5
  // 3x kernels
  { NULL, nc_hamil_vel_alpha_quad_vy_3x3v_ser_p1, NULL, NULL }, // 6
};

GKYL_CU_D
static const gkyl_hamil_alpha_quad_kern_list ser_nc_hamil_vel_ho_alpha_quad_vz_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL, NULL }, // 1
  { NULL, nc_hamil_vel_alpha_quad_vz_1x3v_ser_p1, nc_hamil_vel_ho_alpha_quad_vz_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, NULL, NULL, NULL }, // 4
  { NULL, nc_hamil_vel_alpha_quad_vz_2x3v_ser_p1, NULL, NULL }, // 5
  // 3x kernels
  { NULL, nc_hamil_vel_alpha_quad_vz_3x3v_ser_p1, NULL, NULL }, // 6
};
...
GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list ser_B_hamil_vel_alpha_quad_vx_kernels[] = {
  // 1x kernels
  { NULL, no_B_alpha_quad, no_B_alpha_quad, no_B_alpha_quad }, // 0
  { NULL, B_hamil_vel_alpha_quad_vx_1x2v_ser_p1, B_hamil_vel_alpha_quad_vx_1x2v_ser_p2, NULL }, // 1
  { NULL, B_hamil_vel_alpha_quad_vx_1x3v_ser_p1, B_hamil_vel_alpha_quad_vx_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, no_B_alpha_quad, no_B_alpha_quad, no_B_alpha_quad }, // 3
  { NULL, B_hamil_vel_alpha_quad_vx_2x2v_ser_p1, B_hamil_vel_alpha_quad_vx_2x2v_ser_p2, NULL }, // 4
  { NULL, B_hamil_vel_alpha_quad_vx_2x3v_ser_p1, B_hamil_vel_alpha_quad_vx_2x3v_ser_p2, NULL }, // 5
  // 3x kernels
  { NULL, B_hamil_vel_alpha_quad_vx_3x3v_ser_p1, NULL, NULL }, // 6
};

GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list ser_B_hamil_vel_alpha_quad_vy_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, B_hamil_vel_alpha_quad_vy_1x2v_ser_p1, B_hamil_vel_alpha_quad_vy_1x2v_ser_p2, NULL }, // 1
  { NULL, B_hamil_vel_alpha_quad_vy_1x3v_ser_p1, B_hamil_vel_alpha_quad_vy_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, B_hamil_vel_alpha_quad_vy_2x2v_ser_p1, B_hamil_vel_alpha_quad_vy_2x2v_ser_p2, NULL }, // 4
  { NULL, B_hamil_vel_alpha_quad_vy_2x3v_ser_p1, NULL, NULL }, // 5
  // 3x kernels
  { NULL, B_hamil_vel_alpha_quad_vy_3x3v_ser_p1, NULL, NULL }, // 6
};

GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list ser_B_hamil_vel_alpha_quad_vz_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL, NULL }, // 1
  { NULL, B_hamil_vel_alpha_quad_vz_1x3v_ser_p1, B_hamil_vel_alpha_quad_vz_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, NULL, NULL, NULL }, // 4
  { NULL, B_hamil_vel_alpha_quad_vz_2x3v_ser_p1, B_hamil_vel_alpha_quad_vz_2x3v_ser_p2, NULL }, // 5
  // 3x kernels
  { NULL, B_hamil_vel_alpha_quad_vz_3x3v_ser_p1, NULL, NULL }, // 6
};

// alpha_v evaluated at quadrature points for the magnetic field Lorentz force (Serendipity basis). 
GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list ser_B_ho_hamil_vel_alpha_quad_vx_kernels[] = {
  // 1x kernels
  { NULL, no_B_alpha_quad, no_B_alpha_quad, no_B_alpha_quad }, // 0
  { NULL, B_hamil_vel_alpha_quad_vx_1x2v_ser_p1, B_ho_hamil_vel_alpha_quad_vx_1x2v_ser_p2, NULL }, // 1
  { NULL, B_hamil_vel_alpha_quad_vx_1x3v_ser_p1, B_ho_hamil_vel_alpha_quad_vx_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, no_B_alpha_quad, no_B_alpha_quad, no_B_alpha_quad }, // 3
  { NULL, B_hamil_vel_alpha_quad_vx_2x2v_ser_p1, B_ho_hamil_vel_alpha_quad_vx_2x2v_ser_p2, NULL }, // 4
  { NULL, B_hamil_vel_alpha_quad_vx_2x3v_ser_p1, NULL, NULL }, // 5
  // 3x kernels
  { NULL, B_hamil_vel_alpha_quad_vx_3x3v_ser_p1, NULL, NULL }, // 6
};

GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list ser_B_ho_hamil_vel_alpha_quad_vy_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, B_hamil_vel_alpha_quad_vy_1x2v_ser_p1, B_ho_hamil_vel_alpha_quad_vy_1x2v_ser_p2, NULL }, // 1
  { NULL, B_hamil_vel_alpha_quad_vy_1x3v_ser_p1, B_ho_hamil_vel_alpha_quad_vy_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, B_hamil_vel_alpha_quad_vy_2x2v_ser_p1, B_ho_hamil_vel_alpha_quad_vy_2x2v_ser_p2, NULL }, // 4
  { NULL, B_hamil_vel_alpha_quad_vy_2x3v_ser_p1, NULL, NULL }, // 5
  // 3x kernels
  { NULL, B_hamil_vel_alpha_quad_vy_3x3v_ser_p1, NULL, NULL }, // 6
};
...
GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list ser_B_ho_hamil_vel_alpha_quad_vz_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL, NULL }, // 1
  { NULL, B_hamil_vel_alpha_quad_vz_1x3v_ser_p1, B_ho_hamil_vel_alpha_quad_vz_1x3v_ser_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, NULL, NULL, NULL }, // 4
  { NULL, B_hamil_vel_alpha_quad_vz_2x3v_ser_p1, NULL, NULL }, // 5
  // 3x kernels
  { NULL, B_hamil_vel_alpha_quad_vz_3x3v_ser_p1, NULL, NULL }, // 6
};

// alpha_v evaluated at quadrature points for the magnetic field Lorentz force with a general Hamiltonian (Serendipity basis). 
GKYL_CU_D
...
GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list tensor_B_hamil_vel_alpha_quad_vx_kernels[] = {
  // 1x kernels
  { NULL, NULL, no_B_alpha_quad, no_B_alpha_quad }, // 0
  { NULL, NULL, B_hamil_vel_alpha_quad_vx_1x2v_tensor_p2, NULL }, // 1
  { NULL, NULL, B_hamil_vel_alpha_quad_vx_1x3v_tensor_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, no_B_alpha_quad, no_B_alpha_quad }, // 3
  { NULL, NULL, B_hamil_vel_alpha_quad_vx_2x2v_tensor_p2, NULL }, // 4
  { NULL, NULL, NULL, NULL }, // 5
  // 3x kernels
  { NULL, NULL, NULL, NULL }, // 6
};
...
GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list tensor_B_hamil_vel_alpha_quad_vy_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, NULL, B_hamil_vel_alpha_quad_vy_1x2v_tensor_p2, NULL }, // 1
  { NULL, NULL, B_hamil_vel_alpha_quad_vy_1x3v_tensor_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, NULL, B_hamil_vel_alpha_quad_vy_2x2v_tensor_p2, NULL }, // 4
  { NULL, NULL, NULL, NULL }, // 5
  // 3x kernels
  { NULL, NULL, NULL, NULL }, // 6
};
...
GKYL_CU_D
static const gkyl_B_alpha_quad_kern_list tensor_B_hamil_vel_alpha_quad_vz_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL, NULL }, // 1
  { NULL, NULL, B_hamil_vel_alpha_quad_vz_1x3v_tensor_p2, NULL }, // 2
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 3
  { NULL, NULL, NULL, NULL }, // 4
  { NULL, NULL, NULL, NULL }, // 5
...
// alpha_v evaluated at quadrature points for the magnetic field Lorentz force with a general Hamiltonian (Tensor basis). 
GKYL_CU_D
