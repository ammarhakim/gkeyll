...
typedef struct {
  fluid_em_coupling_set_t kernels[4];
} gkyl_dg_fluid_em_coupling_set_kern_list;
typedef struct {
  fluid_em_coupling_copy_t kernels[4];
} gkyl_dg_fluid_em_coupling_copy_kern_list;
typedef struct {
  fluid_em_coupling_energy_t kernels[4];
} gkyl_dg_fluid_em_coupling_energy_kern_list;
...
struct gkyl_dg_calc_fluid_em_coupling {
  ...
  fluid_em_coupling_energy_t
    fluid_em_coupling_energy; // kernel for computing energy from updated solution (for Euler/5-moment)
