                                                       ...
                                                       enum gkyl_distribution_moments mom_type)
{
  ...
  struct mom_type_canonical_pb *mom_can_pb =
    (struct mom_type_canonical_pb *)gkyl_malloc(sizeof(struct mom_type_canonical_pb));
  ...
  struct mom_type_canonical_pb *momt_cu =
