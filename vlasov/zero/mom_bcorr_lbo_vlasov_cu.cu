...
gkyl_mom_bcorr_lbo_vlasov_set_cu_dev_ptrs(struct mom_type_bcorr_lbo_vlasov *mom_bcorr,
...
struct gkyl_mom_type *gkyl_mom_bcorr_lbo_vlasov_cu_dev_new(const struct gkyl_basis *cbasis,
                                                           ...
                                                           const double *vBoundary)
{
  ...
  struct mom_type_bcorr_lbo_vlasov *mom_bcorr =
    (struct mom_type_bcorr_lbo_vlasov *)gkyl_malloc(sizeof(struct mom_type_bcorr_lbo_vlasov));
  ...
  struct mom_type_bcorr_lbo_vlasov *mom_bcorr_cu =
    (struct mom_type_bcorr_lbo_vlasov *)gkyl_cu_malloc(sizeof(struct mom_type_bcorr_lbo_vlasov));
  gkyl_cu_memcpy(mom_bcorr_cu, mom_bcorr, sizeof(struct mom_type_bcorr_lbo_vlasov),
                 GKYL_CU_MEMCPY_H2D);

  assert(cv_index[cdim].vdim[vdim] != -1);

  gkyl_mom_bcorr_lbo_vlasov_set_cu_dev_ptrs<<<1, 1> > >(mom_bcorr_cu, cbasis->b_type, vdim,
                                                        poly_order, cv_index[cdim].vdim[vdim]);
