...
typedef double (*fpo_vlasov_drag_surf_t)(const double *w, const double *dxv, const double *h,
...
typedef double (*fpo_vlasov_drag_boundary_surf_t)(const double *w, const double *dxv,
                                                  const double *h, const int edge,
                                                  const double *fSkin, const double *fEdge,
                                                  double *GKYL_RESTRICT out);

// for use in kernel tables
typedef struct {
  vol_termf_t kernels[3];
} gkyl_dg_fpo_vlasov_drag_vol_kern_list;
typedef struct {
  fpo_vlasov_drag_surf_t kernels[3];
} gkyl_dg_fpo_vlasov_drag_surf_kern_list;
typedef struct {
  fpo_vlasov_drag_boundary_surf_t kernels[3];
} gkyl_dg_fpo_vlasov_drag_boundary_surf_kern_list;
...
GKYL_CU_DH static double kernel_fpo_vlasov_drag_vol_1x3v_ser_p1(const struct gkyl_dg_eqn *eqn,
                                                                ...
                                                                double *GKYL_RESTRICT qRhsOut)
{
  ...
  return fpo_vlasov_drag_vol_1x3v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(fpo_vlasov_drag->auxfields.h, pidx), qIn, qRhsOut);
}

GKYL_CU_DH static double kernel_fpo_vlasov_drag_vol_1x3v_ser_p2(const struct gkyl_dg_eqn *eqn,
                                                                const double *xc, const double *dx,
                                                                const int *idx, const double *qIn,
                                                                double *GKYL_RESTRICT qRhsOut)
{
  struct dg_fpo_vlasov_drag *fpo_vlasov_drag = container_of(eqn, struct dg_fpo_vlasov_drag, eqn);
  long pidx = gkyl_range_idx(&fpo_vlasov_drag->phase_range, idx);
  return fpo_vlasov_drag_vol_1x3v_ser_p2(
    xc, dx, (const double *)gkyl_array_cfetch(fpo_vlasov_drag->auxfields.h, pidx), qIn, qRhsOut);
}
...
// Volume kernel list
GKYL_CU_D static const gkyl_dg_fpo_vlasov_drag_vol_kern_list ser_vol_kernels[] = {
...
GKYL_CU_D static const gkyl_dg_fpo_vlasov_drag_surf_kern_list ser_surf_vx_kernels[] = {
...
GKYL_CU_D static const gkyl_dg_fpo_vlasov_drag_surf_kern_list ser_surf_vy_kernels[] = {
...
GKYL_CU_D static const gkyl_dg_fpo_vlasov_drag_surf_kern_list ser_surf_vz_kernels[] = {
                             ...
                             const double *qInR, double *GKYL_RESTRICT qRhsOut)
{
  ...
  if (dir >= fpo_vlasov_drag->cdim) {
    return fpo_vlasov_drag->surf[dir - fpo_vlasov_drag->cdim](
      xcC, dxC, (const double *)gkyl_array_cfetch(fpo_vlasov_drag->auxfields.h, pidx), qInL, qInC,
      qInR, qRhsOut);
  }
  return 0.;
}
                                      ...
                                      double *GKYL_RESTRICT qRhsOut)
{
  ...
  if (dir >= fpo_vlasov_drag->cdim) {
    return fpo_vlasov_drag->boundary_surf[dir - fpo_vlasov_drag->cdim](
      xcSkin, dxSkin, (const double *)gkyl_array_cfetch(fpo_vlasov_drag->auxfields.h, pidx), edge,
      qInSkin, qInEdge, qRhsOut);
  }
  return 0.;
}
