...
static inline int diffdirs_linidx(const bool *isdirdiff, int cdim)
{
  ...
  for (int d = 0; d < cdim; d++) {
    if (diff_in_dir[d])
      dirs_linidx = dirs_linidx | dirs_bin_key[d];
  }
  dirs_linidx -= 1;
  return dirs_linidx;
}
...
typedef double (*diffusion_boundary_surf_t)(const double *w, const double *dx, const double *coeff,
                                            int edge, const double *fSkin, const double *fEdge,
                                            double *GKYL_RESTRICT out);
...
} gkyl_dg_diffusion_fluid_vol_kern_list;
...
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_1x_ser_p1_constcoeff_diffdirsx(
  ...
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return dg_diffusion_fluid_order2_vol_1x_ser_p1_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_1x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_1x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
// 1x 4th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_1x_ser_p1_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_1x_ser_p1_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_1x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_1x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
// 1x 6th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_1x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_1x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
// 2x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
// 2x 4th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
// 2x 6th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
// 3x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
// 3x 4th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
// 3x 6th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
...
// 1x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_1x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_1x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
// 1x 4th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_1x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_1x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
// 1x 6th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_1x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_1x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
// 2x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
// 2x 4th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
// 2x 6th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
// 3x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                           qRhsOut);
}
// 3x 4th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                           qRhsOut);
}
// 3x 6th order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                          qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                           qRhsOut);
}
...
// 1x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_1x_ser_p1_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_1x_ser_p1_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_1x_ser_p2_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_1x_ser_p2_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
// 2x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
// 3x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                    qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                     qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                      qRhsOut);
}
...
// 1x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_1x_tensor_p2_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_1x_tensor_p2_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
// 2x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
// 3x 2nd order diffusion.
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsx(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsx(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsy(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxy(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxy(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsz(xc, dx, _cfD(idx), qIn,
                                                                       qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxz(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsyz(xc, dx, _cfD(idx), qIn,
                                                                        qRhsOut);
}
GKYL_CU_DH static double ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxyz(
  const struct gkyl_dg_eqn *eqn, const double *xc, const double *dx, const int *idx,
  const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxyz(xc, dx, _cfD(idx), qIn,
                                                                         qRhsOut);
}
...
#define CKVOL(lst, cdim, diff_order, poly_order, diffdir_linidx) \
  lst[cdim - 1].list[diff_order / 2 - 1].list[poly_order - 1].kernels[diffdir_linidx]
#define CKSURF(lst, diff_order, cdim, poly_order) \
  lst[diff_order / 2 - 1].list[cdim - 1].kernels[poly_order - 1]
                                      ...
                                      double *GKYL_RESTRICT qRhsOut)
{
  ...
  if (diffusion->diff_in_dir[dir]) {
    for (int c = 0; c < diffusion->num_equations; c++) {
      int off = c * diffusion->num_basis;
      diffusion->boundary_surf[dir](xcSkin, dxSkin, _cfD(idxSkin), edge, qInSkin + off,
                                    qInEdge + off, qRhsOut + off);
    }
  }
  return 0.; // CFL frequency computed in volume term.
}
 ...
 */
struct gkyl_dg_eqn *gkyl_dg_diffusion_fluid_cu_dev_new(const struct gkyl_basis *basis,
                                                       bool is_diff_const, int num_equations,
                                                       const bool *diff_in_dir, int diff_order,
