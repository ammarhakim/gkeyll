...
ker_dg_diffusion_fluid_order2_vol_1x_ser_p1_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_1x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_1x_ser_p1_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_1x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_1x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_ser_p1_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_ser_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_2x_ser_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p1_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_ser_p2_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_ser_p2_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 1x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_1x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 1x 4th order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_1x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 1x 6th order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_1x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 2x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 2x 4th order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_2x_tensor_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 2x 6th order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_2x_tensor_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 3x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 3x 4th order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order4_vol_3x_tensor_p2_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 3x 6th order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order6_vol_3x_tensor_p2_constcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 1x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_1x_ser_p1_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_1x_ser_p1_varcoeff_diffdirsx(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_1x_ser_p2_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_1x_ser_p2_varcoeff_diffdirsx(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
// 2x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsx(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsy(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p1_varcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsx(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsy(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_ser_p2_varcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 3x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsx(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsy(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsz(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p1_varcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsx(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsy(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
  return dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsz(
    xc, dx, _cfD(idx), qIn, qRhsOut);
}
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_ser_p2_varcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 1x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_1x_tensor_p2_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 2x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_2x_tensor_p2_varcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
// 3x 2nd order diffusion.
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsx(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxy(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
GKYL_CU_DH static double
ker_dg_diffusion_fluid_order2_vol_3x_tensor_p2_varcoeff_diffdirsxyz(const struct gkyl_dg_eqn *eqn,
  const double *xc, const double *dx, const int *idx, const double *qIn,
  double *GKYL_RESTRICT qRhsOut)
{
  struct dg_diffusion_fluid *diffusion = container_of(eqn, struct dg_diffusion_fluid, eqn);
...
struct gkyl_dg_eqn *gkyl_dg_diffusion_fluid_cu_dev_new(const struct gkyl_basis *basis,
  bool is_diff_const, int num_equations, const bool *diff_in_dir, int diff_order,
