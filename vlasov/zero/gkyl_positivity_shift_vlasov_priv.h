...
} pos_shift_vlasov_kern_list_m0_pos_check; // For use in kernel tables.
typedef struct {
  shift_t kernels[3];
} pos_shift_vlasov_kern_list_shift; // For use in kernel tables.
typedef struct {
  m0_t kernels[3];
} pos_shift_vlasov_kern_list_m0; // For use in kernel tables.
