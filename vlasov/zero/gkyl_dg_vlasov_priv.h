...
} gkyl_dg_vlasov_stream_vol_kern_list;
typedef struct {
  vol_termf_t kernels[3];
} gkyl_dg_vlasov_vol_kern_list;

typedef struct {
  vlasov_stream_surf_t kernels[3];
} gkyl_dg_vlasov_stream_surf_kern_list;

typedef struct {
  vlasov_stream_boundary_surf_t kernels[3];
} gkyl_dg_vlasov_stream_boundary_surf_kern_list;

typedef struct {
  vlasov_accel_surf_t kernels[3];
} gkyl_dg_vlasov_accel_surf_kern_list;

typedef struct {
  vlasov_accel_boundary_surf_t kernels[3];
} gkyl_dg_vlasov_accel_boundary_surf_kern_list;
...
kernel_vlasov_stream_vol_1x1v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x1v_ser_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x2v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x2v_ser_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x3v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x3v_ser_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x2v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x2v_ser_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x3v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x3v_ser_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_3x3v_ser_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
// Volume kernel list
GKYL_CU_D static const gkyl_dg_vlasov_stream_vol_kern_list ser_stream_vol_kernels[] = {
  // 1x kernels
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x1v_tensor_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x1v_tensor_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x2v_tensor_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x2v_tensor_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x3v_tensor_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_1x3v_tensor_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x2v_tensor_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x2v_tensor_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x3v_tensor_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_2x3v_tensor_p2(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
GKYL_CU_DH static double
kernel_vlasov_stream_vol_3x3v_tensor_p1(const struct gkyl_dg_eqn *eqn, const double *xc,
  const double *dx, const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
...
// Volume kernel list
GKYL_CU_D static const gkyl_dg_vlasov_stream_vol_kern_list tensor_stream_vol_kernels[] = {
  // 1x kernels
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  return vlasov_vol_1x1v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_3x3v_ser_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}

GKYL_CU_D static const gkyl_dg_vlasov_vol_kern_list ser_vol_kernels[] = {
  // 1x kernels
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_1x1v_tensor_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_1x1v_tensor_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_1x2v_tensor_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_1x2v_tensor_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_1x3v_tensor_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_1x3v_tensor_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_2x2v_tensor_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_2x2v_tensor_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_2x3v_tensor_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_2x3v_tensor_p2(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}
  ...
  const int *idx, const double *qIn, double *GKYL_RESTRICT qRhsOut)
{
  ...
  long cidx = gkyl_range_idx(&vlasov->conf_range, idx);
  return vlasov_vol_3x3v_tensor_p1(
    xc, dx, (const double *)gkyl_array_cfetch(vlasov->auxfields.field, cidx), qIn, qRhsOut);
}

GKYL_CU_D static const gkyl_dg_vlasov_vol_kern_list tensor_vol_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_surf_kern_list ser_stream_surf_x_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_surf_kern_list tensor_stream_surf_x_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_surf_kern_list ser_stream_surf_y_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_surf_kern_list tensor_stream_surf_y_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_surf_kern_list ser_stream_surf_z_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_surf_kern_list tensor_stream_surf_z_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
  { NULL, NULL, NULL }, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_surf_kern_list ser_accel_surf_vx_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_surf_kern_list tensor_accel_surf_vx_kernels[] = {
  // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_surf_kern_list ser_accel_surf_vy_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_surf_kern_list tensor_accel_surf_vy_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_surf_kern_list ser_accel_surf_vz_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_surf_kern_list tensor_accel_surf_vz_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL }, // 0
  { NULL, NULL, NULL }, // 1
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_boundary_surf_kern_list
  ser_stream_boundary_surf_x_kernels[] = {
    // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_boundary_surf_kern_list
  tensor_stream_boundary_surf_x_kernels[] = {
    // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_boundary_surf_kern_list
  tensor_stream_boundary_surf_y_kernels[] = {
    // 1x kernels
    { NULL, NULL, NULL }, // 0
    { NULL, NULL, NULL }, // 1
    { NULL, NULL, NULL }, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_stream_boundary_surf_kern_list
  tensor_stream_boundary_surf_z_kernels[] = {
    // 1x kernels
    { NULL, NULL, NULL }, // 0
    { NULL, NULL, NULL }, // 1
    { NULL, NULL, NULL }, // 2
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_boundary_surf_kern_list
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_boundary_surf_kern_list
  tensor_accel_boundary_surf_vx_kernels[] = {
    // 1x kernels
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_boundary_surf_kern_list
  tensor_accel_boundary_surf_vy_kernels[] = {
    // 1x kernels
    { NULL, NULL, NULL }, // 0
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_boundary_surf_kern_list
  ser_accel_boundary_surf_vz_kernels[] = {
    // 1x kernels
    { NULL, NULL, NULL }, // 0
    { NULL, NULL, NULL }, // 1
...
GKYL_CU_D static const gkyl_dg_vlasov_accel_boundary_surf_kern_list
  tensor_accel_boundary_surf_vz_kernels[] = {
    // 1x kernels
    { NULL, NULL, NULL }, // 0
    { NULL, NULL, NULL }, // 1
  ...
  if (dir < vlasov->cdim) {
    ...
    return vlasov->stream_surf[dir](xcC, dxC,
      vlasov->auxfields.alpha_surf
        ...
        : 0,
      vlasov->auxfields.alpha_surf
        ? (const double *)gkyl_array_cfetch(vlasov->auxfields.alpha_surf, pidxR)
        : 0,
      vlasov->auxfields.sgn_alpha_surf
        ? (const double *)gkyl_array_cfetch(vlasov->auxfields.sgn_alpha_surf, pidxC)
        : 0,
      vlasov->auxfields.sgn_alpha_surf
        ? (const double *)gkyl_array_cfetch(vlasov->auxfields.sgn_alpha_surf, pidxR)
        : 0,
      vlasov->auxfields.const_sgn_alpha
        ? (const int *)gkyl_array_cfetch(vlasov->auxfields.const_sgn_alpha, pidxC)
        : 0,
      vlasov->auxfields.const_sgn_alpha
        ? (const int *)gkyl_array_cfetch(vlasov->auxfields.const_sgn_alpha, pidxR)
        : 0,
  ...
  if (dir < vlasov->cdim) {
    ...
    return vlasov->stream_boundary_surf[dir](xcSkin, dxSkin,
      vlasov->auxfields.alpha_surf
        ...
        : 0,
      vlasov->auxfields.alpha_surf
        ? (const double *)gkyl_array_cfetch(vlasov->auxfields.alpha_surf, pidxSkin)
        : 0,
      vlasov->auxfields.sgn_alpha_surf
        ? (const double *)gkyl_array_cfetch(vlasov->auxfields.sgn_alpha_surf, pidxEdge)
        : 0,
      vlasov->auxfields.sgn_alpha_surf
        ? (const double *)gkyl_array_cfetch(vlasov->auxfields.sgn_alpha_surf, pidxSkin)
        : 0,
      vlasov->auxfields.const_sgn_alpha
        ? (const int *)gkyl_array_cfetch(vlasov->auxfields.const_sgn_alpha, pidxEdge)
        : 0,
      vlasov->auxfields.const_sgn_alpha
        ? (const int *)gkyl_array_cfetch(vlasov->auxfields.const_sgn_alpha, pidxSkin)
        : 0,
