...
typedef double (*lax_flux_nodal_to_modal_t)(const double *dxv, const double *det_h, const double *flux_l, 
  ...
  double* GKYL_RESTRICT flux_l, double* GKYL_RESTRICT flux_r, double* GKYL_RESTRICT alpha_quad)
{
  up->dg_gr_maxwell_alpha_quad[dir](w, dxv, geom_edge, lapse, shift, 
    h_ij, det_h, field_no_J_con_l, field_no_J_con_r, flux_l, flux_r, alpha_quad);  
}
   ...
   const double *field_no_J_con_r, double* GKYL_RESTRICT conf_flux_surf)
{
  ...
  double cflrate = up->lax_flux_nodal_to_modal[dir](dxv, det_h, flux_l, flux_r, alpha_quad,
...
static const gkyl_lax_flux_nodal_to_modal_kern_list ser_lax_flux_nodal_to_modal_x_kernels[] = {
  // 1x kernels
  { NULL, lax_flux_nodal_to_modal_x_1x_ser_p1, lax_flux_nodal_to_modal_x_1x_ser_p2, NULL }, // 0
  // 2x kernels
  { NULL, lax_flux_nodal_to_modal_x_2x_ser_p1, lax_flux_nodal_to_modal_x_2x_ser_p2, NULL }, // 1
  // 3x kernels
  { NULL, lax_flux_nodal_to_modal_x_3x_ser_p1, lax_flux_nodal_to_modal_x_3x_ser_p2, NULL }, // 2
};
...
static const gkyl_lax_flux_nodal_to_modal_kern_list ser_lax_flux_nodal_to_modal_y_kernels[] = {
  ...
  // 2x kernels
  { NULL, lax_flux_nodal_to_modal_y_2x_ser_p1, lax_flux_nodal_to_modal_y_2x_ser_p2, NULL }, // 1
  // 3x kernels
  { NULL, lax_flux_nodal_to_modal_y_3x_ser_p1, lax_flux_nodal_to_modal_y_3x_ser_p2, NULL }, // 2
};
...
static const gkyl_lax_flux_nodal_to_modal_kern_list ser_lax_flux_nodal_to_modal_z_kernels[] = {
  ...
  // 3x kernels
  { NULL, lax_flux_nodal_to_modal_z_3x_ser_p1, lax_flux_nodal_to_modal_z_3x_ser_p2, NULL }, // 2
};

// Nodal Lax-Friedrichs to modal Configuration-space flux conversion (Tensor basis). 
GKYL_CU_D
static const gkyl_lax_flux_nodal_to_modal_kern_list ten_lax_flux_nodal_to_modal_x_kernels[] = {
  // 1x kernels
  { NULL, lax_flux_nodal_to_modal_x_1x_tensor_p1, lax_flux_nodal_to_modal_x_1x_tensor_p2, NULL }, // 0
  // 2x kernels
  { NULL, lax_flux_nodal_to_modal_x_2x_tensor_p1, lax_flux_nodal_to_modal_x_2x_tensor_p2, NULL }, // 1
  // 3x kernels
  { NULL, lax_flux_nodal_to_modal_x_3x_tensor_p1, lax_flux_nodal_to_modal_x_3x_tensor_p2, NULL }, // 2
};

GKYL_CU_D
static const gkyl_lax_flux_nodal_to_modal_kern_list ten_lax_flux_nodal_to_modal_y_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  // 2x kernels
  { NULL, lax_flux_nodal_to_modal_y_2x_tensor_p1, lax_flux_nodal_to_modal_y_2x_tensor_p2, NULL }, // 1
  // 3x kernels
  { NULL, lax_flux_nodal_to_modal_y_3x_tensor_p1, lax_flux_nodal_to_modal_y_3x_tensor_p2, NULL }, // 2
};

GKYL_CU_D
static const gkyl_lax_flux_nodal_to_modal_kern_list ten_lax_flux_nodal_to_modal_z_kernels[] = {
  // 1x kernels
  { NULL, NULL, NULL, NULL }, // 0
  // 2x kernels
  { NULL, NULL, NULL, NULL }, // 1
  // 3x kernels
  { NULL, lax_flux_nodal_to_modal_z_3x_tensor_p1, lax_flux_nodal_to_modal_z_3x_tensor_p2, NULL }, // 2
};
