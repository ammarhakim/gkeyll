...
void
evalDensityInitBackGround(double t, const double* GKYL_RESTRICT xn, double* GKYL_RESTRICT fout, void* ctx)
{
  struct sphere_rot_ctx *app = ctx;
  double R = app->R;
  double pi = app->pi;
...
void
evalTempInitBackGround(double t, const double* GKYL_RESTRICT xn, double* GKYL_RESTRICT fout, void* ctx)
{
  struct sphere_rot_ctx *app = ctx;
  double theta = xn[0];
...
void
evalVDriftInitBackGround(double t, const double* GKYL_RESTRICT xn, double* GKYL_RESTRICT fout, void* ctx)
{
  struct sphere_rot_ctx *app = ctx;
  double theta = xn[0];
...
main(int argc, char **argv)
{
  ...
  struct gkyl_vlasov_kinetic_species neut = {
    ...
    // .projection[1] = {
    //   .proj_id = GKYL_PROJ_VLASOV_LTE,
    //   .density = evalDensityInitBackGround,
    //   .ctx_density = &ctx,
    //   .temp = evalTempInitBackGround,
    //   .ctx_temp = &ctx,
    //   .V_drift = evalVDriftInitBackGround,
    //   .ctx_V_drift = &ctx,
    //   .correct_all_moms = false,
    //   .iter_eps = 0,
    //   .max_iter = 0,
  ...
  struct gkyl_vm app_inp = {
   .name = "rt_can_pb_rot_surf_sphere_coriolis_backgrd_2x2v_p2",
