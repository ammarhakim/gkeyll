...
evalTriadBasisGradient(double t, const double* GKYL_RESTRICT xn, double* GKYL_RESTRICT fout, void* ctx)
{
  ...
  fout[2] = d_sigma_tx_dr;
  fout[3] = d_sigma_ty_dr;

  fout[4] = d_sigma_rx_dtheta;
  fout[5] = d_sigma_ry_dtheta;
  fout[6] = d_sigma_tx_dtheta;
  fout[7] = d_sigma_ty_dtheta;
}
...
main(int argc, char **argv)
{
  ...
  struct gkyl_vm app_inp = {
   .name = "triad_bgk_annulus_sodshock_1x2v_p2",
