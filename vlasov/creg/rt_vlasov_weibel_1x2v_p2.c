...
struct weibel_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
  ...
  double T_elc1 = 0.01; // First electron temperature.
  double T_elc2 = 0.01; // Second electron temperature.
