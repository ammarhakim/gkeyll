// Constant diffusion of a 2D sine wave using a p2 DG discretization of the advection-diffusion equation.
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_vlasov_fluid_species fluid = { .name = "q",
                                             .equation = advect,
                                             .advection = { .velocity = evalAdvectVel,
                                                            .velocity_ctx = &ctx },
                                             .diffusion = { .D = ctx.diffusion_coeff },
