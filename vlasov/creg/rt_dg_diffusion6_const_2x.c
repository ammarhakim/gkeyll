// Constant 6th-order diffusion of a 2D sine wave using a p2 DG discretization of the advection-diffusion equation.
...
void evalAdvectInit(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
  ...
  double f = sin(x) * sin(y); // Advected quantity.
...
int main(int argc, char **argv)
{
  ...
  struct gkyl_vlasov_fluid_species fluid = {
    ...
    .diffusion = { .D = ctx.diffusion_coeff, .order = ctx.diffusion_order },
