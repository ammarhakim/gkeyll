...
struct diffusion_ctx create_ctx(void)
{
  // Mathematical constants (dimensionless).
  double pi = M_PI;
...
void evalAdvectInit(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
...
void evalAdvectVel(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout, void *ctx)
{
...
void evalDiffusionInit(double t, const double *GKYL_RESTRICT xn, double *GKYL_RESTRICT fout,
                       void *ctx)
{
  ...
  double diffusion_xz = diffusion_coeff; // Diffusion tensor (xz-component).
  double diffusion_yy = diffusion_coeff; // Diffusion tensor (yy-component).
  double diffusion_yz = diffusion_coeff; // Diffusion tensor (yz-component).
  double diffusion_zz = diffusion_coeff; // Diffusion tensor (zz-component).
...
int main(int argc, char **argv)
{
  ...
  struct diffusion_ctx ctx = create_ctx(); // Context for initialization functions.
